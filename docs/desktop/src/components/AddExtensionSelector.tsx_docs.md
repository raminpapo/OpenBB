# File Documentation: AddExtensionSelector.tsx

## Metadata
- **Path**: `desktop/src/components/AddExtensionSelector.tsx`
- **Size**: 38,850 bytes
- **Lines**: 915
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `AddExtensionSelector.tsx`.

This file contains 915 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.029339Z
