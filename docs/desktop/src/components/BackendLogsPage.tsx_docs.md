# File Documentation: BackendLogsPage.tsx

## Metadata
- **Path**: `desktop/src/components/BackendLogsPage.tsx`
- **Size**: 8,791 bytes
- **Lines**: 253
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `BackendLogsPage.tsx`.

This file contains 253 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.032427Z
