# File Documentation: EnvironmentActions.tsx

## Metadata
- **Path**: `desktop/src/components/EnvironmentActions.tsx`
- **Size**: 6,660 bytes
- **Lines**: 192
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `EnvironmentActions.tsx`.

This file contains 192 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.034129Z
