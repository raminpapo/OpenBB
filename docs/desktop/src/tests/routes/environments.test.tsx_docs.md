# File Documentation: environments.test.tsx

## Metadata
- **Path**: `desktop/src/tests/routes/environments.test.tsx`
- **Size**: 20,076 bytes
- **Lines**: 514
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `environments.test.tsx`.

This file contains 514 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.109060Z
