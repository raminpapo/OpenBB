# File Documentation: uninstall.test.tsx

## Metadata
- **Path**: `desktop/src/tests/routes/uninstall.test.tsx`
- **Size**: 6,632 bytes
- **Lines**: 169
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `uninstall.test.tsx`.

This file contains 169 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.119022Z
