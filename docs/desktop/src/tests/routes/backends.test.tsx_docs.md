# File Documentation: backends.test.tsx

## Metadata
- **Path**: `desktop/src/tests/routes/backends.test.tsx`
- **Size**: 21,798 bytes
- **Lines**: 566
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `backends.test.tsx`.

This file contains 566 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.106453Z
