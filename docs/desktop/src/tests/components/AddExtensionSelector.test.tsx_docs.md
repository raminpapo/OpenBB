# File Documentation: AddExtensionSelector.test.tsx

## Metadata
- **Path**: `desktop/src/tests/components/AddExtensionSelector.test.tsx`
- **Size**: 14,214 bytes
- **Lines**: 348
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `AddExtensionSelector.test.tsx`.

This file contains 348 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.092585Z
