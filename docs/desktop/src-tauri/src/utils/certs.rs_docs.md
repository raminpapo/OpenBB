# File Documentation: certs.rs

## Metadata
- **Path**: `desktop/src-tauri/src/utils/certs.rs`
- **Size**: 18,195 bytes
- **Lines**: 563
- **Category**: text
- **Extension**: .rs
...
This is a **text** file named `certs.rs`.

This file contains 563 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.468308Z
