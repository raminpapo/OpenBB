# File Documentation: process_monitor.rs

## Metadata
- **Path**: `desktop/src-tauri/src/utils/process_monitor.rs`
- **Size**: 21,541 bytes
- **Lines**: 699
- **Category**: text
- **Extension**: .rs
...
This is a **text** file named `process_monitor.rs`.

This file contains 699 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.476155Z
