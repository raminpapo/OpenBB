# File Documentation: macos_autostart.rs

## Metadata
- **Path**: `desktop/src-tauri/src/utils/autostart/macos_autostart.rs`
- **Size**: 7,432 bytes
- **Lines**: 216
- **Category**: text
- **Extension**: .rs
...
This is a **text** file named `macos_autostart.rs`.

This file contains 216 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.480268Z
