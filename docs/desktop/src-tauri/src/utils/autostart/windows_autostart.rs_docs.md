# File Documentation: windows_autostart.rs

## Metadata
- **Path**: `desktop/src-tauri/src/utils/autostart/windows_autostart.rs`
- **Size**: 4,968 bytes
- **Lines**: 146
- **Category**: text
- **Extension**: .rs
...
This is a **text** file named `windows_autostart.rs`.

This file contains 146 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.483121Z
