# File Documentation: command_sanitizer.rs

## Metadata
- **Path**: `desktop/src-tauri/src/utils/command_sanitizer.rs`
- **Size**: 32,124 bytes
- **Lines**: 978
- **Category**: text
- **Extension**: .rs
...
This is a **text** file named `command_sanitizer.rs`.

This file contains 978 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.471340Z
