# File Documentation: backends.rs

## Metadata
- **Path**: `desktop/src-tauri/src/tauri_handlers/backends.rs`
- **Size**: 68,833 bytes
- **Lines**: 2,001
- **Category**: text
- **Extension**: .rs
...
This is a **text** file named `backends.rs`.

This file contains 2001 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.427203Z
