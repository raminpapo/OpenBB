# File Documentation: jupyter.rs

## Metadata
- **Path**: `desktop/src-tauri/src/tauri_handlers/jupyter.rs`
- **Size**: 25,707 bytes
- **Lines**: 727
- **Category**: text
- **Extension**: .rs
...
This is a **text** file named `jupyter.rs`.

This file contains 727 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.456415Z
