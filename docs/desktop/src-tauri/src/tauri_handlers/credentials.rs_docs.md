# File Documentation: credentials.rs

## Metadata
- **Path**: `desktop/src-tauri/src/tauri_handlers/credentials.rs`
- **Size**: 17,752 bytes
- **Lines**: 534
- **Category**: text
- **Extension**: .rs
...
This is a **text** file named `credentials.rs`.

This file contains 534 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.434156Z
