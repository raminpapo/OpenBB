# Documentation: openbb_platform/dev_install.py

## File Metadata
- **Path**: `openbb_platform/dev_install.py`
- **Size**: 9,102 characters, 216 lines
- **Words**: 1,022
- **Extension**: .py
...
**Functions** (4):
`extract_dependencies`, `get_all_dev_dependencies`, `install_platform_local`, `install_platform_cli`

**Imports** (9):
`subprocess`, `sys`, `pathlib`, `Path`, `tomlkit`, `dumps`, `a`, `all`, `dependencies`
...
## Notes
- Generated: 2025-11-18T07:54:35.891578
