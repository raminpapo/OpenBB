# File Documentation: dev_install.py

## Metadata
- **Path**: `openbb_platform/dev_install.py`
- **Size**: 9,102 bytes
- **Lines**: 216
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `dev_install.py`.

**Python Module**

- **Functions** (4): extract_dependencies, get_all_dev_dependencies, install_platform_local, install_platform_cli
- **Import Statements**: 1
...
- **`extract_dependencies(local_dep_path, dev: bool = False)`**
- **`get_all_dev_dependencies()`**
- **`install_platform_local(_extras: bool = False)`**
- **`install_platform_cli()`**
...
**Generated**: 2025-11-19T02:16:46.121274Z
