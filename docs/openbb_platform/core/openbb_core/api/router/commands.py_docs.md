# File Documentation: commands.py
...
This is a **python** file named `commands.py`.

**Python Module**

- **Functions** (8): build_new_annotation_map, build_new_signature, validate_output, is_model, exclude_fields_from_api, build_api_wrapper, wrapper, add_command_map
- **Import Statements**: 2
...
- **`is_model(type_)`**
- **`exclude_fields_from_api(key: str, value: Any)`**
...
**Generated**: 2025-11-19T02:16:46.198467Z
