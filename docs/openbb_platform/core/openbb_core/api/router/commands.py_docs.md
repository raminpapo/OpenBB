# Documentation: openbb_platform/core/openbb_core/api/router/commands.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/api/router/commands.py`
- **Size**: 9,950 characters, 288 lines
- **Words**: 794
- **Extension**: .py
...
**Functions** (8):
`build_new_annotation_map`, `build_new_signature`, `validate_output`, `is_model`, `exclude_fields_from_api`, `build_api_wrapper`, `wrapper`, `add_command_map`

**Imports** (44):
`inspect`, `collections.abc`, `Callable`, `functools`, `partial`, `inspect`, `Parameter`, `typing`, `Annotated`, `fastapi`, `APIRouter`, `fastapi.encoders`, `jsonable_encoder`, `fastapi.responses`, `JSONResponse`, `fastapi.routing`, `APIRoute`, `openbb_core.app.command_runner`, `CommandRunner`, `openbb_core.app.model.abstract.error`
...
## Notes
- Generated: 2025-11-18T07:54:35.402229
