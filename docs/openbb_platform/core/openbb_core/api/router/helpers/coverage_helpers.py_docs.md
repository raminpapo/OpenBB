# Documentation: openbb_platform/core/openbb_core/api/router/helpers/coverage_helpers.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/api/router/helpers/coverage_helpers.py`
- **Size**: 4,194 characters, 122 lines
- **Words**: 408
- **Extension**: .py
...
**Functions** (5):
`get_route_callable`, `signature_to_fields`, `dataclass_to_fields`, `create_combined_model`, `get_route_schema_map`

**Imports** (13):
`collections.abc`, `Callable`, `inspect`, `_empty`, `typing`, `TYPE_CHECKING`, `openbb_core.app.provider_interface`, `ProviderInterface`, `pydantic`, `BaseModel`, `openbb_core.app.static.app_factory`, `BaseApp`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:35.406625
