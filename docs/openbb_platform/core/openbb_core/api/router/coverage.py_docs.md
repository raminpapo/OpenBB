# Documentation: openbb_platform/core/openbb_core/api/router/coverage.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/api/router/coverage.py`
- **Size**: 4,261 characters, 106 lines
- **Words**: 278
- **Extension**: .py
...
**Functions** (4):
`get_commands_model_map`, `serializer`, `get_provider_coverage`, `get_command_coverage`

**Imports** (11):
`json`, `typing`, `Annotated`, `fastapi`, `APIRouter`, `openbb_core.api.dependency.coverage`, `get_command_map`, `openbb_core.app.provider_interface`, `ProviderInterface`, `openbb_core.app.router`, `CommandMap`
...
## Notes
- Generated: 2025-11-18T07:54:35.404070
