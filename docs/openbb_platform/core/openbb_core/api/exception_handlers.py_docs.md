# File Documentation: exception_handlers.py
...
This is a **python** file named `exception_handlers.py`.

**Python Module**

- **Classes** (1): ExceptionHandlers
- **Functions** (6): _handle, exception, validation, openbb, empty_data, unauthorized
- **Import Statements**: 1
...
- **`_handle(exception: Exception, status_code: int, detail: Any)`**
- **`validation(
        request: Request, error: ValidationError | ResponseValidationError
    )`**
- **`openbb(_: Request, error: OpenBBError)`**
- **`empty_data(_: Request, error: EmptyDataError)`**
- **`unauthorized(_: Request, error: UnauthorizedError)`**
...
**Generated**: 2025-11-19T02:16:46.187686Z
