# Documentation: openbb_platform/core/openbb_core/api/exception_handlers.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/api/exception_handlers.py`
- **Size**: 4,715 characters, 135 lines
- **Words**: 387
- **Extension**: .py
...
**Functions** (6):
`_handle`, `exception`, `validation`, `openbb`, `empty_data`, `unauthorized`

**Imports** (20):
`logging`, `collections.abc`, `Iterable`, `typing`, `Any`, `fastapi`, `Request`, `fastapi.exceptions`, `ResponseValidationError`, `fastapi.responses`, `JSONResponse`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.env`, `Env`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `ValidationError`, `a`


## Key Components

**Class `ExceptionHandlers`**: Exception handlers.
...
## Notes
- Generated: 2025-11-18T07:54:35.397809
