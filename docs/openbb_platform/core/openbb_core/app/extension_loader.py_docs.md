# File Documentation: extension_loader.py
...
This is a **python** file named `extension_loader.py`.

**Python Module**

- **Classes** (2): OpenBBGroups, ExtensionLoader
- **Functions** (20): groups, __init__, on_command_output_callbacks, _register_command_output_callbacks, obbject_entry_points, core_entry_points, provider_entry_points, entry_points, _get_entry_point, get_obbject_entry_point ... and 10 more
- **Import Statements**: 4
...
- **`OpenBBGroups`**(Enum)
- **`ExtensionLoader`**(metaclass=SingletonMeta)
...
**Generated**: 2025-11-19T02:16:46.216347Z
