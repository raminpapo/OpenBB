# Documentation: openbb_platform/core/openbb_core/app/model/extension.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/model/extension.py`
- **Size**: 5,406 characters, 141 lines
- **Words**: 525
- **Extension**: .py
...
**Classes** (3):
`for`, `Extension`, `CachedAccessor`

**Functions** (6):
`__init__`, `obbject_accessor`, `register_accessor`, `decorator`, `__init__`, `__get__`

**Imports** (9):
`warnings`, `collections.abc`, `Callable`, `openbb_core.app.service.system_service`, `SystemService`, `a`, `a`, `openbb_core.app.model.obbject`, `OBBject`


## Key Components

**Class `for`**: Serves as OBBject extension entry point and must be created by each extension package.

    See https://docs.openbb.co/developer/extension_types/obbject for more information.

**Class `CachedAccessor`**: CachedAccessor.
...
## Notes
- Generated: 2025-11-18T07:54:35.450552
