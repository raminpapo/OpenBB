# Documentation: openbb_platform/core/openbb_core/app/model/metadata.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/model/metadata.py`
- **Size**: 5,771 characters, 144 lines
- **Words**: 467
- **Extension**: .py
...
**Functions** (2):
`__repr__`, `scale_arguments`

**Imports** (16):
`collections.abc`, `Sequence`, `datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.data`, `Data`, `pydantic`, `BaseModel`, `inspect`, `isclass`, `numpy`, `ndarray`, `pandas`, `DataFrame`


## Key Components

**Class `Metadata`**: Metadata of a command execution.

**Class `or`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:35.453826
