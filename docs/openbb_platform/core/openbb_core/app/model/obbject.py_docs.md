# Documentation: openbb_platform/core/openbb_core/app/model/obbject.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/model/obbject.py`
- **Size**: 12,449 characters, 383 lines
- **Words**: 1,155
- **Extension**: .py
...
**Functions** (10):
`__repr__`, `to_df`, `to_dataframe`, `is_list_of_basemodel`, `to_polars`, `to_numpy`, `to_dict`, `to_llm`, `show`, `from_query`

**Imports** (38):
`collections.abc`, `Callable`, `typing`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.model.abstract.tagged`, `Tagged`, `openbb_core.app.model.abstract.warning`, `Warning_`, `openbb_core.app.model.charts.chart`, `Chart`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.data`, `Data`, `pydantic`, `BaseModel`, `numpy`, `ndarray`, `pandas`


## Key Components

**Class `OBBject`**: OpenBB object.
...
## Notes
- Generated: 2025-11-18T07:54:35.455780
