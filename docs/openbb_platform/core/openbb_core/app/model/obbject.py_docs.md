...
This is a **python** file named `obbject.py`.

**Python Module**

- **Classes** (1): OBBject
- **Functions** (10): __repr__, to_df, to_dataframe, is_list_of_basemodel, to_polars, to_numpy, to_dict, to_llm, show, from_query
- **Import Statements**: 9
...
**Generated**: 2025-11-19T02:16:46.259847Z
