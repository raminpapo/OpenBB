# Documentation: openbb_platform/core/openbb_core/app/model/charts/charting_settings.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/model/charts/charting_settings.py`
- **Size**: 2,086 characters, 56 lines
- **Words**: 137
- **Extension**: .py
...
**Imports** (11):
`importlib`, `pathlib`, `Path`, `typing`, `TYPE_CHECKING`, `openbb_core.env`, `Env`, `openbb_core.app.model.system_settings`, `SystemSettings`, `openbb_core.app.model.user_settings`, `UserSettings`


## Key Components

**Class `ChartingSettings`**: Charting settings.
...
## Notes
- Generated: 2025-11-18T07:54:35.441145
