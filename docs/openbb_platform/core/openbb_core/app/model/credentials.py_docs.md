# Documentation: openbb_platform/core/openbb_core/app/model/credentials.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/model/credentials.py`
- **Size**: 7,605 characters, 224 lines
- **Words**: 604
- **Extension**: .py
...
**Classes** (3):
`LoadingError`, `CredentialsLoader`, `Credentials`

**Functions** (10):
`_normalize_credential_map`, `format_credentials`, `from_obbject`, `from_providers`, `load`, `_is_unset`, `model_post_init`, `__repr__`, `show`, `update`

**Imports** (26):
`json`, `os`, `traceback`, `warnings`, `pathlib`, `Path`, `typing`, `Annotated`, `openbb_core.app.constants`, `USER_SETTINGS_PATH`, `openbb_core.app.extension_loader`, `ExtensionLoader`, `openbb_core.app.model.abstract.warning`, `OpenBBWarning`, `openbb_core.app.provider_interface`, `ProviderInterface`, `openbb_core.env`, `Env`, `pydantic`, `pydantic.functional_serializers`
...
**Class `CredentialsLoader`**: Here we create the Credentials model.

**Class `Credentials`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:35.444585
