...
This is a **python** file named `example.py`.

**Python Module**

- **Classes** (4): to, Example, APIEx, PythonEx
- **Functions** (9): to_python, provider, validate_model, _unpack_type, _shift, mock_data, to_python, to_python, filter_list
- **Import Statements**: 1
...
abstractmethod, classmethod, computed_field, model_validator, property, staticmethod
...
**Generated**: 2025-11-19T02:16:46.252542Z
