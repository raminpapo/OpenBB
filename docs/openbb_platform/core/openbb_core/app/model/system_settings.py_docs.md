# File Documentation: system_settings.py
...
This is a **python** file named `system_settings.py`.

**Python Module**

- **Classes** (1): SystemSettings
- **Functions** (4): __repr__, create_json, create_openbb_directory, validate_logging_handlers
- **Import Statements**: 4
...
- **`SystemSettings`**(Tagged)

#### Functions

- **`validate_logging_handlers(cls, v)`**
...
**Generated**: 2025-11-19T02:16:46.265710Z
