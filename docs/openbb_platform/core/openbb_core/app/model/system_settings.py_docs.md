# Documentation: openbb_platform/core/openbb_core/app/model/system_settings.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/model/system_settings.py`
- **Size**: 3,884 characters, 105 lines
- **Words**: 358
- **Extension**: .py
...
**Functions** (4):
`__repr__`, `create_json`, `create_openbb_directory`, `validate_logging_handlers`

**Imports** (20):
`json`, `platform`, `doesn`, `pathlib`, `Path`, `typing`, `Literal`, `openbb_core.app.constants`, `openbb_core.app.model.abstract.tagged`, `Tagged`, `openbb_core.app.model.api_settings`, `APISettings`, `openbb_core.app.model.python_settings`, `PythonSettings`, `openbb_core.app.version`, `CORE_VERSION`, `openbb_core.env`, `Env`, `pydantic`, `ConfigDict`


## Key Components

**Class `SystemSettings`**: System settings model.
...
- `openbb_core.app.model.api_settings`
- `openbb_core.app.model.python_settings`
- `openbb_core.app.version`

## Notes
- Generated: 2025-11-18T07:54:35.463294
