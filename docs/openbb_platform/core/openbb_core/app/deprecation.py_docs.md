# File Documentation: deprecation.py
...
This is a **python** file named `deprecation.py`.

**Python Module**

- **Classes** (6): DeprecationSummary, that, OpenBBDeprecationWarning, variables, in, level
- **Functions** (3): __new__, __init__, __str__
- **Import Statements**: 1
...
- **`DeprecationSummary`**(str)
- **`OpenBBDeprecationWarning`**(DeprecationWarning)

#### Functions

- **`__new__(cls, value: str, metadata: DeprecationWarning)`**
...
**Generated**: 2025-11-19T02:16:46.214697Z
