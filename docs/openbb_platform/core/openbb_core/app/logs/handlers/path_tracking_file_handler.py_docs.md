# Documentation: openbb_platform/core/openbb_core/app/logs/handlers/path_tracking_file_handler.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/logs/handlers/path_tracking_file_handler.py`
- **Size**: 2,706 characters, 87 lines
- **Words**: 184
- **Extension**: .py
...
**Functions** (5):
`build_log_file_path`, `clean_expired_files`, `settings`, `settings`, `__init__`

**Imports** (10):
`copy`, `deepcopy`, `logging.handlers`, `TimedRotatingFileHandler`, `pathlib`, `Path`, `openbb_core.app.logs.models.logging_settings`, `LoggingSettings`, `openbb_core.app.logs.utils.expired_files`, `logs`


## Key Components

**Class `PathTrackingFileHandler`**: Path Tracking File Handler.
...
## Notes
- Generated: 2025-11-18T07:54:35.420815
