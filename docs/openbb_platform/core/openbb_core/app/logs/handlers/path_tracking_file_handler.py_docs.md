# File Documentation: path_tracking_file_handler.py
...
This is a **python** file named `path_tracking_file_handler.py`.

**Python Module**

- **Classes** (1): PathTrackingFileHandler
- **Functions** (5): build_log_file_path, clean_expired_files, settings, settings, __init__
- **Import Statements**: 2
...
- **`PathTrackingFileHandler`**(TimedRotatingFileHandler)

#### Functions

- **`clean_expired_files(self, before_timestamp: float)`**

#### Decorators Used

property, settings, staticmethod
...
**Generated**: 2025-11-19T02:16:46.237830Z
