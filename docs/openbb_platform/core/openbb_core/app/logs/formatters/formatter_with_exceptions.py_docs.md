# Documentation: openbb_platform/core/openbb_core/app/logs/formatters/formatter_with_exceptions.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/logs/formatters/formatter_with_exceptions.py`
- **Size**: 6,322 characters, 209 lines
- **Words**: 489
- **Extension**: .py
...
**Functions** (15):
`calculate_level_name`, `extract_log_extra`, `mock_ipv4`, `mock_email`, `mock_password`, `mock_flair`, `mock_home_directory`, `filter_special_tags`, `filter_piis`, `filter_log_line`, `__init__`, `settings`, `settings`, `formatException`, `format`

**Imports** (12):
`logging`, `openbb_core.app.logs.models.logging_settings`, `LoggingSettings`, `the`, `re`, `re`, `re`, `re`, `pathlib`, `Path`, `copy`, `deepcopy`


## Key Components

**Class `FormatterWithExceptions`**: Logging Formatter that includes formatting of Exceptions.
...
## Notes
- Generated: 2025-11-18T07:54:35.419310
