# File Documentation: formatter_with_exceptions.py
...
This is a **python** file named `formatter_with_exceptions.py`.

**Python Module**

- **Classes** (1): FormatterWithExceptions
- **Functions** (15): calculate_level_name, extract_log_extra, mock_ipv4, mock_email, mock_password, mock_flair, mock_home_directory, filter_special_tags, filter_piis, filter_log_line ... and 5 more
- **Import Statements**: 7
...
- **`FormatterWithExceptions`**(logging.Formatter)

#### Functions

- **`extract_log_extra(record: logging.LogRecord)`**
- **`filter_log_line(cls, text: str)`**

#### Decorators Used

classmethod, property, settings, staticmethod
...
**Generated**: 2025-11-19T02:16:46.235482Z
