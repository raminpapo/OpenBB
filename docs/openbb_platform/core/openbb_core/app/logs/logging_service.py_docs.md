# File Documentation: logging_service.py
...
This is a **python** file named `logging_service.py`.

**Python Module**

- **Classes** (4): DummyProvider, LoggingService, responsible, CredentialsDefinition
- **Functions** (7): __init__, logging_settings, logging_settings, _setup_handlers, _log_startup, check_credentials_defined, log
- **Import Statements**: 2
...
- **`DummyProvider`**(BaseModel)
- **`LoggingService`**(metaclass=SingletonMeta)
- **`CredentialsDefinition`**(Enum)

#### Functions

- **`check_credentials_defined(credentials: dict[str, Any])`**

#### Decorators Used

logging_settings, property
...
**Generated**: 2025-11-19T02:16:46.232914Z
