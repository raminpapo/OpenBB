# Documentation: openbb_platform/core/openbb_core/app/logs/logging_service.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/logs/logging_service.py`
- **Size**: 9,307 characters, 283 lines
- **Words**: 692
- **Extension**: .py
...
**Classes** (4):
`DummyProvider`, `LoggingService`, `responsible`, `CredentialsDefinition`

**Functions** (7):
`__init__`, `logging_settings`, `logging_settings`, `_setup_handlers`, `_log_startup`, `check_credentials_defined`, `log`

**Imports** (25):
`json`, `logging`, `collections.abc`, `Callable`, `enum`, `Enum`, `types`, `TracebackType`, `typing`, `Any`, `openbb_core.app.logs.formatters.formatter_with_exceptions`, `openbb_core.app.logs.handlers_manager`, `HandlersManager`, `openbb_core.app.logs.models.logging_settings`, `LoggingSettings`, `openbb_core.app.model.abstract.singleton`, `SingletonMeta`, `openbb_core.app.model.system_settings`, `SystemSettings`, `openbb_core.app.model.user_settings`


## Key Components

**Class `DummyProvider`**: Dummy Provider for error handling with logs.

**Class `LoggingService`**: Logging Service class responsible for managing logging settings and handling logs.
...
**Class `CredentialsDefinition`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:35.423604
