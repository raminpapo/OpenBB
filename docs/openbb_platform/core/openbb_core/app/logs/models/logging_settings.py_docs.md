# Documentation: openbb_platform/core/openbb_core/app/logs/models/logging_settings.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/logs/models/logging_settings.py`
- **Size**: 2,347 characters, 57 lines
- **Words**: 183
- **Extension**: .py
...
**Imports** (8):
`pathlib`, `Path`, `openbb_core.app.logs.utils.utils`, `get_app_id`, `openbb_core.app.model.system_settings`, `SystemSettings`, `openbb_core.app.model.user_settings`, `UserSettings`


## Key Components

**Class `LoggingSettings`**: Logging settings.
...
## Notes
- Generated: 2025-11-18T07:54:35.425132
