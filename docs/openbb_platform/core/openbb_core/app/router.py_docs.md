...
This is a **python** file named `router.py`.

**Python Module**

- **Classes** (7): from, OpenBBErrorResponse, Router, SignatureInspector, CommandMap, LoadingError, RouterLoader
- **Functions** (29): api_router, prefix, description, routers, __init__, command, command, command, include_router, get_attr ... and 19 more
- **Import Statements**: 3
...
classmethod, lru_cache, overload, property, staticmethod
...
**Generated**: 2025-11-19T02:16:46.224291Z
