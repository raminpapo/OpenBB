# Documentation: openbb_platform/core/openbb_core/app/utils.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/utils.py`
- **Size**: 6,641 characters, 194 lines
- **Words**: 677
- **Extension**: .py
...
**Functions** (10):
`basemodel_to_df`, `df_to_basemodel`, `list_to_basemodel`, `dict_to_basemodel`, `ndarray_to_basemodel`, `convert_to_basemodel`, `get_target_column`, `get_target_columns`, `get_user_cache_directory`, `check_single_item`

**Imports** (36):
`ast`, `json`, `datetime`, `time`, `typing`, `TYPE_CHECKING`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.model.preferences`, `Preferences`, `openbb_core.app.model.system_settings`, `SystemSettings`, `openbb_core.provider.abstract.data`, `Data`, `pydantic`, `ValidationError`, `numpy`, `ndarray`, `pandas`, `DataFrame`
...
## Notes
- Generated: 2025-11-18T07:54:35.501005
