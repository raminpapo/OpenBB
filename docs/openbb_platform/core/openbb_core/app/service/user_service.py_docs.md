# Documentation: openbb_platform/core/openbb_core/app/service/user_service.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/service/user_service.py`
- **Size**: 2,682 characters, 79 lines
- **Words**: 240
- **Extension**: .py
...
**Functions** (7):
`__init__`, `read_from_file`, `write_to_file`, `_merge_dicts`, `recursive_merge`, `default_user_settings`, `default_user_settings`

**Imports** (16):
`json`, `collections.abc`, `MutableMapping`, `functools`, `reduce`, `pathlib`, `Path`, `typing`, `Any`, `openbb_core.app.constants`, `USER_SETTINGS_PATH`, `openbb_core.app.model.abstract.singleton`, `SingletonMeta`, `openbb_core.app.model.user_settings`, `UserSettings`, `json`
...
## Notes
- Generated: 2025-11-18T07:54:35.476694
