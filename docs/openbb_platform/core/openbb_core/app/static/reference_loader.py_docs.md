# File Documentation: reference_loader.py
...
This is a **python** file named `reference_loader.py`.

**Python Module**

- **Classes** (3): for, ReferenceLoader, for
- **Functions** (4): __init__, reference, _get_default_directory, _load
- **Import Statements**: 1
...
- **`ReferenceLoader`**(metaclass=SingletonMeta)

#### Functions

- **`__init__(self, directory: Path | None = None)`**
- **`_load(self, file_path: Path)`**
...
**Generated**: 2025-11-19T02:16:46.312226Z
