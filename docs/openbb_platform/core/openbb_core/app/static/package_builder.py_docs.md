# File Documentation: package_builder.py
...
This is a **python** file named `package_builder.py`.

**Python Module**

- **Classes** (17): FileLock, PackageBuilder, ModuleBuilder, ImportDefinition, ClassDefinition, definition, definition, MethodDefinition, loader, DocstringGenerator ... and 7 more
- **Functions** (73): create_indent, __init__, acquire, release, __init__, auto_build, build, _clean, _get_extension_map, _save_modules ... and 63 more
...
- **`_save_package(self)`**
- **`_save_reference_file(self, ext_map: dict[str, list[str]] | None = None)`**
- **`_run_linters(self)`**
- **`get_default(field: FieldInfo)`**
- **`add_field_custom_annotations(
        od: OrderedDict[str, Parameter], model_name: str | None = None
    )`**
...
- **`build_command_method_body(
        path: str,
        func: Callable,
        formatted_params: OrderedDict[str, Parameter] | None = None,
    )`**
- **`get_route(path: str, route_map: dict[str, BaseRoute])`**

#### Decorators Used

1, classmethod, deprecated, exception_handler, property, staticmethod, validate
...
**Generated**: 2025-11-19T02:16:46.301238Z
