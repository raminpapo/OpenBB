# Documentation: openbb_platform/core/openbb_core/app/static/utils/decorators.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/static/utils/decorators.py`
- **Size**: 3,681 characters, 109 lines
- **Words**: 302
- **Extension**: .py
...
**Functions** (7):
`validate`, `validate`, `validate`, `decorated`, `wrapper`, `exception_handler`, `wrapper`

**Imports** (23):
`collections.abc`, `Callable`, `functools`, `wraps`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.env`, `Env`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `ValidationError`, `typing_extensions`, `ParamSpec`, `the`, `the`, `None`, `None`
...
## Notes
- Generated: 2025-11-18T07:54:35.496499
