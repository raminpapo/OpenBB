# Documentation: openbb_platform/core/openbb_core/app/static/container.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/static/container.py`
- **Size**: 4,272 characters, 115 lines
- **Words**: 387
- **Extension**: .py
...
**Functions** (4):
`__init__`, `_run`, `_check_credentials`, `_get_provider`

**Imports** (8):
`typing`, `TYPE_CHECKING`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.command_runner`, `CommandRunner`, `openbb_core.app.model.obbject`, `OBBject`


## Key Components

**Class `Container`**: Container class for the command runner session.
...
## Notes
- Generated: 2025-11-18T07:54:35.480618
