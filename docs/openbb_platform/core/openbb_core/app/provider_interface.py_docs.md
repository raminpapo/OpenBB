# File Documentation: provider_interface.py
...
This is a **python** file named `provider_interface.py`.

**Python Module**

- **Classes** (21): from, class, field, class, class, StandardData, ExtraData, class, ProviderInterface, with ... and 11 more
- **Functions** (26): __init__, map, credentials, model_providers, params, data, return_schema, available_providers, provider_choices, models ... and 16 more
- **Import Statements**: 3
...
- **`StandardParams`**
- **`ExtraParams`**
- **`StandardData`**(BaseModel)
- **`ExtraData`**(BaseModel)
- **`ProviderChoices`**
- **`ProviderInterface`**(metaclass=SingletonMeta)
- **`CompanyNews`**(StandardParams)
- **`CompanyNews`**(ExtraParams)
- **`CompanyNews`**(ProviderChoices)
- **`EquityHistoricalData`**(StandardData)
- **`Data`**(BaseModel)
- **`EquityData`**(Data)
- **`YFEquityData`**(EquityData)
- **`AVEquityData`**(EquityData)
- **`OBBject`**(BaseModel)

#### Functions

- **`get_provider(v: type[BaseModel])`**

#### Decorators Used

classmethod, dataclass, property, staticmethod
...
**Generated**: 2025-11-19T02:16:46.218892Z
