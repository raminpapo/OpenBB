# Documentation: openbb_platform/core/openbb_core/app/provider_interface.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/app/provider_interface.py`
- **Size**: 23,180 characters, 666 lines
- **Words**: 1,738
- **Extension**: .py
...
**Classes** (21):
`from`, `class`, `field`, `class`, `class`, `StandardData`, `ExtraData`, `class`, `ProviderInterface`, `with`, `with`, `fields`, `class`, `class`, `class`, `EquityHistoricalData`, `Data`, `EquityData`, `YFEquityData`, `AVEquityData`

**Functions** (26):
`__init__`, `map`, `credentials`, `model_providers`, `params`, `data`, `return_schema`, `available_providers`, `provider_choices`, `models`, `return_annotations`, `create_executor`, `_merge_fields`, `split_desc`, `merge_json_schema_extra`, `_create_field`, `_extract_params`, `_extract_data`, `_generate_params_dc`, `_generate_model_providers_dc`

**Imports** (24):
`collections.abc`, `Callable`, `dataclasses`, `dataclass`, `difflib`, `SequenceMatcher`, `typing`, `fastapi`, `Body`, `openbb_core.app.model.abstract.singleton`, `SingletonMeta`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.provider.query_executor`, `QueryExecutor`, `openbb_core.provider.registry_map`, `MapType`, `openbb_core.provider.utils.helpers`, `to_snake_case`, `pydantic`


## Key Components

**Class `from`**: Dataclass field.

**Class `class`**: Standard params dataclass.

**Class `class`**: Extra params dataclass.

**Class `StandardData`**: Standard data model.

**Class `ExtraData`**: Extra data model.

**Class `class`**: Provider choices dataclass.

**Class `ProviderInterface`**: Provider interface class.
...
**Class `with`**: List of model names.

**Class `fields`**: No documentation

**Class `class`**: No documentation

**Class `class`**: No documentation

**Class `class`**: No documentation

**Class `EquityHistoricalData`**: No documentation

**Class `Data`**: No documentation

**Class `EquityData`**: No documentation

**Class `YFEquityData`**: No documentation

**Class `AVEquityData`**: No documentation

**Class `OBBject`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:35.466620
