# Documentation: openbb_platform/core/openbb_core/provider/abstract/fetcher.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/abstract/fetcher.py`
- **Size**: 9,093 characters, 234 lines
- **Words**: 863
- **Extension**: .py
...
**Classes** (5):
`for`, `classproperty`, `Fetcher`, `for`, `must`

**Functions** (13):
`__init__`, `__get__`, `transform_query`, `aextract_data`, `extract_data`, `transform_data`, `__init_subclass__`, `fetch_data`, `query_params_type`, `return_type`, `data_type`, `_get_data_type`, `test`

**Imports** (14):
`typing`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.utils.helpers`, `maybe_coroutine`, `the`, `the`, `a`, `pandas`, `DataFrame`
...
**Class `classproperty`**: Class property decorator.

**Class `Fetcher`**: Abstract class for the fetcher.

**Class `must`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:35.512421
