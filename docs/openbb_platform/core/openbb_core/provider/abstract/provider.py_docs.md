# Documentation: openbb_platform/core/openbb_core/provider/abstract/provider.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/abstract/provider.py`
- **Size**: 2,022 characters, 55 lines
- **Words**: 206
- **Extension**: .py
...
**Class `Provider`**: Serves as provider extension entry point and must be created by each provider.
...
## Notes
- Generated: 2025-11-18T07:54:35.514307
