# Documentation: openbb_platform/core/openbb_core/provider/query_executor.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/query_executor.py`
- **Size**: 3,685 characters, 98 lines
- **Words**: 321
- **Extension**: .py
...
**Functions** (5):
`__init__`, `get_provider`, `get_fetcher`, `filter_credentials`, `execute`

**Imports** (15):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.provider`, `Provider`, `openbb_core.provider.registry`, `Registry`, `pydantic`, `SecretStr`, `providers.`, `the`, `a`


## Key Components

**Class `QueryExecutor`**: Class to execute queries from providers.
...
## Notes
- Generated: 2025-11-18T07:54:35.517168
