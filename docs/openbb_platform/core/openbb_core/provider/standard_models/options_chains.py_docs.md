# Documentation: openbb_platform/core/openbb_core/provider/standard_models/options_chains.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/options_chains.py`
- **Size**: 15,847 characters, 372 lines
- **Words**: 1,623
- **Extension**: .py
...
**Classes** (2):
`OptionsChainsQueryParams`, `OptionsChainsData`

**Functions** (3):
`to_upper`, `_date_validate`, `model_serialize`

**Imports** (9):
`datetime`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.utils.descriptions`, `openbb_core.provider.utils.options_chains_properties`, `OptionsChainsProperties`, `pydantic`, `Field`, `the`


## Key Components

**Class `OptionsChainsQueryParams`**: Options Chains Query.

**Class `OptionsChainsData`**: Options Chains Data.

    Note: The attached properties and methods are available only when working with an instance of this class,
    initialized with validated provider data. The items below bind t
...
- `openbb_core.provider.utils.options_chains_properties`
- `pydantic`

## Notes
- Generated: 2025-11-18T07:54:35.705472
