# Documentation: openbb_platform/core/openbb_core/provider/standard_models/country_profile.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/country_profile.py`
- **Size**: 3,653 characters, 87 lines
- **Words**: 307
- **Extension**: .py
...
**Classes** (2):
`CountryProfileQueryParams`, `CountryProfileData`
...
**Class `CountryProfileQueryParams`**: Country Profile Query.

**Class `CountryProfileData`**: Country Profile Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.570818
