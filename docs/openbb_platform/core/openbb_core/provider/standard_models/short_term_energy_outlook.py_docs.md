# Documentation: openbb_platform/core/openbb_core/provider/standard_models/short_term_energy_outlook.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/short_term_energy_outlook.py`
- **Size**: 1,364 characters, 39 lines
- **Words**: 134
- **Extension**: .py
...
**Classes** (2):
`ShortTermEnergyOutlookQueryParams`, `ShortTermEnergyOutlookData`
...
**Class `ShortTermEnergyOutlookQueryParams`**: Short Term Energy Outlook Query.

**Class `ShortTermEnergyOutlookData`**: Short Term Energy Outlook Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.737970
