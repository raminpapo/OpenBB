# Documentation: openbb_platform/core/openbb_core/provider/standard_models/price_target.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/price_target.py`
- **Size**: 2,800 characters, 85 lines
- **Words**: 293
- **Extension**: .py
...
**Classes** (2):
`PriceTargetQueryParams`, `PriceTargetData`

**Functions** (1):
`to_upper`

**Imports** (9):
`datetime`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.utils.descriptions`, `pydantic`, `Field`, `firm`


## Key Components

**Class `PriceTargetQueryParams`**: Price Target Query.

**Class `PriceTargetData`**: Price Target Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.716828
