# Documentation: openbb_platform/core/openbb_core/provider/standard_models/balance_of_payments.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/balance_of_payments.py`
- **Size**: 22,911 characters, 574 lines
- **Words**: 2,330
- **Extension**: .py
...
**Classes** (10):
`BalanceOfPaymentsQueryParams`, `BP6BopUsdData`, `ECBMain`, `ECBSummary`, `ECBServices`, `ECBInvestmentIncome`, `ECBDirectInvestment`, `ECBPortfolioInvestment`, `ECBOtherInvestment`, `ECBCountry`
...
**Class `BalanceOfPaymentsQueryParams`**: Balance Of Payments Query.

**Class `BP6BopUsdData`**: OECD BP6 Balance of Payments Items, in USD.

**Class `ECBMain`**: ECB Main Balance of Payments Items.

**Class `ECBSummary`**: ECB Summary Balance of Payments Items.

**Class `ECBServices`**: ECB Services Balance of Payments Items.

**Class `ECBInvestmentIncome`**: ECB Investment Income Balance of Payments Items.

**Class `ECBDirectInvestment`**: ECB Direct Investment Balance of Payments Items.

**Class `ECBPortfolioInvestment`**: ECB Portfolio Investment Balance of Payments Items.

**Class `ECBOtherInvestment`**: ECB Other Investment Balance of Payments Items.

**Class `ECBCountry`**: ECB Balance of Payments Items by Country.
...
## Notes
- Generated: 2025-11-18T07:54:35.530715
