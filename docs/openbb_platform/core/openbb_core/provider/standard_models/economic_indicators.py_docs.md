...
- **Classes** (2): EconomicIndicatorsQueryParams, EconomicIndicatorsData
- **Import Statements**: 2
...
- **`EconomicIndicatorsQueryParams`**(QueryParams)
- **`EconomicIndicatorsData`**(Data)
...
**Generated**: 2025-11-19T02:16:46.415486Z
