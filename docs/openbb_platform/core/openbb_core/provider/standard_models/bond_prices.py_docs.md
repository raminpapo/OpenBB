# Documentation: openbb_platform/core/openbb_core/provider/standard_models/bond_prices.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/bond_prices.py`
- **Size**: 3,908 characters, 122 lines
- **Words**: 416
- **Extension**: .py
...
**Classes** (2):
`BondPricesQueryParams`, `BondPricesData`
...
**Class `BondPricesQueryParams`**: Bond Prices Query.

**Class `BondPricesData`**: Bond Prices Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.539841
