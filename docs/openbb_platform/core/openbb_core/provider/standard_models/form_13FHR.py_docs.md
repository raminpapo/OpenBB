...
- **Classes** (5): Form13FHRQueryParams, Form13FHRData, for, of, of
- **Functions** (2): to_upper, validate_option_type
- **Import Statements**: 2
...
- **`Form13FHRQueryParams`**(QueryParams)
- **`Form13FHRData`**(Data)

#### Functions

- **`to_upper(cls, v: str)`**
- **`validate_option_type(cls, v: str)`**
...
**Generated**: 2025-11-19T02:16:46.463582Z
