# Documentation: openbb_platform/core/openbb_core/provider/standard_models/form_13FHR.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/form_13FHR.py`
- **Size**: 4,156 characters, 110 lines
- **Words**: 505
- **Extension**: .py
...
**Classes** (5):
`Form13FHRQueryParams`, `Form13FHRData`, `for`, `of`, `of`

**Functions** (2):
`to_upper`, `validate_option_type`
...
**Class `Form13FHRQueryParams`**: Form 13F-HR Query.

**Class `Form13FHRData`**: Form 13F-HR Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.635296
