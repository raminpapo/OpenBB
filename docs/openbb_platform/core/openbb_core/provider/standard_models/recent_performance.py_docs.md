# Documentation: openbb_platform/core/openbb_core/provider/standard_models/recent_performance.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/recent_performance.py`
- **Size**: 3,962 characters, 110 lines
- **Words**: 305
- **Extension**: .py
...
**Classes** (2):
`RecentPerformanceQueryParams`, `RecentPerformanceData`

**Functions** (1):
`to_upper`

**Imports** (8):
`openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.utils.descriptions`, `pydantic`, `Field`, `the`


## Key Components

**Class `RecentPerformanceQueryParams`**: Recent Performance Query.

**Class `RecentPerformanceData`**: Recent Performance Data. All returns are normalized percents.
...
## Notes
- Generated: 2025-11-18T07:54:35.721416
