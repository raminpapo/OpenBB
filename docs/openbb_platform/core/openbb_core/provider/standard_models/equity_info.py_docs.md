# Documentation: openbb_platform/core/openbb_core/provider/standard_models/equity_info.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/equity_info.py`
- **Size**: 5,290 characters, 142 lines
- **Words**: 576
- **Extension**: .py
...
**Classes** (2):
`EquityInfoQueryParams`, `EquityInfoData`
...
**Class `EquityInfoQueryParams`**: Equity Info Query.

**Class `EquityInfoData`**: Equity Info Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.594593
