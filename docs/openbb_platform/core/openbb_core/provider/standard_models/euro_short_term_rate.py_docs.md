...
- **Classes** (2): EuroShortTermRateQueryParams, EuroShortTermRateData
- **Import Statements**: 2
...
- **`EuroShortTermRateQueryParams`**(QueryParams)
- **`EuroShortTermRateData`**(Data)
...
**Generated**: 2025-11-19T02:16:46.451735Z
