# Documentation: openbb_platform/core/openbb_core/provider/standard_models/overnight_bank_funding_rate.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/overnight_bank_funding_rate.py`
- **Size**: 2,215 characters, 64 lines
- **Words**: 176
- **Extension**: .py
...
**Classes** (2):
`OvernightBankFundingRateQueryParams`, `OvernightBankFundingRateData`
...
**Class `OvernightBankFundingRateQueryParams`**: Overnight Bank Funding Rate Query.

**Class `OvernightBankFundingRateData`**: Overnight Bank Funding Rate Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.711326
