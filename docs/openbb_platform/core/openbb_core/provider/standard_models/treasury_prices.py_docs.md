# Documentation: openbb_platform/core/openbb_core/provider/standard_models/treasury_prices.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/treasury_prices.py`
- **Size**: 3,576 characters, 101 lines
- **Words**: 380
- **Extension**: .py
...
**Classes** (2):
`TreasuryPricesQueryParams`, `TreasuryPricesData`
...
**Class `TreasuryPricesQueryParams`**: Treasury Prices Query.

**Class `TreasuryPricesData`**: Treasury Prices Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.756869
