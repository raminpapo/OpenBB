# Documentation: openbb_platform/core/openbb_core/provider/standard_models/manufacturing_outlook_texas.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/manufacturing_outlook_texas.py`
- **Size**: 1,842 characters, 50 lines
- **Words**: 160
- **Extension**: .py
...
**Classes** (2):
`ManufacturingOutlookTexasQueryParams`, `ManufacturingOutlookTexasData`
...
**Class `ManufacturingOutlookTexasQueryParams`**: Manufacturing Outlook - Texas - Query.

**Class `ManufacturingOutlookTexasData`**: Manufacturing Outlook - Texas - Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.693285
