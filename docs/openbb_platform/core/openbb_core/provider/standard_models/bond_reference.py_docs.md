# File Documentation: bond_reference.py
...
This is a **python** file named `bond_reference.py`.

**Python Module**

- **Classes** (2): BondReferenceQueryParams, BondReferenceData
- **Functions** (1): validate_upper_case
- **Import Statements**: 1
...
- **`BondReferenceQueryParams`**(QueryParams)
- **`BondReferenceData`**(Data)

#### Functions

- **`validate_upper_case(cls, v)`**
...
**Generated**: 2025-11-19T02:16:46.359712Z
