# Documentation: openbb_platform/core/openbb_core/provider/standard_models/search_attributes.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/search_attributes.py`
- **Size**: 1,661 characters, 45 lines
- **Words**: 170
- **Extension**: .py
...
**Classes** (2):
`SearchAttributesQueryParams`, `SearchAttributesData`
...
**Class `SearchAttributesQueryParams`**: Search Attributes Query.

**Class `SearchAttributesData`**: Search Attributes Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.729145
