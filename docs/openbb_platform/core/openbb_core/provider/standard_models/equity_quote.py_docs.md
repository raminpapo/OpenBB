# Documentation: openbb_platform/core/openbb_core/provider/standard_models/equity_quote.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/equity_quote.py`
- **Size**: 5,694 characters, 143 lines
- **Words**: 679
- **Extension**: .py
...
**Imports** (11):
`datetime`, `datetime`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.utils.descriptions`, `pydantic`, `Field`, `the`, `previous`


## Key Components

**Class `EquityQuoteQueryParams`**: Equity Quote Query.

**Class `EquityQuoteData`**: Equity Quote Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.603072
