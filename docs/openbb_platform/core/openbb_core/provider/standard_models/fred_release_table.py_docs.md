# File Documentation: fred_release_table.py
...
This is a **python** file named `fred_release_table.py`.

**Python Module**

- **Classes** (2): ReleaseTableQueryParams, ReleaseTableData
- **Functions** (1): _validate_date
- **Import Statements**: 3
...
- **`ReleaseTableQueryParams`**(QueryParams)
...
**Generated**: 2025-11-19T02:16:46.471760Z
