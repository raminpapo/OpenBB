# Documentation: openbb_platform/core/openbb_core/provider/standard_models/treasury_auctions.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/treasury_auctions.py`
- **Size**: 23,005 characters, 598 lines
- **Words**: 2,175
- **Extension**: .py
...
**Classes** (2):
`USTreasuryAuctionsQueryParams`, `USTreasuryAuctionsData`

**Functions** (1):
`validate_dates`

**Imports** (20):
`datetime`, `typing`, `Literal`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `pydantic`, `Field`, `direct`, `direct`, `FIMAs.`, `FIMAs.`, `indirect`, `indirect`, `non`, `retail.`, `retail`


## Key Components

**Class `USTreasuryAuctionsQueryParams`**: US Treasury Auctions Query.

**Class `USTreasuryAuctionsData`**: US Treasury Auctions Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.754623
