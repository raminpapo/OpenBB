# Documentation: openbb_platform/core/openbb_core/provider/standard_models/forward_eps_estimates.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/forward_eps_estimates.py`
- **Size**: 2,256 characters, 66 lines
- **Words**: 229
- **Extension**: .py
...
**Classes** (2):
`ForwardEpsEstimatesQueryParams`, `ForwardEpsEstimatesData`
...
**Class `ForwardEpsEstimatesQueryParams`**: Forward EPS Estimates Query Parameters.

**Class `ForwardEpsEstimatesData`**: Forward EPS Estimates Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.638459
