...
- **Classes** (2): EuropeanCentralBankInterestRatesParams, EuropeanCentralBankInterestRatesData
...
- **`EuropeanCentralBankInterestRatesParams`**(QueryParams)
- **`EuropeanCentralBankInterestRatesData`**(Data)
...
**Generated**: 2025-11-19T02:16:46.412387Z
