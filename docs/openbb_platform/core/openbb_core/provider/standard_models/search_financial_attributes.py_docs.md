# File Documentation: search_financial_attributes.py
...
This is a **python** file named `search_financial_attributes.py`.

**Python Module**

- **Classes** (2): SearchFinancialAttributesQueryParams, SearchFinancialAttributesData
- **Import Statements**: 1
...
- **`SearchFinancialAttributesQueryParams`**(QueryParams)
- **`SearchFinancialAttributesData`**(Data)
...
**Generated**: 2025-11-19T02:16:46.563830Z
