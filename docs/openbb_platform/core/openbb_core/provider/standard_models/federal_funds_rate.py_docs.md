# Documentation: openbb_platform/core/openbb_core/provider/standard_models/federal_funds_rate.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/federal_funds_rate.py`
- **Size**: 2,611 characters, 74 lines
- **Words**: 209
- **Extension**: .py
...
**Classes** (2):
`FederalFundsRateQueryParams`, `FederalFundsRateData`
...
**Class `FederalFundsRateQueryParams`**: Federal Funds Rate Query.

**Class `FederalFundsRateData`**: Federal Funds Rate Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.629472
