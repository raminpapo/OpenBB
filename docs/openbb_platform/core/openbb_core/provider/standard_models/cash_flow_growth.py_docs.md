# Documentation: openbb_platform/core/openbb_core/provider/standard_models/cash_flow_growth.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/cash_flow_growth.py`
- **Size**: 1,202 characters, 36 lines
- **Words**: 113
- **Extension**: .py
...
**Classes** (2):
`CashFlowStatementGrowthQueryParams`, `CashFlowStatementGrowthData`
...
**Class `CashFlowStatementGrowthQueryParams`**: Cash Flow Statement Growth Query.

**Class `CashFlowStatementGrowthData`**: Cash Flow Statement Growth Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.552401
