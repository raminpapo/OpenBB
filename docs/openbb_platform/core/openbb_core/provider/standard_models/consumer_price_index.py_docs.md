...
- **Classes** (2): ConsumerPriceIndexQueryParams, ConsumerPriceIndexData
...
- **`ConsumerPriceIndexQueryParams`**(QueryParams)
- **`ConsumerPriceIndexData`**(Data)
...
**Generated**: 2025-11-19T02:16:46.388291Z
