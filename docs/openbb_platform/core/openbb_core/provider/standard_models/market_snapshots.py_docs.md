...
- **Classes** (2): MarketSnapshotsQueryParams, MarketSnapshotsData
- **Import Statements**: 1
...
- **`MarketSnapshotsQueryParams`**(QueryParams)
- **`MarketSnapshotsData`**(Data)
...
**Generated**: 2025-11-19T02:16:46.528013Z
