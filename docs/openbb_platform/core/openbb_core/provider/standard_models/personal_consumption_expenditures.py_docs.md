...
- **Classes** (2): PersonalConsumptionExpendituresQueryParams, PersonalConsumptionExpendituresData
- **Import Statements**: 2
...
- **`PersonalConsumptionExpendituresQueryParams`**(QueryParams)
- **`PersonalConsumptionExpendituresData`**(Data)
...
**Generated**: 2025-11-19T02:16:46.543640Z
