# File Documentation: esg_risk_rating.py
...
This is a **python** file named `esg_risk_rating.py`.

**Python Module**

- **Classes** (2): ESGRiskRatingQueryParams, ESGRiskRatingData
- **Functions** (2): to_upper, to_upper
- **Import Statements**: 2
...
- **`ESGRiskRatingQueryParams`**(QueryParams)
- **`ESGRiskRatingData`**(Data)
...
**Generated**: 2025-11-19T02:16:46.435240Z
