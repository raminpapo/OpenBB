# Documentation: openbb_platform/core/openbb_core/provider/standard_models/economic_calendar.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/standard_models/economic_calendar.py`
- **Size**: 2,023 characters, 60 lines
- **Words**: 210
- **Extension**: .py
...
**Classes** (2):
`EconomicCalendarQueryParams`, `EconomicCalendarData`
...
**Class `EconomicCalendarQueryParams`**: Economic Calendar Query.

**Class `EconomicCalendarData`**: Economic Calendar Data.
...
## Notes
- Generated: 2025-11-18T07:54:35.587582
