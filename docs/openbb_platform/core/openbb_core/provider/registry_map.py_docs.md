# File Documentation: registry_map.py
...
This is a **python** file named `registry_map.py`.

**Python Module**

- **Classes** (5): from, RegistryMap, of, family, itself
- **Functions** (17): __init__, registry, available_providers, credentials, standard_extra, original_models, models, _get_credentials, _get_available_providers, _get_maps ... and 7 more
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:16:46.325839Z
