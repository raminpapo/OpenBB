# Documentation: openbb_platform/core/openbb_core/provider/utils/client.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/utils/client.py`
- **Size**: 5,072 characters, 140 lines
- **Words**: 451
- **Extension**: .py
...
**Classes** (2):
`ClientResponse`, `ClientSession`

**Functions** (12):
`obfuscate`, `get_user_agent`, `__init__`, `obfuscate_request_info`, `json`, `__init__`, `__del__`, `get`, `post`, `get_json`, `get_one`, `request`

**Imports** (11):
`asyncio`, `random`, `warnings`, `typing`, `Any`, `aiohttp`, `multidict`, `CIMultiDict`, `re`, `request`, `zlib`


## Key Components

**Class `ClientResponse`**: Client response class.

**Class `ClientSession`**: Client session.
...
## Notes
- Generated: 2025-11-18T07:54:35.766519
