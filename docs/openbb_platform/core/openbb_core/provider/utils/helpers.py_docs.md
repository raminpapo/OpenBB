# Documentation: openbb_platform/core/openbb_core/provider/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/utils/helpers.py`
- **Size**: 21,247 characters, 633 lines
- **Words**: 2,230
- **Extension**: .py
...
**Functions** (16):
`check_item`, `get_querystring`, `get_python_request_settings`, `get_requests_session`, `get_async_requests_session`, `at_exit`, `amake_request`, `amake_requests`, `combine_certificates`, `make_request`, `to_snake_case`, `maybe_coroutine`, `run_async`, `filter_by_dates`, `_filter`, `safe_fromtimestamp`

**Imports** (43):
`asyncio`, `os`, `collections.abc`, `Awaitable`, `datetime`, `date`, `difflib`, `SequenceMatcher`, `functools`, `partial`, `inspect`, `iscoroutinefunction`, `typing`, `anyio.from_thread`, `start_blocking_portal`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.utils.client`, `openbb_core.provider.utils.errors`, `UnauthorizedError`
...
## Notes
- Generated: 2025-11-18T07:54:35.771201
