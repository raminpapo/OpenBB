# File Documentation: options_chains_properties.py
...
This is a **python** file named `options_chains_properties.py`.

**Python Module**

- **Classes** (2): OptionsChainsProperties, is
- **Functions** (28): last_price, last_price, last_price, dataframe, expirations, strikes, has_iv, has_greeks, total_oi, total_volume ... and 18 more
...
- **`OptionsChainsProperties`**(Data)

#### Functions

- **`last_price(self)`**
- **`last_price(self, price: float)`**
- **`last_price(self)`**
- **`to_clean_list(x)`**
- **`split_into_tuples(x)`**
...
atm_call_strike, atm_put_strike, cached_property, last_price, option_type, property, staticmethod
...
**Generated**: 2025-11-19T02:16:46.614754Z
