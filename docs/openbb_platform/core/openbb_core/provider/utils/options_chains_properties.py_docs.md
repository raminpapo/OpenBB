# Documentation: openbb_platform/core/openbb_core/provider/utils/options_chains_properties.py

## File Metadata
- **Path**: `openbb_platform/core/openbb_core/provider/utils/options_chains_properties.py`
- **Size**: 73,431 characters, 1,830 lines
- **Words**: 6,952
- **Extension**: .py
...
**Classes** (2):
`OptionsChainsProperties`, `is`

**Functions** (28):
`last_price`, `last_price`, `last_price`, `dataframe`, `expirations`, `strikes`, `has_iv`, `has_greeks`, `total_oi`, `total_volume`, `total_dex`, `total_gex`, `_identify_price_col`, `filter_data`, `_get_stat`, `_get_nearest_expiration`, `_get_nearest_otm_strikes`, `_get_nearest_strike`, `straddle`, `strangle`

**Imports** (61):
`datetime`, `datetime`, `functools`, `cached_property`, `typing`, `TYPE_CHECKING`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.data`, `Data`, `pandas`, `DataFrame`, `numpy`, `nan`, `pandas`, `DataFrame`, `numpy`, `nan`, `pandas`, `DataFrame`


## Key Components

**Class `OptionsChainsProperties`**: Base Class For OptionsChainsData.
...
## Notes
- Generated: 2025-11-18T07:54:35.775657
