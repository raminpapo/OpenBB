# File Documentation: test_command_runner.py

## Metadata
- **Path**: `openbb_platform/core/tests/app/test_command_runner.py`
- **Size**: 17,658 bytes
- **Lines**: 565
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_command_runner.py`.

**Python Module**

- **Classes** (9): from, MockAPIRoute, MockExecutionContext, class, Model, MockOBBject, MockOBBject, MockProviderChoices, for
- **Functions** (34): __init__, __init__, api_route, execution_context, mock_func, mock_func, test_execution_context, test_parameters_builder, test_parameters_builder_get_polished_func, test_parameters_builder_get_polished_parameter_list ... and 24 more
- **Import Statements**: 2
...
- **`__init__(self, route)`**
- **`__init__(self, cmd_map, route, sys, user)`**
- **`execution_context()`**
- **`mock_func()`**
- **`test_execution_context()`**
- **`test_parameters_builder()`**
- **`test_parameters_builder_get_polished_func(input_func, expected_annotations)`**
- **`test_parameters_builder_get_polished_parameter_list(input_func, expected_params)`**
- **`test_parameters_builder_merge_args_and_kwargs(
    input_func, input_args, input_kwargs, expected_result
)`**
- **`test_parameters_builder_update_command_context(
    kwargs, system_settings, user_settings, expected_result
)`**
- **`test_parameters_builder_validate_kwargs(mock_func)`**
- **`test_parameters_builder__warn_kwargs(extra_params, base, expect)`**
- **`test_parameters_builder_build(mock_func, execution_context)`**
- **`test_command_runner()`**
- **`test_command_runner_properties()`**
- **`test_command_runner_run(_)`**
- **`test_static_command_runner_run(
    mock_execute_func, mock_get_command, execution_context
)`**
...
- **`test_static_command_runner_chart()`**
- **`test_static_command_runner_command()`**
- **`__init__(self, results, **kwargs)`**
- **`__init__(self, provider)`**
- **`other_mock_func(**kwargs)`**
- **`test_extension_immutable_preserves_original_and_does_not_set_extension_modified(
    monkeypatch,
)`**
- **`imm_accessor(self)`**
- **`test_extension_mutable_modifies_original_and_sets_extension_modified_and_route_scoping(
    monkeypatch,
)`**
- **`mut_accessor(self)`**
- **`test_results_only_flag_sets_attribute_and_accessor_runs(monkeypatch)`**
- **`ro_accessor(self)`**

#### Decorators Used

dataclass, patch, property, pytest
...
**Generated**: 2025-11-19T02:16:46.633597Z
