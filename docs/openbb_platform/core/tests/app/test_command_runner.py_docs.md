# Documentation: openbb_platform/core/tests/app/test_command_runner.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/test_command_runner.py`
- **Size**: 17,658 characters, 565 lines
- **Words**: 1,341
- **Extension**: .py
...
**Classes** (9):
`from`, `MockAPIRoute`, `MockExecutionContext`, `class`, `Model`, `MockOBBject`, `MockOBBject`, `MockProviderChoices`, `for`

**Functions** (34):
`__init__`, `__init__`, `api_route`, `execution_context`, `mock_func`, `mock_func`, `test_execution_context`, `test_parameters_builder`, `test_parameters_builder_get_polished_func`, `test_parameters_builder_get_polished_parameter_list`, `test_parameters_builder_merge_args_and_kwargs`, `test_parameters_builder_update_command_context`, `other_mock_func`, `test_parameters_builder_validate_kwargs`, `test_parameters_builder__warn_kwargs`, `test_parameters_builder_build`, `test_command_runner`, `test_command_runner_properties`, `test_command_runner_run`, `test_static_command_runner_run`

**Imports** (32):
`dataclasses`, `dataclass`, `inspect`, `Parameter`, `types`, `SimpleNamespace`, `unittest.mock`, `Mock`, `pytest`, `fastapi`, `Query`, `fastapi.params`, `Query`, `openbb_core.app.command_runner`, `openbb_core.app.model.abstract.warning`, `OpenBBWarning`, `openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.extension`, `CachedAccessor`


## Key Components

**Class `from`**: No documentation

**Class `MockAPIRoute`**: MockAPIRoute

**Class `MockExecutionContext`**: MockExecutionContext

**Class `class`**: No documentation

**Class `Model`**: Model

**Class `MockOBBject`**: Mock OBBject

**Class `MockOBBject`**: Mock OBBject

**Class `MockProviderChoices`**: Mock ProviderChoices
...
## Notes
- Generated: 2025-11-18T07:54:35.865073
