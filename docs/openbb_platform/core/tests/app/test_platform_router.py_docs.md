# Documentation: openbb_platform/core/tests/app/test_platform_router.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/test_platform_router.py`
- **Size**: 5,174 characters, 213 lines
- **Words**: 349
- **Extension**: .py
...
**Functions** (31):
`router`, `test_router_init`, `test_command`, `valid_function`, `test_include_router`, `router_loader`, `test_router_loader_init`, `test_from_extensions`, `signature_inspector`, `test_signature_inspector_init`, `test_complete_signature`, `sample_function`, `test_complete_signature_error`, `valid_function`, `test_validate_signature`, `sample_function`, `test_inject_dependency`, `sample_function`, `test_get_description`, `some_function`

**Imports** (9):
`pytest`, `openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.router`, `pydantic`, `BaseModel`


## Key Components

**Class `MockBaseModel`**: Mock BaseModel class.
...
## Notes
- Generated: 2025-11-18T07:54:35.869836
