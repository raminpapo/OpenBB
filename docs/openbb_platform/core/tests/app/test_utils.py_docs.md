# Documentation: openbb_platform/core/tests/app/test_utils.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/test_utils.py`
- **Size**: 4,768 characters, 161 lines
- **Words**: 469
- **Extension**: .py
...
**Functions** (10):
`test_df_to_basemodel`, `test_df_to_basemodel_multiindex`, `test_basemodel_to_df`, `test_basemodel_to_multiindex_df`, `test_get_target_column`, `test_get_target_columns`, `test_list_to_basemodel`, `test_dict_to_basemodel`, `test_ndarray_to_basemodel`, `test_check_single_item`

**Imports** (8):
`numpy`, `pandas`, `pytest`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.utils`, `openbb_core.provider.abstract.data`, `Data`
...
## Notes
- Generated: 2025-11-18T07:54:35.874124
