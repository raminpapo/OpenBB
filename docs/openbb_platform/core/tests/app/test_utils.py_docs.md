# File Documentation: test_utils.py

## Metadata
- **Path**: `openbb_platform/core/tests/app/test_utils.py`
- **Size**: 4,768 bytes
- **Lines**: 161
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_utils.py`.

**Python Module**

- **Functions** (10): test_df_to_basemodel, test_df_to_basemodel_multiindex, test_basemodel_to_df, test_basemodel_to_multiindex_df, test_get_target_column, test_get_target_columns, test_list_to_basemodel, test_dict_to_basemodel, test_ndarray_to_basemodel, test_check_single_item
- **Import Statements**: 2
...
- **`test_df_to_basemodel()`**
- **`test_df_to_basemodel_multiindex()`**
- **`test_basemodel_to_df()`**
- **`test_basemodel_to_multiindex_df()`**
- **`test_get_target_column()`**
- **`test_get_target_columns()`**
- **`test_list_to_basemodel(data_list, expected)`**
- **`test_dict_to_basemodel(data_dict, expected)`**
- **`test_ndarray_to_basemodel(array, expected)`**
- **`test_check_single_item(item, expected)`**
...
**Generated**: 2025-11-19T02:16:46.644633Z
