# Documentation: openbb_platform/core/tests/app/static/test_reference_loader.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/static/test_reference_loader.py`
- **Size**: 2,190 characters, 65 lines
- **Words**: 224
- **Extension**: .py
...
**Functions** (6):
`reference_loader`, `mock_reference_data`, `test_load_reference_data`, `test_default_directory_load`, `test_missing_reference_file`, `test_nonexistent_directory`

**Imports** (8):
`json`, `pathlib`, `Path`, `pytest`, `openbb_core.app.static.reference_loader`, `ReferenceLoader`, `the`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:35.861664
