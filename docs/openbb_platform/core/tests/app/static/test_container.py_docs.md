# Documentation: openbb_platform/core/tests/app/static/test_container.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/static/test_container.py`
- **Size**: 3,550 characters, 107 lines
- **Words**: 278
- **Extension**: .py
...
**Functions** (5):
`container`, `test_container_init`, `test_container__run`, `test_container__check_credentials`, `test_container__get_provider`

**Imports** (17):
`re`, `escape`, `unittest.mock`, `patch`, `pytest`, `openbb_core.app.command_runner`, `CommandRunner`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.model.defaults`, `Defaults`, `openbb_core.app.model.user_settings`, `UserSettings`, `openbb_core.app.static.container`, `Container`, `pydantic`, `BaseModel`
...
## Notes
- Generated: 2025-11-18T07:54:35.855138
