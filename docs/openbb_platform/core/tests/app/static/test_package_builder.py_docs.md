# File Documentation: test_package_builder.py

## Metadata
- **Path**: `openbb_platform/core/tests/app/static/test_package_builder.py`
- **Size**: 21,289 bytes
- **Lines**: 753
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_package_builder.py`.

**Python Module**

- **Classes** (12): from, definition, definition, loader, TestField, TestField, TestField, TestField, TestField, TestField ... and 2 more
- **Functions** (64): tmp_openbb_dir, package_builder, test_package_builder_init, test_package_builder_build, test_save_modules, test_save_package, test_run_linters, test_write, module_builder, test_module_builder_init ... and 54 more
- **Import Statements**: 6
...
- **`TestField`**
- **`TestField`**
- **`TestAnnotatedDataClass`**
- **`MockPathDistribution`**

#### Functions

- **`tmp_openbb_dir(tmp_path_factory)`**
- **`package_builder(tmp_openbb_dir)`**
- **`test_package_builder_init(package_builder)`**
- **`test_package_builder_build(tmp_openbb_dir)`**
- **`test_save_modules(package_builder)`**
- **`test_save_package(package_builder)`**
- **`test_run_linters(package_builder)`**
- **`test_write(package_builder)`**
- **`module_builder()`**
- **`test_module_builder_init(module_builder)`**
- **`class_definition()`**
- **`test_class_definition_init(class_definition)`**
- **`test_build(class_definition)`**
- **`method_definition()`**
- **`test_method_definition_init(method_definition)`**
- **`test_build_class_loader_method(method_definition)`**
- **`test_get_type(method_definition)`**
- **`test_get_type_hint(method_definition)`**
- **`test_field_with_type_attribute_missing_type(method_definition)`**
- **`test_get_default(method_definition)`**
- **`test_get_default_none(method_definition)`**
- **`test_get_default_default_value(method_definition)`**
- **`test_get_default_no_default(method_definition)`**
- **`test_is_annotated_dc(method_definition)`**
- **`test_is_annotated_dc_annotated(method_definition)`**
- **`test_reorder_params(method_definition, params, var_kw, expected)`**
- **`test_build_func_params(method_definition)`**
- **`test_build_func_returns(method_definition, return_type, expected_output)`**
- **`test_build_command_method_signature(mock_method_definitions, method_definition)`**
- **`test_build_command_method_signature_deprecated(
    mock_method_definitions, method_definition
)`**

#### Decorators Used

0, 1, 5, 9, dataclass, deprecated, patch, pytest
...
**Generated**: 2025-11-19T02:16:46.701448Z
