# Documentation: openbb_platform/core/tests/app/static/test_package_builder.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/static/test_package_builder.py`
- **Size**: 21,289 characters, 753 lines
- **Words**: 1,420
- **Extension**: .py
...
**Classes** (12):
`from`, `definition`, `definition`, `loader`, `TestField`, `TestField`, `TestField`, `TestField`, `TestField`, `TestField`, `class`, `MockPathDistribution`

**Functions** (64):
`tmp_openbb_dir`, `package_builder`, `test_package_builder_init`, `test_package_builder_build`, `test_save_modules`, `test_save_package`, `test_run_linters`, `test_write`, `module_builder`, `test_module_builder_init`, `class_definition`, `test_class_definition_init`, `test_build`, `method_definition`, `test_method_definition_init`, `test_build_class_loader_method`, `test_get_type`, `test_get_type_hint`, `test_field_with_type_attribute_missing_type`, `test_get_default`

**Imports** (23):
`dataclasses`, `dataclass`, `inspect`, `_empty`, `pathlib`, `Path`, `typing`, `Annotated`, `unittest.mock`, `PropertyMock`, `pandas`, `pytest`, `importlib_metadata`, `EntryPoint`, `openbb_core.app.static.package_builder`, `openbb_core.env`, `Env`, `pydantic`, `Field`, `definition.`


## Key Components

**Class `from`**: Return a temporary openbb directory.

**Class `definition`**: Test class definition init.

**Class `loader`**: Test get type.

**Class `TestField`**: No documentation
...
**Class `class`**: Test annotated data class.

**Class `MockPathDistribution`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:35.859551
