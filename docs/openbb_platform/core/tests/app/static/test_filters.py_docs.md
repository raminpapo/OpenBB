# Documentation: openbb_platform/core/tests/app/static/test_filters.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/static/test_filters.py`
- **Size**: 2,072 characters, 70 lines
- **Words**: 238
- **Extension**: .py
...
**Functions** (3):
`test_filter_inputs_not_df`, `test_filter_inputs_df`, `test_filter_inputs`

**Imports** (7):
`numpy`, `pandas`, `pytest`, `openbb_core.app.static.utils.filters`, `filter_inputs`, `openbb_core.provider.abstract.data`, `Data`
...
- `pandas`
- `pytest`
- `openbb_core.app.static.utils.filters`
- `openbb_core.provider.abstract.data`

## Notes
- Generated: 2025-11-18T07:54:35.857758
