# Documentation: openbb_platform/core/tests/app/logs/handlers/test_path_tracking_file_handler.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/logs/handlers/test_path_tracking_file_handler.py`
- **Size**: 2,888 characters, 84 lines
- **Words**: 206
- **Extension**: .py
...
**Functions** (5):
`__init__`, `mocked_path`, `handler`, `test_build_log_file_path`, `test_clean_expired_files`

**Imports** (6):
`pathlib`, `Path`, `unittest.mock`, `MagicMock`, `pytest`, `openbb_core.app.logs.handlers.path_tracking_file_handler`
...
## Notes
- Generated: 2025-11-18T07:54:35.808222
