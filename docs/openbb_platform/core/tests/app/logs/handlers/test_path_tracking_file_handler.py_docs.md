# File Documentation: test_path_tracking_file_handler.py

## Metadata
- **Path**: `openbb_platform/core/tests/app/logs/handlers/test_path_tracking_file_handler.py`
- **Size**: 2,888 bytes
- **Lines**: 84
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_path_tracking_file_handler.py`.

**Python Module**

- **Classes** (1): MockLoggingSettings
- **Functions** (5): __init__, mocked_path, handler, test_build_log_file_path, test_clean_expired_files
- **Import Statements**: 1
...
- **`__init__(self, app_name, user_logs_directory, session_id, frequency)`**
- **`mocked_path(tmp_path_factory)`**
- **`handler(mocked_path)`**
- **`test_build_log_file_path(handler, mocked_path)`**
- **`test_clean_expired_files(handler)`**
...
**Generated**: 2025-11-19T02:16:46.657431Z
