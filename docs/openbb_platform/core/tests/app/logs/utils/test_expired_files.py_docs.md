# Documentation: openbb_platform/core/tests/app/logs/utils/test_expired_files.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/logs/utils/test_expired_files.py`
- **Size**: 5,260 characters, 166 lines
- **Words**: 573
- **Extension**: .py
...
**Functions** (12):
`temp_test_files`, `test_get_timestamp_from_x_days`, `test_all_files_expired`, `test_no_files_expired`, `test_some_files_expired`, `test_directory_not_exists`, `test_directory_not_dir`, `mock_path`, `test_remove_file_list_no_files`, `test_remove_file_list_remove_files_successfully`, `test_remove_file_list_ignore_permission_error`, `test_remove_file_list_other_exception`

**Imports** (13):
`os`, `tempfile`, `pathlib`, `Path`, `time`, `time`, `unittest.mock`, `MagicMock`, `pytest`, `openbb_core.app.logs.utils.expired_files`, `now`, `now`, `now`


## Key Components

**Class `to`**: Test remove_file_list when there are no files to remove.
...
## Notes
- Generated: 2025-11-18T07:54:35.818199
