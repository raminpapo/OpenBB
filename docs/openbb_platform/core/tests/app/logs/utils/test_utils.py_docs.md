...
## Metadata
- **Path**: `openbb_platform/core/tests/app/logs/utils/test_utils.py`
- **Size**: 3,571 bytes
- **Lines**: 107
- **Category**: python
- **Extension**: .py
...
- **Functions** (7): test_get_session_id_return_type, test_get_session_id_format, test_get_session_id_uniqueness, test_get_app_id_success, test_get_app_id_os_error, test_get_app_id_other_exception, test_get_log_dir
- **Import Statements**: 1
...
- **`test_get_session_id_return_type()`**
- **`test_get_session_id_format()`**
- **`test_get_session_id_uniqueness()`**
- **`test_get_app_id_success()`**
- **`test_get_app_id_os_error()`**
- **`test_get_app_id_other_exception()`**
- **`test_get_log_dir()`**
...
- `Path`
- `get_app_id`
- `openbb_core.app.logs.utils.utils`
- `patch`
- `pathlib`
- `pytest`
- `unittest.mock`
...
**Generated**: 2025-11-19T02:16:46.661995Z
