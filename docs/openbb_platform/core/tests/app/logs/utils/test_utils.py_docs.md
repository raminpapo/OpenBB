# Documentation: openbb_platform/core/tests/app/logs/utils/test_utils.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/logs/utils/test_utils.py`
- **Size**: 3,571 characters, 107 lines
- **Words**: 285
- **Extension**: .py
...
**Functions** (7):
`test_get_session_id_return_type`, `test_get_session_id_format`, `test_get_session_id_uniqueness`, `test_get_app_id_success`, `test_get_app_id_os_error`, `test_get_app_id_other_exception`, `test_get_log_dir`

**Imports** (8):
`uuid`, `pathlib`, `Path`, `unittest.mock`, `patch`, `pytest`, `openbb_core.app.logs.utils.utils`, `get_app_id`
...
## Notes
- Generated: 2025-11-18T07:54:35.820232
