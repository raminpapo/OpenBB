# File Documentation: test_formatter_with_exceptions.py

## Metadata
- **Path**: `openbb_platform/core/tests/app/logs/formatters/test_formatter_with_exceptions.py`
- **Size**: 10,336 bytes
- **Lines**: 326
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_formatter_with_exceptions.py`.

**Python Module**

- **Functions** (17): formatter, test_level_name_with_exc_text, test_level_name_with_levelname, test_extract_log_extra_with_override_and_session_id, test_extract_log_extra_with_override, test_extract_log_extra_with_session_id, test_extract_log_extra_with_no_override_or_session_id, test_mock_ipv4, test_mock_email, test_mock_password ... and 7 more
- **Import Statements**: 1
...
- **`formatter()`**
- **`test_level_name_with_exc_text(formatter)`**
- **`test_level_name_with_levelname(formatter)`**
- **`test_extract_log_extra_with_override_and_session_id(formatter)`**
- **`test_extract_log_extra_with_override(formatter)`**
- **`test_extract_log_extra_with_session_id(formatter)`**
- **`test_extract_log_extra_with_no_override_or_session_id(formatter)`**
- **`test_mock_ipv4(input_text, expected_output, formatter)`**
- **`test_mock_email(input_text, expected_output, formatter)`**
- **`test_mock_password(input_text, expected_output, formatter)`**
- **`test_mock_flair(input_text, expected_output, formatter)`**
- **`test_mock_home_directory(input_text, expected_output, formatter)`**
- **`test_filter_special_tags(input_text, expected_output, formatter)`**
- **`test_filter_piis(input_text, expected_output, formatter)`**
- **`test_filter_log_line(input_text, expected_output, formatter)`**
- **`test_formatException_invalid()`**
...
**Generated**: 2025-11-19T02:16:46.654262Z
