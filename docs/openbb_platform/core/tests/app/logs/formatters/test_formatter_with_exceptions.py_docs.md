# Documentation: openbb_platform/core/tests/app/logs/formatters/test_formatter_with_exceptions.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/logs/formatters/test_formatter_with_exceptions.py`
- **Size**: 10,336 characters, 326 lines
- **Words**: 821
- **Extension**: .py
...
**Functions** (17):
`formatter`, `test_level_name_with_exc_text`, `test_level_name_with_levelname`, `test_extract_log_extra_with_override_and_session_id`, `test_extract_log_extra_with_override`, `test_extract_log_extra_with_session_id`, `test_extract_log_extra_with_no_override_or_session_id`, `test_mock_ipv4`, `test_mock_email`, `test_mock_password`, `test_mock_flair`, `test_mock_home_directory`, `test_filter_special_tags`, `test_filter_piis`, `test_filter_log_line`, `test_formatException_invalid`, `test_format`

**Imports** (6):
`logging`, `os`, `unittest.mock`, `Mock`, `pytest`, `openbb_core.app.logs.formatters.formatter_with_exceptions`
...
## Notes
- Generated: 2025-11-18T07:54:35.804505
