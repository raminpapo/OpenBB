# File Documentation: test_logging_service.py
...
This is a **python** file named `test_logging_service.py`.

**Python Module**

- **Classes** (4): MockSystemSettings, MockLoggingSettings, MockOBBject, MockCredentials
- **Functions** (7): __init__, __init__, logging_service, test_correctly_initialized, test_logging_settings_setter, test_log_startup, test_log
- **Import Statements**: 1
...
- **`MockSystemSettings`**
- **`MockLoggingSettings`**
- **`MockOBBject`**(BaseModel)
- **`MockCredentials`**(BaseModel)

#### Functions

- **`__init__(self)`**
- **`__init__(self, system_settings, user_settings)`**
- **`logging_service()`**
- **`test_correctly_initialized()`**
- **`test_logging_settings_setter(logging_service)`**
- **`test_log_startup(logging_service)`**
- **`test_log(
    logging_service,
    user_settings,
    system_settings,
...
**Generated**: 2025-11-19T02:16:46.650550Z
