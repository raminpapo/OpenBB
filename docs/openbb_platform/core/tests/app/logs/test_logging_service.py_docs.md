# Documentation: openbb_platform/core/tests/app/logs/test_logging_service.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/logs/test_logging_service.py`
- **Size**: 7,860 characters, 255 lines
- **Words**: 454
- **Extension**: .py
...
**Classes** (4):
`MockSystemSettings`, `MockLoggingSettings`, `MockOBBject`, `MockCredentials`

**Functions** (7):
`__init__`, `__init__`, `logging_service`, `test_correctly_initialized`, `test_logging_settings_setter`, `test_log_startup`, `test_log`

**Imports** (10):
`json`, `unittest.mock`, `MagicMock`, `pytest`, `openbb_core.app.logs.logging_service`, `LoggingService`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `pydantic`, `BaseModel`


## Key Components

**Class `MockSystemSettings`**: Mock system settings.

**Class `MockLoggingSettings`**: Mock logging settings.

**Class `MockOBBject`**: Mock object for testing.

**Class `MockCredentials`**: No documentation
...
- `unittest.mock`
- `pytest`
- `openbb_core.app.logs.logging_service`
- `openbb_core.app.model.abstract.error`
- `pydantic`

## Notes
- Generated: 2025-11-18T07:54:35.815055
