# Documentation: openbb_platform/core/tests/app/test_query.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/test_query.py`
- **Size**: 3,166 characters, 134 lines
- **Words**: 227
- **Extension**: .py
...
**Classes** (5):
`from`, `MockBaseModel`, `EquityHistorical`, `class`, `class`

**Functions** (9):
`create_mock_query`, `create_mock_extra_params`, `query`, `test_init`, `mock_registry`, `query_instance`, `test_filter_extra_params`, `test_filter_extra_params_wrong_param`, `test_execute_method_fake_credentials`

**Imports** (12):
`dataclasses`, `dataclass`, `unittest.mock`, `MagicMock`, `pytest`, `openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `pydantic`, `BaseModel`


## Key Components

**Class `from`**: Mock QueryParams class.

**Class `EquityHistorical`**: Mock EquityHistorical class.

**Class `class`**: Mock ExtraParams dataclass.
...
## Notes
- Generated: 2025-11-18T07:54:35.872727
