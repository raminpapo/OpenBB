# Documentation: openbb_platform/core/tests/app/model/test_system_settings.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/model/test_system_settings.py`
- **Size**: 4,035 characters, 114 lines
- **Words**: 280
- **Extension**: .py
...
**Functions** (5):
`test_system_settings`, `test_create_openbb_directory_directory_and_files_not_exist`, `test_create_openbb_directory_directory_exists_user_settings_missing`, `test_create_openbb_directory_directory_exists_system_settings_missing`, `test_validate_logging_handlers`

**Imports** (8):
`os`, `pathlib`, `Path`, `pytest`, `openbb_core.app.model.system_settings`, `SystemSettings`, `pydantic`, `BaseModel`


## Key Components

**Class `MockSystemSettings`**: Mock SystemSettings.
...
## Notes
- Generated: 2025-11-18T07:54:35.842306
