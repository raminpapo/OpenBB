# Documentation: openbb_platform/core/tests/app/model/test_metadata.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/model/test_metadata.py`
- **Size**: 4,645 characters, 145 lines
- **Words**: 368
- **Extension**: .py
...
**Functions** (3):
`test_Metadata`, `test_fields`, `test_scale_arguments`

**Imports** (9):
`datetime`, `datetime`, `numpy`, `pandas`, `pytest`, `openbb_core.app.model.metadata`, `Metadata`, `openbb_core.provider.abstract.data`, `Data`
...
## Notes
- Generated: 2025-11-18T07:54:35.837656
