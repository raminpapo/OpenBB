# Documentation: openbb_platform/core/tests/app/model/test_extension.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/model/test_extension.py`
- **Size**: 4,033 characters, 122 lines
- **Words**: 350
- **Extension**: .py
...
**Classes** (7):
`Dummy`, `__dict__`, `returns`, `Dummy`, `__dict__`, `FakeOBBject`, `__dict__`

**Functions** (8):
`test_init_raises_if_invalid_configuration`, `test_register_accessor_registers_and_warns_on_override`, `accessor_factory`, `test_cached_accessor_descriptor_behavior_and_caching`, `__init__`, `make_accessor`, `test_obbject_accessor_registers_on_mocked_obbject_module`, `sample_accessor`

**Imports** (8):
`sys`, `types`, `types`, `SimpleNamespace`, `pytest`, `openbb_core.app.model.extension`, `CachedAccessor`, `inside`


## Key Components

**Class `Dummy`**: No documentation

**Class `__dict__`**: No documentation

**Class `Dummy`**: No documentation

**Class `__dict__`**: No documentation

**Class `FakeOBBject`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:35.835881
