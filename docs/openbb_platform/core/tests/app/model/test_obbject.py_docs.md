# Documentation: openbb_platform/core/tests/app/model/test_obbject.py

## File Metadata
- **Path**: `openbb_platform/core/tests/app/model/test_obbject.py`
- **Size**: 12,146 characters, 393 lines
- **Words**: 1,094
- **Extension**: .py
...
**Classes** (3):
`MockData`, `MockMultiData`, `MockDataFrame`

**Functions** (10):
`test_OBBject`, `test_fields`, `test_to_dataframe_no_results`, `test_to_dataframe`, `test_to_dataframe_w_args`, `test_to_df_daylight_savings`, `test_to_dict`, `test_show_chart_exists`, `test_show_chart_no_chart`, `test_show_chart_no_fig`

**Imports** (12):
`unittest.mock`, `MagicMock`, `pandas`, `pytest`, `openbb_core.app.model.obbject`, `Chart`, `openbb_core.app.utils`, `basemodel_to_df`, `openbb_core.provider.abstract.data`, `Data`, `pandas.testing`, `assert_frame_equal`


## Key Components

**Class `MockData`**: Test helper.

**Class `MockMultiData`**: Test helper.

**Class `MockDataFrame`**: Test helper.
...
## Notes
- Generated: 2025-11-18T07:54:35.839434
