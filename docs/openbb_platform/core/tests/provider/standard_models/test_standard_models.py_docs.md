# Documentation: openbb_platform/core/tests/provider/standard_models/test_standard_models.py

## File Metadata
- **Path**: `openbb_platform/core/tests/provider/standard_models/test_standard_models.py`
- **Size**: 2,727 characters, 70 lines
- **Words**: 252
- **Extension**: .py
...
**Imports** (11):
`inspect`, `importlib`, `import_module`, `pathlib`, `Path`, `pytest`, `openbb_core.provider.abstract.fetcher`, `Data`, `openbb_core.provider.utils.descriptions`, `pydantic.fields`, `FieldInfo`
...
## Notes
- Generated: 2025-11-18T07:54:35.880435
