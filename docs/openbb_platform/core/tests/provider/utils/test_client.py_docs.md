# Documentation: openbb_platform/core/tests/provider/utils/test_client.py

## File Metadata
- **Path**: `openbb_platform/core/tests/provider/utils/test_client.py`
- **Size**: 5,829 characters, 205 lines
- **Words**: 444
- **Extension**: .py
...
**Classes** (2):
`MockResponse`, `MockClientSession`

**Functions** (14):
`test_obfuscate`, `test_get_user_agent`, `__init__`, `json`, `read`, `raise_for_status`, `__del__`, `request`, `test_client_response_obfuscate_request_info`, `test_client_get`, `test_client_post`, `test_client_get_one`, `test_client_get_json`, `test_client_content_encoding`

**Imports** (11):
`gzip`, `json`, `zlib`, `aiohttp`, `pytest`, `multidict`, `CIMultiDict`, `openbb_core.provider.utils`, `client`, `yarl`, `URL`


## Key Components

**Class `MockResponse`**: Mock response class.

**Class `MockClientSession`**: Mock ClientSession.
...
## Notes
- Generated: 2025-11-18T07:54:35.885822
