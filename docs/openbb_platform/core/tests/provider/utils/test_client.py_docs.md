# File Documentation: test_client.py
...
This is a **python** file named `test_client.py`.

**Python Module**

- **Classes** (2): MockResponse, MockClientSession
- **Functions** (14): test_obfuscate, test_get_user_agent, __init__, json, read, raise_for_status, __del__, request, test_client_response_obfuscate_request_info, test_client_get ... and 4 more
- **Import Statements**: 1
...
- **`MockResponse`**
- **`MockClientSession`**(client.ClientSession)

#### Functions

- **`test_obfuscate()`**
- **`test_get_user_agent()`**
- **`__init__(self, method, url, **kwargs)`**
- **`json(self, **_)`**
- **`read(self)`**
- **`raise_for_status(self)`**
- **`__del__(self)`**
- **`test_client_response_obfuscate_request_info(url_params, obfuscated_params)`**
- **`test_client_get()`**
- **`test_client_post()`**
- **`test_client_get_one(body, expected)`**
- **`test_client_get_json()`**
- **`test_client_content_encoding()`**
...
**Generated**: 2025-11-19T02:16:46.718345Z
