# Documentation: openbb_platform/providers/multpl/openbb_multpl/models/sp500_multiples.py

## File Metadata
- **Path**: `openbb_platform/providers/multpl/openbb_multpl/models/sp500_multiples.py`
- **Size**: 7,031 characters, 180 lines
- **Words**: 434
- **Extension**: .py
...
**Classes** (3):
`MultplSP500MultiplesQueryParams`, `MultplSP500MultiplesData`, `MultplSP500MultiplesFetcher`

**Functions** (6):
`validate_series_name`, `transform_query`, `aextract_data`, `response_callback`, `get_one`, `transform_data`

**Imports** (22):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.sp500_multiples`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `field_validator`, `asyncio`, `io`, `StringIO`, `openbb_core.provider.utils.helpers`, `amake_request`, `numpy`, `nan`


## Key Components

**Class `MultplSP500MultiplesQueryParams`**: Multpl S&P 500 Multiples Query Params.

**Class `MultplSP500MultiplesData`**: Multpl S&P 500 Multiples Data.

**Class `MultplSP500MultiplesFetcher`**: Multpl S&P 500 Multiples Fetcher.
...
- `openbb_core.provider.standard_models.sp500_multiples`
...
## Notes
- Generated: 2025-11-18T07:54:40.289559
