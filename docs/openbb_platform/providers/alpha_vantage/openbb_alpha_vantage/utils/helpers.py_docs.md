# Documentation: openbb_platform/providers/alpha_vantage/openbb_alpha_vantage/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/alpha_vantage/openbb_alpha_vantage/utils/helpers.py`
- **Size**: 2,726 characters, 100 lines
- **Words**: 290
- **Extension**: .py
...
**Functions** (4):
`get_interval`, `extract_key_name`, `filter_by_dates`, `calculate_adjusted_prices`

**Imports** (9):
`datetime`, `datetime`, `typing`, `TYPE_CHECKING`, `pandas`, `DataFrame`, `re`, `numpy`, `zeros`
...
## Notes
- Generated: 2025-11-18T07:54:37.250745
