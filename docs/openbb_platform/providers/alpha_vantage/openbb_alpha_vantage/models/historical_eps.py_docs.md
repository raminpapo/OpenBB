# Documentation: openbb_platform/providers/alpha_vantage/openbb_alpha_vantage/models/historical_eps.py

## File Metadata
- **Path**: `openbb_platform/providers/alpha_vantage/openbb_alpha_vantage/models/historical_eps.py`
- **Size**: 5,811 characters, 165 lines
- **Words**: 503
- **Extension**: .py
...
**Classes** (3):
`AlphaVantageHistoricalEpsQueryParams`, `AlphaVantageHistoricalEpsData`, `AVHistoricalEpsFetcher`

**Functions** (6):
`validate_null`, `normalize_percent`, `transform_query`, `aextract_data`, `response_callback`, `transform_data`

**Imports** (17):
`datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.historical_eps`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `AlphaVantageHistoricalEpsQueryParams`**: AlphaVantage Historical EPS Query Params.

    Source: https://www.alphavantage.co/documentation/#earnings

**Class `AlphaVantageHistoricalEpsData`**: AlphaVantage Historical EPS Data.

**Class `AVHistoricalEpsFetcher`**: AlphaVantage Historical EPS Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:37.247483
