# Documentation: openbb_platform/providers/alpha_vantage/openbb_alpha_vantage/models/equity_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/alpha_vantage/openbb_alpha_vantage/models/equity_historical.py`
- **Size**: 12,226 characters, 309 lines
- **Words**: 878
- **Extension**: .py
...
**Classes** (3):
`AVEquityHistoricalQueryParams`, `AVEquityHistoricalData`, `AVEquityHistoricalFetcher`

**Functions** (6):
`transform_query`, `aextract_data`, `callback`, `intraday_callback`, `get_one`, `transform_data`

**Imports** (25):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_historical`, `openbb_core.provider.utils.descriptions`, `pydantic`, `the`, `dateutil.relativedelta`, `relativedelta`, `the`, `asyncio`, `io`, `BytesIO`, `openbb_alpha_vantage.utils.helpers`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `AVEquityHistoricalQueryParams`**: Alpha Vantage Equity Historical Price Query.

    Source: https://www.alphavantage.co/documentation/#time-series-data

**Class `AVEquityHistoricalData`**: Alpha Vantage Equity Historical Price Data.

**Class `AVEquityHistoricalFetcher`**: Transform the query, extract and transform the data from the AlphaVantage endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:37.245113
