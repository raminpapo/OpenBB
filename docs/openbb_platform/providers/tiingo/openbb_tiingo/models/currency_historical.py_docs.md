...
- **Classes** (3): TiingoCurrencyHistoricalQueryParams, TiingoCurrencyHistoricalData, TiingoCurrencyHistoricalFetcher
...
- **`TiingoCurrencyHistoricalQueryParams`**(CurrencyHistoricalQueryParams)
- **`TiingoCurrencyHistoricalData`**(CurrencyHistoricalData)
...
**Generated**: 2025-11-19T02:16:53.011215Z
