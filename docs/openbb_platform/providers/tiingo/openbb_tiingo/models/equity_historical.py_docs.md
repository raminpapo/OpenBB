# Documentation: openbb_platform/providers/tiingo/openbb_tiingo/models/equity_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/tiingo/openbb_tiingo/models/equity_historical.py`
- **Size**: 7,402 characters, 238 lines
- **Words**: 593
- **Extension**: .py
...
**Classes** (3):
`TiingoEquityHistoricalQueryParams`, `TiingoEquityHistoricalData`, `TiingoEquityHistoricalFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (31):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_historical`, `openbb_core.provider.utils.descriptions`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `dateutil.relativedelta`, `relativedelta`, `the`


## Key Components

**Class `TiingoEquityHistoricalQueryParams`**: Tiingo Equity Historical Price Query.

    Source: https://www.tiingo.com/documentation/end-of-day

**Class `TiingoEquityHistoricalData`**: Tiingo Equity Historical Price Data.

**Class `TiingoEquityHistoricalFetcher`**: Transform the query, extract and transform the data from the Tiingo endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:41.717744
