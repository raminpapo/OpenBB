# Documentation: openbb_platform/providers/tmx/openbb_tmx/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/utils/helpers.py`
- **Size**: 41,334 characters, 1,145 lines
- **Words**: 3,804
- **Extension**: .py
...
**Functions** (24):
`get_random_agent`, `get_companies_backend`, `get_indices_backend`, `response_callback`, `get_data_from_url`, `get_data_from_gql`, `replace_values_in_list_of_dicts`, `check_weekday`, `get_all_etfs`, `get_tmx_tickers`, `get_all_tmx_companies`, `get_all_options_tickers`, `get_current_options`, `download_eod_chains`, `get_company_filings`, `get_daily_price_history`, `create_task`, `try_again`, `get_weekly_or_monthly_price_history`, `try_again`

**Imports** (81):
`datetime`, `typing`, `TYPE_CHECKING`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_tmx.utils`, `gql`, `aiohttp_client_cache`, `SQLiteBackend`, `pandas`, `DataFrame`, `random_user_agent.user_agent`, `UserAgent`, `aiohttp_client_cache`, `SQLiteBackend`, `openbb_core.app.utils`, `get_user_cache_directory`, `aiohttp_client_cache`, `SQLiteBackend`, `openbb_core.app.utils`
...
## Notes
- Generated: 2025-11-18T07:54:41.813083
