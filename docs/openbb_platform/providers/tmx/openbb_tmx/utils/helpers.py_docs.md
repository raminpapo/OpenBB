...
- **Functions** (24): get_random_agent, get_companies_backend, get_indices_backend, response_callback, get_data_from_url, get_data_from_gql, replace_values_in_list_of_dicts, check_weekday, get_all_etfs, get_tmx_tickers ... and 14 more
...
- **`get_companies_backend()`**
- **`get_indices_backend()`**
- **`response_callback(response, _: Any)`**
- **`replace_values_in_list_of_dicts(data)`**
...
**Generated**: 2025-11-19T02:16:53.117425Z
