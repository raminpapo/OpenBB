# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/company_news.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/company_news.py`
- **Size**: 4,834 characters, 137 lines
- **Words**: 394
- **Extension**: .py
...
**Classes** (3):
`TmxCompanyNewsQueryParams`, `TmxCompanyNewsData`, `TmxCompanyNewsFetcher`

**Functions** (6):
`symbols_validate`, `date_validate`, `transform_query`, `aextract_data`, `create_task`, `transform_data`

**Imports** (19):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.company_news`, `pydantic`, `Field`, `pytz`, `the`, `asyncio`, `json`, `openbb_tmx.utils`, `gql`, `openbb_tmx.utils.helpers`, `get_data_from_gql`


## Key Components

**Class `TmxCompanyNewsQueryParams`**: TMX Stock News query.

**Class `TmxCompanyNewsData`**: TMX Stock News Data.

**Class `TmxCompanyNewsFetcher`**: TMX Stock News Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.771796
