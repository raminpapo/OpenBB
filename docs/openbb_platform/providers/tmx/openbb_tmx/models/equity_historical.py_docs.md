# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/equity_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/equity_historical.py`
- **Size**: 9,083 characters, 247 lines
- **Words**: 815
- **Extension**: .py
...
**Classes** (3):
`TmxEquityHistoricalQueryParams`, `TmxEquityHistoricalData`, `TmxEquityHistoricalFetcher`

**Functions** (6):
`validate_interval`, `date_validate`, `transform_query`, `aextract_data`, `create_task`, `transform_data`

**Imports** (21):
`datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_historical`, `openbb_core.provider.utils.descriptions`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `pytz`, `the`, `asyncio`, `openbb_tmx.utils.helpers`, `pandas`


## Key Components

**Class `TmxEquityHistoricalQueryParams`**: TMX Equity Historical Query Params.
...
**Class `TmxEquityHistoricalData`**: TMX Equity Historical Data.

**Class `TmxEquityHistoricalFetcher`**: TMX Equity Historical Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.773820
