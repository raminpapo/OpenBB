...
- **Classes** (3): TmxEtfInfoQueryParams, TmxEtfInfoData, TmxEtfInfoFetcher
...
- **`TmxEtfInfoQueryParams`**(EtfInfoQueryParams)
- **`TmxEtfInfoData`**(EtfInfoData)
- **`TmxEtfInfoFetcher`**(
    Fetcher[
        TmxEtfInfoQueryParams,
        list[TmxEtfInfoData],
...
**Generated**: 2025-11-19T02:16:53.087084Z
