# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/equity_profile.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/equity_profile.py`
- **Size**: 5,560 characters, 168 lines
- **Words**: 454
- **Extension**: .py
...
**Classes** (3):
`TmxEquityProfileQueryParams`, `TmxEquityProfileData`, `TmxEquityProfileFetcher`

**Functions** (5):
`validate_empty_strings`, `transform_query`, `aextract_data`, `create_task`, `transform_data`

**Imports** (15):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_info`, `pydantic`, `Field`, `all`, `the`, `asyncio`, `json`, `openbb_tmx.utils`, `gql`, `openbb_tmx.utils.helpers`, `get_data_from_gql`


## Key Components

**Class `TmxEquityProfileQueryParams`**: TMX Equity Profile query params.

**Class `TmxEquityProfileData`**: TMX Equity Profile Data.

**Class `TmxEquityProfileFetcher`**: TMX Equity Profile Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.776028
