...
- **Classes** (3): TmxEtfSearchQueryParams, TmxEtfSearchData, TmxEtfSearchFetcher
...
- **`TmxEtfSearchQueryParams`**(EtfSearchQueryParams)
- **`TmxEtfSearchData`**(EtfSearchData)
- **`TmxEtfSearchFetcher`**(
    Fetcher[
        TmxEtfSearchQueryParams,
        list[TmxEtfSearchData],
...
**Generated**: 2025-11-19T02:16:53.089348Z
