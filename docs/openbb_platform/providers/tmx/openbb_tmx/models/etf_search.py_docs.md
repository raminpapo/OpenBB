# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/etf_search.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/etf_search.py`
- **Size**: 9,715 characters, 272 lines
- **Words**: 883
- **Extension**: .py
...
**Classes** (3):
`TmxEtfSearchQueryParams`, `TmxEtfSearchData`, `TmxEtfSearchFetcher`

**Functions** (4):
`normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (15):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.etf_search`, `pydantic`, `Field`, `a`, `inception`, `the`, `the`, `openbb_tmx.utils.helpers`, `get_all_etfs`, `pandas`, `DataFrame`


## Key Components

**Class `TmxEtfSearchQueryParams`**: TMX ETF Search query.

    Source: https://www.tmx.com/

**Class `TmxEtfSearchData`**: TMX ETF Search Data.

**Class `TmxEtfSearchFetcher`**: Transform the query, extract and transform the data from the TMX endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:41.788393
