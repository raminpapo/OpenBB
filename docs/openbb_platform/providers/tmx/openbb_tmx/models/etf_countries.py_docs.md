# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/etf_countries.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/etf_countries.py`
- **Size**: 3,317 characters, 102 lines
- **Words**: 283
- **Extension**: .py
...
**Classes** (3):
`TmxEtfCountriesQueryParams`, `TmxEtfCountriesData`, `TmxEtfCountriesFetcher`

**Functions** (4):
`_normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (16):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.etf_countries`, `pydantic`, `Field`, `a`, `the`, `warnings`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_tmx.utils.helpers`, `get_all_etfs`, `pandas`, `DataFrame`


## Key Components

**Class `TmxEtfCountriesQueryParams`**: TMX ETF Countries Query Params

**Class `TmxEtfCountriesData`**: TMX ETF Countries Data.

**Class `TmxEtfCountriesFetcher`**: TMX ETF Countries Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.781519
