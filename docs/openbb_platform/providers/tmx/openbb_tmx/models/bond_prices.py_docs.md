# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/bond_prices.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/bond_prices.py`
- **Size**: 7,375 characters, 219 lines
- **Words**: 681
- **Extension**: .py
...
**Classes** (3):
`TmxBondPricesQueryParams`, `TmxBondPricesData`, `TmxBondPricesFetcher`

**Functions** (4):
`normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (19):
`datetime`, `typing`, `TYPE_CHECKING`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.bond_reference`, `pydantic`, `Field`, `pandas`, `DataFrame`, `a`, `datetime`, `timedelta`, `openbb_tmx.utils.helpers`, `get_all_bonds`, `numpy`, `nan`


## Key Components

**Class `TmxBondPricesQueryParams`**: TMX Bond Prices Query Params.

    Data will be made available by 5:00 EST on T+1

    Source: https://bondtradedata.iiroc.ca/#/

**Class `TmxBondPricesData`**: TMX Bond Prices Data.

**Class `TmxBondPricesFetcher`**: Tmx Bond Reference Fetcher.
...
- `openbb_core.provider.standard_models.bond_reference`
- `pydantic`
- `pandas`
- `datetime`
...
## Notes
- Generated: 2025-11-18T07:54:41.766003
