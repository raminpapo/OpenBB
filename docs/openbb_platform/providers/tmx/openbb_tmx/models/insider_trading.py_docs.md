# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/insider_trading.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/insider_trading.py`
- **Size**: 6,212 characters, 170 lines
- **Words**: 507
- **Extension**: .py
...
**Classes** (3):
`TmxInsiderTradingQueryParams`, `TmxInsiderTradingData`, `TmxInsiderTradingFetcher`

**Functions** (4):
`period_to_snake_case`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (17):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.insider_trading`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `openbb_core.provider.utils.helpers`, `to_snake_case`, `the`, `json`, `openbb_tmx.utils`, `gql`, `openbb_tmx.utils.helpers`, `get_data_from_gql`


## Key Components

**Class `TmxInsiderTradingQueryParams`**: TMX Insider Trading Query Params.

**Class `TmxInsiderTradingData`**: TMX Insider Trading Data.

**Class `TmxInsiderTradingFetcher`**: TMX Insider Trading Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.802077
