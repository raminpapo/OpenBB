# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/price_target_consensus.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/price_target_consensus.py`
- **Size**: 6,095 characters, 169 lines
- **Words**: 427
- **Extension**: .py
...
**Classes** (3):
`TmxPriceTargetConsensusQueryParams`, `TmxPriceTargetConsensusData`, `TmxPriceTargetConsensusFetcher`

**Functions** (7):
`check_symbol`, `normalize_percent`, `round_targets`, `transform_query`, `aextract_data`, `create_task`, `transform_data`

**Imports** (17):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.price_target_consensus`, `pydantic`, `Field`, `the`, `the`, `asyncio`, `json`, `openbb_tmx.utils`, `gql`, `openbb_tmx.utils.helpers`, `get_data_from_gql`


## Key Components

**Class `TmxPriceTargetConsensusQueryParams`**: TMX Price Target Consensus Query.

**Class `TmxPriceTargetConsensusData`**: TMX Price Target Consensus Data.

**Class `TmxPriceTargetConsensusFetcher`**: Transform the query, extract and transform the data from the TMX endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:41.805531
