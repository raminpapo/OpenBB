# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/etf_holdings.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/etf_holdings.py`
- **Size**: 5,059 characters, 147 lines
- **Words**: 462
- **Extension**: .py
...
**Classes** (3):
`TmxEtfHoldingsQueryParams`, `TmxEtfHoldingsData`, `TmxEtfHoldingsFetcher`

**Functions** (4):
`normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (13):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.etf_holdings`, `pydantic`, `Field`, `a`, `the`, `openbb_tmx.utils.helpers`, `get_all_etfs`, `pandas`, `DataFrame`


## Key Components

**Class `TmxEtfHoldingsQueryParams`**: TMX ETF Holdings query.

    Source: https://www.tmx.com/

**Class `TmxEtfHoldingsData`**: TMX ETF Holdings Data.

**Class `TmxEtfHoldingsFetcher`**: TMX ETF Holdings Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.783955
