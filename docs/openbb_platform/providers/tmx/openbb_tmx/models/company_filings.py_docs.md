# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/company_filings.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/company_filings.py`
- **Size**: 6,317 characters, 185 lines
- **Words**: 497
- **Extension**: .py
...
**Classes** (3):
`TmxCompanyFilingsQueryParams`, `TmxCompanyFilingsData`, `TmxCompanyFilingsFetcher`

**Functions** (6):
`_validate_symbol`, `transform_query`, `aextract_data`, `create_task`, `try_again`, `transform_data`

**Imports** (23):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.company_filings`, `pydantic`, `Field`, `datetime`, `timedelta`, `the`, `asyncio`, `json`, `dateutil`, `rrule`, `datetime`, `timedelta`, `openbb_tmx.utils`, `gql`, `openbb_tmx.utils.helpers`


## Key Components

**Class `TmxCompanyFilingsQueryParams`**: TMX Company Filings Query Parameters.

**Class `TmxCompanyFilingsData`**: TMX Sedar Filings Data.

**Class `TmxCompanyFilingsFetcher`**: TMX Company Filings Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.770208
