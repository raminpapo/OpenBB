...
- **Classes** (3): TmxEquityQuoteQueryParams, TmxEquityQuoteData, TmxEquityQuoteFetcher
- **Functions** (6): date_validate, normalize_percent, transform_query, aextract_data, create_task, transform_data
- **Import Statements**: 7
...
- **`TmxEquityQuoteQueryParams`**(EquityQuoteQueryParams)
- **`TmxEquityQuoteData`**(EquityQuoteData)
...
**Generated**: 2025-11-19T02:16:53.078320Z
