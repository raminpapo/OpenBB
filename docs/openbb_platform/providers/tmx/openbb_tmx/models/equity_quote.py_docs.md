# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/equity_quote.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/equity_quote.py`
- **Size**: 12,785 characters, 381 lines
- **Words**: 1,148
- **Extension**: .py
...
**Classes** (3):
`TmxEquityQuoteQueryParams`, `TmxEquityQuoteData`, `TmxEquityQuoteFetcher`

**Functions** (6):
`date_validate`, `normalize_percent`, `transform_query`, `aextract_data`, `create_task`, `transform_data`

**Imports** (23):
`datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_quote`, `openbb_core.provider.utils.descriptions`, `DATA_DESCRIPTIONS`, `pydantic`, `Field`, `all`, `the`, `the`, `asyncio`, `json`, `openbb_tmx.utils`, `gql`, `openbb_tmx.utils.helpers`


## Key Components

**Class `TmxEquityQuoteQueryParams`**: TMX Equity Profile query params.

**Class `TmxEquityQuoteData`**: TMX Equity Profile Data.

**Class `TmxEquityQuoteFetcher`**: TMX Equity Quote Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.777889
