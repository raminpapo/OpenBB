# Documentation: openbb_platform/providers/tmx/openbb_tmx/models/index_snapshots.py

## File Metadata
- **Path**: `openbb_platform/providers/tmx/openbb_tmx/models/index_snapshots.py`
- **Size**: 10,429 characters, 289 lines
- **Words**: 790
- **Extension**: .py
...
**Classes** (3):
`TmxIndexSnapshotsQueryParams`, `TmxIndexSnapshotsData`, `TmxIndexSnapshotsFetcher`

**Functions** (5):
`normalize_percent`, `round_floating`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (15):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.index_snapshots`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `a`, `the`, `json`, `openbb_tmx.utils`, `gql`, `openbb_tmx.utils.helpers`


## Key Components

**Class `TmxIndexSnapshotsQueryParams`**: TMX Index Snapshots Query Params.

**Class `TmxIndexSnapshotsData`**: TMX Index Snapshots Data.

**Class `TmxIndexSnapshotsFetcher`**: TMX Index Snapshots Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.799809
