...
- **Classes** (3): TmxIndexSnapshotsQueryParams, TmxIndexSnapshotsData, TmxIndexSnapshotsFetcher
- **Functions** (5): normalize_percent, round_floating, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`TmxIndexSnapshotsQueryParams`**(IndexSnapshotsQueryParams)
- **`TmxIndexSnapshotsData`**(IndexSnapshotsData)
...
**Generated**: 2025-11-19T02:16:53.101716Z
