...
- **Classes** (3): TmxGainersQueryParams, TmxGainersData, TmxGainersFetcher
- **Functions** (5): normalize_percent, check_metric, transform_query, aextract_data, transform_data
- **Import Statements**: 5
...
- **`TmxGainersQueryParams`**(EquityPerformanceQueryParams)
- **`TmxGainersData`**(EquityPerformanceData)
- **`TmxGainersFetcher`**(
    Fetcher[
        TmxGainersQueryParams,
        list[TmxGainersData],
...
**Generated**: 2025-11-19T02:16:53.093310Z
