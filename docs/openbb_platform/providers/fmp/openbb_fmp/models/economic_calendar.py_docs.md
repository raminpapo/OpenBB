# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/economic_calendar.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/economic_calendar.py`
- **Size**: 5,350 characters, 152 lines
- **Words**: 441
- **Extension**: .py
...
**Classes** (3):
`FMPEconomicCalendarQueryParams`, `FMPEconomicCalendarData`, `FMPEconomicCalendarFetcher`

**Functions** (7):
`_normalize_percent`, `empty_strings`, `transform_query`, `aextract_data`, `date_range`, `get_one`, `transform_data`

**Imports** (23):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.economic_calendar`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `asyncio`, `warnings`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_fmp.utils.helpers`, `response_callback`


## Key Components

**Class `FMPEconomicCalendarQueryParams`**: FMP Economic Calendar Query.

    Source: https://site.financialmodelingprep.com/developer/docs#economics-calendar

**Class `FMPEconomicCalendarData`**: FMP Economics Calendar Data.

    Source: https://site.financialmodelingprep.com/developer/docs#economics-calendar

**Class `FMPEconomicCalendarFetcher`**: FMP Economic Calendar Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.345164
