...
- **Classes** (3): FMPEconomicCalendarQueryParams, FMPEconomicCalendarData, FMPEconomicCalendarFetcher
- **Functions** (7): _normalize_percent, empty_strings, transform_query, aextract_data, date_range, get_one, transform_data
- **Import Statements**: 4
...
- **`FMPEconomicCalendarQueryParams`**(EconomicCalendarQueryParams)
- **`FMPEconomicCalendarData`**(EconomicCalendarData)
...
**Generated**: 2025-11-19T02:16:50.607838Z
