...
- **Classes** (3): FMPEquityQuoteQueryParams, FMPEquityQuoteData, FMPEquityQuoteFetcher
- **Functions** (6): validate_last_timestamp, _normalize_percent, transform_query, aextract_data, get_one, transform_data
- **Import Statements**: 6
...
- **`FMPEquityQuoteQueryParams`**(EquityQuoteQueryParams)
- **`FMPEquityQuoteData`**(EquityQuoteData)
...
**Generated**: 2025-11-19T02:16:50.622688Z
