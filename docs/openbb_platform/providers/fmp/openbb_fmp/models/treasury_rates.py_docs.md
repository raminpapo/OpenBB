# File Documentation: treasury_rates.py
...
This is a **python** file named `treasury_rates.py`.

**Python Module**

- **Classes** (3): FMPTreasuryRatesQueryParams, FMPTreasuryRatesData, FMPTreasuryRatesFetcher
- **Functions** (5): normalize_percent, transform_query, aextract_data, generate_urls, transform_data
- **Import Statements**: 3
...
- **`FMPTreasuryRatesQueryParams`**(TreasuryRatesQueryParams)
- **`FMPTreasuryRatesData`**(TreasuryRatesData)
...
- **`normalize_percent(cls, values)`**
- **`generate_urls(start_date, end_date)`**
...
**Generated**: 2025-11-19T02:16:50.695761Z
