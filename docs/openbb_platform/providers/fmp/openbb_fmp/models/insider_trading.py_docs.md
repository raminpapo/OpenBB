...
- **Classes** (3): FMPInsiderTradingQueryParams, FMPInsiderTradingData, FMPInsiderTradingFetcher
- **Functions** (4): validate_transaction_type, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`FMPInsiderTradingQueryParams`**(InsiderTradingQueryParams)
- **`FMPInsiderTradingData`**(InsiderTradingData)
...
- **`validate_transaction_type(cls, v)`**
...
**Generated**: 2025-11-19T02:16:50.668146Z
