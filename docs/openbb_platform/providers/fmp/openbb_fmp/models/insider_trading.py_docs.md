# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/insider_trading.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/insider_trading.py`
- **Size**: 6,327 characters, 181 lines
- **Words**: 531
- **Extension**: .py
...
**Classes** (3):
`FMPInsiderTradingQueryParams`, `FMPInsiderTradingData`, `FMPInsiderTradingFetcher`

**Functions** (4):
`validate_transaction_type`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (16):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.insider_trading`, `openbb_fmp.utils.definitions`, `TRANSACTION_TYPES`, `pydantic`, `Field`, `the`, `the`, `math`, `openbb_core.provider.utils.helpers`, `get_querystring`, `openbb_fmp.utils.helpers`, `get_data_urls`


## Key Components

**Class `FMPInsiderTradingQueryParams`**: FMP Insider Trading Query.

    Source: https://site.financialmodelingprep.com/developer/docs#search-insider-trades

**Class `FMPInsiderTradingData`**: FMP Insider Trading Data.

**Class `FMPInsiderTradingFetcher`**: Transform the query, extract and transform the data from the FMP endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:39.398302
