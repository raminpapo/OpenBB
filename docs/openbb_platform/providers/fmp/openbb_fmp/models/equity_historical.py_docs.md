...
- **Classes** (3): FMPEquityHistoricalQueryParams, FMPEquityHistoricalData, FMPEquityHistoricalFetcher
- **Functions** (5): _validate_params, _normalize_percent, transform_query, aextract_data, transform_data
- **Import Statements**: 3
...
- **`FMPEquityHistoricalQueryParams`**(EquityHistoricalQueryParams)
- **`FMPEquityHistoricalData`**(EquityHistoricalData)
...
**Generated**: 2025-11-19T02:16:50.611433Z
