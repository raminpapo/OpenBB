# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/cash_flow.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/cash_flow.py`
- **Size**: 10,738 characters, 306 lines
- **Words**: 842
- **Extension**: .py
...
**Classes** (3):
`FMPCashFlowStatementQueryParams`, `FMPCashFlowStatementData`, `FMPCashFlowStatementFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (19):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.cash_flow`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_fmp.utils.definitions`, `FinancialStatementPeriods`, `pydantic`, `Field`, `operating`, `investing`, `financing`, `the`, `the`, `openbb_fmp.utils.helpers`, `get_data_many`


## Key Components

**Class `FMPCashFlowStatementQueryParams`**: FMP Cash Flow Statement Query.

    Source: https://financialmodelingprep.com/developer/docs/#Cash-Flow-Statement

**Class `FMPCashFlowStatementData`**: FMP Cash Flow Statement Data.

**Class `FMPCashFlowStatementFetcher`**: Transform the query, extract and transform the data from the FMP endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:39.326311
