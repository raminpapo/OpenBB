# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/balance_sheet_growth.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/balance_sheet_growth.py`
- **Size**: 15,210 characters, 348 lines
- **Words**: 1,132
- **Extension**: .py
...
**Classes** (3):
`FMPBalanceSheetGrowthQueryParams`, `FMPBalanceSheetGrowthData`, `FMPBalanceSheetGrowthFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (13):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.balance_sheet_growth`, `openbb_core.provider.utils.descriptions`, `openbb_fmp.utils.definitions`, `FinancialPeriods`, `pydantic`, `Field`, `the`, `openbb_fmp.utils.helpers`, `get_data_many`


## Key Components

**Class `FMPBalanceSheetGrowthQueryParams`**: FMP Balance Sheet Growth Query.

    Source: https://site.financialmodelingprep.com/developer/docs#balance-sheet-statement-growth

**Class `FMPBalanceSheetGrowthData`**: FMP Balance Sheet Growth Data.

**Class `FMPBalanceSheetGrowthFetcher`**: FMP Balance Sheet Growth Fetcher.
...
- `openbb_core.provider.standard_models.balance_sheet_growth`
...
## Notes
- Generated: 2025-11-18T07:54:39.317556
