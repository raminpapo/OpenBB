# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/government_trades.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/government_trades.py`
- **Size**: 9,059 characters, 251 lines
- **Words**: 697
- **Extension**: .py
...
**Classes** (3):
`FMPGovernmentTradesQueryParams`, `FMPGovernmentTradesData`, `FMPGovernmentTradesFetcher`

**Functions** (6):
`_fill_missing`, `transform_query`, `aextract_data`, `get_one`, `fetch_page`, `transform_data`

**Imports** (21):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.government_trades`, `pydantic`, `ConfigDict`, `the`, `asyncio`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_fmp.utils.helpers`, `response_callback`, `warnings`, `warn`, `any`


## Key Components

**Class `FMPGovernmentTradesQueryParams`**: Government Trades Query Parameters.

    Source: https://site.financialmodelingprep.com/developer/docs#house-trading

**Class `FMPGovernmentTradesData`**: Government Trades Data Model.

**Class `FMPGovernmentTradesFetcher`**: FMP Government Trades Fetcher.
...
- `openbb_core.provider.standard_models.government_trades`
- `pydantic`
- `asyncio`
...
## Notes
- Generated: 2025-11-18T07:54:39.380010
