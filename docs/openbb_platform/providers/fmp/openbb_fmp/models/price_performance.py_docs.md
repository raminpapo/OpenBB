# File Documentation: price_performance.py
...
This is a **python** file named `price_performance.py`.

**Python Module**

- **Classes** (3): FMPPricePerformanceQueryParams, FMPPricePerformanceData, FMPPricePerformanceFetcher
- **Functions** (4): replace_zero, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`FMPPricePerformanceQueryParams`**(RecentPerformanceQueryParams)
- **`FMPPricePerformanceData`**(RecentPerformanceData)
...
**Generated**: 2025-11-19T02:16:50.682339Z
