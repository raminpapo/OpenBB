# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/price_performance.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/price_performance.py`
- **Size**: 3,381 characters, 104 lines
- **Words**: 282
- **Extension**: .py
...
**Classes** (3):
`FMPPricePerformanceQueryParams`, `FMPPricePerformanceData`, `FMPPricePerformanceFetcher`

**Functions** (4):
`replace_zero`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (12):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.recent_performance`, `pydantic`, `model_validator`, `the`, `the`, `openbb_fmp.utils.helpers`, `get_data_urls`, `warnings`


## Key Components

**Class `FMPPricePerformanceQueryParams`**: FMP Price Performance Query.

    Source: https://site.financialmodelingprep.com/developer/docs#quote-change

**Class `FMPPricePerformanceData`**: FMP Price Performance Data.

**Class `FMPPricePerformanceFetcher`**: Transform the query, extract and transform the data from the FMP endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:39.410616
