# File Documentation: income_statement_growth.py
...
This is a **python** file named `income_statement_growth.py`.

**Python Module**

- **Classes** (3): FMPIncomeStatementGrowthQueryParams, FMPIncomeStatementGrowthData, FMPIncomeStatementGrowthFetcher
...
- **`FMPIncomeStatementGrowthQueryParams`**(IncomeStatementGrowthQueryParams)
- **`FMPIncomeStatementGrowthData`**(IncomeStatementGrowthData)
...
**Generated**: 2025-11-19T02:16:50.661919Z
