# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/financial_ratios.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/financial_ratios.py`
- **Size**: 19,015 characters, 487 lines
- **Words**: 1,339
- **Extension**: .py
...
**Classes** (3):
`FMPFinancialRatiosQueryParams`, `FMPFinancialRatiosData`, `FMPFinancialRatiosFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (18):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.financial_ratios`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fmp.utils.definitions`, `FinancialPeriods`, `pydantic`, `ConfigDict`, `the`, `asyncio`, `warnings`, `openbb_fmp.utils.helpers`, `get_data_many`


## Key Components

**Class `FMPFinancialRatiosQueryParams`**: FMP Financial Ratios Query.

    Source: https://site.financialmodelingprep.com/developer/docs#metrics-ratios

**Class `FMPFinancialRatiosData`**: FMP Financial Ratios Data.

**Class `FMPFinancialRatiosFetcher`**: FMP Financial Ratios Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.374340
