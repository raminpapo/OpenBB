# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/key_metrics.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/key_metrics.py`
- **Size**: 12,586 characters, 316 lines
- **Words**: 983
- **Extension**: .py
...
**Classes** (3):
`FMPKeyMetricsQueryParams`, `FMPKeyMetricsData`, `FMPKeyMetricsFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (18):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.key_metrics`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fmp.utils.definitions`, `FinancialPeriods`, `pydantic`, `Field`, `the`, `asyncio`, `warnings`, `openbb_fmp.utils.helpers`, `get_data_many`


## Key Components

**Class `FMPKeyMetricsQueryParams`**: FMP Equity Valuation Multiples Query.

    Source: https://site.financialmodelingprep.com/developer/docs#key-metrics

**Class `FMPKeyMetricsData`**: FMP Equity Valuation Multiples Data.

**Class `FMPKeyMetricsFetcher`**: FMP Key Metrics Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.404428
