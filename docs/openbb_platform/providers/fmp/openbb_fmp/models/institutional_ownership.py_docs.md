...
- **Classes** (3): FMPInstitutionalOwnershipQueryParams, FMPInstitutionalOwnershipData, FMPInstitutionalOwnershipFetcher
...
- **`FMPInstitutionalOwnershipQueryParams`**(InstitutionalOwnershipQueryParams)
- **`FMPInstitutionalOwnershipData`**(InstitutionalOwnershipData)
...
**Generated**: 2025-11-19T02:16:50.670903Z
