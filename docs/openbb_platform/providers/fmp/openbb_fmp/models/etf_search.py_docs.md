# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/etf_search.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/etf_search.py`
- **Size**: 4,268 characters, 135 lines
- **Words**: 362
- **Extension**: .py
...
**Classes** (3):
`FMPEtfSearchQueryParams`, `FMPEtfSearchData`, `FMPEtfSearchFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (14):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.etf_search`, `pydantic`, `ConfigDict`, `the`, `openbb_fmp.utils.helpers`, `get_data_many`, `numpy`, `nan`, `pandas`, `DataFrame`


## Key Components

**Class `FMPEtfSearchQueryParams`**: FMP ETF Search Query.

**Class `FMPEtfSearchData`**: FMP ETF Search Data.

**Class `FMPEtfSearchFetcher`**: FMP ETF Search Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.369322
