# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/income_statement.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/income_statement.py`
- **Size**: 8,707 characters, 260 lines
- **Words**: 690
- **Extension**: .py
...
**Classes** (3):
`FMPIncomeStatementQueryParams`, `FMPIncomeStatementData`, `FMPIncomeStatementFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (17):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.income_statement`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_fmp.utils.definitions`, `FinancialStatementPeriods`, `pydantic`, `Field`, `continuing`, `discontinued`, `the`, `openbb_fmp.utils.helpers`, `get_data_many`


## Key Components

**Class `FMPIncomeStatementQueryParams`**: FMP Income Statement Query.

    Source: https://financialmodelingprep.com/developer/docs/#Income-Statement

**Class `FMPIncomeStatementData`**: FMP Income Statement Data.

**Class `FMPIncomeStatementFetcher`**: FMP Income Statement Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.390099
