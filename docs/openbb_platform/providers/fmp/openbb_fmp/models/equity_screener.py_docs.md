# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/equity_screener.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/equity_screener.py`
- **Size**: 9,727 characters, 294 lines
- **Words**: 906
- **Extension**: .py
...
**Classes** (3):
`FMPEquityScreenerQueryParams`, `FMPEquityScreenerData`, `FMPEquityScreenerFetcher`

**Functions** (4):
`_validate_industry`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (15):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_screener`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fmp.utils.definitions`, `pydantic`, `Field`, `the`, `openbb_core.provider.utils.helpers`, `get_querystring`, `openbb_fmp.utils.helpers`, `get_data`


## Key Components

**Class `FMPEquityScreenerQueryParams`**: FMP Equity Screener Query.

**Class `FMPEquityScreenerData`**: FMP Equity Screener Data.

**Class `FMPEquityScreenerFetcher`**: FMP Equity Screener Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.359854
