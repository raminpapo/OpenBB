...
- **Classes** (4): FMPEquityOwnershipQueryParams, FMPEquityOwnershipData, of, FMPEquityOwnershipFetcher
...
- **`FMPEquityOwnershipQueryParams`**(EquityOwnershipQueryParams)
- **`FMPEquityOwnershipData`**(EquityOwnershipData)
...
**Generated**: 2025-11-19T02:16:50.616601Z
