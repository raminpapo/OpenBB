# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/calendar_ipo.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/calendar_ipo.py`
- **Size**: 4,115 characters, 135 lines
- **Words**: 378
- **Extension**: .py
...
**Classes** (3):
`FMPCalendarIpoQueryParams`, `FMPCalendarIpoData`, `FMPCalendarIpoFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (14):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.calendar_ipo`, `pydantic`, `Field`, `the`, `openbb_core.provider.utils.helpers`, `amake_requests`, `openbb_fmp.utils.helpers`, `response_callback`, `all`


## Key Components

**Class `FMPCalendarIpoQueryParams`**: FMP IPO Calendar Query.

    Source: https://site.financialmodelingprep.com/developer/docs#ipos-calendar

**Class `FMPCalendarIpoData`**: FMP Earnings Calendar Data.

**Class `FMPCalendarIpoFetcher`**: FMP IPO Calendar Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.323556
