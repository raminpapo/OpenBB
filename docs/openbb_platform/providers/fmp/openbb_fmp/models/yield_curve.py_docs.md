...
- **Classes** (3): FMPYieldCurveQueryParams, FMPYieldCurveData, FMPYieldCurveFetcher
- **Functions** (4): transform_query, aextract_data, generate_url, transform_data
- **Import Statements**: 5
...
- **`FMPYieldCurveQueryParams`**(YieldCurveQueryParams)
- **`FMPYieldCurveData`**(YieldCurveData)
...
**Generated**: 2025-11-19T02:16:50.699886Z
