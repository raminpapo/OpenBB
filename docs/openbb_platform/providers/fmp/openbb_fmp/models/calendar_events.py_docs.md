# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/calendar_events.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/calendar_events.py`
- **Size**: 4,673 characters, 141 lines
- **Words**: 427
- **Extension**: .py
...
**Classes** (3):
`FmpCalendarEventsQueryParams`, `FmpCalendarEventsData`, `FMPCalendarEventsFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (22):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.calendar_events`, `pydantic`, `Field`, `the`, `asyncio`, `warnings`, `datetime`, `timedelta`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fmp.utils.helpers`, `get_data`, `pandas`, `date_range`


## Key Components

**Class `FmpCalendarEventsQueryParams`**: FMP Company Events Calendar Query.

    Source: https://site.financialmodelingprep.com/developer/docs/earnings-calendar-confirmed-api

**Class `FmpCalendarEventsData`**: FMP Company Events Calendar Data.

**Class `FMPCalendarEventsFetcher`**: FMP Company Events Calendar Fetcher.
...
- `openbb_core.provider.standard_models.calendar_events`
- `pydantic`
- `asyncio`
- `warnings`
- `datetime`
...
## Notes
- Generated: 2025-11-18T07:54:39.322132
