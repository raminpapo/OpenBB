# File Documentation: equity_losers.py
...
This is a **python** file named `equity_losers.py`.

**Python Module**

- **Classes** (3): FMPLosersQueryParams, FMPLosersData, FMPLosersFetcher
...
- **`FMPLosersQueryParams`**(EquityPerformanceQueryParams)
- **`FMPLosersData`**(EquityPerformanceData)
- **`FMPLosersFetcher`**(Fetcher[FMPLosersQueryParams, list[FMPLosersData]])
...
**Generated**: 2025-11-19T02:16:50.613093Z
