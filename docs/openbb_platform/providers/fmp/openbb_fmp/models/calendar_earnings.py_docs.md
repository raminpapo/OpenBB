# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/calendar_earnings.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/calendar_earnings.py`
- **Size**: 4,317 characters, 137 lines
- **Words**: 355
- **Extension**: .py
...
**Classes** (3):
`FMPCalendarEarningsQueryParams`, `FMPCalendarEarningsData`, `FMPCalendarEarningsFetcher`

**Functions** (4):
`date_validate`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (15):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.calendar_earnings`, `pydantic`, `Field`, `the`, `the`, `openbb_core.provider.utils.helpers`, `amake_requests`, `openbb_fmp.utils.helpers`, `response_callback`, `all`


## Key Components

**Class `FMPCalendarEarningsQueryParams`**: FMP Earnings Calendar Query.

    Source: https://site.financialmodelingprep.com/developer/docs#earnings-calendar

**Class `FMPCalendarEarningsData`**: FMP Earnings Calendar Data.

**Class `FMPCalendarEarningsFetcher`**: Transform the query, extract and transform the data from the FMP endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:39.320635
