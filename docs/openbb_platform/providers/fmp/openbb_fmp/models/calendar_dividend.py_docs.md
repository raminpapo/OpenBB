...
- **Classes** (3): FMPCalendarDividendQueryParams, FMPCalendarDividendData, FMPCalendarDividendFetcher
- **Functions** (5): date_validate, dividend_yield_validate, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`FMPCalendarDividendQueryParams`**(CalendarDividendQueryParams)
- **`FMPCalendarDividendData`**(CalendarDividendData)
...
**Generated**: 2025-11-19T02:16:50.574779Z
