...
- **Classes** (4): FMPEtfInfoQueryParams, FMPEtfInfoData, of, FMPEtfInfoFetcher
- **Functions** (5): _normalize_percent, transform_query, aextract_data, get_one, transform_data
- **Import Statements**: 4
...
- **`FMPEtfInfoQueryParams`**(EtfInfoQueryParams)
- **`FMPEtfInfoData`**(EtfInfoData)
- **`FMPEtfInfoFetcher`**(
    Fetcher[
        FMPEtfInfoQueryParams,
        list[FMPEtfInfoData],
...
**Generated**: 2025-11-19T02:16:50.633974Z
