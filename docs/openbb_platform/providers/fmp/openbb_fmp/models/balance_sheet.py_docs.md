# Documentation: openbb_platform/providers/fmp/openbb_fmp/models/balance_sheet.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/openbb_fmp/models/balance_sheet.py`
- **Size**: 12,629 characters, 378 lines
- **Words**: 986
- **Extension**: .py
...
**Classes** (3):
`FMPBalanceSheetQueryParams`, `FMPBalanceSheetData`, `FMPBalanceSheetFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (16):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.balance_sheet`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_fmp.utils.definitions`, `FinancialStatementPeriods`, `pydantic`, `Field`, `the`, `the`, `openbb_fmp.utils.helpers`, `get_data_many`


## Key Components

**Class `FMPBalanceSheetQueryParams`**: FMP Balance Sheet Query.

    Source: https://site.financialmodelingprep.com/developer/docs#balance-sheet-statement

**Class `FMPBalanceSheetData`**: FMP Balance Sheet Data.

**Class `FMPBalanceSheetFetcher`**: Transform the query, extract and transform the data from the FMP endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:39.315622
