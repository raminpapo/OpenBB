# Documentation: openbb_platform/providers/fmp/tests/test_fmp_fetchers.py

## File Metadata
- **Path**: `openbb_platform/providers/fmp/tests/test_fmp_fetchers.py`
- **Size**: 27,175 characters, 829 lines
- **Words**: 2,114
- **Extension**: .py
...
**Functions** (69):
`response_filter`, `vcr_config`, `test_fmp_company_filings_fetcher`, `test_fmp_crypto_historical_fetcher`, `test_fmp_currency_historical_fetcher`, `test_fmp_index_historical_fetcher`, `test_fmp_equity_historical_fetcher`, `test_fmp_company_news_fetcher`, `test_fmp_balance_sheet_fetcher`, `test_fmp_cash_flow_statement_fetcher`, `test_fmp_income_statement_fetcher`, `test_fmp_available_indices_fetcher`, `test_fmp_key_executives_fetcher`, `test_fmp_world_news_fetcher`, `test_fmp_income_statement_growth_fetcher`, `test_fmp_balance_sheet_growth_fetcher`, `test_fmp_cash_flow_statement_growth_fetcher`, `test_fmp_share_statistics_fetcher`, `test_fmp_revenue_geographic_fetcher`, `test_fmp_revenue_business_line_fetcher`

**Imports** (139):
`re`, `datetime`, `date`, `pytest`, `openbb_core.app.service.user_service`, `UserService`, `openbb_fmp.models.analyst_estimates`, `FMPAnalystEstimatesFetcher`, `openbb_fmp.models.available_indices`, `FMPAvailableIndicesFetcher`, `openbb_fmp.models.balance_sheet`, `FMPBalanceSheetFetcher`, `openbb_fmp.models.balance_sheet_growth`, `FMPBalanceSheetGrowthFetcher`, `openbb_fmp.models.calendar_dividend`, `FMPCalendarDividendFetcher`, `openbb_fmp.models.calendar_earnings`, `FMPCalendarEarningsFetcher`, `openbb_fmp.models.calendar_events`, `FMPCalendarEventsFetcher`
...
- `openbb_fmp.models.analyst_estimates`
- `openbb_fmp.models.available_indices`
- `openbb_fmp.models.balance_sheet`
- `openbb_fmp.models.balance_sheet_growth`
- `openbb_fmp.models.calendar_dividend`
- `openbb_fmp.models.calendar_earnings`

## Notes
- Generated: 2025-11-18T07:54:39.644774
