# Documentation: openbb_platform/providers/nasdaq/openbb_nasdaq/app.py

## File Metadata
- **Path**: `openbb_platform/providers/nasdaq/openbb_nasdaq/app.py`
- **Size**: 39,238 characters, 971 lines
- **Words**: 2,284
- **Extension**: .py
...
**Functions** (14):
`main`, `get_listings`, `startup_event`, `get_symbol_choices`, `get_document_choices`, `download_pdf_file`, `open_document`, `post_open_document`, `earnings_calendar`, `dividend_calendar`, `historical_dividends`, `ipo_calendar`, `economic_calendar`, `get_apps`

**Imports** (29):
`datetime`, `datetime`, `typing`, `Annotated`, `async_lru`, `alru_cache`, `fastapi`, `Depends`, `openbb_nasdaq.models.calendar_dividend`, `NasdaqCalendarDividendFetcher`, `openbb_nasdaq.models.calendar_earnings`, `NasdaqCalendarEarningsFetcher`, `openbb_nasdaq.models.calendar_ipo`, `NasdaqCalendarIpoFetcher`, `openbb_nasdaq.models.company_filings`, `NasdaqCompanyFilingsFetcher`, `openbb_nasdaq.models.economic_calendar`, `NasdaqEconomicCalendarFetcher`, `openbb_nasdaq.models.equity_search`, `NasdaqEquitySearchFetcher`
...
This file contains a `main()` function. It may be executable.
...
## Notes
- Generated: 2025-11-18T07:54:40.310604
