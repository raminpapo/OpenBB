...
- **Functions** (14): main, get_listings, startup_event, get_symbol_choices, get_document_choices, download_pdf_file, open_document, post_open_document, earnings_calendar, dividend_calendar ... and 4 more
- **Import Statements**: 4
...
- **`main()`**
- **`startup_event()`**
- **`download_pdf_file(document_url: str)`**
- **`historical_dividends(
        symbol2: str,
        start_date: str | None = None,
        end_date: str | None = None,
...
**Generated**: 2025-11-19T02:16:51.631029Z
