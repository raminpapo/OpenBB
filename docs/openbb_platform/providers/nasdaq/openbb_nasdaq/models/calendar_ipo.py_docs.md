# Documentation: openbb_platform/providers/nasdaq/openbb_nasdaq/models/calendar_ipo.py

## File Metadata
- **Path**: `openbb_platform/providers/nasdaq/openbb_nasdaq/models/calendar_ipo.py`
- **Size**: 7,041 characters, 224 lines
- **Words**: 577
- **Extension**: .py
...
**Classes** (3):
`NasdaqCalendarIpoQueryParams`, `NasdaqCalendarIpoData`, `NasdaqCalendarIpoFetcher`

**Functions** (7):
`validate_date`, `validate_offer_amount`, `validate_share_count`, `transform_query`, `aextract_data`, `get_calendar_data`, `transform_data`

**Imports** (19):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.calendar_ipo`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `datetime`, `timedelta`, `the`, `asyncio`, `openbb_nasdaq.utils.helpers`, `get_headers`, `openbb_core.provider.utils.helpers`, `amake_request`


## Key Components

**Class `NasdaqCalendarIpoQueryParams`**: Nasdaq IPO Calendar Query.

    Source: https://www.nasdaq.com/market-activity/ipos

**Class `NasdaqCalendarIpoData`**: Nasdaq IPO Calendar Data.

**Class `NasdaqCalendarIpoFetcher`**: Transform the query, extract and transform the data from the Nasdaq endpoints.
...
- `openbb_core.provider.standard_models.calendar_ipo`
...
## Notes
- Generated: 2025-11-18T07:54:40.317885
