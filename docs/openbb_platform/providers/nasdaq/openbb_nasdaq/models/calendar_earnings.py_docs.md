# Documentation: openbb_platform/providers/nasdaq/openbb_nasdaq/models/calendar_earnings.py

## File Metadata
- **Path**: `openbb_platform/providers/nasdaq/openbb_nasdaq/models/calendar_earnings.py`
- **Size**: 6,779 characters, 210 lines
- **Words**: 571
- **Extension**: .py
...
**Classes** (3):
`NasdaqCalendarEarningsQueryParams`, `NasdaqCalendarEarningsData`, `NasdaqCalendarEarningsFetcher`

**Functions** (9):
`validate_period_ending`, `validate_previous_report_date`, `validate_reporting_time`, `validate_numbers`, `validate_surprise_percent`, `transform_query`, `aextract_data`, `get_calendar_data`, `transform_data`

**Imports** (19):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.calendar_earnings`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `datetime`, `timedelta`, `the`, `asyncio`, `openbb_nasdaq.utils.helpers`, `get_headers`, `openbb_core.provider.utils.helpers`, `amake_request`


## Key Components

**Class `NasdaqCalendarEarningsQueryParams`**: Nasdaq Earnings Calendar Query.

    Source: https://www.nasdaq.com/market-activity/earnings

**Class `NasdaqCalendarEarningsData`**: Nasdaq Earnings Calendar Data.

**Class `NasdaqCalendarEarningsFetcher`**: Transform the query, extract and transform the data from the Nasdaq endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.316106
