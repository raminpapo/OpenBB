# Documentation: openbb_platform/providers/nasdaq/openbb_nasdaq/models/company_filings.py

## File Metadata
- **Path**: `openbb_platform/providers/nasdaq/openbb_nasdaq/models/company_filings.py`
- **Size**: 8,540 characters, 253 lines
- **Words**: 688
- **Extension**: .py
...
**Classes** (3):
`NasdaqCompanyFilingsQueryParams`, `NasdaqCompanyFilingsData`, `NasdaqCompanyFilingsFetcher`

**Functions** (5):
`_validate_period_ending`, `_validate`, `transform_query`, `extract_data`, `transform_data`

**Imports** (23):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.company_filings`, `pydantic`, `Field`, `the`, `time`, `openbb_core.provider.utils.errors`, `OpenBBError`, `openbb_core.provider.utils.helpers`, `get_requests_session`, `openbb_nasdaq.utils.helpers`, `get_headers`, `requests.exceptions`, `ReadTimeout`, `urllib3.exceptions`, `ReadTimeoutError`


## Key Components

**Class `NasdaqCompanyFilingsQueryParams`**: Nasdaq Company Filings Query Parameters.

**Class `NasdaqCompanyFilingsData`**: Nasdaq Company Filings Data.

**Class `NasdaqCompanyFilingsFetcher`**: Nasdaq Company Filings Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.319973
