# Documentation: openbb_platform/providers/nasdaq/openbb_nasdaq/models/equity_screener.py

## File Metadata
- **Path**: `openbb_platform/providers/nasdaq/openbb_nasdaq/models/equity_screener.py`
- **Size**: 14,586 characters, 496 lines
- **Words**: 1,097
- **Extension**: .py
...
**Classes** (3):
`NasdaqEquityScreenerQueryParams`, `NasdaqEquityScreenerData`, `NasdaqEquityScreenerFetcher`

**Functions** (11):
`validate_exchange`, `validate_exsubcategory`, `validate_mktcap`, `validate_recommendation`, `validate_sector`, `validate_region`, `validate_country`, `validate_numbers`, `transform_query`, `extract_data`, `transform_data`

**Imports** (20):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_screener`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `openbb_core.provider.utils.helpers`, `get_querystring`, `openbb_nasdaq.utils.helpers`, `get_headers`, `Nasdaq`, `error`


## Key Components

**Class `NasdaqEquityScreenerQueryParams`**: Nasdaq Equity Screener Query Params.

**Class `NasdaqEquityScreenerData`**: Nasdaq Equity Screener Data.

**Class `NasdaqEquityScreenerFetcher`**: Nasdaq Equity Screener Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.324191
