# Documentation: openbb_platform/providers/nasdaq/openbb_nasdaq/models/historical_dividends.py

## File Metadata
- **Path**: `openbb_platform/providers/nasdaq/openbb_nasdaq/models/historical_dividends.py`
- **Size**: 5,265 characters, 163 lines
- **Words**: 422
- **Extension**: .py
...
**Classes** (3):
`NasdaqHistoricalDividendsQueryParams`, `NasdaqHistoricalDividendsData`, `NasdaqHistoricalDividendsFetcher`

**Functions** (6):
`validate_date`, `validate_amount`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (19):
`datetime`, `typing`, `Any`, `warnings`, `warn`, `dateutil`, `parser`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.historical_dividends`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `asyncio`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_nasdaq.utils.helpers`, `get_headers`


## Key Components

**Class `NasdaqHistoricalDividendsQueryParams`**: Nasdaq Historical Dividends Query Params.

**Class `NasdaqHistoricalDividendsData`**: Nasdaq Historical Dividends Data.

**Class `NasdaqHistoricalDividendsFetcher`**: Nasdaq Historical Dividends Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.327943
