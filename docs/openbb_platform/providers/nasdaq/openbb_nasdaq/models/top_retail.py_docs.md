...
- **Classes** (3): NasdaqTopRetailQueryParams, NasdaqTopRetailData, NasdaqTopRetailFetcher
- **Functions** (4): validate_date, transform_query, extract_data, transform_data
- **Import Statements**: 3
...
- **`NasdaqTopRetailQueryParams`**(TopRetailQueryParams)
- **`NasdaqTopRetailData`**(TopRetailData)
...
**Generated**: 2025-11-19T02:16:51.655770Z
