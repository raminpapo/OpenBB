# Documentation: openbb_platform/providers/nasdaq/openbb_nasdaq/models/calendar_dividend.py

## File Metadata
- **Path**: `openbb_platform/providers/nasdaq/openbb_nasdaq/models/calendar_dividend.py`
- **Size**: 4,375 characters, 134 lines
- **Words**: 336
- **Extension**: .py
...
**Classes** (3):
`NasdaqCalendarDividendQueryParams`, `NasdaqCalendarDividendData`, `NasdaqCalendarDividendFetcher`

**Functions** (5):
`validate_date`, `transform_query`, `aextract_data`, `get_calendar_data`, `transform_data`

**Imports** (20):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.calendar_dividend`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `datetime`, `timedelta`, `the`, `asyncio`, `openbb_nasdaq.utils.helpers`, `get_headers`, `openbb_core.provider.utils.helpers`, `amake_request`


## Key Components

**Class `NasdaqCalendarDividendQueryParams`**: Nasdaq Dividend Calendar Query.

    Source: https://www.nasdaq.com/market-activity/dividends

**Class `NasdaqCalendarDividendData`**: Nasdaq Dividend Calendar Data.

**Class `NasdaqCalendarDividendFetcher`**: Transform the query, extract and transform the data from the Nasdaq endpoints.
...
- `openbb_core.provider.standard_models.calendar_dividend`
...
## Notes
- Generated: 2025-11-18T07:54:40.314422
