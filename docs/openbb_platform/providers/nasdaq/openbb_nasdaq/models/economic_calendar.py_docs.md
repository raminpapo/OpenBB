# Documentation: openbb_platform/providers/nasdaq/openbb_nasdaq/models/economic_calendar.py

## File Metadata
- **Path**: `openbb_platform/providers/nasdaq/openbb_nasdaq/models/economic_calendar.py`
- **Size**: 6,192 characters, 188 lines
- **Words**: 501
- **Extension**: .py
...
**Classes** (3):
`NasdaqEconomicCalendarQueryParams`, `NasdaqEconomicCalendarData`, `NasdaqEconomicCalendarFetcher`

**Functions** (7):
`validate_country`, `clean_fields`, `clean_html`, `transform_query`, `aextract_data`, `get_calendar_data`, `transform_data`

**Imports** (21):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.economic_calendar`, `pydantic`, `Field`, `html`, `openbb_nasdaq.utils.helpers`, `remove_html_tags`, `the`, `datetime`, `datetime`, `the`, `asyncio`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_nasdaq.utils.helpers`


## Key Components

**Class `NasdaqEconomicCalendarQueryParams`**: Nasdaq Economic Calendar Query.

    Source: https://www.nasdaq.com/market-activity/economic-calendar

**Class `NasdaqEconomicCalendarData`**: Nasdaq Economic Calendar Data.

**Class `NasdaqEconomicCalendarFetcher`**: Transform the query, extract and transform the data from the Nasdaq endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.322189
