# Documentation: openbb_platform/providers/polygon/tests/test_polygon_fetchers.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/tests/test_polygon_fetchers.py`
- **Size**: 5,851 characters, 187 lines
- **Words**: 442
- **Extension**: .py
...
**Functions** (15):
`scrub_string`, `before_record_response`, `vcr_config`, `test_polygon_equity_historical_fetcher`, `test_polygon_index_historical_fetcher`, `test_polygon_company_news_fetcher`, `test_polygon_balance_sheet_fetcher`, `test_polygon_income_statement_fetcher`, `test_polygon_cash_flow_statement_fetcher`, `test_polygon_crypto_historical_fetcher`, `test_polygon_currency_historical_fetcher`, `test_polygon_currency_pairs_fetcher`, `test_polygon_equity_nbbo_fetcher`, `test_polygon_market_snapshots_fetcher`, `test_polygon_currency_snapshots_fetcher`

**Imports** (29):
`datetime`, `date`, `pytest`, `openbb_core.app.service.user_service`, `UserService`, `openbb_polygon.models.balance_sheet`, `PolygonBalanceSheetFetcher`, `openbb_polygon.models.cash_flow`, `PolygonCashFlowStatementFetcher`, `openbb_polygon.models.company_news`, `PolygonCompanyNewsFetcher`, `openbb_polygon.models.crypto_historical`, `PolygonCryptoHistoricalFetcher`, `openbb_polygon.models.currency_historical`, `PolygonCurrencyHistoricalFetcher`, `openbb_polygon.models.currency_pairs`, `PolygonCurrencyPairsFetcher`, `openbb_polygon.models.currency_snapshots`, `PolygonCurrencySnapshotsFetcher`, `openbb_polygon.models.equity_historical`
...
## Notes
- Generated: 2025-11-18T07:54:40.578118
