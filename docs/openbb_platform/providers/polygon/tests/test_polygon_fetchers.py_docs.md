# File Documentation: test_polygon_fetchers.py

## Metadata
- **Path**: `openbb_platform/providers/polygon/tests/test_polygon_fetchers.py`
- **Size**: 5,851 bytes
- **Lines**: 187
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_polygon_fetchers.py`.

**Python Module**

- **Functions** (15): scrub_string, before_record_response, vcr_config, test_polygon_equity_historical_fetcher, test_polygon_index_historical_fetcher, test_polygon_company_news_fetcher, test_polygon_balance_sheet_fetcher, test_polygon_income_statement_fetcher, test_polygon_cash_flow_statement_fetcher, test_polygon_crypto_historical_fetcher ... and 5 more
- **Import Statements**: 2
...
- **`vcr_config()`**
- **`test_polygon_equity_historical_fetcher(credentials=test_credentials)`**
- **`test_polygon_index_historical_fetcher(credentials=test_credentials)`**
- **`test_polygon_company_news_fetcher(credentials=test_credentials)`**
- **`test_polygon_balance_sheet_fetcher(credentials=test_credentials)`**
- **`test_polygon_income_statement_fetcher(credentials=test_credentials)`**
- **`test_polygon_cash_flow_statement_fetcher(credentials=test_credentials)`**
- **`test_polygon_crypto_historical_fetcher(credentials=test_credentials)`**
- **`test_polygon_currency_historical_fetcher(credentials=test_credentials)`**
- **`test_polygon_currency_pairs_fetcher(credentials=test_credentials)`**
- **`test_polygon_equity_nbbo_fetcher(credentials=test_credentials)`**
- **`test_polygon_market_snapshots_fetcher(credentials=test_credentials)`**
- **`test_polygon_currency_snapshots_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:51.888130Z
