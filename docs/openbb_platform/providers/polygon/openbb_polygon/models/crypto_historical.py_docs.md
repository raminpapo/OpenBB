...
- **Classes** (3): PolygonCryptoHistoricalQueryParams, PolygonCryptoHistoricalData, PolygonCryptoHistoricalFetcher
...
- **`PolygonCryptoHistoricalQueryParams`**(CryptoHistoricalQueryParams)
- **`PolygonCryptoHistoricalData`**(CryptoHistoricalData)
...
- **`get_api_interval_params(cls, values: "PolygonCryptoHistoricalQueryParams")`**
...
**Generated**: 2025-11-19T02:16:51.863532Z
