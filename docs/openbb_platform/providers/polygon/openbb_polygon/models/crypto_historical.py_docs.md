# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/crypto_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/crypto_historical.py`
- **Size**: 6,655 characters, 198 lines
- **Words**: 536
- **Extension**: .py
...
**Classes** (3):
`PolygonCryptoHistoricalQueryParams`, `PolygonCryptoHistoricalData`, `PolygonCryptoHistoricalFetcher`

**Functions** (5):
`get_api_interval_params`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (20):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.crypto_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `dateutil.relativedelta`, `relativedelta`, `the`, `datetime`, `timezone`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `PolygonCryptoHistoricalQueryParams`**: Polygon Crypto Historical Price Query.

    Source:
    https://polygon.io/docs/crypto/get_v2_aggs_ticker__cryptoticker__range__multiplier___timespan___from___to

**Class `PolygonCryptoHistoricalData`**: Polygon Crypto Historical Price Data.

**Class `PolygonCryptoHistoricalFetcher`**: Polygon Crypto Historical Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.498378
