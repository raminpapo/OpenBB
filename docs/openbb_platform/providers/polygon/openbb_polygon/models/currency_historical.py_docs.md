...
- **Classes** (3): PolygonCurrencyHistoricalQueryParams, PolygonCurrencyHistoricalData, PolygonCurrencyHistoricalFetcher
...
- **`PolygonCurrencyHistoricalQueryParams`**(CurrencyHistoricalQueryParams)
- **`PolygonCurrencyHistoricalData`**(CurrencyHistoricalData)
...
- **`get_api_interval_params(cls, values: "PolygonCurrencyHistoricalQueryParams")`**
...
**Generated**: 2025-11-19T02:16:51.865852Z
