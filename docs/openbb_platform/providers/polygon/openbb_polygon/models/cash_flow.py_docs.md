# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/cash_flow.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/cash_flow.py`
- **Size**: 7,636 characters, 203 lines
- **Words**: 662
- **Extension**: .py
...
**Classes** (3):
`PolygonCashFlowStatementQueryParams`, `PolygonCashFlowStatementData`, `PolygonCashFlowStatementFetcher`

**Functions** (4):
`replace_zero`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (25):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.cash_flow`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `pydantic`, `Field`, `operating`, `operating`, `operating`, `investing`, `investing`, `investing`, `financing`, `financing`, `financing`


## Key Components

**Class `PolygonCashFlowStatementQueryParams`**: Polygon Cash Flow Statement Query.

    Source: https://polygon.io/docs/stocks#!/get_vx_reference_financials

**Class `PolygonCashFlowStatementData`**: Polygon Cash Flow Statement Data.

**Class `PolygonCashFlowStatementFetcher`**: Polygon Cash Flow Statement Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.494507
