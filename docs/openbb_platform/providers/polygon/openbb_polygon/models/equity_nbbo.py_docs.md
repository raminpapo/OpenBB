...
- **Classes** (3): PolygonEquityNBBOQueryParams, PolygonEquityNBBOData, PolygonEquityNBBOFetcher
- **Functions** (5): capping_limit, date_validate, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`PolygonEquityNBBOQueryParams`**(EquityNBBOQueryParams)
- **`PolygonEquityNBBOData`**(EquityNBBOData)
...
**Generated**: 2025-11-19T02:16:51.875411Z
