# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/equity_nbbo.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/equity_nbbo.py`
- **Size**: 8,265 characters, 232 lines
- **Words**: 802
- **Extension**: .py
...
class PolygonEquityNBBOQueryParams(EquityNBBOQueryParams):
    ...
    timestamp_lt: datetime | str | None = Field(
        default=None,
        description=(
    ...
    timestamp_gt: datetime | str | None = Field(
        default=None,
        description=(
    ...
    timestamp_lte: datetime | str | None = Field(
        default=None,
        description=(
    ...
    timestamp_gte: datetime | str | None = Field(
        default=None,
        description=(
...
class PolygonEquityNBBOData(EquityNBBOData):
    ...
    conditions: str | list[int] | list[str] | None = Field(
        default=None,
        description="A list of condition codes.",
    )
    indicators: list[int] | None = Field(
        default=None,
        description="A list of indicator codes.",
    )
    sequence_num: int | None = Field(
        default=None,
        description=(
...
**Classes** (3):
`PolygonEquityNBBOQueryParams`, `PolygonEquityNBBOData`, `PolygonEquityNBBOFetcher`

**Functions** (5):
`capping_limit`, `date_validate`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (18):
`datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_nbbo`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `pydantic`, `Field`, `the`, `pandas`, `to_datetime`, `the`, `openbb_core.provider.utils.helpers`, `get_querystring`, `openbb_polygon.utils.helpers`, `get_data_one`


## Key Components

**Class `PolygonEquityNBBOQueryParams`**: Polygon Equity NBBO Query.

    Source: https://polygon.io/docs/stocks/get_v3_quotes__stockticker

**Class `PolygonEquityNBBOData`**: Polygon Equity NBBO data.

**Class `PolygonEquityNBBOFetcher`**: Polygon Equity NBBO Fetcher.
...
- `openbb_core.provider.standard_models.equity_nbbo`
- `openbb_core.provider.utils.descriptions`
- `pydantic`
- `pandas`
- `openbb_core.provider.utils.helpers`
- `openbb_polygon.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:40.507900
