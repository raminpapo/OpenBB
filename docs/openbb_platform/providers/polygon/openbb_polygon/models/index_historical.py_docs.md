# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/index_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/index_historical.py`
- **Size**: 7,218 characters, 211 lines
- **Words**: 583
- **Extension**: .py
...
**Classes** (3):
`PolygonIndexHistoricalQueryParams`, `PolygonIndexHistoricalData`, `PolygonIndexHistoricalFetcher`

**Functions** (5):
`get_api_interval_params`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (26):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.index_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `dateutil.relativedelta`, `relativedelta`, `the`, `aiohttp`, `ClientResponseError`, `openbb_core.provider.utils.errors`, `OpenBBError`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `PolygonIndexHistoricalQueryParams`**: Polygon Index Historical Query.

    Source: https://polygon.io/docs/indices/getting-started

**Class `PolygonIndexHistoricalData`**: Polygon Index Historical Data.

**Class `PolygonIndexHistoricalFetcher`**: Polygon Index Historical Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.512380
