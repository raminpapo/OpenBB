...
- **Classes** (3): PolygonCurrencyPairsQueryParams, PolygonCurrencyPairsData, PolygonCurrencyPairsFetcher
- **Functions** (4): last_updated_utc_validate, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`PolygonCurrencyPairsQueryParams`**(CurrencyPairsQueryParams)
- **`PolygonCurrencyPairsData`**(CurrencyPairsData)
...
- **`last_updated_utc_validate(cls, v)`**
...
**Generated**: 2025-11-19T02:16:51.868224Z
