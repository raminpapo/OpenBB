# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/currency_pairs.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/currency_pairs.py`
- **Size**: 5,217 characters, 140 lines
- **Words**: 426
- **Extension**: .py
...
**Classes** (3):
`PolygonCurrencyPairsQueryParams`, `PolygonCurrencyPairsData`, `PolygonCurrencyPairsFetcher`

**Functions** (4):
`last_updated_utc_validate`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (17):
`datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.currency_pairs`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `openbb_polygon.utils.helpers`, `get_data`, `pandas`, `DataFrame`


## Key Components

**Class `PolygonCurrencyPairsQueryParams`**: Polygon Currency Available Pairs Query.

    Source: https://polygon.io/docs/forex/get_v3_reference_tickers

**Class `PolygonCurrencyPairsData`**: Polygon Currency Available Pairs Data.

**Class `PolygonCurrencyPairsFetcher`**: Polygon Currency Pairs Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.501985
