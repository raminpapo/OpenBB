# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/company_news.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/company_news.py`
- **Size**: 5,142 characters, 159 lines
- **Words**: 417
- **Extension**: .py
...
**Classes** (4):
`PolygonCompanyNewsQueryParams`, `PolygonPublisher`, `PolygonCompanyNewsData`, `PolygonCompanyNewsFetcher`

**Functions** (7):
`_symbol_mandatory`, `symbols_string`, `validate_images`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (11):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.company_news`, `pydantic`, `BaseModel`, `asyncio`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `PolygonCompanyNewsQueryParams`**: Polygon Company News Query.

    Source: https://polygon.io/docs/stocks/get_v2_reference_news

**Class `PolygonPublisher`**: PolygonPublisher Data Model.

**Class `PolygonCompanyNewsData`**: Polygon Company News Data.

**Class `PolygonCompanyNewsFetcher`**: Polygon Company News Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.496725
