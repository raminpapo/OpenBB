# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/income_statement.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/income_statement.py`
- **Size**: 13,827 characters, 320 lines
- **Words**: 1,076
- **Extension**: .py
...
**Classes** (3):
`PolygonIncomeStatementQueryParams`, `PolygonIncomeStatementData`, `PolygonIncomeStatementFetcher`

**Functions** (4):
`replace_zero`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (16):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.income_statement`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `pydantic`, `Field`, `the`, `openbb_core.provider.utils.helpers`, `get_querystring`, `openbb_polygon.utils.helpers`, `get_data_many`


## Key Components

**Class `PolygonIncomeStatementQueryParams`**: Polygon Income Statement Query.

    Source: https://polygon.io/docs/stocks#!/get_vx_reference_financials

**Class `PolygonIncomeStatementData`**: Polygon Income Statement Data.

**Class `PolygonIncomeStatementFetcher`**: Polygon Income Statement Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.510132
