# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/market_snapshots.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/market_snapshots.py`
- **Size**: 6,122 characters, 170 lines
- **Words**: 478
- **Extension**: .py
...
**Classes** (3):
`PolygonMarketSnapshotsQueryParams`, `PolygonMarketSnapshotsData`, `PolygonMarketSnapshotsFetcher`

**Functions** (4):
`date_validate`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (15):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.market_snapshots`, `pydantic`, `Field`, `pandas`, `to_datetime`, `the`, `openbb_polygon.utils.helpers`, `get_data_many`, `a`


## Key Components

**Class `PolygonMarketSnapshotsQueryParams`**: Polygon Market Snapshots Query.

    Source: https://polygon.io/docs/stocks/get_v2_snapshot_locale_us_markets_stocks_tickers

**Class `PolygonMarketSnapshotsData`**: Polygon Market Snapshots Data.

**Class `PolygonMarketSnapshotsFetcher`**: Polygon Market Snapshots Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.514098
