# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/currency_snapshots.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/currency_snapshots.py`
- **Size**: 10,097 characters, 241 lines
- **Words**: 849
- **Extension**: .py
...
**Classes** (3):
`PolygonCurrencySnapshotsQueryParams`, `PolygonCurrencySnapshotsData`, `PolygonCurrencySnapshotsFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (29):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.currency_snapshots`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `the`, `the`, `the`, `the`, `the`, `the`


## Key Components

**Class `PolygonCurrencySnapshotsQueryParams`**: Polygon Currency Snapshots Query Parameters.

    Source: https://polygon.io/docs/forex/get_v2_snapshot_locale_global_markets_forex_tickers

**Class `PolygonCurrencySnapshotsData`**: Polygon Currency Snapshots Data.

**Class `PolygonCurrencySnapshotsFetcher`**: Polygon Currency Snapshots Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.503923
