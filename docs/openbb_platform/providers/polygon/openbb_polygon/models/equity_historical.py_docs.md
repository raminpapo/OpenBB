# Documentation: openbb_platform/providers/polygon/openbb_polygon/models/equity_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/polygon/openbb_polygon/models/equity_historical.py`
- **Size**: 7,258 characters, 211 lines
- **Words**: 598
- **Extension**: .py
...
**Classes** (3):
`PolygonEquityHistoricalQueryParams`, `PolygonEquityHistoricalData`, `PolygonEquityHistoricalFetcher`

**Functions** (5):
`get_api_interval_params`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (23):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `dateutil.relativedelta`, `relativedelta`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `the`, `openbb_core.provider.utils.helpers`, `pytz`, `timezone`


## Key Components

**Class `PolygonEquityHistoricalQueryParams`**: Polygon Equity Historical Price Query.

    Source: https://polygon.io/docs/stocks/getting-started

**Class `PolygonEquityHistoricalData`**: Polygon Equity Historical Price Data.

**Class `PolygonEquityHistoricalFetcher`**: Polygon Equity Historical Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.506079
