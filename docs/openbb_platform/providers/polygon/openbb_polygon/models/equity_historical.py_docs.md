...
- **Classes** (3): PolygonEquityHistoricalQueryParams, PolygonEquityHistoricalData, PolygonEquityHistoricalFetcher
- **Functions** (5): get_api_interval_params, transform_query, aextract_data, callback, transform_data
- **Import Statements**: 4
...
- **`PolygonEquityHistoricalQueryParams`**(EquityHistoricalQueryParams)
- **`PolygonEquityHistoricalData`**(EquityHistoricalData)
...
- **`get_api_interval_params(cls, values: "PolygonEquityHistoricalQueryParams")`**
...
**Generated**: 2025-11-19T02:16:51.873113Z
