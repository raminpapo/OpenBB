# File Documentation: test_oecd_fetchers.py

## Metadata
- **Path**: `openbb_platform/providers/oecd/tests/test_oecd_fetchers.py`
- **Size**: 4,788 bytes
- **Lines**: 158
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_oecd_fetchers.py`.

**Python Module**

- **Functions** (10): vcr_config, test_oecd_cpi_fetcher, test_oecd_nominal_gdp_fetcher, test_oecd_real_gdp_fetcher, test_oecd_gdp_forecast_fetcher, test_oecd_unemployment_fetcher, test_oecd_composite_leading_indicator_fetcher, test_oecd_share_price_index_fetcher, test_oecd_house_price_index_fetcher, test_oecd_country_interest_rates_fetcher
- **Import Statements**: 2
...
- **`vcr_config()`**
- **`test_oecd_cpi_fetcher(credentials=test_credentials)`**
- **`test_oecd_nominal_gdp_fetcher(credentials=test_credentials)`**
- **`test_oecd_real_gdp_fetcher(credentials=test_credentials)`**
- **`test_oecd_gdp_forecast_fetcher(credentials=test_credentials)`**
- **`test_oecd_unemployment_fetcher(credentials=test_credentials)`**
- **`test_oecd_composite_leading_indicator_fetcher(credentials=test_credentials)`**
- **`test_oecd_share_price_index_fetcher(credentials=test_credentials)`**
- **`test_oecd_house_price_index_fetcher(credentials=test_credentials)`**
- **`test_oecd_country_interest_rates_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:51.821266Z
