# File Documentation: share_price_index.py
...
This is a **python** file named `share_price_index.py`.

**Python Module**

- **Classes** (3): OECDSharePriceIndexQueryParams, OECDSharePriceIndexData, OECDSharePriceIndexFetcher
...
- **`OECDSharePriceIndexQueryParams`**(SharePriceIndexQueryParams)
- **`OECDSharePriceIndexData`**(SharePriceIndexData)
...
DF_FINMARK, classmethod, field_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.811266Z
