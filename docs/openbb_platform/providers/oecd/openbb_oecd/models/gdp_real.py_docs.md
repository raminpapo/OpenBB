# Documentation: openbb_platform/providers/oecd/openbb_oecd/models/gdp_real.py

## File Metadata
- **Path**: `openbb_platform/providers/oecd/openbb_oecd/models/gdp_real.py`
- **Size**: 6,599 characters, 174 lines
- **Words**: 532
- **Extension**: .py
...
**Classes** (3):
`OECDGdpRealQueryParams`, `OECDGdpRealData`, `OECDGdpRealFetcher`

**Functions** (7):
`validate_country`, `transform_query`, `aextract_data`, `country_string`, `response_callback`, `apply_map`, `transform_data`

**Imports** (34):
`datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.gdp_real`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_oecd.utils.constants`, `CODE_TO_COUNTRY_GDP`, `pydantic`, `Field`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `OECDGdpRealQueryParams`**: OECD Real GDP Query.

    Source: https://www.oecd.org/en/data/datasets/gdp-and-non-financial-accounts.html

    This table presents Gross Domestic Product (GDP) and its main components according to t

**Class `OECDGdpRealData`**: OECD Real GDP Data.

**Class `OECDGdpRealFetcher`**: OECD GDP Real Fetcher.
...
- `openbb_core.provider.standard_models.gdp_real`
...
## Notes
- Generated: 2025-11-18T07:54:40.449599
