...
- **Classes** (3): OECDGdpRealQueryParams, OECDGdpRealData, OECDGdpRealFetcher
- **Functions** (7): validate_country, transform_query, aextract_data, country_string, response_callback, apply_map, transform_data
- **Import Statements**: 5
...
- **`OECDGdpRealQueryParams`**(GdpRealQueryParams)
- **`OECDGdpRealData`**(GdpRealData)
- **`OECDGdpRealFetcher`**(Fetcher[OECDGdpRealQueryParams, list[OECDGdpRealData]])
...
DF_QNA, classmethod, field_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.806046Z
