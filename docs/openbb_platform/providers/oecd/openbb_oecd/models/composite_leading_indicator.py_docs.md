# Documentation: openbb_platform/providers/oecd/openbb_oecd/models/composite_leading_indicator.py

## File Metadata
- **Path**: `openbb_platform/providers/oecd/openbb_oecd/models/composite_leading_indicator.py`
- **Size**: 7,306 characters, 233 lines
- **Words**: 579
- **Extension**: .py
...
**Classes** (3):
`OECDCompositeLeadingIndicatorQueryParams`, `OECDCompositeLeadingIndicatorData`, `OECDCompositeLeadingIndicatorFetcher`

**Functions** (6):
`country_validate`, `transform_query`, `aextract_data`, `country_string`, `response_callback`, `transform_data`

**Imports** (25):
`datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.composite_leading_indicator`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `io`, `StringIO`, `openbb_oecd.utils.helpers`, `oecd_date_to_python_date`


## Key Components

**Class `OECDCompositeLeadingIndicatorQueryParams`**: OECD Composite Leading Indicator Query.

**Class `OECDCompositeLeadingIndicatorData`**: OECD Composite Leading Indicator Data.

**Class `OECDCompositeLeadingIndicatorFetcher`**: OECD Composite Leading Indicator Fetcher.
...
- `openbb_core.provider.standard_models.composite_leading_indicator`
- `openbb_core.provider.utils.errors`
- `pydantic`
- `io`
- `openbb_oecd.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:40.438850
