...
- **Classes** (3): OECDCompositeLeadingIndicatorQueryParams, OECDCompositeLeadingIndicatorData, OECDCompositeLeadingIndicatorFetcher
- **Functions** (6): country_validate, transform_query, aextract_data, country_string, response_callback, transform_data
- **Import Statements**: 4
...
- **`OECDCompositeLeadingIndicatorQueryParams`**(CompositeLeadingIndicatorQueryParams)
- **`OECDCompositeLeadingIndicatorData`**(CompositeLeadingIndicatorData)
...
- **`country_validate(cls, v)`**
- **`country_string(input_str: str)`**
- **`response_callback(response, _)`**

#### Decorators Used

DF_CLI, classmethod, field_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.791492Z
