...
- **Classes** (3): OECDGdpNominalQueryParams, OECDGdpNominalData, OECDGdpNominalFetcher
...
- **`OECDGdpNominalQueryParams`**(GdpNominalQueryParams)
- **`OECDGdpNominalData`**(GdpNominalData)
...
DF_QNA_EXPENDITURE_, classmethod, field_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.803144Z
