# Documentation: openbb_platform/providers/oecd/openbb_oecd/models/gdp_nominal.py

## File Metadata
- **Path**: `openbb_platform/providers/oecd/openbb_oecd/models/gdp_nominal.py`
- **Size**: 7,659 characters, 201 lines
- **Words**: 628
- **Extension**: .py
...
**Classes** (3):
`OECDGdpNominalQueryParams`, `OECDGdpNominalData`, `OECDGdpNominalFetcher`

**Functions** (7):
`validate_country`, `transform_query`, `aextract_data`, `country_string`, `response_callback`, `apply_map`, `transform_data`

**Imports** (34):
`datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.gdp_nominal`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_oecd.utils.constants`, `CODE_TO_COUNTRY_GDP`, `pydantic`, `Field`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `OECDGdpNominalQueryParams`**: OECD Nominal GDP Query.

    Source: https://www.oecd.org/en/data/datasets/gdp-and-non-financial-accounts.html

    This table presents Gross Domestic Product (GDP) and its main components according t

**Class `OECDGdpNominalData`**: OECD Nominal GDP Data.

**Class `OECDGdpNominalFetcher`**: OECD GDP Nominal Fetcher.
...
- `openbb_core.provider.standard_models.gdp_nominal`
...
## Notes
- Generated: 2025-11-18T07:54:40.447234
