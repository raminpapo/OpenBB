...
- **Classes** (3): OECDUnemploymentQueryParams, OECDUnemploymentData, OECDUnemploymentFetcher
...
- **`OECDUnemploymentQueryParams`**(UnemploymentQueryParams)
- **`OECDUnemploymentData`**(UnemploymentData)
...
DF_IALFS_UNE_M, classmethod, field_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.813468Z
