# Documentation: openbb_platform/providers/oecd/openbb_oecd/models/unemployment.py

## File Metadata
- **Path**: `openbb_platform/providers/oecd/openbb_oecd/models/unemployment.py`
- **Size**: 6,774 characters, 190 lines
- **Words**: 524
- **Extension**: .py
...
**Classes** (3):
`OECDUnemploymentQueryParams`, `OECDUnemploymentData`, `OECDUnemploymentFetcher`

**Functions** (5):
`validate_country`, `transform_query`, `extract_data`, `country_string`, `transform_data`

**Imports** (32):
`datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.unemployment`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `check_item`, `openbb_oecd.utils.constants`, `pydantic`, `Field`


## Key Components

**Class `OECDUnemploymentQueryParams`**: OECD Unemployment Query.

    Source: https://data-explorer.oecd.org/?lc=en

**Class `OECDUnemploymentData`**: OECD Unemployment Data.

**Class `OECDUnemploymentFetcher`**: Transform the query, extract and transform the data from the OECD endpoints.
...
- `openbb_core.provider.standard_models.unemployment`
...
## Notes
- Generated: 2025-11-18T07:54:40.454886
