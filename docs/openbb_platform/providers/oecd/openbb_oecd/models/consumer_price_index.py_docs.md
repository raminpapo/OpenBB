# File Documentation: consumer_price_index.py
...
This is a **python** file named `consumer_price_index.py`.

**Python Module**

- **Classes** (3): OECDCPIQueryParams, OECDCPIData, OECDCPIFetcher
- **Functions** (5): validate_country, transform_query, extract_data, country_string, transform_data
- **Import Statements**: 5
...
- **`OECDCPIQueryParams`**(ConsumerPriceIndexQueryParams)
- **`OECDCPIData`**(ConsumerPriceIndexData)
- **`OECDCPIFetcher`**(Fetcher[OECDCPIQueryParams, list[OECDCPIData]])
...
DF_PRICES_ALL, field_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.794419Z
