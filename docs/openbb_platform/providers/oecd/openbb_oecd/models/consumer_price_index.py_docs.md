# Documentation: openbb_platform/providers/oecd/openbb_oecd/models/consumer_price_index.py

## File Metadata
- **Path**: `openbb_platform/providers/oecd/openbb_oecd/models/consumer_price_index.py`
- **Size**: 8,470 characters, 248 lines
- **Words**: 623
- **Extension**: .py
...
**Classes** (3):
`OECDCPIQueryParams`, `OECDCPIData`, `OECDCPIFetcher`

**Functions** (5):
`validate_country`, `transform_query`, `extract_data`, `country_string`, `transform_data`

**Imports** (21):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.consumer_price_index`, `openbb_core.provider.utils.helpers`, `check_item`, `openbb_oecd.utils.constants`, `pydantic`, `Field`, `the`, `requests.exceptions`, `HTTPError`, `openbb_oecd.utils`, `helpers`, `exc`


## Key Components

**Class `OECDCPIQueryParams`**: OECD CPI Query.

    Source: https://data-explorer.oecd.org/?lc=en

**Class `OECDCPIData`**: OECD CPI Data.

**Class `OECDCPIFetcher`**: OECD CPI Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.440849
