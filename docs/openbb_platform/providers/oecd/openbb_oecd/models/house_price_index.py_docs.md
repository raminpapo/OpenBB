# Documentation: openbb_platform/providers/oecd/openbb_oecd/models/house_price_index.py

## File Metadata
- **Path**: `openbb_platform/providers/oecd/openbb_oecd/models/house_price_index.py`
- **Size**: 6,148 characters, 168 lines
- **Words**: 463
- **Extension**: .py
...
**Classes** (3):
`OECDHousePriceIndexQueryParams`, `OECDHousePriceIndexData`, `OECDHousePriceIndexFetcher`

**Functions** (5):
`validate_country`, `transform_query`, `extract_data`, `country_string`, `transform_data`

**Imports** (31):
`datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.house_price_index`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `check_item`, `openbb_oecd.utils.constants`, `pydantic`, `Field`


## Key Components

**Class `OECDHousePriceIndexQueryParams`**: OECD House Price Index Query.

    Source: https://data-explorer.oecd.org/?lc=en

**Class `OECDHousePriceIndexData`**: OECD House Price Index Data.

**Class `OECDHousePriceIndexFetcher`**: OECD House Price Index Fetcher.
...
- `openbb_core.provider.standard_models.house_price_index`
...
## Notes
- Generated: 2025-11-18T07:54:40.451682
