...
- **Classes** (3): OECDHousePriceIndexQueryParams, OECDHousePriceIndexData, OECDHousePriceIndexFetcher
...
- **`OECDHousePriceIndexQueryParams`**(HousePriceIndexQueryParams)
- **`OECDHousePriceIndexData`**(HousePriceIndexData)
...
DF_RHPI_TARGET, classmethod, field_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.809055Z
