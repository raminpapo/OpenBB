# Documentation: openbb_platform/providers/oecd/openbb_oecd/models/gdp_forecast.py

## File Metadata
- **Path**: `openbb_platform/providers/oecd/openbb_oecd/models/gdp_forecast.py`
- **Size**: 8,393 characters, 253 lines
- **Words**: 689
- **Extension**: .py
...
**Classes** (3):
`OECDGdpForecastQueryParams`, `OECDGdpForecastData`, `OECDGdpForecastFetcher`

**Functions** (5):
`transform_query`, `aextract_data`, `country_string`, `response_callback`, `transform_data`

**Imports** (26):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.gdp_forecast`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_oecd.utils.constants`, `pydantic`, `Field`, `the`, `io`, `StringIO`, `openbb_oecd.utils.helpers`


## Key Components

**Class `OECDGdpForecastQueryParams`**: OECD GDP Forecast Query.

    The OECD Economic Outlook presents the OECD's analysis of the major
    global economic trends and prospects for the next two years.
    The Outlook puts forward a consis

**Class `OECDGdpForecastData`**: OECD GDP Forecast Data.

**Class `OECDGdpForecastFetcher`**: OECD GDP Forecast Fetcher.
...
- `openbb_core.provider.standard_models.gdp_forecast`
...
## Notes
- Generated: 2025-11-18T07:54:40.444698
