...
- **Classes** (3): OECDGdpForecastQueryParams, OECDGdpForecastData, OECDGdpForecastFetcher
- **Functions** (5): transform_query, aextract_data, country_string, response_callback, transform_data
- **Import Statements**: 5
...
- **`OECDGdpForecastQueryParams`**(GdpForecastQueryParams)
- **`OECDGdpForecastData`**(GdpForecastData)
...
**Generated**: 2025-11-19T02:16:51.800184Z
