...
- **Classes** (1): CustomHttpAdapter
- **Functions** (11): __init__, init_poolmanager, get_legacy_session, fetch_data, oecd_xml_to_df, parse_url, check_cache_exists_and_valid, write_to_cache, query_dict_to_path, get_possibly_cached_data ... and 1 more
- **Import Statements**: 1
...
- **`CustomHttpAdapter`**(requests.adapters.HTTPAdapter)

#### Functions

- **`__init__(self, ssl_context=None, **kwargs)`**
...
**Generated**: 2025-11-19T02:16:51.818740Z
