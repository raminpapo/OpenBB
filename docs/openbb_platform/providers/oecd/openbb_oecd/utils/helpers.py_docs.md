# Documentation: openbb_platform/providers/oecd/openbb_oecd/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/oecd/openbb_oecd/utils/helpers.py`
- **Size**: 8,801 characters, 263 lines
- **Words**: 911
- **Extension**: .py
...
**Functions** (11):
`__init__`, `init_poolmanager`, `get_legacy_session`, `fetch_data`, `oecd_xml_to_df`, `parse_url`, `check_cache_exists_and_valid`, `write_to_cache`, `query_dict_to_path`, `get_possibly_cached_data`, `oecd_date_to_python_date`

**Imports** (27):
`ssl`, `datetime`, `date`, `io`, `StringIO`, `pathlib`, `Path`, `typing`, `Any`, `requests`, `urllib3`, `defusedxml.ElementTree`, `fromstring`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.utils`, `get_user_cache_directory`, `openbb_core.provider`, `helpers`, `pandas`


## Key Components

**Class `CustomHttpAdapter`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:40.458902
