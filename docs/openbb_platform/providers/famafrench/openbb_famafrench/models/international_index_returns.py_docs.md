# Documentation: openbb_platform/providers/famafrench/openbb_famafrench/models/international_index_returns.py

## File Metadata
- **Path**: `openbb_platform/providers/famafrench/openbb_famafrench/models/international_index_returns.py`
- **Size**: 11,191 characters, 314 lines
- **Words**: 1,147
- **Extension**: .py
...
**Classes** (3):
`FamaFrenchInternationalIndexReturnsQueryParams`, `FamaFrenchInternationalIndexReturnsData`, `FamaFrenchInternationalIndexReturnsFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (29):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_famafrench.utils.constants`, `InternationalIndexPortfolios`, `pydantic`, `Field`, `the`, `openbb_famafrench.utils.helpers`


## Key Components

**Class `FamaFrenchInternationalIndexReturnsQueryParams`**: International Index Returns Query parameters.

**Class `FamaFrenchInternationalIndexReturnsData`**: International Index Portfolio Returns Data.

**Class `FamaFrenchInternationalIndexReturnsFetcher`**: International Index Returns Fetcher.
...
- `openbb_famafrench.utils.constants`
- `pydantic`
- `openbb_famafrench.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:38.328000
