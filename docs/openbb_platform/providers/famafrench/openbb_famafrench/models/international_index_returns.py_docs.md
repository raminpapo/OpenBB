# File Documentation: international_index_returns.py
...
This is a **python** file named `international_index_returns.py`.

**Python Module**

- **Classes** (3): FamaFrenchInternationalIndexReturnsQueryParams, FamaFrenchInternationalIndexReturnsData, FamaFrenchInternationalIndexReturnsFetcher
...
- **`FamaFrenchInternationalIndexReturnsQueryParams`**(QueryParams)
- **`FamaFrenchInternationalIndexReturnsData`**(Data)
...
- `Fetcher`
- `Field`
- `InternationalIndexPortfolios`
- `MultiIndex`
- `OpenBBError`
- `QueryParams`
- `date`
- `datetime`
- `get_international_portfolio`
...
**Generated**: 2025-11-19T02:16:49.457086Z
