# Documentation: openbb_platform/providers/famafrench/openbb_famafrench/models/factors.py

## File Metadata
- **Path**: `openbb_platform/providers/famafrench/openbb_famafrench/models/factors.py`
- **Size**: 10,926 characters, 314 lines
- **Words**: 992
- **Extension**: .py
...
**Classes** (3):
`FamaFrenchFactorsQueryParams`, `FamaFrenchFactorsData`, `FamaFrenchFactorsFetcher`

**Functions** (4):
`validate_region_and_factor`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (26):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.service.system_service`, `SystemService`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_famafrench.utils.constants`, `FACTOR_REGION_MAP`, `pydantic`, `Field`


## Key Components

**Class `FamaFrenchFactorsQueryParams`**: Query parameters for Fama-French factors.

    Source: https://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html

**Class `FamaFrenchFactorsData`**: Fama-French Factors Data.

    Source: https://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html

**Class `FamaFrenchFactorsFetcher`**: Fama-French Factors Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.325467
