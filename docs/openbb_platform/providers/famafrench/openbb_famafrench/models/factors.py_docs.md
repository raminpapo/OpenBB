...
This is a **python** file named `factors.py`.

**Python Module**

- **Classes** (3): FamaFrenchFactorsQueryParams, FamaFrenchFactorsData, FamaFrenchFactorsFetcher
- **Functions** (4): validate_region_and_factor, transform_query, aextract_data, transform_data
- **Import Statements**: 3
...
- **`FamaFrenchFactorsQueryParams`**(QueryParams)
- **`FamaFrenchFactorsData`**(Data)
...
- **`validate_region_and_factor(cls, values)`**
...
**Generated**: 2025-11-19T02:16:49.453806Z
