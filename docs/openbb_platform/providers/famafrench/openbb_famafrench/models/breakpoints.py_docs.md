# File Documentation: breakpoints.py
...
This is a **python** file named `breakpoints.py`.

**Python Module**

- **Classes** (3): FamaFrenchBreakpointQueryParams, FamaFrenchBreakpointData, FamaFrenchBreakpointFetcher
...
- **`FamaFrenchBreakpointQueryParams`**(QueryParams)
- **`FamaFrenchBreakpointData`**(Data)
...
**Generated**: 2025-11-19T02:16:49.447719Z
