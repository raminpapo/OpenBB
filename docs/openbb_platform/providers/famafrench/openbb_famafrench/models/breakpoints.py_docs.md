# Documentation: openbb_platform/providers/famafrench/openbb_famafrench/models/breakpoints.py

## File Metadata
- **Path**: `openbb_platform/providers/famafrench/openbb_famafrench/models/breakpoints.py`
- **Size**: 10,134 characters, 297 lines
- **Words**: 1,269
- **Extension**: .py
...
**Classes** (3):
`FamaFrenchBreakpointQueryParams`, `FamaFrenchBreakpointData`, `FamaFrenchBreakpointFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (30):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_famafrench.utils.constants`, `BreakpointChoices`, `pydantic`, `Field`, `5`, `CRSP.`


## Key Components

**Class `FamaFrenchBreakpointQueryParams`**: Fama-French Breakpoints Query.

**Class `FamaFrenchBreakpointData`**: Fama-French Breakpoints Data.

**Class `FamaFrenchBreakpointFetcher`**: Fama-French Breakpoints Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.319858
