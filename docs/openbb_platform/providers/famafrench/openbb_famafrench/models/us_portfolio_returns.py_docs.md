# File Documentation: us_portfolio_returns.py
...
This is a **python** file named `us_portfolio_returns.py`.

**Python Module**

- **Classes** (3): FamaFrenchUSPortfolioReturnsQueryParams, FamaFrenchUSPortfolioReturnsData, FamaFrenchUSPortfolioReturnsFetcher
...
- **`FamaFrenchUSPortfolioReturnsQueryParams`**(QueryParams)
- **`FamaFrenchUSPortfolioReturnsData`**(Data)
...
**Generated**: 2025-11-19T02:16:49.461809Z
