# Documentation: openbb_platform/providers/famafrench/openbb_famafrench/models/country_portfolio_returns.py

## File Metadata
- **Path**: `openbb_platform/providers/famafrench/openbb_famafrench/models/country_portfolio_returns.py`
- **Size**: 11,408 characters, 319 lines
- **Words**: 1,217
- **Extension**: .py
...
**Classes** (3):
`FamaFrenchCountryPortfolioReturnsQueryParams`, `FamaFrenchCountryPortfolioReturnsData`, `FamaFrenchCountryPortfolioReturnsFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (28):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_famafrench.utils.constants`, `CountryPortfolios`, `pydantic`, `Field`, `the`, `openbb_famafrench.utils.helpers`


## Key Components

**Class `FamaFrenchCountryPortfolioReturnsQueryParams`**: Country Portfolio Returns Query parameters.

**Class `FamaFrenchCountryPortfolioReturnsData`**: US Portfolio Returns Data.

**Class `FamaFrenchCountryPortfolioReturnsFetcher`**: Country Portfolio Returns Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.322786
