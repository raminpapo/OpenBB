# File Documentation: country_portfolio_returns.py
...
This is a **python** file named `country_portfolio_returns.py`.

**Python Module**

- **Classes** (3): FamaFrenchCountryPortfolioReturnsQueryParams, FamaFrenchCountryPortfolioReturnsData, FamaFrenchCountryPortfolioReturnsFetcher
...
- **`FamaFrenchCountryPortfolioReturnsQueryParams`**(QueryParams)
- **`FamaFrenchCountryPortfolioReturnsData`**(Data)
...
**Generated**: 2025-11-19T02:16:49.450840Z
