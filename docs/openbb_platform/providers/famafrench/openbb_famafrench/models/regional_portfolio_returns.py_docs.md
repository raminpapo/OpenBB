# File Documentation: regional_portfolio_returns.py
...
This is a **python** file named `regional_portfolio_returns.py`.

**Python Module**

- **Classes** (3): FamaFrenchRegionalPortfolioReturnsQueryParams, FamaFrenchRegionalPortfolioReturnsData, FamaFrenchRegionalPortfolioReturnsFetcher
...
- **`FamaFrenchRegionalPortfolioReturnsQueryParams`**(QueryParams)
- **`FamaFrenchRegionalPortfolioReturnsData`**(Data)
...
**Generated**: 2025-11-19T02:16:49.459721Z
