# Documentation: openbb_platform/providers/famafrench/openbb_famafrench/models/regional_portfolio_returns.py

## File Metadata
- **Path**: `openbb_platform/providers/famafrench/openbb_famafrench/models/regional_portfolio_returns.py`
- **Size**: 6,125 characters, 188 lines
- **Words**: 508
- **Extension**: .py
...
**Classes** (3):
`FamaFrenchRegionalPortfolioReturnsQueryParams`, `FamaFrenchRegionalPortfolioReturnsData`, `FamaFrenchRegionalPortfolioReturnsFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (22):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_famafrench.utils.constants`, `RegionalPortfolios`, `pydantic`, `Field`, `the`, `openbb_famafrench.utils.helpers`


## Key Components

**Class `FamaFrenchRegionalPortfolioReturnsQueryParams`**: Regional Portfolio Returns Query parameters.

**Class `FamaFrenchRegionalPortfolioReturnsData`**: Regional Portfolio Returns Data.

**Class `FamaFrenchRegionalPortfolioReturnsFetcher`**: Regional Portfolio Returns Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.330490
