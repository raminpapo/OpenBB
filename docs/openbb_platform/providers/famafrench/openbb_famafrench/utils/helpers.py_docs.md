# Documentation: openbb_platform/providers/famafrench/openbb_famafrench/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/famafrench/openbb_famafrench/utils/helpers.py`
- **Size**: 32,032 characters, 968 lines
- **Words**: 3,365
- **Extension**: .py
...
**Functions** (12):
`get_factor_choices`, `download_file`, `download_international_portfolios`, `apply_date`, `read_csv_file`, `process_csv_tables`, `read_dat_file`, `get_international_portfolio_data`, `process_international_portfolio_data`, `get_international_portfolio`, `get_portfolio_data`, `get_breakpoint_data`

**Imports** (38):
`functools`, `lru_cache`, `openbb_famafrench.utils.constants`, `the`, `zipfile`, `io`, `BytesIO`, `openbb_core.provider.utils.helpers`, `get_requests_session`, `openbb_core.provider.utils.helpers`, `get_requests_session`, `pandas`, `to_datetime`, `a`, `re`, `the`, `the`, `CSV`, `warnings`, `pandas`
...
## Notes
- Generated: 2025-11-18T07:54:38.343661
