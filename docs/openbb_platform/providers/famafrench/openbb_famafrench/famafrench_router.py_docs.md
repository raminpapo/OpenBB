# File Documentation: famafrench_router.py
...
This is a **python** file named `famafrench_router.py`.

**Python Module**

- **Functions** (7): factors, factor_choices, us_portfolio_returns, regional_portfolio_returns, country_portfolio_returns, international_index_returns, breakpoints
- **Import Statements**: 3
...
**Generated**: 2025-11-19T02:16:49.441202Z
