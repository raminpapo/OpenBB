# Documentation: openbb_platform/providers/famafrench/openbb_famafrench/famafrench_router.py

## File Metadata
- **Path**: `openbb_platform/providers/famafrench/openbb_famafrench/famafrench_router.py`
- **Size**: 17,385 characters, 519 lines
- **Words**: 1,926
- **Extension**: .py
...
**Functions** (7):
`factors`, `factor_choices`, `us_portfolio_returns`, `regional_portfolio_returns`, `country_portfolio_returns`, `international_index_returns`, `breakpoints`

**Imports** (26):
`typing`, `Annotated`, `fastapi`, `Query`, `openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `openbb_famafrench.utils.helpers`, `get_factor_choices`, `CRSP.`, `Compustat`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:38.315318
