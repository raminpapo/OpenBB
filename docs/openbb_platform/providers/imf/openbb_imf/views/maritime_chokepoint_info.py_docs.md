# Documentation: openbb_platform/providers/imf/openbb_imf/views/maritime_chokepoint_info.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/views/maritime_chokepoint_info.py`
- **Size**: 8,055 characters, 244 lines
- **Words**: 518
- **Extension**: .py
...
**Imports** (15):
`openbb_imf.models.maritime_chokepoint_info`, `ImfMaritimeChokePointInfoData`, `datetime`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `pandas`, `DataFrame`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `plotly`, `graph_objects`, `plotly.subplots`, `make_subplots`, `Charting`, `e`
...
## Notes
- Generated: 2025-11-18T07:54:40.031655
