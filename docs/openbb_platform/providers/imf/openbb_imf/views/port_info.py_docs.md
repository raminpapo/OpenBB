# Documentation: openbb_platform/providers/imf/openbb_imf/views/port_info.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/views/port_info.py`
- **Size**: 6,201 characters, 180 lines
- **Words**: 472
- **Extension**: .py
...
**Functions** (2):
`plot_port_info_map`, `generate_hover_html`

**Imports** (14):
`openbb_imf.models.port_info`, `ImfPortInfoData`, `numpy`, `nan`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `pandas`, `DataFrame`, `plotly.express`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `Charting`, `e`, `is`
...
## Notes
- Generated: 2025-11-18T07:54:40.034086
