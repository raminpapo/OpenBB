...
- **Functions** (2): plot_port_info_map, generate_hover_html
- **Import Statements**: 5
...
- **`plot_port_info_map(data: list[ImfPortInfoData])`**
- **`generate_hover_html(row)`**
...
**Generated**: 2025-11-19T02:16:51.344099Z
