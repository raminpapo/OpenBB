# Documentation: openbb_platform/providers/imf/openbb_imf/utils/constants.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/utils/constants.py`
- **Size**: 16,311 characters, 578 lines
- **Words**: 1,094
- **Extension**: .py
...
**Imports** (11):
`typing`, `Literal`, `json`, `json.decoder`, `JSONDecodeError`, `pathlib`, `Path`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `the`, `e`
...
## Notes
- Generated: 2025-11-18T07:54:40.017724
