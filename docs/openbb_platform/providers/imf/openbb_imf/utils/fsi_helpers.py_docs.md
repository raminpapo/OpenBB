# Documentation: openbb_platform/providers/imf/openbb_imf/utils/fsi_helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/utils/fsi_helpers.py`
- **Size**: 8,777 characters, 246 lines
- **Words**: 818
- **Extension**: .py
...
**Functions** (3):
`load_fsi_symbols`, `validate_symbols`, `_get_fsi_data`

**Imports** (22):
`openbb_imf.utils.constants`, `load_symbols`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_imf.utils.constants`, `FSI_PRESETS`, `datetime`, `date`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_imf.utils.helpers`, `get_data`, `openbb_imf.utils.irfcl_helpers`, `load_country_to_code_map`, `openbb_imf.utils`, `constants`, `pandas`, `to_datetime`
...
- `datetime`
- `openbb_core.app.model.abstract.error`
- `openbb_imf.utils.helpers`
- `openbb_imf.utils.irfcl_helpers`
- `openbb_imf.utils`
- `pandas`

## Notes
- Generated: 2025-11-18T07:54:40.022033
