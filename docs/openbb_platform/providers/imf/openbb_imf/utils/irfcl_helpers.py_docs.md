# Documentation: openbb_platform/providers/imf/openbb_imf/utils/irfcl_helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/utils/irfcl_helpers.py`
- **Size**: 9,537 characters, 282 lines
- **Words**: 883
- **Extension**: .py
...
**Functions** (6):
`load_irfcl_symbols`, `load_country_map`, `load_country_to_code_map`, `validate_countries`, `validate_symbols`, `_get_irfcl_data`

**Imports** (30):
`openbb_imf.utils.constants`, `load_symbols`, `json`, `json.decoder`, `JSONDecodeError`, `pathlib`, `Path`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `e`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_imf.utils.constants`, `IRFCL_PRESET`
...
## Notes
- Generated: 2025-11-18T07:54:40.026065
