# File Documentation: irfcl_helpers.py
...
This is a **python** file named `irfcl_helpers.py`.

**Python Module**

- **Functions** (6): load_irfcl_symbols, load_country_map, load_country_to_code_map, validate_countries, validate_symbols, _get_irfcl_data
- **Import Statements**: 8
...
OBS_STATUS, OBS_VALUE, TIME_PERIOD, UNIT_MULT
...
**Generated**: 2025-11-19T02:16:51.334246Z
