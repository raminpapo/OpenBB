# Documentation: openbb_platform/providers/imf/openbb_imf/utils/port_watch_helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/utils/port_watch_helpers.py`
- **Size**: 13,067 characters, 390 lines
- **Words**: 1,164
- **Extension**: .py
...
**Functions** (10):
`map_port_country_code`, `get_port_ids_by_country`, `get_port_id_choices`, `get_daily_chokepoint_data`, `get_chokepoints_url`, `get_all_daily_chokepoint_activity_data`, `_get_one_chokepoint_data`, `get_all_daily_port_activity_data`, `get_daily_port_activity_data`, `get_port_url`

**Imports** (34):
`async_lru`, `alru_cache`, `openbb_imf.utils.constants`, `importlib.resources`, `json`, `json`, `importlib.resources`, `datetime`, `datetime`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.helpers`, `get_async_requests_session`, `asyncio`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `e`, `e`, `io`, `StringIO`
...
## Notes
- Generated: 2025-11-18T07:54:40.028297
