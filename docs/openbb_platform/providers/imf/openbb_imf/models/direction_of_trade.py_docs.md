# File Documentation: direction_of_trade.py
...
This is a **python** file named `direction_of_trade.py`.

**Python Module**

- **Classes** (3): ImfDirectionOfTradeQueryParams, ImfDirectionOfTradeData, ImfDirectionOfTradeFetcher
...
- **`ImfDirectionOfTradeQueryParams`**(DirectionOfTradeQueryParams)
- **`ImfDirectionOfTradeData`**(DirectionOfTradeData)
...
OBS_STATUS, OBS_VALUE, TIME_PERIOD, UNIT_MULT, staticmethod
...
**Generated**: 2025-11-19T02:16:51.306179Z
