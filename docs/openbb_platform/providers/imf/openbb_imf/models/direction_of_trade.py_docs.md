# Documentation: openbb_platform/providers/imf/openbb_imf/models/direction_of_trade.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/models/direction_of_trade.py`
- **Size**: 9,939 characters, 275 lines
- **Words**: 785
- **Extension**: .py
...
**Classes** (3):
`ImfDirectionOfTradeQueryParams`, `ImfDirectionOfTradeData`, `ImfDirectionOfTradeFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (30):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.direction_of_trade`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_imf.utils.dot_helpers`, `the`, `aiohttp.client_exceptions`, `ContentTypeError`, `json`, `JSONDecodeError`, `openbb_core.provider.utils.helpers`, `amake_request`, `pandas`


## Key Components

**Class `ImfDirectionOfTradeQueryParams`**: IMF Direction Of Trade Query Parameters.

**Class `ImfDirectionOfTradeData`**: IMF Direction Of Trade Data.

**Class `ImfDirectionOfTradeFetcher`**: IMF Direction Of Trade Fetcher.
...
- `openbb_core.provider.standard_models.direction_of_trade`
- `openbb_core.provider.utils.errors`
- `openbb_imf.utils.dot_helpers`
- `aiohttp.client_exceptions`
- `json`
- `openbb_core.provider.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:40.000426
