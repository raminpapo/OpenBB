...
- **Classes** (3): ImfPortInfoQueryParams, ImfPortInfoData, ImfPortInfoFetcher
...
- **`ImfPortInfoQueryParams`**(PortInfoQueryParams)
- **`ImfPortInfoData`**(PortInfoData)
- **`ImfPortInfoFetcher`**(Fetcher[ImfPortInfoQueryParams, list[ImfPortInfoData]])
...
**Generated**: 2025-11-19T02:16:51.316977Z
