# Documentation: openbb_platform/providers/imf/openbb_imf/models/port_info.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/models/port_info.py`
- **Size**: 11,058 characters, 316 lines
- **Words**: 939
- **Extension**: .py
...
**Classes** (3):
`ImfPortInfoQueryParams`, `ImfPortInfoData`, `ImfPortInfoFetcher`

**Functions** (4):
`_normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (14):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.port_info`, `openbb_imf.utils.constants`, `pydantic`, `ConfigDict`, `the`, `openbb_core.provider.utils.helpers`, `get_async_requests_session`, `e`


## Key Components

**Class `ImfPortInfoQueryParams`**: IMF Port Info Query Parameters.

    Source: https://portwatch.imf.org/pages/port-monitor

**Class `ImfPortInfoData`**: IMF Port Info Data.

    Source: https://portwatch.imf.org/pages/port-monitor

**Class `ImfPortInfoFetcher`**: IMF Port Info Fetcher.
...
- `openbb_core.provider.standard_models.port_info`
- `openbb_imf.utils.constants`
- `pydantic`
- `openbb_core.provider.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:40.010442
