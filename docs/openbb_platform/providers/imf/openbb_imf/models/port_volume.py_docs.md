# Documentation: openbb_platform/providers/imf/openbb_imf/models/port_volume.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/models/port_volume.py`
- **Size**: 17,211 characters, 465 lines
- **Words**: 1,539
- **Extension**: .py
...
**Classes** (3):
`ImfPortVolumeQueryParams`, `ImfPortVolumeData`, `ImfPortVolumeFetcher`

**Functions** (6):
`validate_port_code`, `validate_model`, `transform_query`, `aextract_data`, `fetch_port_data`, `transform_data`

**Imports** (26):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.port_volume`, `openbb_imf.utils.constants`, `openbb_imf.utils.port_watch_helpers`, `pydantic`, `ConfigDict`, `volumes`, `volume`, `volume`, `volume`, `volume`, `volume`, `volume`


## Key Components

**Class `ImfPortVolumeQueryParams`**: IMF Port Volume Query Parameters.
...
**Class `ImfPortVolumeData`**: IMF Port Volume Data Model.

**Class `ImfPortVolumeFetcher`**: IMF Port Volume Fetcher.
...
- `openbb_core.provider.standard_models.port_volume`
...
## Notes
- Generated: 2025-11-18T07:54:40.013322
