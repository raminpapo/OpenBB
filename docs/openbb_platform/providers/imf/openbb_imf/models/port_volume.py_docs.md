...
- **Classes** (3): ImfPortVolumeQueryParams, ImfPortVolumeData, ImfPortVolumeFetcher
- **Functions** (6): validate_port_code, validate_model, transform_query, aextract_data, fetch_port_data, transform_data
...
- **`ImfPortVolumeQueryParams`**(PortVolumeQueryParams)
- **`ImfPortVolumeData`**(PortVolumeData)
- **`ImfPortVolumeFetcher`**(Fetcher[ImfPortVolumeQueryParams, list[ImfPortVolumeData]])

#### Functions

- **`validate_port_code(cls, v)`**
- **`validate_model(cls, values)`**
- **`fetch_port_data(port_code: str)`**
...
**Generated**: 2025-11-19T02:16:51.319915Z
