...
- **Classes** (3): ImfMaritimeChokePointVolumeQueryParams, ImfMaritimeChokePointVolumeData, ImfMaritimeChokePointVolumeFetcher
- **Functions** (5): validate_chokepoint, transform_query, aextract_data, get_one, transform_data
- **Import Statements**: 3
...
- **`ImfMaritimeChokePointVolumeQueryParams`**(MaritimeChokePointVolumeQueryParams)
- **`ImfMaritimeChokePointVolumeData`**(MaritimeChokePointVolumeData)
...
**Generated**: 2025-11-19T02:16:51.314197Z
