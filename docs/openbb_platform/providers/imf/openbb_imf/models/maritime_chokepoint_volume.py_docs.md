# Documentation: openbb_platform/providers/imf/openbb_imf/models/maritime_chokepoint_volume.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/models/maritime_chokepoint_volume.py`
- **Size**: 13,003 characters, 351 lines
- **Words**: 1,093
- **Extension**: .py
...
**Classes** (3):
`ImfMaritimeChokePointVolumeQueryParams`, `ImfMaritimeChokePointVolumeData`, `ImfMaritimeChokePointVolumeFetcher`

**Functions** (5):
`validate_chokepoint`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (16):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.maritime_chokepoint_volume`, `openbb_imf.utils.constants`, `CHOKEPOINTS_NAME_TO_ID`, `pydantic`, `ConfigDict`, `the`, `asyncio`, `openbb_imf.utils.port_watch_helpers`, `e`, `CHOKEPOINTS_NAME_TO_ID`


## Key Components

**Class `ImfMaritimeChokePointVolumeQueryParams`**: IMF Maritime Chokepoint Volume Query Parameters.

    Source: https://portwatch.imf.org/datasets/42132aa4e2fc4d41bdaf9a445f688931/about

**Class `ImfMaritimeChokePointVolumeData`**: IMF Maritime Chokepoint Volume Data.

    Source: https://portwatch.imf.org/datasets/42132aa4e2fc4d41bdaf9a445f688931/about

**Class `ImfMaritimeChokePointVolumeFetcher`**: IMF Maritime Chokepoint Info Fetcher.
...
- `openbb_core.provider.standard_models.maritime_chokepoint_volume`
- `openbb_imf.utils.constants`
- `pydantic`
- `asyncio`
- `openbb_imf.utils.port_watch_helpers`

## Notes
- Generated: 2025-11-18T07:54:40.008191
