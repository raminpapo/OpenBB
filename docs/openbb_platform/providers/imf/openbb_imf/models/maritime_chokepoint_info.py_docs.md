...
- **Classes** (3): ImfMaritimeChokePointInfoQueryParams, ImfMaritimeChokePointInfoData, ImfMaritimeChokePointInfoFetcher
...
- **`ImfMaritimeChokePointInfoQueryParams`**(MaritimeChokePointInfoQueryParams)
- **`ImfMaritimeChokePointInfoData`**(MaritimeChokePointInfoData)
...
**Generated**: 2025-11-19T02:16:51.311615Z
