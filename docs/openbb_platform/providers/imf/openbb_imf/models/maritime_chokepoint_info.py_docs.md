# Documentation: openbb_platform/providers/imf/openbb_imf/models/maritime_chokepoint_info.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/models/maritime_chokepoint_info.py`
- **Size**: 6,641 characters, 185 lines
- **Words**: 593
- **Extension**: .py
...
**Classes** (3):
`ImfMaritimeChokePointInfoQueryParams`, `ImfMaritimeChokePointInfoData`, `ImfMaritimeChokePointInfoFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (13):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.maritime_chokepoint_info`, `pydantic`, `ConfigDict`, `the`, `openbb_core.provider.utils.helpers`, `get_async_requests_session`, `e`


## Key Components

**Class `ImfMaritimeChokePointInfoQueryParams`**: IMF Maritime Chokepoint Info Query Parameters.

    Source: https://portwatch.imf.org/pages/port-monitor

**Class `ImfMaritimeChokePointInfoData`**: IMF Maritime Chokepoint Data.

    Source: https://portwatch.imf.org/pages/port-monitor

**Class `ImfMaritimeChokePointInfoFetcher`**: IMF Maritime Chokepoint Info Fetcher.
...
- `openbb_core.provider.standard_models.maritime_chokepoint_info`
- `pydantic`
- `openbb_core.provider.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:40.006030
