# Documentation: openbb_platform/providers/imf/openbb_imf/models/economic_indicators.py

## File Metadata
- **Path**: `openbb_platform/providers/imf/openbb_imf/models/economic_indicators.py`
- **Size**: 11,829 characters, 304 lines
- **Words**: 1,099
- **Extension**: .py
...
**Classes** (3):
`ImfEconomicIndicatorsQueryParams`, `ImfEconomicIndicatorsData`, `ImfEconomicIndicatorsFetcher`

**Functions** (4):
`_count_presets`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (31):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.economic_indicators`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_imf.utils.constants`, `openbb_imf.utils.irfcl_helpers`, `pydantic`, `Field`, `International`, `the`, `the`


## Key Components

**Class `ImfEconomicIndicatorsQueryParams`**: IMF Economic Indicators Query.

**Class `ImfEconomicIndicatorsData`**: IMF Economic Indicators Data.

**Class `ImfEconomicIndicatorsFetcher`**: IMF Economic Indicators Fetcher.
...
- `openbb_imf.utils.irfcl_helpers`
- `pydantic`

## Notes
- Generated: 2025-11-18T07:54:40.003462
