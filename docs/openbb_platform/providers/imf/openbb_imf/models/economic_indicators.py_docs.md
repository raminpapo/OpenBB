...
- **Classes** (3): ImfEconomicIndicatorsQueryParams, ImfEconomicIndicatorsData, ImfEconomicIndicatorsFetcher
- **Functions** (4): _count_presets, transform_query, aextract_data, transform_data
- **Import Statements**: 6
...
- **`ImfEconomicIndicatorsQueryParams`**(EconomicIndicatorsQueryParams)
- **`ImfEconomicIndicatorsData`**(EconomicIndicatorsData)
...
**Generated**: 2025-11-19T02:16:51.308919Z
