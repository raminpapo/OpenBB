# File Documentation: test_imf_fetchers.py
...
This is a **python** file named `test_imf_fetchers.py`.

**Python Module**

- **Functions** (10): scrub_string, before_record_response, vcr_config, test_imf_economic_indicators_fetcher, test_imf_available_indicators_fetcher, test_imf_direction_of_trade_fetcher, test_imf_port_info_fetcher, test_imf_port_volume_fetcher, test_imf_maritime_chokepoint_info_fetcher, test_imf_maritime_chokepoint_volume_fetcher
- **Import Statements**: 2
...
- **`vcr_config()`**
- **`test_imf_economic_indicators_fetcher(credentials=test_credentials)`**
- **`test_imf_available_indicators_fetcher(credentials=test_credentials)`**
- **`test_imf_direction_of_trade_fetcher(credentials=test_credentials)`**
- **`test_imf_port_info_fetcher(credentials=test_credentials)`**
- **`test_imf_port_volume_fetcher(credentials=test_credentials)`**
- **`test_imf_maritime_chokepoint_info_fetcher(credentials=test_credentials)`**
- **`test_imf_maritime_chokepoint_volume_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:51.347417Z
