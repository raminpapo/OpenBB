# Documentation: openbb_platform/providers/deribit/tests/test_deribit_fetchers.py

## File Metadata
- **Path**: `openbb_platform/providers/deribit/tests/test_deribit_fetchers.py`
- **Size**: 4,857 characters, 150 lines
- **Words**: 357
- **Extension**: .py
...
**Functions** (7):
`vcr_config`, `test_get_options_symbols`, `test_deribit_options_chains_fetcher`, `test_deribit_futures_curve_fetcher`, `test_deribit_futures_historical_fetcher`, `test_deribit_futures_instruments_fetcher`, `test_deribit_futures_info_fetcher`

**Imports** (20):
`datetime`, `date`, `unittest.mock`, `MagicMock`, `pytest`, `openbb_core.app.service.user_service`, `UserService`, `openbb_core.provider.utils.helpers`, `run_async`, `openbb_deribit.models.futures_curve`, `DeribitFuturesCurveFetcher`, `openbb_deribit.models.futures_historical`, `DeribitFuturesHistoricalFetcher`, `openbb_deribit.models.futures_info`, `DeribitFuturesInfoFetcher`, `openbb_deribit.models.futures_instruments`, `DeribitFuturesInstrumentsFetcher`, `openbb_deribit.models.options_chains`, `openbb_deribit.utils.helpers`, `get_options_symbols`
...
## Notes
- Generated: 2025-11-18T07:54:37.679759
