# File Documentation: test_deribit_fetchers.py

## Metadata
- **Path**: `openbb_platform/providers/deribit/tests/test_deribit_fetchers.py`
- **Size**: 4,857 bytes
- **Lines**: 150
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_deribit_fetchers.py`.

**Python Module**

- **Functions** (7): vcr_config, test_get_options_symbols, test_deribit_options_chains_fetcher, test_deribit_futures_curve_fetcher, test_deribit_futures_historical_fetcher, test_deribit_futures_instruments_fetcher, test_deribit_futures_info_fetcher
- **Import Statements**: 2
...
- **`vcr_config()`**
- **`test_get_options_symbols()`**
- **`test_deribit_options_chains_fetcher(credentials=test_credentials)`**
- **`test_deribit_futures_curve_fetcher(credentials=test_credentials)`**
- **`test_deribit_futures_historical_fetcher(credentials=test_credentials)`**
- **`test_deribit_futures_instruments_fetcher(credentials=test_credentials)`**
- **`test_deribit_futures_info_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:48.760046Z
