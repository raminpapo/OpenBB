# Documentation: openbb_platform/providers/deribit/openbb_deribit/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/deribit/openbb_deribit/utils/helpers.py`
- **Size**: 12,072 characters, 403 lines
- **Words**: 1,155
- **Extension**: .py
...
**Functions** (12):
`get_instruments`, `get_options_symbols`, `get_futures_curve_symbols`, `get_ticker_data`, `get_perpetual_symbols`, `get_ohlc_data`, `generate_urls`, `get_one`, `check_ohlc_symbol`, `get_futures_symbols`, `get_futures_curve_by_hours_ago`, `get_one`

**Imports** (25):
`typing`, `Literal`, `async_lru`, `alru_cache`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.helpers`, `amake_request`, `e`, `pandas`, `to_datetime`, `openbb_core.provider.utils.helpers`, `amake_request`, `e`, `asyncio`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_request`, `pandas`
...
## Notes
- Generated: 2025-11-18T07:54:37.654656
