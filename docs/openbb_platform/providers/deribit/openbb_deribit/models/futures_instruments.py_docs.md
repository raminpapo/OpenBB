# Documentation: openbb_platform/providers/deribit/openbb_deribit/models/futures_instruments.py

## File Metadata
- **Path**: `openbb_platform/providers/deribit/openbb_deribit/models/futures_instruments.py`
- **Size**: 4,942 characters, 134 lines
- **Words**: 444
- **Extension**: .py
...
**Classes** (3):
`DeribitFuturesInstrumentsQueryParams`, `DeribitFuturesInstrumentData`, `DeribitFuturesInstrumentsFetcher`

**Functions** (4):
`_validate_expiration`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (17):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.futures_instruments`, `openbb_core.provider.utils.descriptions`, `DATA_DESCRIPTIONS`, `pydantic`, `ConfigDict`, `Deribit`, `openbb_deribit.utils.helpers`, `get_instruments`, `e`


## Key Components

**Class `DeribitFuturesInstrumentsQueryParams`**: Deribit Futures Instruments Query.

**Class `DeribitFuturesInstrumentData`**: Deribit Futures Instrument Data.

**Class `DeribitFuturesInstrumentsFetcher`**: Deribit Futures Instruments Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:37.650051
