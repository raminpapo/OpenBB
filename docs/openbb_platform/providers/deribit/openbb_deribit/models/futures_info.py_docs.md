...
- **Classes** (3): DeribitFuturesInfoQueryParams, DeribitFuturesInfoData, DeribitFuturesInfoFetcher
- **Functions** (5): _validate_symbol, _validate_change_percent, transform_query, aextract_data, transform_data
- **Import Statements**: 5
...
- **`DeribitFuturesInfoQueryParams`**(FuturesInfoQueryParams)
- **`DeribitFuturesInfoData`**(FuturesInfoData)
...
- **`_validate_symbol(cls, v)`**
- **`_validate_change_percent(cls, v)`**
...
**Generated**: 2025-11-19T02:16:48.748275Z
