# Documentation: openbb_platform/providers/deribit/openbb_deribit/models/futures_info.py

## File Metadata
- **Path**: `openbb_platform/providers/deribit/openbb_deribit/models/futures_info.py`
- **Size**: 8,243 characters, 225 lines
- **Words**: 736
- **Extension**: .py
...
**Classes** (3):
`DeribitFuturesInfoQueryParams`, `DeribitFuturesInfoData`, `DeribitFuturesInfoFetcher`

**Functions** (5):
`_validate_symbol`, `_validate_change_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (20):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.futures_info`, `openbb_core.provider.utils.descriptions`, `pydantic`, `ConfigDict`, `openbb_core.provider.utils.helpers`, `run_async`, `openbb_deribit.utils.helpers`, `the`, `asyncio`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_deribit.utils.helpers`, `get_ticker_data`, `e`


## Key Components

**Class `DeribitFuturesInfoQueryParams`**: Deribit Futures Instruments Query.

**Class `DeribitFuturesInfoData`**: Deribit Futures Info Data.

**Class `DeribitFuturesInfoFetcher`**: Deribit Futures Info Fetcher.
...
- `openbb_core.provider.standard_models.futures_info`
...
## Notes
- Generated: 2025-11-18T07:54:37.648341
