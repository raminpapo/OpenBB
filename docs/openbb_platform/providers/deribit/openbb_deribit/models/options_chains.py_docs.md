...
- **Classes** (3): DeribitOptionsChainsQueryParams, DeribitOptionsChainsData, DeribitOptionsChainsFetcher
- **Functions** (6): _validate_symbol, transform_query, aextract_data, call_api, receive_data, transform_data
- **Import Statements**: 5
...
- **`DeribitOptionsChainsQueryParams`**(OptionsChainsQueryParams)
- **`DeribitOptionsChainsData`**(OptionsChainsData)
...
- **`call_api(expiration)`**
- **`receive_data(websocket, symbols, received_symbols)`**
...
**Generated**: 2025-11-19T02:16:48.752696Z
