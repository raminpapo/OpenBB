# Documentation: openbb_platform/providers/deribit/openbb_deribit/models/options_chains.py

## File Metadata
- **Path**: `openbb_platform/providers/deribit/openbb_deribit/models/options_chains.py`
- **Size**: 10,551 characters, 282 lines
- **Words**: 816
- **Extension**: .py
...
**Classes** (3):
`DeribitOptionsChainsQueryParams`, `DeribitOptionsChainsData`, `DeribitOptionsChainsFetcher`

**Functions** (6):
`_validate_symbol`, `transform_query`, `aextract_data`, `call_api`, `receive_data`, `transform_data`

**Imports** (32):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.options_chains`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_deribit.utils.helpers`, `DERIBIT_OPTIONS_SYMBOLS`, `pydantic`, `Field`, `asyncio`, `json`, `websockets`, `openbb_deribit.utils.helpers`, `get_options_symbols`


## Key Components

**Class `DeribitOptionsChainsQueryParams`**: Deribit Options Chains Query Parameters Model.

**Class `DeribitOptionsChainsData`**: Deribit Options Chains Data Model.

**Class `DeribitOptionsChainsFetcher`**: Deribit Options Chains Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:37.651734
