...
- **Classes** (3): DeribitFuturesCurveQueryParams, DeribitFuturesCurveData, DeribitFuturesCurveFetcher
- **Functions** (6): validate_symbol, _validate_hours_ago, _validate_model, transform_query, aextract_data, transform_data
- **Import Statements**: 6
...
- **`DeribitFuturesCurveQueryParams`**(FuturesCurveQueryParams)
- **`DeribitFuturesCurveData`**(FuturesCurveData)
...
- **`validate_symbol(cls, v)`**
- **`_validate_hours_ago(cls, v)`**
- **`_validate_model(cls, values)`**
...
**Generated**: 2025-11-19T02:16:48.744327Z
