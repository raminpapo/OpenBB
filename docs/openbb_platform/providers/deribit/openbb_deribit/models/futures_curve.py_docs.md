# Documentation: openbb_platform/providers/deribit/openbb_deribit/models/futures_curve.py

## File Metadata
- **Path**: `openbb_platform/providers/deribit/openbb_deribit/models/futures_curve.py`
- **Size**: 6,027 characters, 186 lines
- **Words**: 483
- **Extension**: .py
...
**Classes** (3):
`DeribitFuturesCurveQueryParams`, `DeribitFuturesCurveData`, `DeribitFuturesCurveFetcher`

**Functions** (6):
`validate_symbol`, `_validate_hours_ago`, `_validate_model`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (20):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.futures_curve`, `openbb_core.provider.utils.descriptions`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_deribit.utils.helpers`, `pydantic`, `Field`, `asyncio`, `openbb_deribit.utils.helpers`, `e`, `datetime`, `datetime`, `pandas`, `to_datetime`


## Key Components

**Class `DeribitFuturesCurveQueryParams`**: Deribit Futures Curve Query.

    Source: https://docs.deribit.com/?shell#public-ticker

**Class `DeribitFuturesCurveData`**: Deribit Futures Curve Data.

**Class `DeribitFuturesCurveFetcher`**: Deribit Futures Curve Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:37.644854
