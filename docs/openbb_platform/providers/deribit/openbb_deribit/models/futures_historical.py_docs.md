# Documentation: openbb_platform/providers/deribit/openbb_deribit/models/futures_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/deribit/openbb_deribit/models/futures_historical.py`
- **Size**: 5,307 characters, 156 lines
- **Words**: 380
- **Extension**: .py
...
**Classes** (3):
`DeribitFuturesHistoricalQueryParams`, `DeribitFuturesHistoricalData`, `DeribitFuturesHistoricalFetcher`

**Functions** (5):
`_validate_symbol`, `_validate_model`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (23):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.futures_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_deribit.utils.helpers`, `DERIBIT_INTERVALS`, `pydantic`, `Field`, `openbb_core.provider.utils.helpers`, `run_async`, `openbb_deribit.utils.helpers`


## Key Components

**Class `DeribitFuturesHistoricalQueryParams`**: Deribit Futures historical Price Query.

    Source: https://docs.deribit.com/?shell#public-get_tradingview_chart_data

**Class `DeribitFuturesHistoricalData`**: Deribit Futures Historical Data.

**Class `DeribitFuturesHistoricalFetcher`**: Deribit Futures Historical Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:37.646700
