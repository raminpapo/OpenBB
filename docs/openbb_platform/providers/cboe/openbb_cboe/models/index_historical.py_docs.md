# Documentation: openbb_platform/providers/cboe/openbb_cboe/models/index_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/cboe/openbb_cboe/models/index_historical.py`
- **Size**: 8,629 characters, 219 lines
- **Words**: 750
- **Extension**: .py
...
**Classes** (3):
`CboeIndexHistoricalQueryParams`, `CboeIndexHistoricalData`, `CboeIndexHistoricalFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `_generate_historical_prices_url`, `transform_data`

**Imports** (27):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.index_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `datetime`, `timedelta`, `the`, `openbb_cboe.utils.helpers`


## Key Components

**Class `CboeIndexHistoricalQueryParams`**: CBOE Market Indices Query.

    Source: https://www.cboe.com/

**Class `CboeIndexHistoricalData`**: CBOE Market Indices Data.

**Class `CboeIndexHistoricalFetcher`**: Transform the query, extract and transform the data from the CBOE endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:37.464219
