# Documentation: openbb_platform/providers/cboe/openbb_cboe/models/available_indices.py

## File Metadata
- **Path**: `openbb_platform/providers/cboe/openbb_cboe/models/available_indices.py`
- **Size**: 3,395 characters, 115 lines
- **Words**: 335
- **Extension**: .py
...
**Classes** (3):
`CboeAvailableIndicesQueryParams`, `CboeAvailableIndicesData`, `CboeAvailableIndicesFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (13):
`datetime`, `time`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.available_indices`, `pydantic`, `Field`, `the`, `the`, `openbb_cboe.utils.helpers`, `get_index_directory`


## Key Components

**Class `CboeAvailableIndicesQueryParams`**: Cboe Available Indices Query.

    Source: https://www.cboe.com/

**Class `CboeAvailableIndicesData`**: Cboe Available Indices Data.

    Source: https://www.cboe.com/

**Class `CboeAvailableIndicesFetcher`**: Transform the query, extract and transform the data from the CBOE endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:37.453269
