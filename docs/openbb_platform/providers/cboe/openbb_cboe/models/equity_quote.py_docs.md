# Documentation: openbb_platform/providers/cboe/openbb_cboe/models/equity_quote.py

## File Metadata
- **Path**: `openbb_platform/providers/cboe/openbb_cboe/models/equity_quote.py`
- **Size**: 9,795 characters, 253 lines
- **Words**: 894
- **Extension**: .py
...
**Classes** (3):
`CboeEquityQuoteQueryParams`, `CboeEquityQuoteData`, `CboeEquityQuoteFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (19):
`typing`, `TYPE_CHECKING`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_quote`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `pandas`, `DataFrame`, `the`, `the`, `openbb_cboe.utils.helpers`, `openbb_core.provider.utils.helpers`, `amake_requests`, `pandas`, `DataFrame`, `EU`


## Key Components

**Class `CboeEquityQuoteQueryParams`**: CBOE Equity Quote Query.

    Source: https://www.cboe.com/

**Class `CboeEquityQuoteData`**: CBOE Equity Quote Data.

**Class `CboeEquityQuoteFetcher`**: Transform the query, extract and transform the data from the CBOE endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:37.457345
