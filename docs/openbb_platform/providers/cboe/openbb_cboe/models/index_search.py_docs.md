# Documentation: openbb_platform/providers/cboe/openbb_cboe/models/index_search.py

## File Metadata
- **Path**: `openbb_platform/providers/cboe/openbb_cboe/models/index_search.py`
- **Size**: 3,725 characters, 115 lines
- **Words**: 350
- **Extension**: .py
...
**Classes** (3):
`CboeIndexSearchQueryParams`, `CboeIndexSearchData`, `CboeIndexSearchFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (13):
`datetime`, `time`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.index_search`, `pydantic`, `Field`, `the`, `the`, `openbb_cboe.utils.helpers`, `get_index_directory`


## Key Components

**Class `CboeIndexSearchQueryParams`**: CBOE Index Search Query.

    Source: https://www.cboe.com/

**Class `CboeIndexSearchData`**: CBOE Index Search Data.

**Class `CboeIndexSearchFetcher`**: Transform the query, extract and transform the data from the CBOE endpoints.
...
- `openbb_core.provider.standard_models.index_search`
- `pydantic`
- `openbb_cboe.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:37.466232
