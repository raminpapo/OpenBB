# Documentation: openbb_platform/providers/cboe/openbb_cboe/models/equity_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/cboe/openbb_cboe/models/equity_historical.py`
- **Size**: 8,698 characters, 216 lines
- **Words**: 774
- **Extension**: .py
...
**Classes** (3):
`CboeEquityHistoricalQueryParams`, `CboeEquityHistoricalData`, `CboeEquityHistoricalFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `_generate_historical_prices_url`, `transform_data`

**Imports** (28):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `datetime`, `timedelta`, `the`, `openbb_cboe.utils.helpers`


## Key Components

**Class `CboeEquityHistoricalQueryParams`**: Cboe Equity Historical Price Query

    Source: https://www.cboe.com/

**Class `CboeEquityHistoricalData`**: Cboe Equity Historical Price Data.

**Class `CboeEquityHistoricalFetcher`**: Transform the query, extract and transform the data from the CBOE endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:37.455281
