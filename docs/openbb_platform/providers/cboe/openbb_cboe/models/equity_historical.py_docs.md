...
- **Classes** (3): CboeEquityHistoricalQueryParams, CboeEquityHistoricalData, CboeEquityHistoricalFetcher
- **Functions** (4): transform_query, aextract_data, _generate_historical_prices_url, transform_data
- **Import Statements**: 7
...
- **`CboeEquityHistoricalQueryParams`**(EquityHistoricalQueryParams)
- **`CboeEquityHistoricalData`**(EquityHistoricalData)
...
**Generated**: 2025-11-19T02:16:48.509593Z
