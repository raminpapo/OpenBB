# Documentation: openbb_platform/providers/cboe/openbb_cboe/utils/vix.py

## File Metadata
- **Path**: `openbb_platform/providers/cboe/openbb_cboe/utils/vix.py`
- **Size**: 10,749 characters, 324 lines
- **Words**: 1,097
- **Extension**: .py
...
**Functions** (6):
`get_front_month`, `get_vx_symbols`, `get_months`, `check_date`, `get_vx_current`, `get_vx_by_date`

**Imports** (33):
`typing`, `TYPE_CHECKING`, `pandas`, `DataFrame`, `datetime`, `datetime`, `calendar`, `monthcalendar`, `collections`, `deque`, `collections`, `deque`, `datetime`, `timedelta`, `datetime`, `datetime`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_cboe.models.equity_quote`, `CboeEquityQuoteFetcher`
...
## Notes
- Generated: 2025-11-18T07:54:37.475035
