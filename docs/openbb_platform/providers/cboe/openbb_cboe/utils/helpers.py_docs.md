# Documentation: openbb_platform/providers/cboe/openbb_cboe/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/cboe/openbb_cboe/utils/helpers.py`
- **Size**: 6,804 characters, 255 lines
- **Words**: 606
- **Extension**: .py
...
**Functions** (6):
`response_callback`, `get_cboe_data`, `get_company_directory`, `get_index_directory`, `list_futures`, `get_settlement_prices`

**Imports** (24):
`datetime`, `date`, `typing`, `TYPE_CHECKING`, `openbb_core.provider.utils.helpers`, `amake_request`, `pandas`, `DataFrame`, `aiohttp_client_cache`, `SQLiteBackend`, `aiohttp_client_cache.session`, `CachedSession`, `openbb_core.app.utils`, `get_user_cache_directory`, `io`, `BytesIO`, `pandas`, `read_csv`, `pandas`, `DataFrame`
...
## Notes
- Generated: 2025-11-18T07:54:37.473172
