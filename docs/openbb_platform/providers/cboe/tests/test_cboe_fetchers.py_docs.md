# File Documentation: test_cboe_fetchers.py

## Metadata
- **Path**: `openbb_platform/providers/cboe/tests/test_cboe_fetchers.py`
- **Size**: 4,838 bytes
- **Lines**: 151
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_cboe_fetchers.py`.

**Python Module**

- **Functions** (11): vcr_config, test_cboe_index_historical_fetcher, test_cboe_index_constituents_fetcher, test_cboe_index_search_fetcher, test_cboe_equity_historical_fetcher, test_cboe_available_indices_fetcher, test_cboe_options_chains_fetcher, test_cboe_equity_search_fetcher, test_cboe_equity_quote_fetcher, test_cboe_futures_curve_fetcher ... and 1 more
- **Import Statements**: 1
...
- **`vcr_config()`**
- **`test_cboe_index_historical_fetcher(credentials=test_credentials)`**
- **`test_cboe_index_constituents_fetcher(credentials=test_credentials)`**
- **`test_cboe_index_search_fetcher(credentials=test_credentials)`**
- **`test_cboe_equity_historical_fetcher(credentials=test_credentials)`**
- **`test_cboe_available_indices_fetcher(credentials=test_credentials)`**
- **`test_cboe_options_chains_fetcher(credentials=test_credentials)`**
- **`test_cboe_equity_search_fetcher(credentials=test_credentials)`**
- **`test_cboe_equity_quote_fetcher(credentials=test_credentials)`**
- **`test_cboe_futures_curve_fetcher(credentials=test_credentials)`**
- **`test_cboe_index_snapshots_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:48.535708Z
