# Documentation: openbb_platform/providers/cboe/tests/test_cboe_fetchers.py

## File Metadata
- **Path**: `openbb_platform/providers/cboe/tests/test_cboe_fetchers.py`
- **Size**: 4,838 characters, 151 lines
- **Words**: 415
- **Extension**: .py
...
**Functions** (11):
`vcr_config`, `test_cboe_index_historical_fetcher`, `test_cboe_index_constituents_fetcher`, `test_cboe_index_search_fetcher`, `test_cboe_equity_historical_fetcher`, `test_cboe_available_indices_fetcher`, `test_cboe_options_chains_fetcher`, `test_cboe_equity_search_fetcher`, `test_cboe_equity_quote_fetcher`, `test_cboe_futures_curve_fetcher`, `test_cboe_index_snapshots_fetcher`

**Imports** (25):
`datetime`, `date`, `pytest`, `openbb_cboe.models.available_indices`, `CboeAvailableIndicesFetcher`, `openbb_cboe.models.equity_historical`, `CboeEquityHistoricalFetcher`, `openbb_cboe.models.equity_quote`, `CboeEquityQuoteFetcher`, `openbb_cboe.models.equity_search`, `CboeEquitySearchFetcher`, `openbb_cboe.models.futures_curve`, `CboeFuturesCurveFetcher`, `openbb_cboe.models.index_constituents`, `CboeIndexConstituentsFetcher`, `openbb_cboe.models.index_historical`, `CboeIndexHistoricalFetcher`, `openbb_cboe.models.index_search`, `CboeIndexSearchFetcher`, `openbb_cboe.models.index_snapshots`
...
## Notes
- Generated: 2025-11-18T07:54:37.564117
