...
- **Classes** (3): SAForwardSalesEstimatesQueryParams, SAForwardSalesEstimatesData, SAForwardSalesEstimatesFetcher
- **Functions** (4): check_symbol, transform_query, aextract_data, transform_data
- **Import Statements**: 3
...
- **`SAForwardSalesEstimatesQueryParams`**(ForwardSalesEstimatesQueryParams)
- **`SAForwardSalesEstimatesData`**(ForwardSalesEstimatesData)
...
**Generated**: 2025-11-19T02:16:52.945132Z
