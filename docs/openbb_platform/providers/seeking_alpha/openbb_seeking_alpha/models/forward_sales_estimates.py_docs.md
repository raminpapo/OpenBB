# Documentation: openbb_platform/providers/seeking_alpha/openbb_seeking_alpha/models/forward_sales_estimates.py

## File Metadata
- **Path**: `openbb_platform/providers/seeking_alpha/openbb_seeking_alpha/models/forward_sales_estimates.py`
- **Size**: 7,836 characters, 196 lines
- **Words**: 554
- **Extension**: .py
...
**Classes** (3):
`SAForwardSalesEstimatesQueryParams`, `SAForwardSalesEstimatesData`, `SAForwardSalesEstimatesFetcher`

**Functions** (4):
`check_symbol`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (18):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.forward_sales_estimates`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_seeking_alpha.utils.helpers`, `HEADERS`, `pydantic`, `Field`, `the`, `openbb_core.provider.utils.client`, `ClientSession`


## Key Components

**Class `SAForwardSalesEstimatesQueryParams`**: Seeking Alpha Forward Sales Estimates Query.

    Source: https://seekingalpha.com/earnings/earnings-calendar

**Class `SAForwardSalesEstimatesData`**: Seeking Alpha Forward Sales Estimates Data.

**Class `SAForwardSalesEstimatesFetcher`**: Seeking Alpha Forward Sales Estimates Fetcher.
...
- `openbb_core.provider.standard_models.forward_sales_estimates`
- `openbb_core.provider.utils.helpers`
- `openbb_seeking_alpha.utils.helpers`
- `pydantic`
- `openbb_core.provider.utils.client`

## Notes
- Generated: 2025-11-18T07:54:41.658146
