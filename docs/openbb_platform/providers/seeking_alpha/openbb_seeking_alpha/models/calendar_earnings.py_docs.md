# Documentation: openbb_platform/providers/seeking_alpha/openbb_seeking_alpha/models/calendar_earnings.py

## File Metadata
- **Path**: `openbb_platform/providers/seeking_alpha/openbb_seeking_alpha/models/calendar_earnings.py`
- **Size**: 5,511 characters, 155 lines
- **Words**: 406
- **Extension**: .py
...
**Classes** (3):
`SACalendarEarningsQueryParams`, `SACalendarEarningsData`, `SACalendarEarningsFetcher`

**Functions** (5):
`validate_release_date`, `transform_query`, `aextract_data`, `get_date`, `transform_data`

**Imports** (22):
`asyncio`, `json`, `datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.calendar_earnings`, `openbb_seeking_alpha.utils.helpers`, `HEADERS`, `pydantic`, `Field`, `the`, `openbb_core.provider.utils.client`, `ClientSession`


## Key Components

**Class `SACalendarEarningsQueryParams`**: Seeking Alpha Calendar Earnings Query.

    Source: https://seekingalpha.com/earnings/earnings-calendar

**Class `SACalendarEarningsData`**: Seeking Alpha Calendar Earnings Data.

**Class `SACalendarEarningsFetcher`**: Seeking Alpha Calendar Earnings Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:41.654128
