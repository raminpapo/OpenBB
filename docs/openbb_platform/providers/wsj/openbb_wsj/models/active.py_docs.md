# Documentation: openbb_platform/providers/wsj/openbb_wsj/models/active.py

## File Metadata
- **Path**: `openbb_platform/providers/wsj/openbb_wsj/models/active.py`
- **Size**: 3,118 characters, 105 lines
- **Words**: 248
- **Extension**: .py
...
**Classes** (3):
`WSJActiveQueryParams`, `WSJActiveData`, `WSJActiveFetcher`
...
**Class `WSJActiveQueryParams`**: WSJ Asset Performance Active Query.

    Source: https://www.wsj.com/market-data/mutualfunds-etfs/etfmovers

**Class `WSJActiveData`**: WSJ Asset Performance Active Data.

**Class `WSJActiveFetcher`**: Transform the query, extract and transform the data from the WSJ endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:43.522594
