# Documentation: openbb_platform/providers/fred/openbb_fred/models/non_farm_payrolls.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/non_farm_payrolls.py`
- **Size**: 13,485 characters, 381 lines
- **Words**: 1,060
- **Extension**: .py
...
**Classes** (3):
`FredNonFarmPayrollsQueryParams`, `FredNonFarmPayrollsData`, `FredNonFarmPayrollsFetcher`

**Functions** (5):
`validate_date`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (18):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.non_farm_payrolls`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `asyncio`, `openbb_core.provider.utils.helpers`, `amake_request`, `numpy`, `nan`, `pandas`, `DataFrame`


## Key Components

**Class `FredNonFarmPayrollsQueryParams`**: FRED NonFarm Payrolls Query.

**Class `FredNonFarmPayrollsData`**: FRED NonFarm Payrolls Data.

**Class `FredNonFarmPayrollsFetcher`**: FRED NonFarm Payrolls Fetcher.
...
- `openbb_core.provider.standard_models.non_farm_payrolls`
...
## Notes
- Generated: 2025-11-18T07:54:39.690628
