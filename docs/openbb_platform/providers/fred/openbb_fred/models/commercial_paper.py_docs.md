# Documentation: openbb_platform/providers/fred/openbb_fred/models/commercial_paper.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/commercial_paper.py`
- **Size**: 12,060 characters, 376 lines
- **Words**: 1,009
- **Extension**: .py
...
**Classes** (3):
`FREDCommercialPaperParams`, `FREDCommercialPaperData`, `FREDCommercialPaperFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (18):
`typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.commercial_paper`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `e`, `pandas`, `Categorical`


## Key Components

**Class `FREDCommercialPaperParams`**: FRED Commercial Paper Query.

**Class `FREDCommercialPaperData`**: FRED Commercial Paper Data.

**Class `FREDCommercialPaperFetcher`**: FRED Commercial Paper Fetcher.
...
- `openbb_core.provider.standard_models.commercial_paper`
...
## Notes
- Generated: 2025-11-18T07:54:39.659979
