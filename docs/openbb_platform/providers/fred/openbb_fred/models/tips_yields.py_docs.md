...
- **Classes** (3): FredTipsYieldsQueryParams, FredTipsYieldsData, FredTipsYieldsFetcher
- **Functions** (4): transform_query, aextract_data, get_tips_series, transform_data
- **Import Statements**: 3
...
- **`FredTipsYieldsQueryParams`**(TipsYieldsQueryParams)
- **`FredTipsYieldsData`**(TipsYieldsData)
...
**Generated**: 2025-11-19T02:16:51.016683Z
