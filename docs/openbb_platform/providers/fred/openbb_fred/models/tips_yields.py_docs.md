# Documentation: openbb_platform/providers/fred/openbb_fred/models/tips_yields.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/tips_yields.py`
- **Size**: 8,111 characters, 249 lines
- **Words**: 741
- **Extension**: .py
...
**Classes** (3):
`FredTipsYieldsQueryParams`, `FredTipsYieldsData`, `FredTipsYieldsFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_tips_series`, `transform_data`

**Imports** (24):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.tips_yields`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `Year`, `Year`, `openbb_fred.models.search`, `FredSearchFetcher`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pandas`


## Key Components

**Class `FredTipsYieldsQueryParams`**: FRED TIPS Yields Query.

**Class `FredTipsYieldsData`**: FRED TIPS Yields Data.

**Class `FredTipsYieldsFetcher`**: FRED TIPS Yields Fetcher.
...
- `openbb_core.provider.standard_models.tips_yields`
...
## Notes
- Generated: 2025-11-18T07:54:39.720188
