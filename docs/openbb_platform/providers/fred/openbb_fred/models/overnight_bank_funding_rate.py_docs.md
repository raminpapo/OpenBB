...
- **Classes** (3): FredOvernightBankFundingRateQueryParams, FredOvernightBankFundingRateData, FredOvernightBankFundingRateFetcher
...
- **`FredOvernightBankFundingRateQueryParams`**(OvernightBankFundingRateQueryParams)
- **`FredOvernightBankFundingRateData`**(OvernightBankFundingRateData)
...
**Generated**: 2025-11-19T02:16:50.985710Z
