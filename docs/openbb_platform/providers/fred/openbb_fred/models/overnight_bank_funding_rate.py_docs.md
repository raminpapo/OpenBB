# Documentation: openbb_platform/providers/fred/openbb_fred/models/overnight_bank_funding_rate.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/overnight_bank_funding_rate.py`
- **Size**: 5,843 characters, 199 lines
- **Words**: 463
- **Extension**: .py
...
**Classes** (3):
`FredOvernightBankFundingRateQueryParams`, `FredOvernightBankFundingRateData`, `FredOvernightBankFundingRateFetcher`

**Functions** (4):
`normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (16):
`typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.overnight_bank_funding_rate`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `e`


## Key Components

**Class `FredOvernightBankFundingRateQueryParams`**: FRED Overnight Bank Funding Rate Query Params.

**Class `FredOvernightBankFundingRateData`**: Fred Overnight Bank Funding Rate Data.

**Class `FredOvernightBankFundingRateFetcher`**: Fred Overnight Bank Funding Rate Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.692865
