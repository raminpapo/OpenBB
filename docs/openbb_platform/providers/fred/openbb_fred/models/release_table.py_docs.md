# Documentation: openbb_platform/providers/fred/openbb_fred/models/release_table.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/release_table.py`
- **Size**: 10,800 characters, 276 lines
- **Words**: 880
- **Extension**: .py
...
**Classes** (3):
`FredReleaseTableQueryParams`, `FredReleaseTableData`, `FredReleaseTableFetcher`

**Functions** (7):
`validate_date`, `transform_query`, `aextract_data`, `to_quarter_start`, `get_one`, `apply_date_format`, `transform_data`

**Imports** (21):
`datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.fred_release_table`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `field_validator`, `asyncio`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_fred.models.search`, `FredSearchFetcher`, `numpy`, `nan`, `pandas`


## Key Components

**Class `FredReleaseTableQueryParams`**: FRED Release Table Query Params.

**Class `FredReleaseTableData`**: FRED Release Table Data.

**Class `FredReleaseTableFetcher`**: FRED Release Table Fetcher.
...
- `openbb_core.provider.standard_models.fred_release_table`
- `openbb_core.provider.utils.errors`
- `pydantic`
- `asyncio`
- `openbb_core.provider.utils.helpers`
- `openbb_fred.models.search`

## Notes
- Generated: 2025-11-18T07:54:39.699321
