# File Documentation: release_table.py
...
This is a **python** file named `release_table.py`.

**Python Module**

- **Classes** (3): FredReleaseTableQueryParams, FredReleaseTableData, FredReleaseTableFetcher
- **Functions** (7): validate_date, transform_query, aextract_data, to_quarter_start, get_one, apply_date_format, transform_data
- **Import Statements**: 4
...
- **`FredReleaseTableQueryParams`**(ReleaseTableQueryParams)
- **`FredReleaseTableData`**(ReleaseTableData)
- **`FredReleaseTableFetcher`**(
    Fetcher[
        FredReleaseTableQueryParams,
        list[FredReleaseTableData],
    ]
...
**Generated**: 2025-11-19T02:16:50.995149Z
