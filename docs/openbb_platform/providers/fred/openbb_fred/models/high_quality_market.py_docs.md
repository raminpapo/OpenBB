# Documentation: openbb_platform/providers/fred/openbb_fred/models/high_quality_market.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/high_quality_market.py`
- **Size**: 5,547 characters, 148 lines
- **Words**: 418
- **Extension**: .py
...
**Classes** (3):
`FredHighQualityMarketCorporateBondQueryParams`, `FredHighQualityMarketCorporateBondData`, `FredHighQualityMarketCorporateBondFetcher`

**Functions** (5):
`validate_date`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (16):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.high_quality_market`, `pydantic`, `Field`, `asyncio`, `dateutil`, `parser`, `openbb_core.provider.utils.helpers`, `amake_request`, `pandas`, `Categorical`


## Key Components

**Class `FredHighQualityMarketCorporateBondQueryParams`**: FRED High Quality Market Corporate Bond Query.

**Class `FredHighQualityMarketCorporateBondData`**: FRED High Quality Market Corporate Bond Data.

**Class `FredHighQualityMarketCorporateBondFetcher`**: FRED High Quality Market Corporate Bond Fetcher.
...
- `openbb_core.provider.standard_models.high_quality_market`
- `pydantic`
- `asyncio`
- `dateutil`
...
## Notes
- Generated: 2025-11-18T07:54:39.679028
