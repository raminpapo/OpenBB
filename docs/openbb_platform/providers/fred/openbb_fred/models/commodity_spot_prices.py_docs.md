# Documentation: openbb_platform/providers/fred/openbb_fred/models/commodity_spot_prices.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/commodity_spot_prices.py`
- **Size**: 7,624 characters, 251 lines
- **Words**: 623
- **Extension**: .py
...
**Classes** (3):
`FredCommoditySpotPricesQueryParams`, `FredCommoditySpotPricesData`, `FredCommoditySpotPricesFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (24):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.commodity_spot_prices`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `Year`, `Year`, `the`, `datetime`, `datetime`, `openbb_fred.models.series`, `FredSeriesFetcher`


## Key Components

**Class `FredCommoditySpotPricesQueryParams`**: FRED Commodity Spot Prices Query Params.

**Class `FredCommoditySpotPricesData`**: FRED Commodity Spot Prices Data.

**Class `FredCommoditySpotPricesFetcher`**: FRED Commodity Spot Prices Fetcher.
...
- `openbb_core.provider.standard_models.commodity_spot_prices`
...
## Notes
- Generated: 2025-11-18T07:54:39.663176
