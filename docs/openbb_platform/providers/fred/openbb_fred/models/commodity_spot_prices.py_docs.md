...
- **Classes** (3): FredCommoditySpotPricesQueryParams, FredCommoditySpotPricesData, FredCommoditySpotPricesFetcher
...
- **`FredCommoditySpotPricesQueryParams`**(CommoditySpotPricesQueryParams)
- **`FredCommoditySpotPricesData`**(CommoditySpotPricesData)
...
**Generated**: 2025-11-19T02:16:50.952923Z
