...
- **Classes** (3): FREDConsumerPriceIndexQueryParams, FREDConsumerPriceIndexData, FREDConsumerPriceIndexFetcher
- **Functions** (4): validate_country, transform_query, aextract_data, transform_data
- **Import Statements**: 3
...
- **`FREDConsumerPriceIndexQueryParams`**(ConsumerPriceIndexQueryParams)
- **`FREDConsumerPriceIndexData`**(ConsumerPriceIndexData)
...
**Generated**: 2025-11-19T02:16:50.955286Z
