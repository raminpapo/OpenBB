...
- **Classes** (3): FREDSpotRateQueryParams, FREDSpotRateData, FREDSpotRateFetcher
...
- **`FREDSpotRateQueryParams`**(SpotRateQueryParams)
- **`FREDSpotRateData`**(SpotRateData)
- **`FREDSpotRateFetcher`**(
    Fetcher[
        FREDSpotRateQueryParams,
        list[FREDSpotRateData],
...
**Generated**: 2025-11-19T02:16:51.010816Z
