# Documentation: openbb_platform/providers/fred/openbb_fred/models/balance_of_payments.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/balance_of_payments.py`
- **Size**: 4,498 characters, 131 lines
- **Words**: 323
- **Extension**: .py
...
**Classes** (3):
`FredBalanceOfPaymentsQueryParams`, `FredBalanceOfPaymentsData`, `FredBalanceOfPaymentsFetcher`

**Functions** (4):
`normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (19):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.balance_of_payments`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `openbb_fred.utils.fred_helpers`, `pydantic`, `Field`, `pandas`, `DataFrame`


## Key Components

**Class `FredBalanceOfPaymentsQueryParams`**: FRED Balance Of Payments Query Parameters.

**Class `FredBalanceOfPaymentsData`**: FRED Balance Of Payments Data.

**Class `FredBalanceOfPaymentsFetcher`**: FRED Balance Of Payments Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.653842
