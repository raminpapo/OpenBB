# Documentation: openbb_platform/providers/fred/openbb_fred/models/search.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/search.py`
- **Size**: 11,163 characters, 316 lines
- **Words**: 955
- **Extension**: .py
...
**Classes** (3):
`FredSearchQueryParams`, `FredSearchData`, `FredSearchFetcher`

**Functions** (5):
`validate_last_updated`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (22):
`typing`, `Any`, `dateutil`, `parser`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.fred_search`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `asyncio`, `openbb_core.provider.utils.helpers`, `the`, `numpy`, `nan`


## Key Components

**Class `FredSearchQueryParams`**: FRED Search Query Params.

**Class `FredSearchData`**: FRED Search Data.

**Class `FredSearchFetcher`**: FRED Search Fetcher.
...
- `openbb_core.provider.standard_models.fred_search`
...
## Notes
- Generated: 2025-11-18T07:54:39.704053
