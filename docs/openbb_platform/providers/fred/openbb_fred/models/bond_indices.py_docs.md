# Documentation: openbb_platform/providers/fred/openbb_fred/models/bond_indices.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/bond_indices.py`
- **Size**: 21,267 characters, 615 lines
- **Words**: 1,471
- **Extension**: .py
...
**Classes** (3):
`FredBondIndicesQueryParams`, `FredBondIndicesData`, `FredBondIndicesFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (21):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.bond_indices`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `pandas`


## Key Components

**Class `FredBondIndicesQueryParams`**: FRED Bond Indices Query.

**Class `FredBondIndicesData`**: FRED Bond Indices Data.

**Class `FredBondIndicesFetcher`**: FRED Bond Indices Fetcher.
...
- `openbb_core.provider.standard_models.bond_indices`
...
## Notes
- Generated: 2025-11-18T07:54:39.656131
