# File Documentation: bond_indices.py
...
This is a **python** file named `bond_indices.py`.

**Python Module**

- **Classes** (3): FredBondIndicesQueryParams, FredBondIndicesData, FredBondIndicesFetcher
...
- **`FredBondIndicesQueryParams`**(BondIndicesQueryParams)
- **`FredBondIndicesData`**(BondIndicesData)
...
**Generated**: 2025-11-19T02:16:50.946752Z
