# Documentation: openbb_platform/providers/fred/openbb_fred/models/series.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/series.py`
- **Size**: 6,872 characters, 217 lines
- **Words**: 575
- **Extension**: .py
...
**Classes** (3):
`FredSeriesQueryParams`, `FredSeriesData`, `FredSeriesFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (23):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.fred_series`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `pydantic`, `Field`, `Year`, `Year`, `openbb_core.provider.utils.helpers`, `pandas`, `DataFrame`, `e`, `pandas`


## Key Components

**Class `FredSeriesQueryParams`**: FRED Series Query Params.

**Class `FredSeriesData`**: FRED Series Data.

**Class `FredSeriesFetcher`**: FRED Series Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.708655
