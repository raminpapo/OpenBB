...
- **Classes** (3): FredSeriesQueryParams, FredSeriesData, FredSeriesFetcher
...
- **`FredSeriesQueryParams`**(SeriesQueryParams)
- **`FredSeriesData`**(SeriesData)
- **`FredSeriesFetcher`**(
    Fetcher[
        FredSeriesQueryParams,
        list[FredSeriesData],
...
**Generated**: 2025-11-19T02:16:51.004993Z
