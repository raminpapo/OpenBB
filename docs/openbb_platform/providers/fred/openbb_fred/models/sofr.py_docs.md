# Documentation: openbb_platform/providers/fred/openbb_fred/models/sofr.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/sofr.py`
- **Size**: 6,460 characters, 219 lines
- **Words**: 524
- **Extension**: .py
...
**Classes** (3):
`FREDSOFRQueryParams`, `FREDSOFRData`, `FREDSOFRFetcher`

**Functions** (4):
`normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (17):
`typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.sofr`, `SOFRData`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `e`


## Key Components

**Class `FREDSOFRQueryParams`**: FRED SOFR Query.

**Class `FREDSOFRData`**: FRED SOFR Data.

**Class `FREDSOFRFetcher`**: FRED SOFR Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.710940
