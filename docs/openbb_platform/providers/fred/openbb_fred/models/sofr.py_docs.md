...
- **Classes** (3): FREDSOFRQueryParams, FREDSOFRData, FREDSOFRFetcher
...
- **`FREDSOFRQueryParams`**(SOFRQueryParams)
- **`FREDSOFRData`**(SOFRData)
- **`FREDSOFRFetcher`**(Fetcher[FREDSOFRQueryParams, list[FREDSOFRData]])
...
**Generated**: 2025-11-19T02:16:51.007246Z
