# Documentation: openbb_platform/providers/fred/openbb_fred/models/university_of_michigan.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/university_of_michigan.py`
- **Size**: 5,036 characters, 147 lines
- **Words**: 446
- **Extension**: .py
...
**Classes** (3):
`FredUofMichiganQueryParams`, `FredUofMichiganData`, `FredUofMichiganFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (21):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.university_of_michigan`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `FRED`, `Year`, `Year`, `e`, `pandas`


## Key Components

**Class `FredUofMichiganQueryParams`**: FRED University of Michigan Survey Query. Data from FRED is delayed by 1 month.

**Class `FredUofMichiganData`**: FRED University of Michigan Survey Data.

**Class `FredUofMichiganFetcher`**: FRED University of Michigan Survey Fetcher.
...
- `openbb_core.provider.standard_models.university_of_michigan`
...
## Notes
- Generated: 2025-11-18T07:54:39.723712
