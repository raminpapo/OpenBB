# File Documentation: university_of_michigan.py
...
This is a **python** file named `university_of_michigan.py`.

**Python Module**

- **Classes** (3): FredUofMichiganQueryParams, FredUofMichiganData, FredUofMichiganFetcher
...
- **`FredUofMichiganQueryParams`**(UofMichiganQueryParams)
- **`FredUofMichiganData`**(UofMichiganData)
...
**Generated**: 2025-11-19T02:16:51.020641Z
