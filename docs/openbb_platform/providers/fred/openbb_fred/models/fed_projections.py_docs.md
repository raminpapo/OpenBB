# Documentation: openbb_platform/providers/fred/openbb_fred/models/fed_projections.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/fed_projections.py`
- **Size**: 2,328 characters, 76 lines
- **Words**: 183
- **Extension**: .py
...
**Classes** (3):
`FREDPROJECTIONQueryParams`, `FREDPROJECTIONData`, `FREDPROJECTIONFetcher`

**Functions** (3):
`transform_query`, `extract_data`, `transform_data`

**Imports** (11):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.fed_projections`, `pydantic`, `Field`, `openbb_fred.utils.fred_base`, `Fred`, `openbb_fred.utils.fred_helpers`, `process_projections`


## Key Components

**Class `FREDPROJECTIONQueryParams`**: FRED PROJECTION Query.

**Class `FREDPROJECTIONData`**: FRED PROJECTION Data.

**Class `FREDPROJECTIONFetcher`**: FRED Federal Funds Rate Projections Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.673524
