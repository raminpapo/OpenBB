# File Documentation: personal_consumption_expenditures.py
...
This is a **python** file named `personal_consumption_expenditures.py`.

**Python Module**

- **Classes** (3): FredPersonalConsumptionExpendituresQueryParams, FredPersonalConsumptionExpendituresData, FredPersonalConsumptionExpendituresFetcher
- **Functions** (5): validate_date, transform_query, aextract_data, get_one, transform_data
- **Import Statements**: 4
...
- **`FredPersonalConsumptionExpendituresData`**(PersonalConsumptionExpendituresData)
...
**Generated**: 2025-11-19T02:16:50.988878Z
