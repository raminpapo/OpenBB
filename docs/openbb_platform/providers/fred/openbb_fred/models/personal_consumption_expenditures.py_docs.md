# Documentation: openbb_platform/providers/fred/openbb_fred/models/personal_consumption_expenditures.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/personal_consumption_expenditures.py`
- **Size**: 8,773 characters, 245 lines
- **Words**: 636
- **Extension**: .py
...
**Classes** (3):
`FredPersonalConsumptionExpendituresQueryParams`, `FredPersonalConsumptionExpendituresData`, `FredPersonalConsumptionExpendituresFetcher`

**Functions** (5):
`validate_date`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (18):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.personal_consumption_expenditures`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `asyncio`, `openbb_core.provider.utils.helpers`, `amake_request`, `numpy`, `nan`, `pandas`, `DataFrame`


## Key Components

**Class `FredPersonalConsumptionExpendituresQueryParams`**: FRED Personal Consumption Expenditures Query.

**Class `FredPersonalConsumptionExpendituresData`**: FRED Personal Consumption Expenditures Data.

**Class `FredPersonalConsumptionExpendituresFetcher`**: FRED Personal Consumption Expenditures Fetcher.
...
- `openbb_core.provider.standard_models.personal_consumption_expenditures`
...
## Notes
- Generated: 2025-11-18T07:54:39.694808
