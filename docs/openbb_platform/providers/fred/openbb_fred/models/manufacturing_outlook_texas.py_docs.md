# Documentation: openbb_platform/providers/fred/openbb_fred/models/manufacturing_outlook_texas.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/manufacturing_outlook_texas.py`
- **Size**: 15,140 characters, 433 lines
- **Words**: 955
- **Extension**: .py
...
**Classes** (3):
`FredManufacturingOutlookTexasQueryParams`, `FredManufacturingOutlookTexasData`, `FredManufacturingOutlookTexasFetcher`

**Functions** (4):
`validate_topic`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (21):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.manufacturing_outlook_texas`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `e`, `pandas`, `Categorical`


## Key Components

**Class `FredManufacturingOutlookTexasQueryParams`**: FRED Manufacturing Outlook - Texas - Query Params.

**Class `FredManufacturingOutlookTexasData`**: FRED Manufacturing Outlook - Texas - Data.

**Class `FredManufacturingOutlookTexasFetcher`**: FRED Manufacturing Outlook - Texas - Fetcher.
...
- `openbb_core.provider.standard_models.manufacturing_outlook_texas`
...
## Notes
- Generated: 2025-11-18T07:54:39.685728
