# File Documentation: manufacturing_outlook_ny.py
...
This is a **python** file named `manufacturing_outlook_ny.py`.

**Python Module**

- **Classes** (3): FredManufacturingOutlookNYQueryParams, FredManufacturingOutlookNYData, FredManufacturingOutlookNYFetcher
- **Functions** (4): validate_topic, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`FredManufacturingOutlookNYQueryParams`**(ManufacturingOutlookTexasQueryParams)
- **`FredManufacturingOutlookNYData`**(ManufacturingOutlookTexasData)
...
**Generated**: 2025-11-19T02:16:50.971868Z
