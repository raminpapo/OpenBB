# Documentation: openbb_platform/providers/fred/openbb_fred/models/manufacturing_outlook_ny.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/manufacturing_outlook_ny.py`
- **Size**: 20,240 characters, 558 lines
- **Words**: 1,201
- **Extension**: .py
...
**Classes** (3):
`FredManufacturingOutlookNYQueryParams`, `FredManufacturingOutlookNYData`, `FredManufacturingOutlookNYFetcher`

**Functions** (4):
`validate_topic`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (23):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.manufacturing_outlook_texas`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `Year`, `Year`, `openbb_fred.models.series`, `FredSeriesFetcher`, `e`, `numpy`, `nan`


## Key Components

**Class `FredManufacturingOutlookNYQueryParams`**: FRED Manufacturing Outlook - New York - Query Params.

**Class `FredManufacturingOutlookNYData`**: FRED Manufacturing Outlook - New York - Data.

**Class `FredManufacturingOutlookNYFetcher`**: FRED Manufacturing Outlook - New York - Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.682897
