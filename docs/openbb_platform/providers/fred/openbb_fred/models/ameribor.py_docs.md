# Documentation: openbb_platform/providers/fred/openbb_fred/models/ameribor.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/ameribor.py`
- **Size**: 5,922 characters, 195 lines
- **Words**: 509
- **Extension**: .py
...
**Classes** (3):
`FredAmeriborQueryParams`, `FredAmeriborData`, `FredAmeriborFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (18):
`typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.ameribor`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `e`, `pandas`, `Categorical`


## Key Components

**Class `FredAmeriborQueryParams`**: FRED AMERIBOR Query.

**Class `FredAmeriborData`**: FRED AMERIBOR Data.

**Class `FredAmeriborFetcher`**: FRED Ameribor Fetcher.
...
- `openbb_core.provider.standard_models.ameribor`
...
## Notes
- Generated: 2025-11-18T07:54:39.652218
