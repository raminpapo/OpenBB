# Documentation: openbb_platform/providers/fred/openbb_fred/models/senior_loan_officer_survey.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/senior_loan_officer_survey.py`
- **Size**: 5,100 characters, 145 lines
- **Words**: 359
- **Extension**: .py
...
**Classes** (3):
`FredSeniorLoanOfficerSurveyQueryParams`, `FredSeniorLoanOfficerSurveyData`, `FredSeniorLoanOfficerSurveyFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (18):
`typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.senior_loan_officer_survey`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `e`, `pandas`, `DataFrame`


## Key Components

**Class `FredSeniorLoanOfficerSurveyQueryParams`**: FRED Senior Loan Officer Opinion Survey Query Params.

**Class `FredSeniorLoanOfficerSurveyData`**: FRED Senior Loan Officer Opinion Survey Data.

**Class `FredSeniorLoanOfficerSurveyFetcher`**: FRED Senior Loan Officer Opinion Survey Fetcher.
...
- `openbb_core.provider.standard_models.senior_loan_officer_survey`
...
## Notes
- Generated: 2025-11-18T07:54:39.706356
