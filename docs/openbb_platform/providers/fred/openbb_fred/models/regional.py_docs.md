# File Documentation: regional.py
...
This is a **python** file named `regional.py`.

**Python Module**

- **Classes** (3): FredRegionalQueryParams, FredRegionalData, FredRegionalDataFetcher
- **Functions** (4): transform_validate, transform_query, aextract_data, transform_data
- **Import Statements**: 2
...
- **`FredRegionalQueryParams`**(SeriesQueryParams)
- **`FredRegionalData`**(SeriesData)
- **`FredRegionalDataFetcher`**(
    Fetcher[
        FredRegionalQueryParams,
        list[FredRegionalData],
    ]
...
**Generated**: 2025-11-19T02:16:50.992633Z
