# Documentation: openbb_platform/providers/fred/openbb_fred/models/regional.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/regional.py`
- **Size**: 9,272 characters, 285 lines
- **Words**: 857
- **Extension**: .py
...
**Classes** (3):
`FredRegionalQueryParams`, `FredRegionalData`, `FredRegionalDataFetcher`

**Functions** (4):
`transform_validate`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (19):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.fred_series`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `searching`, `Year`, `Year`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `FredRegionalQueryParams`**: FRED Regional Data Query Params.

**Class `FredRegionalData`**: FRED Regional Data.

**Class `FredRegionalDataFetcher`**: FRED Regional Data Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.697004
