# Documentation: openbb_platform/providers/fred/openbb_fred/models/retail_prices.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/retail_prices.py`
- **Size**: 8,828 characters, 368 lines
- **Words**: 724
- **Extension**: .py
...
**Classes** (3):
`FredRetailPricesQueryParams`, `FredRetailPricesData`, `FredRetailPricesFetcher`

**Functions** (4):
`validate_item`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (25):
`typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.retail_prices`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `json`, `importlib.resources`, `files`


## Key Components

**Class `FredRetailPricesQueryParams`**: FRED Retail Prices Query Parameters.

**Class `FredRetailPricesData`**: FRED Retail Prices Data.

**Class `FredRetailPricesFetcher`**: FRED Retail Prices Fetcher.
...
- `openbb_core.provider.standard_models.retail_prices`
...
## Notes
- Generated: 2025-11-18T07:54:39.701719
