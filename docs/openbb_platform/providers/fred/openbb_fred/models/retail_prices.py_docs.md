...
- **Classes** (3): FredRetailPricesQueryParams, FredRetailPricesData, FredRetailPricesFetcher
- **Functions** (4): validate_item, transform_query, aextract_data, transform_data
- **Import Statements**: 6
...
- **`FredRetailPricesQueryParams`**(RetailPricesQueryParams)
- **`FredRetailPricesData`**(RetailPricesData)
...
**Generated**: 2025-11-19T02:16:50.997683Z
