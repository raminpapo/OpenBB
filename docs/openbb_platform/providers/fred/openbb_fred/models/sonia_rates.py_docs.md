# Documentation: openbb_platform/providers/fred/openbb_fred/models/sonia_rates.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/sonia_rates.py`
- **Size**: 2,323 characters, 82 lines
- **Words**: 180
- **Extension**: .py
...
**Classes** (3):
`FREDSONIAQueryParams`, `FREDSONIAData`, `FREDSONIAFetcher`

**Functions** (4):
`value_validate`, `transform_query`, `extract_data`, `transform_data`

**Imports** (10):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.sonia_rates`, `SONIAData`, `pydantic`, `Field`, `openbb_fred.utils.fred_base`, `Fred`


## Key Components

**Class `FREDSONIAQueryParams`**: FRED SONIA Query.

**Class `FREDSONIAData`**: FRED SONIA Data.

**Class `FREDSONIAFetcher`**: FRED SONIA Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.712858
