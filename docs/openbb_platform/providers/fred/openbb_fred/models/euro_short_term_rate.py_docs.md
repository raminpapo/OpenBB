# File Documentation: euro_short_term_rate.py
...
This is a **python** file named `euro_short_term_rate.py`.

**Python Module**

- **Classes** (3): FredEuroShortTermRateQueryParams, FredEuroShortTermRateData, FredEuroShortTermRateFetcher
...
- **`FredEuroShortTermRateQueryParams`**(EuroShortTermRateQueryParams)
- **`FredEuroShortTermRateData`**(EuroShortTermRateData)
...
**Generated**: 2025-11-19T02:16:50.960452Z
