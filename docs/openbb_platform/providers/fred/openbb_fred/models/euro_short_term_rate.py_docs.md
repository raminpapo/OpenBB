# Documentation: openbb_platform/providers/fred/openbb_fred/models/euro_short_term_rate.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/euro_short_term_rate.py`
- **Size**: 5,960 characters, 195 lines
- **Words**: 482
- **Extension**: .py
...
**Classes** (3):
`FredEuroShortTermRateQueryParams`, `FredEuroShortTermRateData`, `FredEuroShortTermRateFetcher`

**Functions** (4):
`normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (16):
`typing`, `Any`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.euro_short_term_rate`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `e`


## Key Components

**Class `FredEuroShortTermRateQueryParams`**: FRED Euro Short Term Rate Query.

**Class `FredEuroShortTermRateData`**: FRED Euro Short Term Rate Data.

**Class `FredEuroShortTermRateFetcher`**: FRED Euro Short Term Rate Fetcher.
...
- `openbb_core.provider.standard_models.euro_short_term_rate`
- `openbb_core.provider.utils.errors`
- `openbb_fred.models.series`
- `pydantic`

## Notes
- Generated: 2025-11-18T07:54:39.671880
