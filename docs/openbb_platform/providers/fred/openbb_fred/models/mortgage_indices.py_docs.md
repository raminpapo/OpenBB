# Documentation: openbb_platform/providers/fred/openbb_fred/models/mortgage_indices.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/models/mortgage_indices.py`
- **Size**: 10,476 characters, 319 lines
- **Words**: 821
- **Extension**: .py
...
**Classes** (3):
`FredMortgageIndicesQueryParams`, `FredMortgageIndicesData`, `FredMortgageIndicesFetcher`

**Functions** (4):
`validate_index`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (22):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.mortgage_indices`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_fred.models.series`, `FredSeriesFetcher`, `pydantic`, `Field`, `Year`, `Year`, `e`


## Key Components

**Class `FredMortgageIndicesQueryParams`**: FRED Mortgage Indices Query.

**Class `FredMortgageIndicesData`**: FRED Mortgage Indices Data.

**Class `FredMortgageIndicesFetcher`**: FRED Mortgage Indices Fetcher.
...
- `openbb_core.provider.standard_models.mortgage_indices`
...
## Notes
- Generated: 2025-11-18T07:54:39.688287
