...
- **Classes** (3): FredMortgageIndicesQueryParams, FredMortgageIndicesData, FredMortgageIndicesFetcher
- **Functions** (4): validate_index, transform_query, aextract_data, transform_data
- **Import Statements**: 3
...
- **`FredMortgageIndicesQueryParams`**(MortgageIndicesQueryParams)
- **`FredMortgageIndicesData`**(MortgageIndicesData)
...
**Generated**: 2025-11-19T02:16:50.979311Z
