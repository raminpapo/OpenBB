# File Documentation: fred_helpers.py
...
This is a **python** file named `fred_helpers.py`.

**Python Module**

- **Functions** (8): comma_to_float_list, all_cpi_options, get_cpi_options, process_projections, get_ice_bofa_series_id, get_cp_series_id, get_spot_series_id, get_bop_series
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:16:51.046818Z
