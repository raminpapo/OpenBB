# Documentation: openbb_platform/providers/fred/openbb_fred/utils/fred_helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/utils/fred_helpers.py`
- **Size**: 12,567 characters, 508 lines
- **Words**: 1,026
- **Extension**: .py
...
**Functions** (8):
`comma_to_float_list`, `all_cpi_options`, `get_cpi_options`, `process_projections`, `get_ice_bofa_series_id`, `get_cp_series_id`, `get_spot_series_id`, `get_bop_series`

**Imports** (9):
`csv`, `os`, `pathlib`, `Path`, `typing`, `Literal`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `e`
...
## Notes
- Generated: 2025-11-18T07:54:39.750226
