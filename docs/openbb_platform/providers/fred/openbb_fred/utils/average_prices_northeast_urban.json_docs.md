# File Documentation: average_prices_northeast_urban.json

## Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/utils/average_prices_northeast_urban.json`
- **Size**: 2,948 bytes
- **Lines**: 1
- **Category**: config
- **Extension**: .json
...
This is a **config** file named `average_prices_northeast_urban.json`.
...
**Generated**: 2025-11-19T02:16:51.028968Z
