# Documentation: openbb_platform/providers/fred/openbb_fred/__init__.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/openbb_fred/__init__.py`
- **Size**: 6,290 characters, 106 lines
- **Words**: 351
- **Extension**: .py
...
**Imports** (64):
`openbb_core.provider.abstract.provider`, `Provider`, `openbb_fred.models.ameribor`, `FredAmeriborFetcher`, `openbb_fred.models.balance_of_payments`, `FredBalanceOfPaymentsFetcher`, `openbb_fred.models.bond_indices`, `FredBondIndicesFetcher`, `openbb_fred.models.commercial_paper`, `FREDCommercialPaperFetcher`, `openbb_fred.models.commodity_spot_prices`, `FredCommoditySpotPricesFetcher`, `openbb_fred.models.consumer_price_index`, `FREDConsumerPriceIndexFetcher`, `openbb_fred.models.dwpcr_rates`, `FREDDiscountWindowPrimaryCreditRateFetcher`, `openbb_fred.models.ecb_interest_rates`, `openbb_fred.models.euro_short_term_rate`, `FredEuroShortTermRateFetcher`, `openbb_fred.models.fed_projections`
...
- `openbb_fred.models.ecb_interest_rates`
- `openbb_fred.models.euro_short_term_rate`

## Notes
- Generated: 2025-11-18T07:54:39.650387
