# Documentation: openbb_platform/providers/fred/tests/test_fred_fetchers.py

## File Metadata
- **Path**: `openbb_platform/providers/fred/tests/test_fred_fetchers.py`
- **Size**: 16,412 characters, 532 lines
- **Words**: 1,163
- **Extension**: .py
...
**Functions** (36):
`vcr_config`, `test_fredcpi_fetcher`, `test_fred_sofr_fetcher`, `test_fred_euro_short_term_rate_fetcher`, `test_fredsonia_fetcher`, `test_fred_ameribor_fetcher`, `test_fred_federal_funds_rate_fetcher`, `test_fredprojection_fetcher`, `test_frediorb_fetcher`, `test_fred_discount_window_primary_credit_rate_fetcher`, `test_fred_european_central_bank_interest_rates_fetcher`, `test_fred_commercial_paper_fetcher`, `test_fred_spot_rate_fetcher`, `test_fred_high_quality_market_corporate_bond_fetcher`, `test_fred_treasury_constant_maturity_fetcher`, `test_fred_selected_treasury_constant_maturity_fetcher`, `test_fred_selected_treasury_bill_fetcher`, `test_fred_search_fetcher`, `test_fred_series_fetcher`, `test_fred_regional_fetcher`

**Imports** (65):
`datetime`, `pytest`, `openbb_core.app.service.user_service`, `UserService`, `openbb_fred.models.ameribor`, `FredAmeriborFetcher`, `openbb_fred.models.balance_of_payments`, `FredBalanceOfPaymentsFetcher`, `openbb_fred.models.bond_indices`, `FredBondIndicesFetcher`, `openbb_fred.models.commercial_paper`, `FREDCommercialPaperFetcher`, `openbb_fred.models.commodity_spot_prices`, `FredCommoditySpotPricesFetcher`, `openbb_fred.models.consumer_price_index`, `FREDConsumerPriceIndexFetcher`, `openbb_fred.models.dwpcr_rates`, `FREDDiscountWindowPrimaryCreditRateFetcher`, `openbb_fred.models.ecb_interest_rates`, `openbb_fred.models.euro_short_term_rate`
...
- `openbb_fred.models.ameribor`
- `openbb_fred.models.balance_of_payments`
- `openbb_fred.models.bond_indices`
- `openbb_fred.models.commercial_paper`
- `openbb_fred.models.commodity_spot_prices`
- `openbb_fred.models.consumer_price_index`
- `openbb_fred.models.dwpcr_rates`

## Notes
- Generated: 2025-11-18T07:54:39.896204
