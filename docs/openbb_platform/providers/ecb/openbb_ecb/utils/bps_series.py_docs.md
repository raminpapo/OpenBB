# File Documentation: bps_series.py

## Metadata
- **Path**: `openbb_platform/providers/ecb/openbb_ecb/utils/bps_series.py`
- **Size**: 16,521 bytes
- **Lines**: 251
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `bps_series.py`.

**Python Module**

- **Functions** (1): generate_bps_series_ids
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:16:48.797648Z
