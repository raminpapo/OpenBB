# File Documentation: yield_curve_series.py

## Metadata
- **Path**: `openbb_platform/providers/ecb/openbb_ecb/utils/yield_curve_series.py`
- **Size**: 5,350 bytes
- **Lines**: 128
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `yield_curve_series.py`.

**Python Module**

- **Functions** (1): get_yield_curve_ids
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:16:48.801958Z
