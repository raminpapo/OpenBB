...
- **Classes** (3): CftcCotSearchQueryParams, CftcCotSearchData, CftcCotSearchFetcher
...
- **`CftcCotSearchQueryParams`**(CotSearchQueryParams)
- **`CftcCotSearchData`**(CotSearchData)
- **`CftcCotSearchFetcher`**(Fetcher[CftcCotSearchQueryParams, list[CftcCotSearchData]])
...
**Generated**: 2025-11-19T02:16:48.663297Z
