# Documentation: openbb_platform/providers/cftc/openbb_cftc/models/cot.py

## File Metadata
- **Path**: `openbb_platform/providers/cftc/openbb_cftc/models/cot.py`
- **Size**: 7,752 characters, 202 lines
- **Words**: 616
- **Extension**: .py
...
**Classes** (3):
`CftcCotQueryParams`, `CftcCotData`, `CftcCotFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (19):
`datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.cot`, `COTData`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `datetime`, `timedelta`, `openbb_core.provider.utils.helpers`, `amake_request`, `error`


## Key Components

**Class `CftcCotQueryParams`**: CFTC Commitment of Traders Reports Query Parameters.

    Source: https://publicreporting.cftc.gov/stories/s/r4w3-av2u

**Class `CftcCotData`**: CFTC Commitment of Traders Reports Data.

**Class `CftcCotFetcher`**: CFTC Commitment of Traders Reports Fetcher.
...
- `openbb_core.provider.standard_models.cot`
...
## Notes
- Generated: 2025-11-18T07:54:37.575165
