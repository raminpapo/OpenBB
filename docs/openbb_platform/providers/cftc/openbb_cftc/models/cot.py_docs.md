...
- **Classes** (3): CftcCotQueryParams, CftcCotData, CftcCotFetcher
...
- **`CftcCotQueryParams`**(COTQueryParams)
- **`CftcCotData`**(COTData)
- **`CftcCotFetcher`**(Fetcher[CftcCotQueryParams, list[CftcCotData]])
...
**Generated**: 2025-11-19T02:16:48.660591Z
