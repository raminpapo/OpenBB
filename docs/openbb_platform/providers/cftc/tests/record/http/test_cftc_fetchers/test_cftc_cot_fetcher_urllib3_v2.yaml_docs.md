# Documentation: openbb_platform/providers/cftc/tests/record/http/test_cftc_fetchers/test_cftc_cot_fetcher_urllib3_v2.yaml

## File Metadata
- **Path**: `openbb_platform/providers/cftc/tests/record/http/test_cftc_fetchers/test_cftc_cot_fetcher_urllib3_v2.yaml`
- **Size**: 7,627 characters, 74 lines
- **Words**: 126
- **Extension**: .yaml
...
- request:
    ...
    headers:
      ...
      - keep-alive
    method: GET
    uri: https://publicreporting.cftc.gov/resource/jun7-fc8e.json?%24limit=MOCK_LIMIT&%24order=MOCK_ORDER&%24where=MOCK_WHERE
  response:
    body:
      string: !!binary |
        
        mORuv/2yTjd7hj+9dnV1eid1w7rN97Iq2Bonw3//+/bL/5C3Jc9HEgAA
    headers:
...
This is a .yaml file containing 74 lines of code.
...
## Notes
- Generated: 2025-11-18T07:54:37.589707
