# Documentation: openbb_platform/providers/congress_gov/openbb_congress_gov/router/congress_gov_router.py

## File Metadata
- **Path**: `openbb_platform/providers/congress_gov/openbb_congress_gov/router/congress_gov_router.py`
- **Size**: 8,383 characters, 253 lines
- **Words**: 742
- **Extension**: .py
...
**Functions** (4):
`bills`, `bill_text_urls`, `bill_info`, `bill_text`

**Imports** (23):
`fastapi.exceptions`, `HTTPException`, `openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `openbb_core.app.service.system_service`, `SystemService`, `the`, `the`, `openbb_congress_gov.utils.helpers`, `get_bill_text_choices`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:37.604557
