# Documentation: openbb_platform/providers/congress_gov/openbb_congress_gov/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/congress_gov/openbb_congress_gov/utils/helpers.py`
- **Size**: 16,180 characters, 488 lines
- **Words**: 1,686
- **Extension**: .py
...
**Functions** (9):
`__init__`, `year_to_congress`, `check_api_key`, `download_bills`, `get_bills_by_type`, `get_all_bills_by_type`, `response_callback`, `get_bill_choices`, `get_bill_text_choices`

**Imports** (31):
`typing`, `Literal`, `fastapi.exceptions`, `HTTPException`, `openbb_congress_gov.utils.constants`, `BillTypes`, `openbb_core.app.model.abstract.singleton`, `SingletonMeta`, `openbb_core.provider.utils.errors`, `UnauthorizedError`, `openbb_core.app.service.user_service`, `UserSettings`, `pydantic`, `SecretStr`, `base64`, `io`, `BytesIO`, `openbb_core.provider.utils.helpers`, `make_request`, `the`


## Key Components

**Class `BillsState`**: Singleton class to manage application cache.
...
## Notes
- Generated: 2025-11-18T07:54:37.609812
