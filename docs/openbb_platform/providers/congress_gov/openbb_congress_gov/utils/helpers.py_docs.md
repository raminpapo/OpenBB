...
- **Classes** (2): BillsState, to
- **Functions** (9): __init__, year_to_congress, check_api_key, download_bills, get_bills_by_type, get_all_bills_by_type, response_callback, get_bill_choices, get_bill_text_choices
- **Import Statements**: 9
...
- **`BillsState`**(metaclass=SingletonMeta)
...
**Generated**: 2025-11-19T02:16:48.704371Z
