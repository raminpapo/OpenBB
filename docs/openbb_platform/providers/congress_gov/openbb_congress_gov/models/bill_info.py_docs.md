# File Documentation: bill_info.py
...
This is a **python** file named `bill_info.py`.

**Python Module**

- **Classes** (3): CongressBillInfoQueryParams, CongressBillInfoData, CongressBillInfoFetcher
- **Functions** (6): transform_query, aextract_data, transform_data, html_to_markdown, ul_replacer, ol_replacer
- **Import Statements**: 3
...
- **`CongressBillInfoQueryParams`**(QueryParams)
- **`CongressBillInfoData`**(Data)
...
**Generated**: 2025-11-19T02:16:48.689846Z
