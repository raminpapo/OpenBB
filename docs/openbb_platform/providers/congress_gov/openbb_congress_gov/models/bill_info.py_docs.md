# Documentation: openbb_platform/providers/congress_gov/openbb_congress_gov/models/bill_info.py

## File Metadata
- **Path**: `openbb_platform/providers/congress_gov/openbb_congress_gov/models/bill_info.py`
- **Size**: 16,340 characters, 397 lines
- **Words**: 1,291
- **Extension**: .py
...
**Classes** (3):
`CongressBillInfoQueryParams`, `CongressBillInfoData`, `CongressBillInfoFetcher`

**Functions** (6):
`transform_query`, `aextract_data`, `transform_data`, `html_to_markdown`, `ul_replacer`, `ol_replacer`

**Imports** (20):
`typing`, `Any`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `pydantic`, `ConfigDict`, `the`, `the`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `UnauthorizedError`, `openbb_core.provider.utils.helpers`, `amake_request`, `re`, `text`


## Key Components

**Class `CongressBillInfoQueryParams`**: Congress Gov Bills Info Query.

**Class `CongressBillInfoData`**: Congress Gov Bills Info Data.

**Class `CongressBillInfoFetcher`**: Congress Gov Bills Info Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:37.597597
