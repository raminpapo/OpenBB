# File Documentation: congress_bills.py
...
This is a **python** file named `congress_bills.py`.

**Python Module**

- **Classes** (3): CongressBillsQueryParams, CongressBillsData, CongressBillsFetcher
- **Functions** (4): validate_query, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`CongressBillsQueryParams`**(QueryParams)
- **`CongressBillsData`**(Data)
...
**Generated**: 2025-11-19T02:16:48.695010Z
