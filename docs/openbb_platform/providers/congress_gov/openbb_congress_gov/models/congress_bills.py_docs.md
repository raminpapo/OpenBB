# Documentation: openbb_platform/providers/congress_gov/openbb_congress_gov/models/congress_bills.py

## File Metadata
- **Path**: `openbb_platform/providers/congress_gov/openbb_congress_gov/models/congress_bills.py`
- **Size**: 12,215 characters, 337 lines
- **Words**: 1,113
- **Extension**: .py
...
**Classes** (3):
`CongressBillsQueryParams`, `CongressBillsData`, `CongressBillsFetcher`

**Functions** (4):
`validate_query`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (27):
`datetime`, `typing`, `Any`, `openbb_congress_gov.utils.constants`, `openbb_congress_gov.utils.helpers`, `year_to_congress`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `pydantic`, `ConfigDict`, `the`, `the`


## Key Components

**Class `CongressBillsQueryParams`**: Congress Bills Query Parameters.

**Class `CongressBillsData`**: Congress Bills Data.

**Class `CongressBillsFetcher`**: Transform the query, extract and transform the data from the Congress API.
...
- `datetime`
- `typing`
- `openbb_congress_gov.utils.constants`
...
## Notes
- Generated: 2025-11-18T07:54:37.601448
