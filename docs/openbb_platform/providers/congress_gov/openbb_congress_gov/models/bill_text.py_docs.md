# Documentation: openbb_platform/providers/congress_gov/openbb_congress_gov/models/bill_text.py

## File Metadata
- **Path**: `openbb_platform/providers/congress_gov/openbb_congress_gov/models/bill_text.py`
- **Size**: 4,736 characters, 145 lines
- **Words**: 388
- **Extension**: .py
...
**Classes** (3):
`CongressBillTextQueryParams`, `CongressBillTextData`, `CongressBillTextFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (16):
`typing`, `Any`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `pydantic`, `Field`, `the`, `base64`, `io`, `BytesIO`, `openbb_core.provider.utils.helpers`, `make_request`


## Key Components

**Class `CongressBillTextQueryParams`**: Congress Gov Bills Text Query.

**Class `CongressBillTextData`**: Congress Gov Bills Text Data.

**Class `CongressBillTextFetcher`**: Congress Gov Bills Text Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:37.599549
