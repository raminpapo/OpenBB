# Documentation: openbb_platform/providers/finra/openbb_finra/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/finra/openbb_finra/utils/helpers.py`
- **Size**: 5,787 characters, 186 lines
- **Words**: 594
- **Extension**: .py
...
**Functions** (6):
`get_finra_weeks`, `get_finra_data`, `get_full_data`, `get_adjusted_date`, `get_short_interest_dates`, `get_adjusted_date`

**Imports** (9):
`datetime`, `FINRA`, `openbb_core.provider.utils.helpers`, `make_request`, `FINRA.`, `openbb_core.provider.utils.helpers`, `make_request`, `FINRA.`, `July`
...
## Notes
- Generated: 2025-11-18T07:54:38.620887
