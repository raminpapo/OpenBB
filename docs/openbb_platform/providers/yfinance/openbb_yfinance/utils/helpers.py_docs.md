# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/utils/helpers.py`
- **Size**: 21,104 characters, 639 lines
- **Words**: 1,800
- **Extension**: .py
...
**Functions** (13):
`get_custom_screener`, `get_defined_screener`, `get_expiration_month`, `get_futures_data`, `get_futures_symbols`, `get_futures_quotes`, `suppress_all_output`, `get_historical_futures_prices`, `get_futures_curve`, `suppress_all_output`, `yf_download`, `df_transform_numbers`, `replace_suffix`

**Imports** (63):
`typing`, `TYPE_CHECKING`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_yfinance.utils.references`, `INTERVALS`, `datetime`, `date`, `pandas`, `DataFrame`, `openbb_core.provider.utils.helpers`, `curl_adapter`, `CurlCffiAdapter`, `pytz`, `timezone`, `yfinance.data`, `YfData`, `yfinance`, `curl_adapter`, `CurlCffiAdapter`
...
## Notes
- Generated: 2025-11-18T07:54:43.601806
