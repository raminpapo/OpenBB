...
- **Functions** (13): get_custom_screener, get_defined_screener, get_expiration_month, get_futures_data, get_futures_symbols, get_futures_quotes, suppress_all_output, get_historical_futures_prices, get_futures_curve, suppress_all_output ... and 3 more
...
- **`suppress_all_output()`**
- **`get_historical_futures_prices(
    symbols: list, start_date: "date", end_date: "date"
)`**
- **`suppress_all_output()`**
- **`replace_suffix(x, suffix, multiplier)`**
...
**Generated**: 2025-11-19T02:16:55.210335Z
