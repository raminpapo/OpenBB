# File Documentation: references.py
...
This is a **python** file named `references.py`.

**Python Module**

- **Classes** (1): YFPredefinedScreenerData
- **Functions** (2): _validate_percent_change, get_industry_sector
- **Import Statements**: 2
...
- **`YFPredefinedScreenerData`**(EquityPerformanceData)

#### Functions

- **`_validate_percent_change(cls, v)`**
- **`get_industry_sector(industry: str)`**
...
**Generated**: 2025-11-19T02:16:55.215435Z
