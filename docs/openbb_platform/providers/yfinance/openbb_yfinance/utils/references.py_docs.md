# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/utils/references.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/utils/references.py`
- **Size**: 47,610 characters, 1,388 lines
- **Words**: 4,283
- **Extension**: .py
...
**Functions** (2):
`_validate_percent_change`, `get_industry_sector`

**Imports** (8):
`datetime`, `datetime`, `typing`, `Literal`, `openbb_core.provider.standard_models.equity_performance`, `pydantic`, `Field`, `the`


## Key Components

**Class `YFPredefinedScreenerData`**: Yahoo Finance Predefined Screener Data.
...
## Notes
- Generated: 2025-11-18T07:54:43.605672
