# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/undervalued_growth_equities.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/undervalued_growth_equities.py`
- **Size**: 3,265 characters, 101 lines
- **Words**: 219
- **Extension**: .py
...
**Classes** (3):
`YFUndervaluedGrowthEquitiesQueryParams`, `YFUndervaluedGrowthEquitiesData`, `YFUndervaluedGrowthEquitiesFetcher`
...
**Class `YFUndervaluedGrowthEquitiesQueryParams`**: Yahoo Finance Undervalued Growth Stocks Query.

    Source: https://finance.yahoo.com/screener/predefined/undervalued_growth_stocks

**Class `YFUndervaluedGrowthEquitiesData`**: Yahoo Finance Undervalued Growth Stocks Data.

**Class `YFUndervaluedGrowthEquitiesFetcher`**: Yahoo Finance Undervalued Growth Stocks Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.594788
