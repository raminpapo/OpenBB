# File Documentation: undervalued_growth_equities.py
...
This is a **python** file named `undervalued_growth_equities.py`.

**Python Module**

- **Classes** (3): YFUndervaluedGrowthEquitiesQueryParams, YFUndervaluedGrowthEquitiesData, YFUndervaluedGrowthEquitiesFetcher
...
- **`YFUndervaluedGrowthEquitiesQueryParams`**(EquityPerformanceQueryParams)
- **`YFUndervaluedGrowthEquitiesData`**(YFPredefinedScreenerData)
...
**Generated**: 2025-11-19T02:16:55.202344Z
