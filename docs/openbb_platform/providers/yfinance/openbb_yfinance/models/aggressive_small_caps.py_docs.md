# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/aggressive_small_caps.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/aggressive_small_caps.py`
- **Size**: 3,119 characters, 90 lines
- **Words**: 231
- **Extension**: .py
...
**Classes** (3):
`YFAggressiveSmallCapsQueryParams`, `YFAggressiveSmallCapsData`, `YFAggressiveSmallCapsFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (13):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_performance`, `openbb_yfinance.utils.references`, `YFPredefinedScreenerData`, `pydantic`, `Field`, `the`, `YF.`, `openbb_yfinance.utils.helpers`, `get_custom_screener`


## Key Components

**Class `YFAggressiveSmallCapsQueryParams`**: Yahoo Finance Aggressive Small Caps Query.

    Source: https://finance.yahoo.com/screener/predefined/aggressive_small_caps

**Class `YFAggressiveSmallCapsData`**: Yahoo Finance Aggressive Small Caps Data.

**Class `YFAggressiveSmallCapsFetcher`**: Transform the query, extract and transform the data from the Yahoo Finance endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:43.553172
