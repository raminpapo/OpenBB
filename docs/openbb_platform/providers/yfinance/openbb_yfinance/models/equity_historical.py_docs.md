# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/equity_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/equity_historical.py`
- **Size**: 5,890 characters, 194 lines
- **Words**: 443
- **Extension**: .py
...
**Classes** (3):
`YFinanceEquityHistoricalQueryParams`, `YFinanceEquityHistoricalData`, `YFinanceEquityHistoricalFetcher`

**Functions** (3):
`transform_query`, `extract_data`, `transform_data`

**Imports** (25):
`datetime`, `datetime`, `typing`, `TYPE_CHECKING`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_yfinance.utils.references`, `INTERVALS_DICT`, `pydantic`, `Field`, `pandas`, `DataFrame`, `the`


## Key Components

**Class `YFinanceEquityHistoricalQueryParams`**: Yahoo Finance Equity Historical Price Query.

    Source: https://finance.yahoo.com/

**Class `YFinanceEquityHistoricalData`**: Yahoo Finance Equity Historical Price Data.

**Class `YFinanceEquityHistoricalFetcher`**: Transform the query, extract and transform the data from the Yahoo Finance endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:43.563995
