...
- **Classes** (3): YFinanceEquityHistoricalQueryParams, YFinanceEquityHistoricalData, YFinanceEquityHistoricalFetcher
...
- **`YFinanceEquityHistoricalQueryParams`**(EquityHistoricalQueryParams)
- **`YFinanceEquityHistoricalData`**(EquityHistoricalData)
...
**Generated**: 2025-11-19T02:16:55.166851Z
