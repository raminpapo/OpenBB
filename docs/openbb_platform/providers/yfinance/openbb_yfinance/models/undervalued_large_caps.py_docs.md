# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/undervalued_large_caps.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/undervalued_large_caps.py`
- **Size**: 3,166 characters, 97 lines
- **Words**: 214
- **Extension**: .py
...
**Classes** (3):
`YFUndervaluedLargeCapsQueryParams`, `YFUndervaluedLargeCapsData`, `YFUndervaluedLargeCapsFetcher`
...
**Class `YFUndervaluedLargeCapsQueryParams`**: Yahoo Finance Undervalued Large Caps Query.

    Source: https://finance.yahoo.com/screener/predefined/undervalued_large_caps

**Class `YFUndervaluedLargeCapsData`**: Yahoo Finance Undervalued Large Caps Data.

**Class `YFUndervaluedLargeCapsFetcher`**: Yahoo Finance Undervalued Large Caps Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.596361
