# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/etf_info.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/etf_info.py`
- **Size**: 11,347 characters, 333 lines
- **Words**: 952
- **Extension**: .py
...
**Classes** (3):
`YFinanceEtfInfoQueryParams`, `YFinanceEtfInfoData`, `YFinanceEtfInfoFetcher`

**Functions** (5):
`validate_date`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (22):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.etf_info`, `pydantic`, `Field`, `datetime`, `datetime`, `YFinance.`, `asyncio`, `curl_adapter`, `CurlCffiAdapter`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `warnings`, `warn`


## Key Components

**Class `YFinanceEtfInfoQueryParams`**: YFinance ETF Info Query.

**Class `YFinanceEtfInfoData`**: YFinance ETF Info Data.

**Class `YFinanceEtfInfoFetcher`**: YFinance ETF Info fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.571989
