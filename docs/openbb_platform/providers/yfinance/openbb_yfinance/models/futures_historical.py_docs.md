...
- **Classes** (3): YFinanceFuturesHistoricalQueryParams, YFinanceFuturesHistoricalData, YFinanceFuturesHistoricalFetcher
...
- **`YFinanceFuturesHistoricalQueryParams`**(FuturesHistoricalQueryParams)
- **`YFinanceFuturesHistoricalData`**(FuturesHistoricalData)
...
**Generated**: 2025-11-19T02:16:55.178690Z
