# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/options_chains.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/options_chains.py`
- **Size**: 7,322 characters, 192 lines
- **Words**: 477
- **Extension**: .py
...
**Classes** (3):
`YFinanceOptionsChainsQueryParams`, `YFinanceOptionsChainsData`, `YFinanceOptionsChainsFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_chain`, `transform_data`

**Imports** (31):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.options_chains`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `YFinance.`, `asyncio`, `curl_adapter`, `CurlCffiAdapter`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `YFinanceOptionsChainsQueryParams`**: YFinance Options Chains Query Parameters.

**Class `YFinanceOptionsChainsData`**: YFinance Options Chains Data.

**Class `YFinanceOptionsChainsFetcher`**: YFinance Options Chains Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.589484
