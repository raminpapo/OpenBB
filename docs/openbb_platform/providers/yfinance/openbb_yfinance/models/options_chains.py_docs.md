...
- **Classes** (3): YFinanceOptionsChainsQueryParams, YFinanceOptionsChainsData, YFinanceOptionsChainsFetcher
- **Functions** (4): transform_query, aextract_data, get_chain, transform_data
- **Import Statements**: 5
...
- **`YFinanceOptionsChainsQueryParams`**(OptionsChainsQueryParams)
- **`YFinanceOptionsChainsData`**(OptionsChainsData)
...
**Generated**: 2025-11-19T02:16:55.195855Z
