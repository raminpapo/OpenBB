...
- **Classes** (3): YFinanceEquityQuoteQueryParams, YFinanceEquityQuoteData, YFinanceEquityQuoteFetcher
...
- **`YFinanceEquityQuoteQueryParams`**(EquityQuoteQueryParams)
- **`YFinanceEquityQuoteData`**(EquityQuoteData)
...
**Generated**: 2025-11-19T02:16:55.170849Z
