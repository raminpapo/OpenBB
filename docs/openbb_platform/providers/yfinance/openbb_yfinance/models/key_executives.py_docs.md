...
- **Classes** (3): YFinanceKeyExecutivesQueryParams, YFinanceKeyExecutivesData, YFinanceKeyExecutivesFetcher
...
- **`YFinanceKeyExecutivesQueryParams`**(KeyExecutivesQueryParams)
- **`YFinanceKeyExecutivesData`**(KeyExecutivesData)
...
**Generated**: 2025-11-19T02:16:55.189232Z
