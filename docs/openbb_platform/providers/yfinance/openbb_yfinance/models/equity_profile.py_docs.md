# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/equity_profile.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/equity_profile.py`
- **Size**: 6,989 characters, 212 lines
- **Words**: 536
- **Extension**: .py
...
**Classes** (3):
`YFinanceEquityProfileQueryParams`, `YFinanceEquityProfileData`, `YFinanceEquityProfileFetcher`

**Functions** (5):
`validate_first_trade_date`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (25):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_info`, `pydantic`, `Field`, `datetime`, `timezone`, `openbb_core.provider.utils.helpers`, `safe_fromtimestamp`, `YFinance.`, `asyncio`, `curl_adapter`, `CurlCffiAdapter`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `YFinanceEquityProfileQueryParams`**: YFinance Equity Profile Query.

**Class `YFinanceEquityProfileData`**: YFinance Equity Profile Data.

**Class `YFinanceEquityProfileFetcher`**: YFinance Equity Profile fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.566115
