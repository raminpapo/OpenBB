...
- **Classes** (3): YFinanceEquityProfileQueryParams, YFinanceEquityProfileData, YFinanceEquityProfileFetcher
...
- **`YFinanceEquityProfileQueryParams`**(EquityInfoQueryParams)
- **`YFinanceEquityProfileData`**(EquityInfoData)
...
**Generated**: 2025-11-19T02:16:55.168844Z
