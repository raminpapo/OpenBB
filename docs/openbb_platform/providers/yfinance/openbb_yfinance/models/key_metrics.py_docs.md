# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/key_metrics.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/key_metrics.py`
- **Size**: 11,790 characters, 344 lines
- **Words**: 909
- **Extension**: .py
...
**Classes** (3):
`YFinanceKeyMetricsQueryParams`, `YFinanceKeyMetricsData`, `YFinanceKeyMetricsFetcher`

**Functions** (5):
`normalize_percent`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (21):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.key_metrics`, `pydantic`, `Field`, `YFinance.`, `asyncio`, `curl_adapter`, `CurlCffiAdapter`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `get_requests_session`, `warnings`, `warn`, `yfinance`


## Key Components

**Class `YFinanceKeyMetricsQueryParams`**: YFinance Key Metrics Query.

**Class `YFinanceKeyMetricsData`**: YFinance Key Metrics Data.

**Class `YFinanceKeyMetricsFetcher`**: YFinance Key Metrics fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.586324
