...
- **Classes** (3): YFinanceKeyMetricsQueryParams, YFinanceKeyMetricsData, YFinanceKeyMetricsFetcher
...
- **`YFinanceKeyMetricsQueryParams`**(KeyMetricsQueryParams)
- **`YFinanceKeyMetricsData`**(KeyMetricsData)
...
**Generated**: 2025-11-19T02:16:55.191110Z
