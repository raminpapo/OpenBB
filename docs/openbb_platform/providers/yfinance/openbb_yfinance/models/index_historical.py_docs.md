...
- **Classes** (3): YFinanceIndexHistoricalQueryParams, YFinanceIndexHistoricalData, YFinanceIndexHistoricalFetcher
...
- **`YFinanceIndexHistoricalQueryParams`**(IndexHistoricalQueryParams)
- **`YFinanceIndexHistoricalData`**(IndexHistoricalData)
...
**Generated**: 2025-11-19T02:16:55.187436Z
