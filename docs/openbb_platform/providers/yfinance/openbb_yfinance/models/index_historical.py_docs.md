# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/index_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/index_historical.py`
- **Size**: 4,518 characters, 155 lines
- **Words**: 328
- **Extension**: .py
...
**Classes** (3):
`YFinanceIndexHistoricalQueryParams`, `YFinanceIndexHistoricalData`, `YFinanceIndexHistoricalFetcher`

**Functions** (3):
`transform_query`, `extract_data`, `transform_data`

**Imports** (25):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.index_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_yfinance.utils.references`, `INDICES`, `pydantic`, `Field`, `the`, `dateutil.relativedelta`, `relativedelta`


## Key Components

**Class `YFinanceIndexHistoricalQueryParams`**: YFinance Index Historical Query.

    Source: https://finance.yahoo.com/world-indices

**Class `YFinanceIndexHistoricalData`**: YFinance Index Historical Data.

**Class `YFinanceIndexHistoricalFetcher`**: Transform the query, extract and transform the data from the Yahoo Finance endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:43.582702
