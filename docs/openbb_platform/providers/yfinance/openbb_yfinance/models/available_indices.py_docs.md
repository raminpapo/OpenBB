# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/available_indices.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/available_indices.py`
- **Size**: 2,111 characters, 69 lines
- **Words**: 169
- **Extension**: .py
...
**Classes** (3):
`YFinanceAvailableIndicesQueryParams`, `YFinanceAvailableIndicesData`, `YFinanceAvailableIndicesFetcher`

**Functions** (3):
`transform_query`, `extract_data`, `transform_data`

**Imports** (12):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.available_indices`, `openbb_yfinance.utils.references`, `INDICES`, `pydantic`, `Field`, `the`, `pandas`, `DataFrame`


## Key Components

**Class `YFinanceAvailableIndicesQueryParams`**: Yahoo Finance Available Indices Query.

    Source: https://finance.yahoo.com/

**Class `YFinanceAvailableIndicesData`**: Yahoo Finance Available Indices Data.

**Class `YFinanceAvailableIndicesFetcher`**: Transform the query, extract and transform the data from the Yahoo Finance endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:43.554652
