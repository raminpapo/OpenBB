# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/growth_tech_equities.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/growth_tech_equities.py`
- **Size**: 3,198 characters, 97 lines
- **Words**: 221
- **Extension**: .py
...
**Classes** (3):
`YFGrowthTechEquitiesQueryParams`, `YFGrowthTechEquitiesData`, `YFGrowthTechEquitiesFetcher`
...
**Class `YFGrowthTechEquitiesQueryParams`**: Yahoo Finance Growth Tech Stocks Query.

    Source: https://finance.yahoo.com/screener/predefined/growth_technology_stocks

**Class `YFGrowthTechEquitiesData`**: Yahoo Finance Growth Tech Stocks Data.

**Class `YFGrowthTechEquitiesFetcher`**: Transform the query, extract and transform the data from the Yahoo Finance endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:43.578576
