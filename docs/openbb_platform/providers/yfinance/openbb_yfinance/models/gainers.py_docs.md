# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/gainers.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/gainers.py`
- **Size**: 2,784 characters, 91 lines
- **Words**: 196
- **Extension**: .py
...
**Classes** (3):
`YFGainersQueryParams`, `YFGainersData`, `YFGainersFetcher`
...
**Class `YFGainersQueryParams`**: Yahoo Finance Gainers Query.

    Source: https://finance.yahoo.com/screener/predefined/day_gainers

**Class `YFGainersData`**: Yahoo Finance Gainers Data.

**Class `YFGainersFetcher`**: Yahoo Finance Gainers Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.577260
