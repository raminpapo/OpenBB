...
- **Classes** (3): YFinanceShareStatisticsQueryParams, YFinanceShareStatisticsData, YFinanceShareStatisticsFetcher
- **Functions** (5): validate_first_trade_date, transform_query, aextract_data, get_one, transform_data
- **Import Statements**: 4
...
- **`YFinanceShareStatisticsQueryParams`**(ShareStatisticsQueryParams)
- **`YFinanceShareStatisticsData`**(ShareStatisticsData)
...
- **`validate_first_trade_date(cls, v)`**
- **`get_one(symbol)`**
...
**Generated**: 2025-11-19T02:16:55.200098Z
