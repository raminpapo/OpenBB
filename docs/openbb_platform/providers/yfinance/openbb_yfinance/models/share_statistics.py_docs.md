# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/share_statistics.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/share_statistics.py`
- **Size**: 7,171 characters, 197 lines
- **Words**: 549
- **Extension**: .py
...
**Classes** (3):
`YFinanceShareStatisticsQueryParams`, `YFinanceShareStatisticsData`, `YFinanceShareStatisticsFetcher`

**Functions** (5):
`validate_first_trade_date`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (23):
`datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.share_statistics`, `pydantic`, `Field`, `UTC`, `YFinance.`, `asyncio`, `curl_adapter`, `CurlCffiAdapter`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `YFinanceShareStatisticsQueryParams`**: YFinance Share Statistics Query.

**Class `YFinanceShareStatisticsData`**: YFinance Share Statistics Data.

**Class `YFinanceShareStatisticsFetcher`**: YFinance Share Statistics Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.592720
