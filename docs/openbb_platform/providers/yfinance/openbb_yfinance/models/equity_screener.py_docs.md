...
- **Classes** (3): YFinanceEquityScreenerQueryParams, YFinanceEquityScreenerData, YFinanceEquityScreenerFetcher
...
- **`YFinanceEquityScreenerQueryParams`**(EquityScreenerQueryParams)
- **`YFinanceEquityScreenerData`**(EquityScreenerData, YFPredefinedScreenerData)
...
**Generated**: 2025-11-19T02:16:55.172640Z
