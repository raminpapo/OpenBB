# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/equity_screener.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/equity_screener.py`
- **Size**: 8,225 characters, 251 lines
- **Words**: 687
- **Extension**: .py
...
**Classes** (3):
`YFinanceEquityScreenerQueryParams`, `YFinanceEquityScreenerData`, `YFinanceEquityScreenerFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (14):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_screener`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_yfinance.utils.references`, `pydantic`, `Field`, `openbb_yfinance.utils.helpers`, `get_custom_screener`


## Key Components

**Class `YFinanceEquityScreenerQueryParams`**: YFinance Equity Screener Query.

**Class `YFinanceEquityScreenerData`**: YFinance Equity Screener Data.

**Class `YFinanceEquityScreenerFetcher`**: YFinance Equity Screener Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.569877
