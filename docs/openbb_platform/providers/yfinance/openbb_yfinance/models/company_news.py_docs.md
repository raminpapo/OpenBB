# Documentation: openbb_platform/providers/yfinance/openbb_yfinance/models/company_news.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/openbb_yfinance/models/company_news.py`
- **Size**: 3,925 characters, 118 lines
- **Words**: 293
- **Extension**: .py
...
**Classes** (3):
`YFinanceCompanyNewsQueryParams`, `YFinanceCompanyNewsData`, `YFinanceCompanyNewsFetcher`

**Functions** (5):
`_symbol_mandatory`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (17):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.company_news`, `pydantic`, `Field`, `the`, `asyncio`, `curl_adapter`, `CurlCffiAdapter`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `get_requests_session`, `yfinance`, `Ticker`


## Key Components

**Class `YFinanceCompanyNewsQueryParams`**: YFinance Company News Query.

    Source: https://finance.yahoo.com/news/

**Class `YFinanceCompanyNewsData`**: YFinance Company News Data.

**Class `YFinanceCompanyNewsFetcher`**: Transform the query, extract and transform the data from the Yahoo Finance endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:43.559444
