# Documentation: openbb_platform/providers/yfinance/tests/test_yfinance_fetchers.py

## File Metadata
- **Path**: `openbb_platform/providers/yfinance/tests/test_yfinance_fetchers.py`
- **Size**: 13,225 characters, 408 lines
- **Words**: 881
- **Extension**: .py
...
**Functions** (31):
`scrub_string`, `before_record_response`, `vcr_config`, `test_y_finance_crypto_historical_fetcher`, `test_y_finance_currency_historical_fetcher`, `test_y_finance_index_historical_fetcher`, `test_y_finance_equity_historical_fetcher`, `test_y_finance_historical_dividends_fetcher`, `test_y_finance_futures_historical_fetcher`, `test_y_finance_options_chains_fetcher`, `test_y_finance_futures_curve_fetcher`, `test_y_finance_company_news_fetcher`, `test_y_finance_balance_sheet_fetcher`, `test_y_finance_cash_flow_statement_fetcher`, `test_y_finance_income_statement_fetcher`, `test_y_finance_available_fetcher`, `test_y_finance_active_fetcher`, `test_y_finance_gainers_fetcher`, `test_y_finance_losers_fetcher`, `test_y_finance_undervalued_large_caps_fetcher`

**Imports** (58):
`datetime`, `date`, `pytest`, `openbb_core.app.service.user_service`, `UserService`, `openbb_yfinance.models.active`, `YFActiveFetcher`, `openbb_yfinance.models.aggressive_small_caps`, `YFAggressiveSmallCapsFetcher`, `openbb_yfinance.models.available_indices`, `YFinanceAvailableIndicesFetcher`, `openbb_yfinance.models.balance_sheet`, `YFinanceBalanceSheetFetcher`, `openbb_yfinance.models.cash_flow`, `YFinanceCashFlowStatementFetcher`, `openbb_yfinance.models.company_news`, `YFinanceCompanyNewsFetcher`, `openbb_yfinance.models.crypto_historical`, `YFinanceCryptoHistoricalFetcher`, `openbb_yfinance.models.currency_historical`
...
## Notes
- Generated: 2025-11-18T07:54:43.853681
