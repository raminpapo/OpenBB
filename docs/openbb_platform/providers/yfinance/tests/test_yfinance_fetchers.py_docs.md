# File Documentation: test_yfinance_fetchers.py

## Metadata
- **Path**: `openbb_platform/providers/yfinance/tests/test_yfinance_fetchers.py`
- **Size**: 13,225 bytes
- **Lines**: 408
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_yfinance_fetchers.py`.

**Python Module**

- **Functions** (31): scrub_string, before_record_response, vcr_config, test_y_finance_crypto_historical_fetcher, test_y_finance_currency_historical_fetcher, test_y_finance_index_historical_fetcher, test_y_finance_equity_historical_fetcher, test_y_finance_historical_dividends_fetcher, test_y_finance_futures_historical_fetcher, test_y_finance_options_chains_fetcher ... and 21 more
- **Import Statements**: 5
...
- **`vcr_config()`**
- **`test_y_finance_crypto_historical_fetcher(credentials=test_credentials)`**
- **`test_y_finance_currency_historical_fetcher(credentials=test_credentials)`**
- **`test_y_finance_index_historical_fetcher(credentials=test_credentials)`**
- **`test_y_finance_equity_historical_fetcher(credentials=test_credentials)`**
- **`test_y_finance_historical_dividends_fetcher(credentials=test_credentials)`**
- **`test_y_finance_futures_historical_fetcher(credentials=test_credentials)`**
- **`test_y_finance_options_chains_fetcher(credentials=test_credentials)`**
- **`test_y_finance_futures_curve_fetcher(credentials=test_credentials)`**
- **`test_y_finance_company_news_fetcher(credentials=test_credentials)`**
- **`test_y_finance_balance_sheet_fetcher(credentials=test_credentials)`**
- **`test_y_finance_cash_flow_statement_fetcher(credentials=test_credentials)`**
- **`test_y_finance_income_statement_fetcher(credentials=test_credentials)`**
- **`test_y_finance_available_fetcher(credentials=test_credentials)`**
- **`test_y_finance_active_fetcher(credentials=test_credentials)`**
- **`test_y_finance_gainers_fetcher(credentials=test_credentials)`**
- **`test_y_finance_losers_fetcher(credentials=test_credentials)`**
- **`test_y_finance_undervalued_large_caps_fetcher(credentials=test_credentials)`**
- **`test_y_finance_undervalued_growth_equities_fetcher(credentials=test_credentials)`**
- **`test_y_finance_aggressive_small_caps_fetcher(credentials=test_credentials)`**
- **`test_y_finance_growth_tech_equities_fetcher(credentials=test_credentials)`**
- **`test_y_finance_equity_profile_fetcher(credentials=test_credentials)`**
- **`test_y_finance_equity_quote_fetcher(credentials=test_credentials)`**
- **`test_y_finance_price_target_consensus_fetcher(credentials=test_credentials)`**
- **`test_y_finance_share_statistics_fetcher(credentials=test_credentials)`**
- **`test_y_finance_key_executives_fetcher(credentials=test_credentials)`**
- **`test_y_finance_key_metrics_fetcher(
    credentials=test_credentials,
)`**
- **`test_y_finance_etf_info_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:55.223849Z
