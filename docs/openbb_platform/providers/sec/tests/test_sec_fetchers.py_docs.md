# Documentation: openbb_platform/providers/sec/tests/test_sec_fetchers.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/tests/test_sec_fetchers.py`
- **Size**: 7,508 characters, 238 lines
- **Words**: 591
- **Extension**: .py
...
**Functions** (18):
`vcr_config`, `test_sec_symbol_map_fetcher`, `test_sec_schema_files_fetcher`, `test_sec_nport_disclosure_fetcher`, `test_sec_sic_search_fetcher`, `test_sec_equity_ftd_fetcher`, `test_sec_equity_search_fetcher`, `test_sec_company_filings_fetcher`, `test_sec_institutions_search_fetcher`, `test_sec_rss_litigation_fetcher`, `test_sec_cik_map_fetcher`, `test_sec_form_13FHR_fetcher`, `test_sec_compare_company_facts_fetcher`, `test_sec_latest_financial_reports_fetcher`, `test_sec_insider_trading_fetcher`, `test_sec_management_discussion_analysis_fetcher`, `test_sec_filing_fetcher`, `test_sec_htm_file_fetcher`

**Imports** (38):
`datetime`, `date`, `pytest`, `openbb_core.app.service.user_service`, `UserService`, `openbb_sec.models.cik_map`, `SecCikMapFetcher`, `openbb_sec.models.company_filings`, `SecCompanyFilingsFetcher`, `openbb_sec.models.compare_company_facts`, `SecCompareCompanyFactsFetcher`, `openbb_sec.models.equity_ftd`, `SecEquityFtdFetcher`, `openbb_sec.models.equity_search`, `SecEquitySearchFetcher`, `openbb_sec.models.form_13FHR`, `SecForm13FHRFetcher`, `openbb_sec.models.htm_file`, `SecHtmFileFetcher`, `openbb_sec.models.insider_trading`
...
## Notes
- Generated: 2025-11-18T07:54:41.646733
