# File Documentation: test_sec_fetchers.py

## Metadata
- **Path**: `openbb_platform/providers/sec/tests/test_sec_fetchers.py`
- **Size**: 7,508 bytes
- **Lines**: 238
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_sec_fetchers.py`.

**Python Module**

- **Functions** (18): vcr_config, test_sec_symbol_map_fetcher, test_sec_schema_files_fetcher, test_sec_nport_disclosure_fetcher, test_sec_sic_search_fetcher, test_sec_equity_ftd_fetcher, test_sec_equity_search_fetcher, test_sec_company_filings_fetcher, test_sec_institutions_search_fetcher, test_sec_rss_litigation_fetcher ... and 8 more
- **Import Statements**: 2
...
- **`vcr_config()`**
- **`test_sec_symbol_map_fetcher(credentials=test_credentials)`**
- **`test_sec_schema_files_fetcher(credentials=test_credentials)`**
- **`test_sec_nport_disclosure_fetcher(credentials=test_credentials)`**
- **`test_sec_sic_search_fetcher(credentials=test_credentials)`**
- **`test_sec_equity_ftd_fetcher(credentials=test_credentials)`**
- **`test_sec_equity_search_fetcher(credentials=test_credentials)`**
- **`test_sec_company_filings_fetcher(credentials=test_credentials)`**
- **`test_sec_institutions_search_fetcher(credentials=test_credentials)`**
- **`test_sec_rss_litigation_fetcher(credentials=test_credentials)`**
- **`test_sec_cik_map_fetcher(credentials=test_credentials)`**
- **`test_sec_form_13FHR_fetcher(credentials=test_credentials)`**
- **`test_sec_compare_company_facts_fetcher(credentials=test_credentials)`**
- **`test_sec_latest_financial_reports_fetcher(credentials=test_credentials)`**
- **`test_sec_insider_trading_fetcher(credentials=test_credentials)`**
- **`test_sec_management_discussion_analysis_fetcher(credentials=test_credentials)`**
- **`test_sec_filing_fetcher(credentials=test_credentials)`**
- **`test_sec_htm_file_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:52.037099Z
