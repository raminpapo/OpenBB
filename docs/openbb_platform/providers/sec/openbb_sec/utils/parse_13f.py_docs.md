# Documentation: openbb_platform/providers/sec/openbb_sec/utils/parse_13f.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/utils/parse_13f.py`
- **Size**: 8,114 characters, 232 lines
- **Words**: 825
- **Extension**: .py
...
**Functions** (8):
`date_to_quarter_end`, `get_13f_candidates`, `complete_submission_callback`, `get_complete_submission`, `parse_header`, `get_submission_type`, `get_period_ending`, `parse_13f_hr`

**Imports** (31):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `pandas`, `to_datetime`, `pandas.tseries.offsets`, `QuarterEnd`, `openbb_sec.models.company_filings`, `SecCompanyFilingsFetcher`, `pandas`, `DataFrame`, `the`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_sec.utils.definitions`, `HEADERS`, `xmltodict`, `bs4`, `BeautifulSoup`
...
## Notes
- Generated: 2025-11-18T07:54:40.634464
