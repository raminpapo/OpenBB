# File Documentation: parse_13f.py
...
This is a **python** file named `parse_13f.py`.

**Python Module**

- **Functions** (8): date_to_quarter_end, get_13f_candidates, complete_submission_callback, get_complete_submission, parse_header, get_submission_type, get_period_ending, parse_13f_hr
- **Import Statements**: 6
...
- **`get_13f_candidates(symbol: str | None = None, cik: str | None = None)`**
- **`complete_submission_callback(response, _)`**
- **`get_complete_submission(url: str)`**
- **`get_submission_type(filing_str: str)`**
- **`get_period_ending(filing_str: str)`**
- **`parse_13f_hr(filing: str)`**
...
**Generated**: 2025-11-19T02:16:52.033148Z
