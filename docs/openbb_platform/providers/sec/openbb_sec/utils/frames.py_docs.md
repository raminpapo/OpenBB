# Documentation: openbb_platform/providers/sec/openbb_sec/utils/frames.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/utils/frames.py`
- **Size**: 11,630 characters, 287 lines
- **Words**: 1,292
- **Extension**: .py
...
**Functions** (4):
`fetch_data`, `get_frame`, `get_concept`, `get_one`

**Imports** (33):
`asyncio`, `datetime`, `datetime`, `warnings`, `warn`, `aiohttp_client_cache`, `SQLiteBackend`, `aiohttp_client_cache.session`, `CachedSession`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.utils`, `get_user_cache_directory`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_sec.utils.definitions`, `openbb_sec.utils.helpers`, `get_all_companies`
...
## Notes
- Generated: 2025-11-18T07:54:40.628831
