# Documentation: openbb_platform/providers/sec/openbb_sec/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/utils/helpers.py`
- **Size**: 13,170 characters, 361 lines
- **Words**: 1,296
- **Extension**: .py
...
**Functions** (14):
`sec_callback`, `get_all_companies`, `get_all_ciks`, `callback`, `get_mf_and_etf_map`, `search_institutions`, `symbol_map`, `cik_map`, `get_schema_filelist`, `download_zip_file`, `callback`, `get_ftd_urls`, `get_series_id`, `get_nport_candidates`

**Imports** (27):
`aiohttp_client_cache`, `SQLiteBackend`, `aiohttp_client_cache.session`, `CachedSession`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.utils`, `get_user_cache_directory`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_sec.utils.definitions`, `HEADERS`, `pandas`, `DataFrame`, `the`, `pandas`, `read_html`, `URLs.`, `io`, `BytesIO`


## Key Components

**Class `IDs`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:40.631775
