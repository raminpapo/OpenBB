# Documentation: openbb_platform/providers/sec/openbb_sec/utils/form4.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/utils/form4.py`
- **Size**: 23,809 characters, 648 lines
- **Words**: 1,923
- **Extension**: .py
...
**Functions** (15):
`get_logger`, `setup_database`, `add_missing_column`, `compress_db`, `decompress_db`, `close_db`, `get_form_4_urls`, `clean_xml`, `get_form_4_data`, `response_callback`, `parse_form_4_data`, `download_data`, `get_one`, `get_cached_data`, `get_form_4`

**Imports** (41):
`the`, `logging`, `datetime`, `date`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `voting`, `gzip`, `shutil`, `gzip`, `shutil`, `os`, `openbb_sec.models.company_filings`, `SecCompanyFilingsFetcher`, `re`, `warnings`, `warn`, `xmltodict`, `parse`, `openbb_core.provider.utils.helpers`
...
## Notes
- Generated: 2025-11-18T07:54:40.626023
