...
- **Classes** (3): SecCompareCompanyFactsQueryParams, SecCompareCompanyFactsData, SecCompareCompanyFactsFetcher
- **Functions** (4): validate_fact, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`SecCompareCompanyFactsQueryParams`**(CompareCompanyFactsQueryParams)
- **`SecCompareCompanyFactsData`**(CompareCompanyFactsData)
...
**Generated**: 2025-11-19T02:16:51.973374Z
