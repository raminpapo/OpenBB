# Documentation: openbb_platform/providers/sec/openbb_sec/models/compare_company_facts.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/models/compare_company_facts.py`
- **Size**: 6,995 characters, 191 lines
- **Words**: 695
- **Extension**: .py
...
**Classes** (3):
`SecCompareCompanyFactsQueryParams`, `SecCompareCompanyFactsData`, `SecCompareCompanyFactsFetcher`

**Functions** (4):
`validate_fact`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (21):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.compare_company_facts`, `openbb_core.provider.utils.descriptions`, `DATA_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_sec.utils.definitions`, `pydantic`, `Field`, `quarter`, `the`, `the`, `openbb_sec.utils.frames`


## Key Components

**Class `SecCompareCompanyFactsQueryParams`**: SEC Compare Company Facts Query.

    Source: https://www.sec.gov/edgar/sec-api-documentation

    The xbrl/frames API aggregates one fact for each reporting entity
    that is last filed that most cl

**Class `SecCompareCompanyFactsData`**: SEC Compare Company Facts Data.

**Class `SecCompareCompanyFactsFetcher`**: SEC Compare Company Facts Fetcher.
...
- `openbb_core.provider.standard_models.compare_company_facts`
- `openbb_core.provider.utils.descriptions`
- `openbb_core.provider.utils.errors`
- `openbb_sec.utils.definitions`
- `pydantic`
- `openbb_sec.utils.frames`

## Notes
- Generated: 2025-11-18T07:54:40.587062
