# File Documentation: sec_filing.py
...
This is a **python** file named `sec_filing.py`.

**Python Module**

- **Classes** (4): SecFilingQueryParams, SecFilingData, SecBaseFiling, SecFilingFetcher
- **Functions** (26): base_url, name, cik, trading_symbols, sic, sic_organization_name, filing_date, period_ending, fiscal_year_end, document_type ... and 16 more
...
- **`SecFilingQueryParams`**(QueryParams)
- **`SecFilingData`**(Data)
- **`SecBaseFiling`**(Data)
- **`SecFilingFetcher`**(Fetcher[SecFilingQueryParams, SecFilingData])

#### Functions

- **`__init__(self, url: str, use_cache: bool = True)`**
- **`_adownload_file(url, use_cache: bool = True)`**
- **`download_file(url, read_html_table: bool = False, use_cache: bool = True)`**
- **`_download_index_headers(
        self,
    )`**
- **`document_to_dict(doc)`**
- **`_download_cover_page(
        self,
    )`**
- **`__repr__(self)`**
...
computed_field, property, staticmethod
...
**Generated**: 2025-11-19T02:16:52.008250Z
