# Documentation: openbb_platform/providers/sec/openbb_sec/models/insider_trading.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/models/insider_trading.py`
- **Size**: 8,294 characters, 220 lines
- **Words**: 852
- **Extension**: .py
...
**Classes** (3):
`SecInsiderTradingQueryParams`, `SecInsiderTradingData`, `SecInsiderTradingFetcher`

**Functions** (8):
`_to_upper`, `_map_ownership_type`, `_map_acquisition_disposition`, `_map_transaction_code`, `_map_timeliness`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (18):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.insider_trading`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `pydantic`, `Field`, `voting`, `being`, `datetime`, `datetime`, `the`, `openbb_sec.utils.form4`, `get_form_4`


## Key Components

**Class `SecInsiderTradingQueryParams`**: SEC Insider Trading Query Params.

    Source: https://www.sec.gov/Archives/edgar/data/

**Class `SecInsiderTradingData`**: SEC Insider Trading Data.

**Class `SecInsiderTradingFetcher`**: SEC Insider Trading Fetcher.
...
- `openbb_core.provider.standard_models.insider_trading`
- `openbb_core.provider.utils.descriptions`
- `pydantic`
- `datetime`
- `openbb_sec.utils.form4`

## Notes
- Generated: 2025-11-18T07:54:40.594300
