# File Documentation: insider_trading.py
...
This is a **python** file named `insider_trading.py`.

**Python Module**

- **Classes** (3): SecInsiderTradingQueryParams, SecInsiderTradingData, SecInsiderTradingFetcher
- **Functions** (8): _to_upper, _map_ownership_type, _map_acquisition_disposition, _map_transaction_code, _map_timeliness, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`SecInsiderTradingQueryParams`**(InsiderTradingQueryParams)
- **`SecInsiderTradingData`**(InsiderTradingData)
...
- **`_to_upper(cls, v)`**
- **`_map_ownership_type(cls, v)`**
- **`_map_acquisition_disposition(cls, v)`**
- **`_map_transaction_code(cls, v)`**
- **`_map_timeliness(cls, v)`**
...
**Generated**: 2025-11-19T02:16:51.981691Z
