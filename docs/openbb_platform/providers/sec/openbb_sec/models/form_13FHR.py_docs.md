# File Documentation: form_13FHR.py
...
This is a **python** file named `form_13FHR.py`.

**Python Module**

- **Classes** (3): SecForm13FHRQueryParams, SecForm13FHRData, SecForm13FHRFetcher
- **Functions** (4): transform_query, aextract_data, get_filing, transform_data
- **Import Statements**: 4
...
- **`SecForm13FHRQueryParams`**(Form13FHRQueryParams)
- **`SecForm13FHRData`**(Form13FHRData)
- **`SecForm13FHRFetcher`**(Fetcher[SecForm13FHRQueryParams, list[SecForm13FHRData]])
...
**Generated**: 2025-11-19T02:16:51.978392Z
