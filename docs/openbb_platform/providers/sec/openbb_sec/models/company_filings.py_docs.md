# Documentation: openbb_platform/providers/sec/openbb_sec/models/company_filings.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/models/company_filings.py`
- **Size**: 12,201 characters, 336 lines
- **Words**: 1,048
- **Extension**: .py
...
**Classes** (3):
`SecCompanyFilingsQueryParams`, `SecCompanyFilingsData`, `SecCompanyFilingsFetcher`

**Functions** (6):
`validate_form_type`, `validate_report_date`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (36):
`datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.company_filings`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_sec.utils.definitions`, `FORM_LIST`, `pydantic`, `Field`, `the`, `aiohttp_client_cache`


## Key Components

**Class `SecCompanyFilingsQueryParams`**: SEC Company Filings Query.

    Source: https://sec.gov/

**Class `SecCompanyFilingsData`**: SEC Company Filings Data.

**Class `SecCompanyFilingsFetcher`**: SEC Company Filings Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.585184
