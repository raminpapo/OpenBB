...
- **Classes** (3): SecCompanyFilingsQueryParams, SecCompanyFilingsData, SecCompanyFilingsFetcher
- **Functions** (6): validate_form_type, validate_report_date, transform_query, aextract_data, callback, transform_data
- **Import Statements**: 4
...
- **`SecCompanyFilingsQueryParams`**(CompanyFilingsQueryParams)
- **`SecCompanyFilingsData`**(CompanyFilingsData)
...
- **`validate_form_type(cls, v)`**
- **`validate_report_date(cls, v: str | dateType | None)`**
...
**Generated**: 2025-11-19T02:16:51.970789Z
