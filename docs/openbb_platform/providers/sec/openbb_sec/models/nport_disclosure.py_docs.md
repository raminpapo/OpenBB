...
- **Classes** (3): SecNportDisclosureQueryParams, SecNportDisclosureData, SecNportDisclosureFetcher
- **Functions** (6): normalize_percent, replace_zero, transform_query, aextract_data, callback, transform_data
- **Import Statements**: 5
...
- **`SecNportDisclosureQueryParams`**(NportDisclosureQueryParams)
- **`SecNportDisclosureData`**(NportDisclosureData)
...
aggrVal, centralCounterparty, classmethod, collateralCd, curCd, derivCat, desc, exchangeRt, field_validator, fixedOrFloating, floatingRtIndex, floatingRtSpread, invstCat, isCleared, isLoanByFund, lei, loanVal, model_validator, name, netRealizedGain, netUnrealizedAppr, pmntAmt, principalCd, rateTenor, rateTenorUnit, redemption, resetDt, resetDtUnit, rtn1, rtn2, rtn3, sales, staticmethod, value
...
**Generated**: 2025-11-19T02:16:51.998772Z
