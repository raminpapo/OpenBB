# File Documentation: htm_file.py
...
This is a **python** file named `htm_file.py`.

**Python Module**

- **Classes** (3): SecHtmFileQueryParams, SecHtmFileData, SecHtmFileFetcher
...
- **`SecHtmFileQueryParams`**(QueryParams)
- **`SecHtmFileData`**(Data)
- **`SecHtmFileFetcher`**(Fetcher[SecHtmFileQueryParams, SecHtmFileData])
...
**Generated**: 2025-11-19T02:16:51.979942Z
