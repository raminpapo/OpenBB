# Documentation: openbb_platform/providers/sec/openbb_sec/models/htm_file.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/models/htm_file.py`
- **Size**: 3,107 characters, 98 lines
- **Words**: 284
- **Extension**: .py
...
**Classes** (3):
`SecHtmFileQueryParams`, `SecHtmFileData`, `SecHtmFileFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (17):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `pydantic`, `Field`, `the`, `openbb_sec.models.sec_filing`, `SecBaseFiling`, `bs4`, `BeautifulSoup`


## Key Components

**Class `SecHtmFileQueryParams`**: SEC HTM File Query Parameters.

**Class `SecHtmFileData`**: SEC HTM File Data.

**Class `SecHtmFileFetcher`**: SEC HTM File Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.592821
