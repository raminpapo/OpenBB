# Documentation: openbb_platform/providers/sec/openbb_sec/models/equity_search.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/models/equity_search.py`
- **Size**: 2,811 characters, 92 lines
- **Words**: 213
- **Extension**: .py
...
**Classes** (3):
`SecEquitySearchQueryParams`, `SecEquitySearchData`, `SecEquitySearchFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (11):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_search`, `pydantic`, `Field`, `the`, `openbb_sec.utils.helpers`, `pandas`, `DataFrame`


## Key Components

**Class `SecEquitySearchQueryParams`**: SEC Equity Search Query.

    Source: https://sec.gov/

**Class `SecEquitySearchData`**: SEC Equity Search Data.

**Class `SecEquitySearchFetcher`**: SEC Equity Search Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.590030
