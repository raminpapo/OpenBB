# File Documentation: schema_files.py
...
This is a **python** file named `schema_files.py`.

**Python Module**

- **Classes** (3): SecSchemaFilesQueryParams, SecSchemaFilesData, SecSchemaFilesFetcher
...
- **`SecSchemaFilesQueryParams`**(CotSearchQueryParams)
- **`SecSchemaFilesData`**(Data)
- **`SecSchemaFilesFetcher`**(Fetcher[SecSchemaFilesQueryParams, SecSchemaFilesData])
...
**Generated**: 2025-11-19T02:16:52.005715Z
