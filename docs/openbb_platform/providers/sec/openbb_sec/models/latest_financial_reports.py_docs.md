...
- **Classes** (3): SecLatestFinancialReportsQueryParams, SecLatestFinancialReportsData, SecLatestFinancialReportsFetcher
- **Functions** (6): validate_report_type, transform_query, aextract_data, get_url, transform_data, parse_entry
- **Import Statements**: 4
...
- **`SecLatestFinancialReportsQueryParams`**(LatestFinancialReportsQueryParams)
- **`SecLatestFinancialReportsData`**(LatestFinancialReportsData)
...
- **`validate_report_type(cls, v)`**
- **`get_url(date, offset)`**
- **`parse_entry(entry)`**

#### Decorators Used

classmethod, fakecompany, field_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.985977Z
