# Documentation: openbb_platform/providers/sec/openbb_sec/models/latest_financial_reports.py

## File Metadata
- **Path**: `openbb_platform/providers/sec/openbb_sec/models/latest_financial_reports.py`
- **Size**: 9,254 characters, 262 lines
- **Words**: 706
- **Extension**: .py
...
**Classes** (3):
`SecLatestFinancialReportsQueryParams`, `SecLatestFinancialReportsData`, `SecLatestFinancialReportsFetcher`

**Functions** (6):
`validate_report_type`, `transform_query`, `aextract_data`, `get_url`, `transform_data`, `parse_entry`

**Imports** (23):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.latest_financial_reports`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `datetime`, `timedelta`, `openbb_core.provider.utils.helpers`, `amake_request`


## Key Components

**Class `SecLatestFinancialReportsQueryParams`**: SEC Latest Financial Reports Query.

    source: https://www.sec.gov/edgar/search/

**Class `SecLatestFinancialReportsData`**: SEC Latest Financial Reports Data.

**Class `SecLatestFinancialReportsFetcher`**: SEC Latest Financial Reports Fetcher.
...
- `openbb_core.provider.standard_models.latest_financial_reports`
...
## Notes
- Generated: 2025-11-18T07:54:40.597341
