# File Documentation: test_econdb_fetchers.py
...
- **`vcr_config()`**
- **`test_econdb_yield_curve_fetcher(credentials=test_credentials)`**
- **`test_econdb_available_indicators_fetcher(credentials=test_credentials)`**
- **`test_econdb_country_profile_fetcher(credentials=test_credentials)`**
- **`test_econdb_economic_indicators_fetcher(credentials=test_credentials)`**
- **`test_econdb_economic_indicators_main_fetcher(credentials=test_credentials)`**
- **`test_econdb_gdp_nominal_fetcher(credentials=test_credentials)`**
- **`test_econdb_gdp_real_fetcher(credentials=test_credentials)`**
- **`test_econdb_export_destinations_fetcher(credentials=test_credentials)`**
- **`test_econdb_port_volume_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:49.273821Z
