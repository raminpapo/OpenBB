# Documentation: openbb_platform/providers/econdb/openbb_econdb/models/country_profile.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/models/country_profile.py`
- **Size**: 12,899 characters, 321 lines
- **Words**: 958
- **Extension**: .py
...
**Classes** (3):
`EconDbCountryProfileQueryParams`, `EconDbCountryProfileData`, `EconDbCountryProfileFetcher`

**Functions** (6):
`validate_country`, `normalize_percent`, `transform_query`, `aextract_data`, `get_one_country`, `transform_data`

**Imports** (24):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.country_profile`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `openbb_econdb.utils.helpers`, `asyncio`, `openbb_econdb.utils.helpers`, `get_context`, `pandas`, `DataFrame`, `the`


## Key Components

**Class `EconDbCountryProfileQueryParams`**: Country Profile Query.

**Class `EconDbCountryProfileData`**: EconDB Country Profile Data.

**Class `EconDbCountryProfileFetcher`**: EconDB Country Profile Fetcher.
...
- `openbb_core.provider.standard_models.country_profile`
...
## Notes
- Generated: 2025-11-18T07:54:38.128682
