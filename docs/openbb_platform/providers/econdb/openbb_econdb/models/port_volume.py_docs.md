# Documentation: openbb_platform/providers/econdb/openbb_econdb/models/port_volume.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/models/port_volume.py`
- **Size**: 6,102 characters, 179 lines
- **Words**: 532
- **Extension**: .py
...
**Classes** (3):
`EconDbPortVolumeQueryParams`, `EconDbPortVolumeData`, `EconDbPortVolumeFetcher`

**Functions** (4):
`validate_dates`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (23):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.port_volume`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `when`, `when`, `a`, `openbb_core.provider.utils.helpers`, `amake_request`, `e`, `openbb_econdb.utils.helpers`


## Key Components

**Class `EconDbPortVolumeQueryParams`**: EconDB Port Volume Query Parameters.

**Class `EconDbPortVolumeData`**: EconDB Port Volume Data.

**Class `EconDbPortVolumeFetcher`**: EconDB Port Volume Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.138318
