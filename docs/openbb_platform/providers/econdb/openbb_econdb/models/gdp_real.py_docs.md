# Documentation: openbb_platform/providers/econdb/openbb_econdb/models/gdp_real.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/models/gdp_real.py`
- **Size**: 7,765 characters, 219 lines
- **Words**: 632
- **Extension**: .py
...
**Classes** (3):
`EconDbGdpRealQueryParams`, `EconDbGdpRealData`, `EconDbGdpRealFetcher`
...
**Class `EconDbGdpRealQueryParams`**: EconDB GDP Real Query.

**Class `EconDbGdpRealData`**: EconDB GDP Real Data.

**Class `EconDbGdpRealFetcher`**: EconDB GDP Real Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.136666
