# Documentation: openbb_platform/providers/econdb/openbb_econdb/models/economic_indicators.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/models/economic_indicators.py`
- **Size**: 21,002 characters, 489 lines
- **Words**: 1,793
- **Extension**: .py
...
**Classes** (3):
`EconDbEconomicIndicatorsQueryParams`, `EconDbEconomicIndicatorsData`, `EconDbEconomicIndicatorsFetcher`

**Functions** (6):
`validate_countries`, `validate_symbols`, `transform_query`, `aextract_data`, `response_callback`, `transform_data`

**Imports** (35):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.economic_indicators`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `previous`


## Key Components

**Class `EconDbEconomicIndicatorsQueryParams`**: EconDB Economic Indicators Query.

**Class `EconDbEconomicIndicatorsData`**: EconDB Economic Indicators Data.

**Class `EconDbEconomicIndicatorsFetcher`**: EconDB Economic Indicators Fetcher.
...
- `openbb_core.provider.standard_models.economic_indicators`
- `openbb_core.provider.utils.descriptions`
- `openbb_core.provider.utils.errors`
- `pydantic`

## Notes
- Generated: 2025-11-18T07:54:38.131021
