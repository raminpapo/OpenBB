# Documentation: openbb_platform/providers/econdb/openbb_econdb/models/export_destinations.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/models/export_destinations.py`
- **Size**: 5,432 characters, 156 lines
- **Words**: 447
- **Extension**: .py
...
**Classes** (3):
`EconDbExportDestinationsQueryParams`, `EconDbExportDestinationsData`, `EconDbExportDestinationsFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one_country`, `transform_data`

**Imports** (22):
`typing`, `Any`, `warnings`, `warn`, `aiohttp.client_exceptions`, `ContentTypeError`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.export_destinations`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `EconDB.`, `asyncio`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_econdb.utils.helpers`


## Key Components

**Class `EconDbExportDestinationsQueryParams`**: EconDB Export Destinations Query Parameters.

**Class `EconDbExportDestinationsData`**: EconDB Export Destinations Data.

**Class `EconDbExportDestinationsFetcher`**: EconDB Export Destinations Fetcher.
...
- `openbb_core.provider.standard_models.export_destinations`
...
## Notes
- Generated: 2025-11-18T07:54:38.133334
