...
- **Classes** (3): EconDbExportDestinationsQueryParams, EconDbExportDestinationsData, EconDbExportDestinationsFetcher
- **Functions** (4): transform_query, aextract_data, get_one_country, transform_data
- **Import Statements**: 4
...
- **`EconDbExportDestinationsQueryParams`**(ExportDestinationsQueryParams)
- **`EconDbExportDestinationsData`**(ExportDestinationsData)
...
**Generated**: 2025-11-19T02:16:49.208779Z
