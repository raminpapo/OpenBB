# Documentation: openbb_platform/providers/econdb/openbb_econdb/models/yield_curve.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/models/yield_curve.py`
- **Size**: 10,068 characters, 268 lines
- **Words**: 774
- **Extension**: .py
...
**Classes** (3):
`EconDbYieldCurveQueryParams`, `EconDbYieldCurveData`, `EconDbYieldCurveFetcher`

**Functions** (8):
`validate_country`, `transform_query`, `aextract_data`, `get_one_country`, `transform_data`, `process_country_data`, `get_nearest_date`, `convert_duration`

**Imports** (29):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.yield_curve`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_econdb.utils.yield_curves`, `COUNTRIES_DICT`, `pydantic`, `Field`, `asyncio`


## Key Components

**Class `EconDbYieldCurveQueryParams`**: EconDB Economic Indicators Query.

**Class `EconDbYieldCurveData`**: EconDB Yield Curve Data.

**Class `EconDbYieldCurveFetcher`**: EconDB Yield Curve Fetcher.
...
- `openbb_econdb.utils.yield_curves`
- `pydantic`

## Notes
- Generated: 2025-11-18T07:54:38.139988
