# Documentation: openbb_platform/providers/econdb/openbb_econdb/models/gdp_nominal.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/models/gdp_nominal.py`
- **Size**: 7,836 characters, 219 lines
- **Words**: 632
- **Extension**: .py
...
**Classes** (3):
`EconDbGdpNominalQueryParams`, `EconDbGdpNominalData`, `EconDbGdpNominalFetcher`

**Functions** (5):
`validate_country`, `transform_query`, `aextract_data`, `get_one_country`, `transform_data`

**Imports** (22):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.gdp_nominal`, `openbb_core.provider.utils.descriptions`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `openbb_econdb.utils.helpers`, `asyncio`, `pandas`, `DataFrame`, `openbb_econdb.utils.helpers`, `get_context`


## Key Components

**Class `EconDbGdpNominalQueryParams`**: EconDB GDP Nominal Query.

**Class `EconDbGdpNominalData`**: EconDB GDP Nominal Data.

**Class `EconDbGdpNominalFetcher`**: EconDB GDP Nominal Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.135018
