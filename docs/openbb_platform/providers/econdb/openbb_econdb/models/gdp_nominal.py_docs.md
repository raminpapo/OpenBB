...
- **Classes** (3): EconDbGdpNominalQueryParams, EconDbGdpNominalData, EconDbGdpNominalFetcher
- **Functions** (5): validate_country, transform_query, aextract_data, get_one_country, transform_data
- **Import Statements**: 5
...
- **`EconDbGdpNominalQueryParams`**(GdpNominalQueryParams)
- **`EconDbGdpNominalData`**(GdpNominalData)
...
**Generated**: 2025-11-19T02:16:49.210687Z
