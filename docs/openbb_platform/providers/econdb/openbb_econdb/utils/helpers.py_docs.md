# Documentation: openbb_platform/providers/econdb/openbb_econdb/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/utils/helpers.py`
- **Size**: 22,998 characters, 705 lines
- **Words**: 2,076
- **Extension**: .py
...
**Functions** (16):
`parse_symbols`, `unit_multiplier`, `get_indicator_countries`, `create_token`, `_callback`, `download_indicators`, `callback`, `get_context`, `parse_context`, `update_json_files`, `update_symbol_to_indicator`, `update_multipliers`, `update_scales`, `update_units`, `update_descriptions`, `update_indicator_countries`

**Imports** (23):
`asyncio`, `json`, `importlib.resources`, `files`, `io`, `StringIO`, `aiohttp_client_cache`, `SQLiteBackend`, `aiohttp_client_cache.session`, `CachedSession`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.utils`, `get_user_cache_directory`, `openbb_core.provider.utils.helpers`, `amake_request`, `pandas`, `DataFrame`, `one`, `previous`
...
## Notes
- Generated: 2025-11-18T07:54:38.143399
