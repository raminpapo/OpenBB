# File Documentation: indicators_descriptions.json

## Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/utils/indicators_descriptions.json`
- **Size**: 5,942 bytes
- **Lines**: 176
- **Category**: config
- **Extension**: .json
...
This is a **config** file named `indicators_descriptions.json`.
...
**Generated**: 2025-11-19T02:16:49.231230Z
