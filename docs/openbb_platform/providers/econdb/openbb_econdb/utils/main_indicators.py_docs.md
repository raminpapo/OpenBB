# Documentation: openbb_platform/providers/econdb/openbb_econdb/utils/main_indicators.py

## File Metadata
- **Path**: `openbb_platform/providers/econdb/openbb_econdb/utils/main_indicators.py`
- **Size**: 8,743 characters, 233 lines
- **Words**: 805
- **Extension**: .py
...
**Functions** (4):
`fetch_data`, `get_main_indicators`, `get_children`, `append_children`

**Imports** (22):
`datetime`, `datetime`, `typing`, `Literal`, `aiohttp_client_cache`, `SQLiteBackend`, `aiohttp_client_cache.session`, `CachedSession`, `numpy`, `arange`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.utils`, `get_user_cache_directory`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_econdb.utils.helpers`, `COUNTRY_MAP`, `pandas`, `Categorical`
...
## Notes
- Generated: 2025-11-18T07:54:38.150781
