# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/financial_ratios.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/financial_ratios.py`
- **Size**: 12,452 characters, 323 lines
- **Words**: 678
- **Extension**: .py
...
**Classes** (3):
`IntrinioFinancialRatiosQueryParams`, `IntrinioFinancialRatiosData`, `IntrinioFinancialRatiosFetcher`

**Functions** (5):
`handle_symbol`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (20):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.financial_ratios`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.helpers`, `ClientResponse`, `openbb_intrinio.utils.helpers`, `get_data_one`, `pydantic`, `Field`, `the`, `the`, `2008`


## Key Components

**Class `IntrinioFinancialRatiosQueryParams`**: Intrinio Financial Ratios Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_company_fundamentals_v2
    Source: https://docs.intrinio.com/documentation/web_api/get_fundamental_st

**Class `IntrinioFinancialRatiosData`**: Intrinio Financial Ratios Data.

**Class `IntrinioFinancialRatiosFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
- `openbb_core.provider.standard_models.financial_ratios`
...
## Notes
- Generated: 2025-11-18T07:54:40.104396
