# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/forward_pe_estimates.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/forward_pe_estimates.py`
- **Size**: 5,799 characters, 164 lines
- **Words**: 464
- **Extension**: .py
...
**Classes** (3):
`IntrinioForwardPeEstimatesQueryParams`, `IntrinioForwardPeEstimatesData`, `IntrinioForwardPeEstimatesFetcher`

**Functions** (5):
`transform_query`, `aextract_data`, `get_one`, `fetch_callback`, `transform_data`

**Imports** (21):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.forward_pe_estimates`, `pydantic`, `Field`, `the`, `asyncio`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_intrinio.utils.helpers`, `response_callback`, `e`


## Key Components

**Class `IntrinioForwardPeEstimatesQueryParams`**: Intrinio Forward PE Estimates Query.

    https://api-v2.intrinio.com/zacks/forward_pe?

**Class `IntrinioForwardPeEstimatesData`**: Intrinio Forward PE Estimates Data.

**Class `IntrinioForwardPeEstimatesFetcher`**: Intrinio Forward PE Estimates Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.109972
