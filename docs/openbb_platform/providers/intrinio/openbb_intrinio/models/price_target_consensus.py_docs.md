# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/price_target_consensus.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/price_target_consensus.py`
- **Size**: 6,430 characters, 179 lines
- **Words**: 518
- **Extension**: .py
...
**Classes** (3):
`IntrinioPriceTargetConsensusQueryParams`, `IntrinioPriceTargetConsensusData`, `IntrinioPriceTargetConsensusFetcher`

**Functions** (5):
`transform_query`, `aextract_data`, `get_one`, `fetch_callback`, `transform_data`

**Imports** (20):
`asyncio`, `datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.price_target_consensus`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `openbb_intrinio.utils.helpers`, `response_callback`, `pydantic`, `Field`, `the`


## Key Components

**Class `IntrinioPriceTargetConsensusQueryParams`**: Intrinio Price Target Consensus  Query.

    https://docs.intrinio.com/documentation/web_api/get_zacks_sales__v2

**Class `IntrinioPriceTargetConsensusData`**: Intrinio Price Target Consensus  Data.

**Class `IntrinioPriceTargetConsensusFetcher`**: Intrinio Price Target Consensus  Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.145581
