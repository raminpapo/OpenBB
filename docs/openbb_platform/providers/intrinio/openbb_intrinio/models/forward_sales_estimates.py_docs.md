# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/forward_sales_estimates.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/forward_sales_estimates.py`
- **Size**: 9,849 characters, 250 lines
- **Words**: 815
- **Extension**: .py
...
**Classes** (3):
`IntrinioForwardSalesEstimatesQueryParams`, `IntrinioForwardSalesEstimatesData`, `IntrinioForwardSalesEstimatesFetcher`

**Functions** (7):
`validate_choices`, `normalize_percent`, `transform_query`, `aextract_data`, `get_one`, `fetch_callback`, `transform_data`

**Imports** (20):
`asyncio`, `datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.forward_sales_estimates`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `openbb_intrinio.utils.helpers`, `response_callback`, `pydantic`, `Field`, `the`


## Key Components

**Class `IntrinioForwardSalesEstimatesQueryParams`**: Intrinio Forward Sales Estimates Query.

    https://docs.intrinio.com/documentation/web_api/get_zacks_sales_estimates_v2

**Class `IntrinioForwardSalesEstimatesData`**: Intrinio Forward Sales Estimates Data.

**Class `IntrinioForwardSalesEstimatesFetcher`**: Intrinio Forward Sales Estimates Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.111770
