# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/etf_holdings.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/etf_holdings.py`
- **Size**: 7,662 characters, 212 lines
- **Words**: 688
- **Extension**: .py
...
**Classes** (3):
`IntrinioEtfHoldingsQueryParams`, `IntrinioEtfHoldingsData`, `IntrinioEtfHoldingsFetcher`

**Functions** (5):
`replace_zero`, `transform_query`, `aextract_data`, `response_callback`, `transform_data`

**Imports** (16):
`datetime`, `date`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.etf_holdings`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.helpers`, `pydantic`, `Field`, `the`, `Intrinio`


## Key Components

**Class `IntrinioEtfHoldingsQueryParams`**: Intrinio ETF Holdings Query Params.

    Source: https://docs.intrinio.com/documentation/web_api/get_etf_holdings_v2

**Class `IntrinioEtfHoldingsData`**: Intrinio ETF Holdings Data.

**Class `IntrinioEtfHoldingsFetcher`**: Intrinio ETF Holdings Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.093656
