# File Documentation: etf_price_performance.py
...
This is a **python** file named `etf_price_performance.py`.

**Python Module**

- **Classes** (3): IntrinioEtfPricePerformanceQueryParams, IntrinioEtfPricePerformanceData, IntrinioEtfPricePerformanceFetcher
...
- **`IntrinioEtfPricePerformanceQueryParams`**(RecentPerformanceQueryParams)
- **`IntrinioEtfPricePerformanceData`**(RecentPerformanceData)
...
**Generated**: 2025-11-19T02:16:51.419060Z
