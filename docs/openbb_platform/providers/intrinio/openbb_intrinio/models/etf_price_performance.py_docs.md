# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/etf_price_performance.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/etf_price_performance.py`
- **Size**: 8,274 characters, 228 lines
- **Words**: 713
- **Extension**: .py
...
**Classes** (3):
`IntrinioEtfPricePerformanceQueryParams`, `IntrinioEtfPricePerformanceData`, `IntrinioEtfPricePerformanceFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (23):
`asyncio`, `datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.recent_performance`, `openbb_core.provider.utils.descriptions`, `DATA_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_intrinio.utils.references`, `ETF_PERFORMANCE_MAP`, `pydantic`, `Field`


## Key Components

**Class `IntrinioEtfPricePerformanceQueryParams`**: Intrinio ETF Performance Query Params.

    Source: https://docs.intrinio.com/documentation/web_api/get_etf_stats_v2
    Source: https://docs.intrinio.com/documentation/web_api/get_etf_analytics_v2

**Class `IntrinioEtfPricePerformanceData`**: Intrinio ETF Performance Data.

**Class `IntrinioEtfPricePerformanceFetcher`**: Intrinio ETF Performance Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.099054
