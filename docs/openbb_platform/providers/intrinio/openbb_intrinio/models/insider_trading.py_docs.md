# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/insider_trading.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/insider_trading.py`
- **Size**: 6,545 characters, 182 lines
- **Words**: 540
- **Extension**: .py
...
**Classes** (3):
`IntrinioInsiderTradingQueryParams`, `IntrinioInsiderTradingData`, `IntrinioInsiderTradingFetcher`

**Functions** (4):
`empty_strings`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (18):
`datetime`, `typing`, `Any`, `dateutil.relativedelta`, `relativedelta`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.insider_trading`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.helpers`, `get_querystring`, `openbb_intrinio.utils.helpers`, `get_data_many`, `pydantic`, `Field`, `the`, `the`


## Key Components

**Class `IntrinioInsiderTradingQueryParams`**: Intrinio Insider Trading Query.

    Source: https://docs.intrinio.com/documentation/web_api/insider_transaction_filings_by_company_v2

**Class `IntrinioInsiderTradingData`**: Intrinio Insider Trading Data.

**Class `IntrinioInsiderTradingFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.127131
