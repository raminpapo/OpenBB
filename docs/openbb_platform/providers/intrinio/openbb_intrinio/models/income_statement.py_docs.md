...
- **Classes** (3): IntrinioIncomeStatementQueryParams, IntrinioIncomeStatementData, IntrinioIncomeStatementFetcher
...
- **`IntrinioIncomeStatementQueryParams`**(IncomeStatementQueryParams)
- **`IntrinioIncomeStatementData`**(IncomeStatementData)
- **`IntrinioIncomeStatementFetcher`**(
    Fetcher[
        IntrinioIncomeStatementQueryParams,
        list[IntrinioIncomeStatementData],
    ]
...
**Generated**: 2025-11-19T02:16:51.446824Z
