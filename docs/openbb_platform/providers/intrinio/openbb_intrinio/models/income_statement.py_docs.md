# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/income_statement.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/income_statement.py`
- **Size**: 22,267 characters, 503 lines
- **Words**: 1,586
- **Extension**: .py
...
**Classes** (3):
`IntrinioIncomeStatementQueryParams`, `IntrinioIncomeStatementData`, `IntrinioIncomeStatementFetcher`

**Functions** (5):
`handle_symbol`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (19):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.income_statement`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.helpers`, `openbb_intrinio.utils.helpers`, `get_data_one`, `pydantic`, `Field`, `the`, `the`, `2008`


## Key Components

**Class `IntrinioIncomeStatementQueryParams`**: Intrinio Income Statement Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_company_fundamentals_v2
    Source: https://docs.intrinio.com/documentation/web_api/get_fundamental_st

**Class `IntrinioIncomeStatementData`**: Intrinio Income Statement Data.

**Class `IntrinioIncomeStatementFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.122226
