# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/forward_eps_estimates.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/forward_eps_estimates.py`
- **Size**: 8,579 characters, 232 lines
- **Words**: 724
- **Extension**: .py
...
**Classes** (3):
`IntrinioForwardEpsEstimatesQueryParams`, `IntrinioForwardEpsEstimatesData`, `IntrinioForwardEpsEstimatesFetcher`
...
**Class `IntrinioForwardEpsEstimatesQueryParams`**: Intrinio Forward EPS Estimates Query.

    https://docs.intrinio.com/documentation/web_api/get_zacks_sales_estimates_v2

**Class `IntrinioForwardEpsEstimatesData`**: Intrinio Forward EPS Estimates Data.

**Class `IntrinioForwardEpsEstimatesFetcher`**: Intrinio Forward EPS Estimates Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.108186
