# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/world_news.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/world_news.py`
- **Size**: 9,579 characters, 255 lines
- **Words**: 889
- **Extension**: .py
...
**Classes** (3):
`IntrinioWorldNewsQueryParams`, `IntrinioWorldNewsData`, `IntrinioWorldNewsFetcher`

**Functions** (7):
`date_validate`, `topics_validate`, `copyright_validate`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (21):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.world_news`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_intrinio.utils.references`, `IntrinioCompany`, `pydantic`, `Field`, `this`, `the`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_intrinio.utils.helpers`


## Key Components

**Class `IntrinioWorldNewsQueryParams`**: Intrinio World News Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_all_company_news_v2

**Class `IntrinioWorldNewsData`**: Intrinio World News Data.

**Class `IntrinioWorldNewsFetcher`**: Intrinio World News Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.152015
