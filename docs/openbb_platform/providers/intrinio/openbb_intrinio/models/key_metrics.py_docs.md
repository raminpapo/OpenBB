# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/key_metrics.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/key_metrics.py`
- **Size**: 12,539 characters, 368 lines
- **Words**: 1,001
- **Extension**: .py
...
**Classes** (3):
`IntrinioKeyMetricsQueryParams`, `IntrinioKeyMetricsData`, `IntrinioKeyMetricsFetcher`

**Functions** (5):
`transform_query`, `aextract_data`, `get_one`, `callback`, `transform_data`

**Imports** (17):
`asyncio`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.data`, `ForceInt`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.key_metrics`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `pydantic`, `Field`, `the`, `the`


## Key Components

**Class `IntrinioKeyMetricsQueryParams`**: Intrinio Key Metrics Query.

    Source: https://data.intrinio.com/data-tags/

**Class `IntrinioKeyMetricsData`**: Intrinio Key Metrics Data.

**Class `IntrinioKeyMetricsFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
- `openbb_core.provider.standard_models.key_metrics`
- `openbb_core.provider.utils.errors`
- `openbb_core.provider.utils.helpers`
- `pydantic`

## Notes
- Generated: 2025-11-18T07:54:40.131526
