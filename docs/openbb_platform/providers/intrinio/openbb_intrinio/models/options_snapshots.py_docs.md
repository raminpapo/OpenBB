# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/options_snapshots.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/options_snapshots.py`
- **Size**: 12,619 characters, 338 lines
- **Words**: 1,005
- **Extension**: .py
...
**Classes** (3):
`IntrinioOptionsSnapshotsQueryParams`, `IntrinioOptionsSnapshotsData`, `IntrinioOptionsSnapshotsFetcher`

**Functions** (7):
`transform_query`, `aextract_data`, `response_callback`, `get_csv`, `transform_data`, `calculate_dte`, `apply_contract_symbol`

**Imports** (32):
`datetime`, `typing`, `TYPE_CHECKING`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.options_snapshots`, `pydantic`, `Field`, `pandas`, `DataFrame`, `pytz`, `timezone`, `exc`, `the`, `gzip`, `io`, `BytesIO`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `IntrinioOptionsSnapshotsQueryParams`**: Intrinio Options Snapshots Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_options_snapshots_v2

**Class `IntrinioOptionsSnapshotsData`**: Intrinio Options Snapshots Data. Warning: This is a large file.

**Class `IntrinioOptionsSnapshotsFetcher`**: Intrinio Options Snapshots Fetcher.
...
- `openbb_core.provider.standard_models.options_snapshots`
- `pydantic`
- `pandas`
- `pytz`
- `gzip`
...
## Notes
- Generated: 2025-11-18T07:54:40.141231
