...
- **Classes** (3): IntrinioInstitutionalOwnershipQueryParams, IntrinioInstitutionalOwnershipData, IntrinioInstitutionalOwnershipFetcher
- **Functions** (4): transform_query, aextract_data, get_owner_name, transform_data
- **Import Statements**: 2
...
- **`IntrinioInstitutionalOwnershipQueryParams`**(InstitutionalOwnershipQueryParams)
- **`IntrinioInstitutionalOwnershipData`**(InstitutionalOwnershipData)
...
**Generated**: 2025-11-19T02:16:51.455193Z
