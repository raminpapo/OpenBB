# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/options_chains.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/options_chains.py`
- **Size**: 14,438 characters, 377 lines
- **Words**: 1,208
- **Extension**: .py
...
**Classes** (3):
`IntrinioOptionsChainsQueryParams`, `IntrinioOptionsChainsData`, `IntrinioOptionsChainsFetcher`

**Functions** (9):
`date_not_allowed_with_realtime`, `_date_validate`, `_volume_oi_validate`, `transform_query`, `aextract_data`, `get_urls`, `generate_url`, `callback`, `transform_data`

**Imports** (31):
`datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.options_chains`, `openbb_core.provider.utils.errors`, `OpenBBError`, `openbb_intrinio.models.equity_historical`, `IntrinioEquityHistoricalFetcher`, `openbb_intrinio.models.index_historical`, `IntrinioIndexHistoricalFetcher`, `pydantic`, `Field`, `the`, `dateutil`, `parser`, `pytz`


## Key Components

**Class `IntrinioOptionsChainsQueryParams`**: Intrinio Options Chains Query.

    source: https://docs.intrinio.com/documentation/web_api/get_options_chain_eod_v2

**Class `IntrinioOptionsChainsData`**: Intrinio Options Chains Data.

**Class `IntrinioOptionsChainsFetcher`**: Intrinio Options Chains Fetcher.
...
- `openbb_intrinio.models.index_historical`
- `pydantic`
- `dateutil`

## Notes
- Generated: 2025-11-18T07:54:40.138683
