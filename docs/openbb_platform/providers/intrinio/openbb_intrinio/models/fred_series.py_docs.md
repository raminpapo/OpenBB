# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/fred_series.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/fred_series.py`
- **Size**: 3,905 characters, 120 lines
- **Words**: 309
- **Extension**: .py
...
**Classes** (3):
`IntrinioFredSeriesQueryParams`, `IntrinioFredSeriesData`, `IntrinioFredSeriesFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (16):
`asyncio`, `datetime`, `datetime`, `typing`, `Any`, `dateutil.relativedelta`, `relativedelta`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.fred_series`, `openbb_core.provider.utils.helpers`, `pydantic`, `Field`, `the`, `the`, `the`


## Key Components

**Class `IntrinioFredSeriesQueryParams`**: Intrinio FRED Series Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_economic_index_historical_data_v2

**Class `IntrinioFredSeriesData`**: Intrinio FRED Series Data.

**Class `IntrinioFredSeriesFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.114220
