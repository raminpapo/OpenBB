# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/options_unusual.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/options_unusual.py`
- **Size**: 11,141 characters, 291 lines
- **Words**: 1,071
- **Extension**: .py
...
**Classes** (3):
`IntrinioOptionsUnusualQueryParams`, `IntrinioOptionsUnusualData`, `IntrinioOptionsUnusualFetcher`

**Functions** (9):
`validate_params`, `validate_timestamp`, `validate_contract_symbol`, `validate_trade_type`, `replace_zero`, `transform_query`, `aextract_data`, `response_callback`, `transform_data`

**Imports** (20):
`datetime`, `typing`, `Any`, `dateutil.parser`, `parse`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.options_unusual`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `pydantic`, `Field`, `pytz`, `timezone`, `the`


## Key Components

**Class `IntrinioOptionsUnusualQueryParams`**: Intrinio Unusual Options Query.

    source: https://docs.intrinio.com/documentation/web_api/get_unusual_activity_v2

**Class `IntrinioOptionsUnusualData`**: Intrinio Unusual Options Data.

**Class `IntrinioOptionsUnusualFetcher`**: Intrinio Unusual Options Fetcher.
...
- `openbb_core.provider.standard_models.options_unusual`
...
## Notes
- Generated: 2025-11-18T07:54:40.143422
