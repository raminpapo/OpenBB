# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/equity_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/equity_historical.py`
- **Size**: 9,570 characters, 275 lines
- **Words**: 859
- **Extension**: .py
...
**Classes** (3):
`IntrinioEquityHistoricalQueryParams`, `IntrinioEquityHistoricalData`, `IntrinioEquityHistoricalFetcher`

**Functions** (5):
`set_time_params`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (21):
`datetime`, `datetime`, `typing`, `Any`, `dateutil.relativedelta`, `relativedelta`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_historical`, `openbb_core.provider.utils.descriptions`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `pydantic`, `Field`, `the`, `the`, `the`


## Key Components

**Class `IntrinioEquityHistoricalQueryParams`**: Intrinio Equity Historical Price Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_security_interval_prices_v2

**Class `IntrinioEquityHistoricalData`**: Intrinio Equity Historical Price Data.

**Class `IntrinioEquityHistoricalFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
- `openbb_core.provider.standard_models.equity_historical`
...
## Notes
- Generated: 2025-11-18T07:54:40.086746
