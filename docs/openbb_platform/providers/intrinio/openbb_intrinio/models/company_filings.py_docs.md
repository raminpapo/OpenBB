# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/company_filings.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/company_filings.py`
- **Size**: 6,320 characters, 174 lines
- **Words**: 524
- **Extension**: .py
...
**Classes** (3):
`IntrinioCompanyFilingsQueryParams`, `IntrinioCompanyFilingsData`, `IntrinioCompanyFilingsFetcher`

**Functions** (4):
`_validate_symbol`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (21):
`datetime`, `typing`, `Any`, `dateutil.relativedelta`, `relativedelta`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.company_filings`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `pydantic`, `Field`, `the`, `the`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `Intrinio`


## Key Components

**Class `IntrinioCompanyFilingsQueryParams`**: Intrinio Company Filings Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_company_filings_v2

**Class `IntrinioCompanyFilingsData`**: Intrinio Company Filings Data.

**Class `IntrinioCompanyFilingsFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.081311
