# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/market_snapshots.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/market_snapshots.py`
- **Size**: 9,162 characters, 264 lines
- **Words**: 728
- **Extension**: .py
...
**Classes** (3):
`IntrinioMarketSnapshotsQueryParams`, `IntrinioMarketSnapshotsData`, `IntrinioMarketSnapshotsFetcher`

**Functions** (5):
`transform_query`, `aextract_data`, `response_callback`, `get_csv`, `transform_data`

**Imports** (24):
`datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.market_snapshots`, `pydantic`, `Field`, `the`, `pytz`, `timezone`, `exc`, `the`, `asyncio`, `gzip`, `datetime`, `timezone`, `io`


## Key Components

**Class `IntrinioMarketSnapshotsQueryParams`**: Intrinio Market Snapshots Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_security_snapshots_v2

**Class `IntrinioMarketSnapshotsData`**: Intrinio Market Snapshots Data.

**Class `IntrinioMarketSnapshotsFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.136277
