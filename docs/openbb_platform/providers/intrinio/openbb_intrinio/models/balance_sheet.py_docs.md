# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/balance_sheet.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/balance_sheet.py`
- **Size**: 22,831 characters, 501 lines
- **Words**: 1,666
- **Extension**: .py
...
**Classes** (3):
`IntrinioBalanceSheetQueryParams`, `IntrinioBalanceSheetData`, `IntrinioBalanceSheetFetcher`

**Functions** (6):
`handle_symbol`, `replace_zero`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (19):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.balance_sheet`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.helpers`, `ClientResponse`, `openbb_intrinio.utils.helpers`, `get_data_one`, `pydantic`, `Field`, `banks.`, `the`, `the`, `2008`


## Key Components

**Class `IntrinioBalanceSheetQueryParams`**: Intrinio Balance Sheet Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_company_fundamentals_v2
    Source: https://docs.intrinio.com/documentation/web_api/get_fundamental_stand

**Class `IntrinioBalanceSheetData`**: Intrinio Balance Sheet Data.

**Class `IntrinioBalanceSheetFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.074257
