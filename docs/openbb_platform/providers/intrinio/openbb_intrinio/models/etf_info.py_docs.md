# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/etf_info.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/etf_info.py`
- **Size**: 28,666 characters, 656 lines
- **Words**: 3,452
- **Extension**: .py
...
class IntrinioEtfInfoData(EtfInfoData):
    ...
    close_date: dateType | None = Field(
        default=None,
    ...
    intraday_nav_symbol: str | None = Field(
        default=None,
    ...
    etp_structure_type: str | None = Field(
        default=None,
    ...
    etn_issuing_bank: str | None = Field(
        default=None,
    ...
    other_asset_types: str | None = Field(
        default=None,
    ...
    single_category_designation: str | None = Field(
        default=None,
    ...
    market_cap_weighting_type: str | None = Field(
        default=None,
    ...
    broader_index_family: str | None = Field(
        default=None,
    ...
    index_provider_code: str | None = Field(
        default=None,
    ...
    cross_sector_theme: str | None = Field(
        default=None,
    ...
    natural_resources_type: str | None = Field(
        default=None,
    ...
    us_or_excludes_us: str | None = Field(
        default=None,
    ...
    latin_america_sub_group: str | None = Field(
        default=None,
    ...
    fundamental_weighting_type: str | None = Field(
        default=None,
    ...
    dividend_weighting_type: str | None = Field(
        default=None,
    ...
    commodity_types: str | None = Field(
        default=None,
    ...
    agricultural_type: str | None = Field(
        default=None,
    ...
    social_environmental_type: str | None = Field(
        default=None,
    ...
    clean_energy_type: str | None = Field(
        default=None,
    ...
    other_quant_models: str | None = Field(
        default=None,
    ...
    hedge_fund_type: str | None = Field(
        default=None,
    ...
    excludes_financials: bool | None = Field(
        default=None,
    ...
    includes_short_exposure: bool | None = Field(
        default=None,
    ...
    registered_countries: str | None = Field(
        default=None,
    ...
    listing_currency: str | None = Field(
        default=None,
...
**Classes** (4):
`IntrinioEtfInfoQueryParams`, `IntrinioEtfInfoData`, `of`, `IntrinioEtfInfoFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `response_callback`, `transform_data`

**Imports** (18):
`datetime`, `date`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.etf_info`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_requests`, `pydantic`, `Field`, `which`, `where`, `the`


## Key Components

**Class `IntrinioEtfInfoQueryParams`**: Intrinio ETF Info Query Params.

    Source: https://docs.intrinio.com/documentation/web_api/get_etf_v2

**Class `IntrinioEtfInfoData`**: Intrinio ETF Info Data.

**Class `of`**: No documentation

**Class `IntrinioEtfInfoFetcher`**: Intrinio ETF Info Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:40.096065
