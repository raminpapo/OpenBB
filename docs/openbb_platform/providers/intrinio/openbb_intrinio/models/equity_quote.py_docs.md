# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/equity_quote.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/equity_quote.py`
- **Size**: 4,917 characters, 141 lines
- **Words**: 413
- **Extension**: .py
...
**Classes** (3):
`IntrinioEquityQuoteQueryParams`, `IntrinioEquityQuoteData`, `IntrinioEquityQuoteFetcher`

**Functions** (7):
`date_validate`, `validate_sales_conditions`, `validate_listing_venue`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (17):
`re`, `warnings`, `datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_quote`, `openbb_core.provider.utils.helpers`, `openbb_intrinio.utils.references`, `SOURCES`, `pydantic`, `Field`, `a`, `the`, `the`


## Key Components

**Class `IntrinioEquityQuoteQueryParams`**: Intrinio Equity Quote Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_security_realtime_price_v2

**Class `IntrinioEquityQuoteData`**: Intrinio Equity Quote Data.

**Class `IntrinioEquityQuoteFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.090377
