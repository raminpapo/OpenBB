# File Documentation: equity_quote.py
...
This is a **python** file named `equity_quote.py`.

**Python Module**

- **Classes** (3): IntrinioEquityQuoteQueryParams, IntrinioEquityQuoteData, IntrinioEquityQuoteFetcher
- **Functions** (7): date_validate, validate_sales_conditions, validate_listing_venue, transform_query, aextract_data, callback, transform_data
- **Import Statements**: 2
...
- **`IntrinioEquityQuoteQueryParams`**(EquityQuoteQueryParams)
- **`IntrinioEquityQuoteData`**(EquityQuoteData)
...
- **`date_validate(cls, v)`**
- **`validate_sales_conditions(cls, v)`**
- **`validate_listing_venue(cls, v)`**
...
**Generated**: 2025-11-19T02:16:51.406864Z
