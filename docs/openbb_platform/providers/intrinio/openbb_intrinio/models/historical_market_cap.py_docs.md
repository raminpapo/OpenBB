# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/historical_market_cap.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/historical_market_cap.py`
- **Size**: 5,048 characters, 151 lines
- **Words**: 383
- **Extension**: .py
...
**Classes** (3):
`IntrinioHistoricalMarketCapQueryParams`, `IntrinioHistoricalMarketCapData`, `IntrinioHistoricalMarketCapFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (23):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.historical_market_cap`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `the`, `asyncio`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_intrinio.utils.helpers`, `response_callback`


## Key Components

**Class `IntrinioHistoricalMarketCapQueryParams`**: Intrinio Historical MarketCap Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_historical_data_v2

**Class `IntrinioHistoricalMarketCapData`**: Intrinio Historical MarketCap Data.

**Class `IntrinioHistoricalMarketCapFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.119871
