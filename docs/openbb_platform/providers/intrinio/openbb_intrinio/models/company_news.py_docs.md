# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/company_news.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/company_news.py`
- **Size**: 10,735 characters, 296 lines
- **Words**: 984
- **Extension**: .py
...
**Classes** (3):
`IntrinioCompanyNewsQueryParams`, `IntrinioCompanyNewsData`, `IntrinioCompanyNewsFetcher`

**Functions** (9):
`_symbol_mandatory`, `date_validate`, `topics_validate`, `copyright_validate`, `transform_query`, `aextract_data`, `callback`, `get_one`, `transform_data`

**Imports** (24):
`asyncio`, `datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.company_news`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `openbb_intrinio.utils.helpers`, `get_data`, `openbb_intrinio.utils.references`, `IntrinioSecurity`, `pydantic`


## Key Components

**Class `IntrinioCompanyNewsQueryParams`**: Intrinio Company News Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_company_news_v2

**Class `IntrinioCompanyNewsData`**: Intrinio Company News Data.

**Class `IntrinioCompanyNewsFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.083288
