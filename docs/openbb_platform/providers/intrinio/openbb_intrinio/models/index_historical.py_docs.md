# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/index_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/index_historical.py`
- **Size**: 3,654 characters, 102 lines
- **Words**: 287
- **Extension**: .py
...
**Classes** (3):
`IntrinioIndexHistoricalQueryParams`, `IntrinioIndexHistoricalData`, `IntrinioIndexHistoricalFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (19):
`datetime`, `datetime`, `typing`, `Any`, `dateutil.relativedelta`, `relativedelta`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.index_historical`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_requests`, `pydantic`, `Field`, `the`, `the`


## Key Components

**Class `IntrinioIndexHistoricalQueryParams`**: Intrinio Index Historical Query.

    Source:
    https://docs.intrinio.com/documentation/web_api/get_stock_market_index_historical_data_v2

**Class `IntrinioIndexHistoricalData`**: Intrinio Index Historical Data.

**Class `IntrinioIndexHistoricalFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.125275
