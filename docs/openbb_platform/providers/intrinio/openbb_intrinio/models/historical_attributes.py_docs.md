# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/historical_attributes.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/historical_attributes.py`
- **Size**: 5,002 characters, 141 lines
- **Words**: 382
- **Extension**: .py
...
**Classes** (3):
`IntrinioHistoricalAttributesQueryParams`, `IntrinioHistoricalAttributesData`, `IntrinioHistoricalAttributesFetcher`

**Functions** (5):
`transform_query`, `aextract_data`, `generate_url`, `callback`, `transform_data`

**Imports** (15):
`warnings`, `datetime`, `datetime`, `typing`, `Any`, `dateutil.relativedelta`, `relativedelta`, `openbb_core.app.model.abstract.warning`, `OpenBBWarning`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.historical_attributes`, `openbb_core.provider.utils.helpers`, `the`, `the`


## Key Components

**Class `IntrinioHistoricalAttributesQueryParams`**: Intrinio Historical Attributes Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_historical_data_v2

**Class `IntrinioHistoricalAttributesData`**: Intrinio Historical Attributes Data.

**Class `IntrinioHistoricalAttributesFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.116120
