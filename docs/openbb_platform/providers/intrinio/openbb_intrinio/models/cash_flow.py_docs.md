# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/models/cash_flow.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/models/cash_flow.py`
- **Size**: 14,982 characters, 337 lines
- **Words**: 1,100
- **Extension**: .py
...
**Classes** (3):
`IntrinioCashFlowStatementQueryParams`, `IntrinioCashFlowStatementData`, `IntrinioCashFlowStatementFetcher`

**Functions** (6):
`handle_symbol`, `replace_zero`, `transform_query`, `aextract_data`, `callback`, `transform_data`

**Imports** (29):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.cash_flow`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.helpers`, `ClientResponse`, `openbb_intrinio.utils.helpers`, `get_data_one`, `pydantic`, `Field`, `Continuing`, `Discontinued`, `Operating`


## Key Components

**Class `IntrinioCashFlowStatementQueryParams`**: Intrinio Cash Flow Statement Query.

    Source: https://docs.intrinio.com/documentation/web_api/get_company_fundamentals_v2
    Source: https://docs.intrinio.com/documentation/web_api/get_fundamental

**Class `IntrinioCashFlowStatementData`**: Intrinio Cash Flow Statement Data.

**Class `IntrinioCashFlowStatementFetcher`**: Transform the query, extract and transform the data from the Intrinio endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:40.078862
