# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/utils/helpers.py`
- **Size**: 4,179 characters, 154 lines
- **Words**: 481
- **Extension**: .py
...
**Functions** (9):
`__init__`, `json`, `request`, `response_callback`, `get_data`, `get_data_many`, `get_data_one`, `get_weekday`, `async_get_data_one`

**Imports** (21):
`asyncio`, `json`, `datetime`, `io`, `StringIO`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `pydantic`, `BaseModel`, `pyodide.http`, `open_url`, `Intrinio`, `Intrinio`, `Intrinio`, `e`


## Key Components

**Class `BasicResponse`**: Basic Response class.
...
## Notes
- Generated: 2025-11-18T07:54:40.155790
