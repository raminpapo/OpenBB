# Documentation: openbb_platform/providers/intrinio/openbb_intrinio/utils/references.py

## File Metadata
- **Path**: `openbb_platform/providers/intrinio/openbb_intrinio/utils/references.py`
- **Size**: 5,300 characters, 156 lines
- **Words**: 461
- **Extension**: .py
...
**Classes** (2):
`IntrinioCompany`, `IntrinioSecurity`

**Functions** (0):
None

**Imports** (6):
`typing`, `Literal`, `openbb_core.provider.abstract.data`, `Data`, `pydantic`, `Field`


## Key Components

**Class `IntrinioCompany`**: Intrinio Company Data.

**Class `IntrinioSecurity`**: Intrinio Security Data.
...
## Notes
- Generated: 2025-11-18T07:54:40.157648
