# File Documentation: unit_tests_generator.py
...
This is a **python** file named `unit_tests_generator.py`.

**Python Module**

- **Functions** (8): get_provider_fetchers, generate_fetcher_unit_tests, get_test_params, write_test_credentials, vcr_config, check_pattern_in_file, write_fetcher_unit_tests, test_
- **Import Statements**: 4
...
**Generated**: 2025-11-19T02:16:52.987372Z
