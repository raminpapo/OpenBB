# Documentation: openbb_platform/providers/tests/utils/unit_tests_generator.py

## File Metadata
- **Path**: `openbb_platform/providers/tests/utils/unit_tests_generator.py`
- **Size**: 7,607 characters, 198 lines
- **Words**: 622
- **Extension**: .py
...
**Functions** (8):
`get_provider_fetchers`, `generate_fetcher_unit_tests`, `get_test_params`, `write_test_credentials`, `vcr_config`, `check_pattern_in_file`, `write_fetcher_unit_tests`, `test_`

**Imports** (26):
`datetime`, `date`, `pathlib`, `Path`, `typing`, `Any`, `openbb_core.app.provider_interface`, `ProviderInterface`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.registry`, `RegistryLoader`, `openbb_core.provider.utils.helpers`, `to_snake_case`, `pydantic.fields`, `FieldInfo`, `pydantic_core`, `PydanticUndefined`, `.credentials_schema`, `test_credentials`
...
## Notes
- Generated: 2025-11-18T07:54:41.706216
