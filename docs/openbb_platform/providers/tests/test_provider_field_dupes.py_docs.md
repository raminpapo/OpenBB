# File Documentation: test_provider_field_dupes.py
...
This is a **python** file named `test_provider_field_dupes.py`.

**Python Module**

- **Classes** (8): and, to, defined, that, names, name, and, ProviderFieldDupesTest
- **Functions** (8): get_module, get_subclasses_w_keys, get_subclasses, child_parent_map, get_path_components, match_provider_and_fields, get_provider_modules, test_provider_field_dupes
- **Import Statements**: 1
...
- **`ProviderFieldDupesTest`**(unittest.TestCase)

#### Functions

- **`get_module(file_path: str, package_name: str)`**
- **`get_path_components(path: str)`**
- **`get_provider_modules()`**
- **`test_provider_field_dupes(self)`**
...
**Generated**: 2025-11-19T02:16:52.983207Z
