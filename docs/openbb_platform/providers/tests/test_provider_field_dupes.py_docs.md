# Documentation: openbb_platform/providers/tests/test_provider_field_dupes.py

## File Metadata
- **Path**: `openbb_platform/providers/tests/test_provider_field_dupes.py`
- **Size**: 7,732 characters, 230 lines
- **Words**: 761
- **Extension**: .py
...
**Classes** (8):
`and`, `to`, `defined`, `that`, `names`, `name`, `and`, `ProviderFieldDupesTest`

**Functions** (8):
`get_module`, `get_subclasses_w_keys`, `get_subclasses`, `child_parent_map`, `get_path_components`, `match_provider_and_fields`, `get_provider_modules`, `test_provider_field_dupes`

**Imports** (15):
`glob`, `importlib`, `inspect`, `os`, `unittest`, `pytest`, `openbb_core.provider`, `standard_models`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.registry`, `RegistryLoader`, `provider`
...
**Class `defined`**: No documentation

**Class `names`**: No documentation

**Class `name`**: No documentation

**Class `and`**: No documentation

**Class `ProviderFieldDupesTest`**: Test for common fields in the provider models that should be standard.
...
## Notes
- Generated: 2025-11-18T07:54:41.702304
