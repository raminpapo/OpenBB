# Documentation: openbb_platform/providers/eia/openbb_us_eia/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/eia/openbb_us_eia/utils/helpers.py`
- **Size**: 1,539 characters, 44 lines
- **Words**: 166
- **Extension**: .py
...
**Functions** (3):
`response_callback`, `download_excel_file`, `callback`

**Imports** (17):
`typing`, `TYPE_CHECKING`, `async_lru`, `alru_cache`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `pandas`, `ExcelFile`, `the`, `io`, `BytesIO`, `openbb_core.provider.utils.helpers`, `amake_request`, `pandas`, `ExcelFile`, `the`, `e`
...
## Notes
- Generated: 2025-11-18T07:54:38.274580
