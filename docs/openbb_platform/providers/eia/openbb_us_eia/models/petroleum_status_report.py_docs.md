# Documentation: openbb_platform/providers/eia/openbb_us_eia/models/petroleum_status_report.py

## File Metadata
- **Path**: `openbb_platform/providers/eia/openbb_us_eia/models/petroleum_status_report.py`
- **Size**: 8,689 characters, 242 lines
- **Words**: 755
- **Extension**: .py
...
**Classes** (3):
`EiaPetroleumStatusReportQueryParams`, `EiaPetroleumStatusReportData`, `EiaPetroleumStatusReportFetcher`

**Functions** (6):
`transform_query`, `aextract_data`, `transform_data`, `replace_data_strings`, `replacer`, `read_excel_file`

**Imports** (30):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.petroleum_status_report`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_us_eia.utils.constants`, `pydantic`, `Field`, `the`, `warnings`, `warn`, `the`, `openbb_us_eia.utils.helpers`, `download_excel_file`, `e`, `concurrent.futures`


## Key Components

**Class `EiaPetroleumStatusReportQueryParams`**: EIA Petroleum Status Report Query Parameters.

    Source: https://www.eia.gov/petroleum/supply/weekly/

**Class `EiaPetroleumStatusReportData`**: EIA Petroleum Status Report Data Model.

**Class `EiaPetroleumStatusReportFetcher`**: EIA Petroleum Status Report Fetcher.
...
- `openbb_core.provider.standard_models.petroleum_status_report`
...
## Notes
- Generated: 2025-11-18T07:54:38.266530
