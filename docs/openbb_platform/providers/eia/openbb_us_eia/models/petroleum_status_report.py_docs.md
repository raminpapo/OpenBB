...
- **Classes** (3): EiaPetroleumStatusReportQueryParams, EiaPetroleumStatusReportData, EiaPetroleumStatusReportFetcher
- **Functions** (6): transform_query, aextract_data, transform_data, replace_data_strings, replacer, read_excel_file
- **Import Statements**: 7
...
- **`EiaPetroleumStatusReportQueryParams`**(PetroleumStatusReportQueryParams)
- **`EiaPetroleumStatusReportData`**(PetroleumStatusReportData)
...
**Generated**: 2025-11-19T02:16:49.377851Z
