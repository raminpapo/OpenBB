# Documentation: openbb_platform/providers/eia/openbb_us_eia/models/short_term_energy_outlook.py

## File Metadata
- **Path**: `openbb_platform/providers/eia/openbb_us_eia/models/short_term_energy_outlook.py`
- **Size**: 11,602 characters, 275 lines
- **Words**: 1,077
- **Extension**: .py
...
**Classes** (3):
`EiaShortTermEnergyOutlookQueryParams`, `EiaShortTermEnergyOutlookData`, `EiaShortTermEnergyOutlookFetcher`

**Functions** (6):
`transform_query`, `aextract_data`, `resample_to_quarter`, `encode_symbols`, `get_one`, `transform_data`

**Imports** (28):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.short_term_energy_outlook`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_us_eia.utils.constants`, `pydantic`, `Field`, `the`, `Shale`, `the`, `asyncio`


## Key Components

**Class `EiaShortTermEnergyOutlookQueryParams`**: EIA Short Term Energy Outlook Query Parameters.

    Monthly short term (18 month) projections using STEO model

    Source: www.eia.gov/steo/

**Class `EiaShortTermEnergyOutlookData`**: EIA Short Term Energy Outlook Data Model.

**Class `EiaShortTermEnergyOutlookFetcher`**: EIA Short Term Energy Outlook Fetcher.
...
- `openbb_core.provider.standard_models.short_term_energy_outlook`
- `openbb_core.provider.utils.descriptions`
- `openbb_core.provider.utils.errors`
- `openbb_us_eia.utils.constants`
- `pydantic`
- `asyncio`

## Notes
- Generated: 2025-11-18T07:54:38.268601
