# Documentation: openbb_platform/providers/finviz/openbb_finviz/utils/screener_helper.py

## File Metadata
- **Path**: `openbb_platform/providers/finviz/openbb_finviz/utils/screener_helper.py`
- **Size**: 53,427 characters, 2,113 lines
- **Words**: 5,124
- **Extension**: .py
...
**Imports** (9):
`typing`, `Literal`, `Open`, `Open`, `shutil`, `pathlib`, `Path`, `warnings`, `warn`
...
## Notes
- Generated: 2025-11-18T07:54:39.219396
