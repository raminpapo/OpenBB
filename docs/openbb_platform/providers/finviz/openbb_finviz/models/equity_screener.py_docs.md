# Documentation: openbb_platform/providers/finviz/openbb_finviz/models/equity_screener.py

## File Metadata
- **Path**: `openbb_platform/providers/finviz/openbb_finviz/models/equity_screener.py`
- **Size**: 27,873 characters, 738 lines
- **Words**: 2,363
- **Extension**: .py
...
**Classes** (3):
`FinvizEquityScreenerQueryParams`, `FinvizEquityScreenerData`, `FinvizEquityScreenerFetcher`

**Functions** (8):
`validate_signal`, `validate_industry`, `validate_preset`, `validate_filters_dict`, `validate_data`, `transform_query`, `extract_data`, `transform_data`

**Imports** (40):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_screener`, `openbb_core.provider.utils.descriptions`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_finviz.utils.screener_helper`, `pydantic`, `Field`, `json`, `e`, `Open`, `the`, `the`


## Key Components

**Class `FinvizEquityScreenerQueryParams`**: Finviz Equity Screener Query Params.

**Class `FinvizEquityScreenerData`**: Finviz Equity Screener Data. Actual returned data varies by the 'metric' parameter.

**Class `FinvizEquityScreenerFetcher`**: Finviz Equity Screener Fetcher.
...
- `openbb_core.provider.standard_models.equity_screener`
- `openbb_core.provider.utils.descriptions`
- `openbb_core.provider.utils.errors`
- `openbb_finviz.utils.screener_helper`
- `pydantic`
- `json`

## Notes
- Generated: 2025-11-18T07:54:39.165361
