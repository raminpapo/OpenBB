...
- **Classes** (3): FinvizEquityScreenerQueryParams, FinvizEquityScreenerData, FinvizEquityScreenerFetcher
- **Functions** (8): validate_signal, validate_industry, validate_preset, validate_filters_dict, validate_data, transform_query, extract_data, transform_data
- **Import Statements**: 8
...
- **`FinvizEquityScreenerQueryParams`**(EquityScreenerQueryParams)
- **`FinvizEquityScreenerData`**(EquityScreenerData)
...
- **`validate_signal(cls, v)`**
- **`validate_industry(cls, v)`**
- **`validate_preset(cls, v)`**
- **`validate_filters_dict(cls, v)`**
- **`validate_data(cls, values)`**
...
**Generated**: 2025-11-19T02:16:50.403854Z
