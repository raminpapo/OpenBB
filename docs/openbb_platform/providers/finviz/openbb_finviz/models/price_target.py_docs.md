# Documentation: openbb_platform/providers/finviz/openbb_finviz/models/price_target.py

## File Metadata
- **Path**: `openbb_platform/providers/finviz/openbb_finviz/models/price_target.py`
- **Size**: 4,589 characters, 135 lines
- **Words**: 374
- **Extension**: .py
...
**Classes** (3):
`FinvizPriceTargetQueryParams`, `FinvizPriceTargetData`, `FinvizPriceTargetFetcher`

**Functions** (4):
`transform_query`, `extract_data`, `get_one`, `transform_data`

**Imports** (22):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.price_target`, `pydantic`, `Field`, `the`, `finvizfinance`, `util`, `finvizfinance.quote`, `finvizfinance`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `get_requests_session`, `pandas`, `DataFrame`


## Key Components

**Class `FinvizPriceTargetQueryParams`**: Finviz Price Target Query.

    Source: https://finviz.com/quote.ashx?

**Class `FinvizPriceTargetData`**: Finviz Price Target Data.

**Class `FinvizPriceTargetFetcher`**: Finviz Price Target Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.172660
