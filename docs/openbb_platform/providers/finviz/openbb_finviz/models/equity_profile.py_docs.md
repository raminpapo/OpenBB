# Documentation: openbb_platform/providers/finviz/openbb_finviz/models/equity_profile.py

## File Metadata
- **Path**: `openbb_platform/providers/finviz/openbb_finviz/models/equity_profile.py`
- **Size**: 8,896 characters, 242 lines
- **Words**: 714
- **Extension**: .py
...
**Classes** (3):
`FinvizEquityProfileQueryParams`, `FinvizEquityProfileData`, `FinvizEquityProfileFetcher`

**Functions** (4):
`transform_query`, `extract_data`, `get_one`, `transform_data`

**Imports** (20):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_info`, `pydantic`, `Field`, `Finviz.`, `finvizfinance`, `util`, `finvizfinance.quote`, `finvizfinance`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `get_requests_session`


## Key Components

**Class `FinvizEquityProfileQueryParams`**: Finviz Equity Profile Query.

    Source: https://finviz.com/screener.ashx

**Class `FinvizEquityProfileData`**: Finviz Equity Profile Data.

**Class `FinvizEquityProfileFetcher`**: Finviz Equity Profile Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.162103
