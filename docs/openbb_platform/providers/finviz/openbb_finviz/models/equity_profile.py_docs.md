...
- **Classes** (3): FinvizEquityProfileQueryParams, FinvizEquityProfileData, FinvizEquityProfileFetcher
...
- **`FinvizEquityProfileQueryParams`**(EquityInfoQueryParams)
- **`FinvizEquityProfileData`**(EquityInfoData)
...
**Generated**: 2025-11-19T02:16:50.400765Z
