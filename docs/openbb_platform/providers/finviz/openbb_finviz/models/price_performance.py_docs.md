...
- **Classes** (3): FinvizPricePerformanceQueryParams, FinvizPricePerformanceData, FinvizPricePerformanceFetcher
...
- **`FinvizPricePerformanceQueryParams`**(RecentPerformanceQueryParams)
- **`FinvizPricePerformanceData`**(RecentPerformanceData)
...
**Generated**: 2025-11-19T02:16:50.410199Z
