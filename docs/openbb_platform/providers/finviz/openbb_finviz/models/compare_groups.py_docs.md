# Documentation: openbb_platform/providers/finviz/openbb_finviz/models/compare_groups.py

## File Metadata
- **Path**: `openbb_platform/providers/finviz/openbb_finviz/models/compare_groups.py`
- **Size**: 10,001 characters, 274 lines
- **Words**: 887
- **Extension**: .py
...
**Classes** (3):
`FinvizCompareGroupsQueryParams`, `FinvizCompareGroupsData`, `FinvizCompareGroupsFetcher`

**Functions** (5):
`validate_percent_values`, `validate_abbreviated_numbers`, `transform_query`, `extract_data`, `transform_data`

**Imports** (22):
`typing`, `Any`, `openbb_core.provider.abstract.data`, `ForceInt`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.compare_groups`, `openbb_core.provider.utils.descriptions`, `DATA_DESCRIPTIONS`, `openbb_finviz.utils.definitions`, `GROUPS`, `pydantic`, `Field`, `Finviz.`, `finvizfinance`, `util`, `finvizfinance.group`, `Overview`, `openbb_core.provider.utils.helpers`, `get_requests_session`


## Key Components

**Class `FinvizCompareGroupsQueryParams`**: Finviz Compare Groups Query Params.

**Class `FinvizCompareGroupsData`**: Finviz Compare Groups Data.

**Class `FinvizCompareGroupsFetcher`**: Finviz Compare Groups Fetcher.
...
- `openbb_core.provider.standard_models.compare_groups`
- `openbb_core.provider.utils.descriptions`
- `openbb_finviz.utils.definitions`
- `pydantic`
- `finvizfinance`
- `finvizfinance.group`
...
## Notes
- Generated: 2025-11-18T07:54:39.159643
