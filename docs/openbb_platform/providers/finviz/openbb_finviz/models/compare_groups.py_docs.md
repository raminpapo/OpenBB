...
- **Classes** (3): FinvizCompareGroupsQueryParams, FinvizCompareGroupsData, FinvizCompareGroupsFetcher
- **Functions** (5): validate_percent_values, validate_abbreviated_numbers, transform_query, extract_data, transform_data
- **Import Statements**: 3
...
- **`FinvizCompareGroupsQueryParams`**(CompareGroupsQueryParams)
- **`FinvizCompareGroupsData`**(CompareGroupsData)
...
- **`validate_percent_values(cls, v)`**
- **`validate_abbreviated_numbers(cls, v)`**
...
**Generated**: 2025-11-19T02:16:50.397995Z
