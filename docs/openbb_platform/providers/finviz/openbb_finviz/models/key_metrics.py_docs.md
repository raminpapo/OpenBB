...
- **Classes** (3): FinvizKeyMetricsQueryParams, FinvizKeyMetricsData, FinvizKeyMetricsFetcher
...
- **`FinvizKeyMetricsQueryParams`**(KeyMetricsQueryParams)
- **`FinvizKeyMetricsData`**(KeyMetricsData)
...
**Generated**: 2025-11-19T02:16:50.407963Z
