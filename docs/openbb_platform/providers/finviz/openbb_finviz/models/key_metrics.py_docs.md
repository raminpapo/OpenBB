# Documentation: openbb_platform/providers/finviz/openbb_finviz/models/key_metrics.py

## File Metadata
- **Path**: `openbb_platform/providers/finviz/openbb_finviz/models/key_metrics.py`
- **Size**: 11,740 characters, 300 lines
- **Words**: 876
- **Extension**: .py
...
**Classes** (3):
`FinvizKeyMetricsQueryParams`, `FinvizKeyMetricsData`, `FinvizKeyMetricsFetcher`

**Functions** (4):
`transform_query`, `extract_data`, `get_one`, `transform_data`

**Imports** (20):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.key_metrics`, `pydantic`, `Field`, `Finviz.`, `finvizfinance`, `util`, `finvizfinance.quote`, `finvizfinance`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `get_requests_session`


## Key Components

**Class `FinvizKeyMetricsQueryParams`**: Finviz Key Metrics Query.

    Source: https://finviz.com/screener.ashx

**Class `FinvizKeyMetricsData`**: Finviz Key Metrics Data.

**Class `FinvizKeyMetricsFetcher`**: Finviz Key Metrics Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:39.168693
