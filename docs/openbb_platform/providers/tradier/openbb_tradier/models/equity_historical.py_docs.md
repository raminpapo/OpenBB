# Documentation: openbb_platform/providers/tradier/openbb_tradier/models/equity_historical.py

## File Metadata
- **Path**: `openbb_platform/providers/tradier/openbb_tradier/models/equity_historical.py`
- **Size**: 6,953 characters, 194 lines
- **Words**: 566
- **Extension**: .py
...
**Classes** (3):
`TradierEquityHistoricalQueryParams`, `TradierEquityHistoricalData`, `TradierEquityHistoricalFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (27):
`datetime`, `datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_historical`, `openbb_core.provider.utils.descriptions`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_tradier.utils.constants`, `INTERVALS_DICT`, `pydantic`, `Field`, `datetime`, `timedelta`


## Key Components

**Class `TradierEquityHistoricalQueryParams`**: Tradier Equity Historical Query.

**Class `TradierEquityHistoricalData`**: Tradier Equity Historical Data.

**Class `TradierEquityHistoricalFetcher`**: Tradier Equity Historical Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.384424
