# Documentation: openbb_platform/providers/tradier/openbb_tradier/models/equity_quote.py

## File Metadata
- **Path**: `openbb_platform/providers/tradier/openbb_tradier/models/equity_quote.py`
- **Size**: 9,375 characters, 294 lines
- **Words**: 833
- **Extension**: .py
...
**Classes** (3):
`TradierEquityQuoteQueryParams`, `TradierEquityQuoteData`, `TradierEquityQuoteFetcher`

**Functions** (6):
`validate_dates`, `normalize_percent`, `replace_zero`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (23):
`datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.equity_quote`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_tradier.utils.constants`, `OPTIONS_EXCHANGES`, `pydantic`, `Field`, `dateutil.parser`, `parse`, `openbb_core.provider.utils.helpers`, `safe_fromtimestamp`, `pytz`, `timezone`


## Key Components

**Class `TradierEquityQuoteQueryParams`**: Tradier Equity Quote Query.

**Class `TradierEquityQuoteData`**: Tradier Equity Quote Data.

**Class `TradierEquityQuoteFetcher`**: Tradier Equity Quote Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:43.386663
