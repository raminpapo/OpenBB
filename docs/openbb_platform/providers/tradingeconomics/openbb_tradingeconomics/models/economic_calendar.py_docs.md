# Documentation: openbb_platform/providers/tradingeconomics/openbb_tradingeconomics/models/economic_calendar.py

## File Metadata
- **Path**: `openbb_platform/providers/tradingeconomics/openbb_tradingeconomics/models/economic_calendar.py`
- **Size**: 8,243 characters, 267 lines
- **Words**: 700
- **Extension**: .py
...
**Classes** (3):
`TEEconomicCalendarQueryParams`, `TEEconomicCalendarData`, `TEEconomicCalendarFetcher`

**Functions** (9):
`validate_country`, `importance_to_number`, `importance_to_number`, `validate_datetime`, `validate_date`, `empty_strings`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (28):
`datetime`, `typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.economic_calendar`, `openbb_tradingeconomics.utils.countries`, `COUNTRIES`, `pydantic`, `Field`, `openbb_core.provider.utils.helpers`, `check_item`, `pandas`, `to_datetime`, `pandas`, `to_datetime`


## Key Components

**Class `TEEconomicCalendarQueryParams`**: Trading Economics Economic Calendar Query.

    Source: https://docs.tradingeconomics.com/economic_calendar/

**Class `TEEconomicCalendarData`**: Trading Economics Economic Calendar Data.

**Class `TEEconomicCalendarFetcher`**: Transform the query, extract and transform the data from the Trading Economics endpoints.
...
- `openbb_core.provider.standard_models.economic_calendar`
- `openbb_tradingeconomics.utils.countries`
- `pydantic`
- `openbb_core.provider.utils.helpers`
- `pandas`

## Notes
- Generated: 2025-11-18T07:54:43.477905
