# Documentation: openbb_platform/providers/tradingeconomics/openbb_tradingeconomics/utils/url_generator.py

## File Metadata
- **Path**: `openbb_platform/providers/tradingeconomics/openbb_tradingeconomics/utils/url_generator.py`
- **Size**: 4,190 characters, 97 lines
- **Words**: 415
- **Extension**: .py
...
**Functions** (2):
`check_args`, `generate_url`

**Imports** (4):
`datetime`, `date`, `urllib.parse`, `quote`
...
## Notes
- Generated: 2025-11-18T07:54:43.482684
