# File Documentation: treasury_auctions.py
...
This is a **python** file named `treasury_auctions.py`.

**Python Module**

- **Classes** (3): GovernmentUSTreasuryAuctionsQueryParams, GovernementUSTreasuryAuctionsData, GovernmentUSTreasuryAuctionsFetcher
- **Functions** (4): _normalize_percent, transform_query, extract_data, transform_data
- **Import Statements**: 3
...
- **`GovernmentUSTreasuryAuctionsQueryParams`**(USTreasuryAuctionsQueryParams)
- **`GovernementUSTreasuryAuctionsData`**(USTreasuryAuctionsData)
...
classmethod, model_validator, staticmethod
...
**Generated**: 2025-11-19T02:16:51.209246Z
