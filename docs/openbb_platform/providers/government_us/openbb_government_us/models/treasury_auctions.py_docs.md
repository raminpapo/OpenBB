# Documentation: openbb_platform/providers/government_us/openbb_government_us/models/treasury_auctions.py

## File Metadata
- **Path**: `openbb_platform/providers/government_us/openbb_government_us/models/treasury_auctions.py`
- **Size**: 9,932 characters, 236 lines
- **Words**: 522
- **Extension**: .py
...
**Classes** (3):
`GovernmentUSTreasuryAuctionsQueryParams`, `GovernementUSTreasuryAuctionsData`, `GovernmentUSTreasuryAuctionsFetcher`

**Functions** (4):
`_normalize_percent`, `transform_query`, `extract_data`, `transform_data`

**Imports** (14):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.treasury_auctions`, `pydantic`, `model_validator`, `the`, `Treasury`, `pandas`, `DataFrame`, `openbb_core.provider.utils.helpers`


## Key Components

**Class `GovernmentUSTreasuryAuctionsQueryParams`**: US Government Treasury Auctions Query.

    Source: https://www.treasurydirect.gov/

**Class `GovernementUSTreasuryAuctionsData`**: US Government Treasury Auctions Data.

**Class `GovernmentUSTreasuryAuctionsFetcher`**: Transform the query, extract and transform the data from the us treasury endpoints.
...
- `openbb_core.provider.standard_models.treasury_auctions`
- `pydantic`
- `pandas`
- `openbb_core.provider.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:39.902470
