# Documentation: openbb_platform/providers/bls/openbb_bls/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/providers/bls/openbb_bls/utils/helpers.py`
- **Size**: 17,220 characters, 435 lines
- **Words**: 1,688
- **Extension**: .py
...
**Functions** (6):
`get_bls_timeseries`, `get_survey_asset`, `download_category_series_ids`, `get_all_series_ids`, `open_asset`, `update_static_asset`

**Imports** (52):
`typing`, `TYPE_CHECKING`, `pandas`, `DataFrame`, `json`, `warnings`, `warn`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_request`, `the`, `io`, `StringIO`, `openbb_core.provider.utils.helpers`, `make_request`, `numpy`, `nan`, `pandas`, `read_csv`
...
## Notes
- Generated: 2025-11-18T07:54:37.435392
