# Documentation: openbb_platform/providers/bls/openbb_bls/models/series.py

## File Metadata
- **Path**: `openbb_platform/providers/bls/openbb_bls/models/series.py`
- **Size**: 7,640 characters, 219 lines
- **Words**: 672
- **Extension**: .py
...
**Classes** (3):
`BlsSeriesQueryParams`, `BlsSeriesData`, `BlsSeriesFetcher`

**Functions** (6):
`transform_query`, `aextract_data`, `chunk_list`, `chunk_years`, `make_query`, `transform_data`

**Imports** (22):
`typing`, `Any`, `warnings`, `warn`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.bls_series`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `asyncio`, `datetime`, `datetime`, `openbb_bls.utils.helpers`


## Key Components

**Class `BlsSeriesQueryParams`**: BLS Series Query Parameters.

**Class `BlsSeriesData`**: BLS Series Data.

**Class `BlsSeriesFetcher`**: BLS Series Fetcher.
...
- `openbb_core.provider.standard_models.bls_series`
...
## Notes
- Generated: 2025-11-18T07:54:37.430536
