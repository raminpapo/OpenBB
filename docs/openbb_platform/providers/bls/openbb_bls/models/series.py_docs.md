...
This is a **python** file named `series.py`.

**Python Module**

- **Classes** (3): BlsSeriesQueryParams, BlsSeriesData, BlsSeriesFetcher
- **Functions** (6): transform_query, aextract_data, chunk_list, chunk_years, make_query, transform_data
- **Import Statements**: 4
...
- **`BlsSeriesQueryParams`**(SeriesQueryParams)
- **`BlsSeriesData`**(SeriesData)
- **`BlsSeriesFetcher`**(Fetcher[BlsSeriesQueryParams, list[BlsSeriesData]])

#### Functions

- **`chunk_list(lst, chunk_size)`**
- **`chunk_years(start_year, end_year, chunk_size)`**
- **`make_query(symbol, start, end)`**
...
**Generated**: 2025-11-19T02:16:48.478417Z
