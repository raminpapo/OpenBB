# Documentation: openbb_platform/providers/bls/openbb_bls/models/search.py

## File Metadata
- **Path**: `openbb_platform/providers/bls/openbb_bls/models/search.py`
- **Size**: 5,155 characters, 153 lines
- **Words**: 473
- **Extension**: .py
...
**Classes** (3):
`BlsSearchQueryParams`, `BlsSearchData`, `BlsSearchFetcher`

**Functions** (3):
`transform_query`, `extract_data`, `transform_data`

**Imports** (23):
`typing`, `Any`, `openbb_bls.utils.constants`, `SURVEY_CATEGORIES`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.annotated_result`, `AnnotatedResult`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.bls_search`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `openbb_bls.utils.helpers`, `open_asset`, `pandas`, `Series`, `e`


## Key Components

**Class `BlsSearchQueryParams`**: BLS Search Query Parameters.

**Class `BlsSearchData`**: BLS Search Data.

**Class `BlsSearchFetcher`**: BLS Search Fetcher.
...
- `typing`
- `openbb_bls.utils.constants`
- `openbb_core.app.model.abstract.error`
- `openbb_core.provider.abstract.annotated_result`
- `openbb_core.provider.abstract.fetcher`
- `openbb_core.provider.standard_models.bls_search`
- `openbb_core.provider.utils.errors`
- `pydantic`
- `openbb_bls.utils.helpers`
- `pandas`

## Notes
- Generated: 2025-11-18T07:54:37.428706
