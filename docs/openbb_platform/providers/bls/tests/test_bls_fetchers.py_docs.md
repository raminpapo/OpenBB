# File Documentation: test_bls_fetchers.py
...
This is a **python** file named `test_bls_fetchers.py`.

**Python Module**

- **Functions** (3): vcr_config, test_bls_series_fetcher, test_bls_search_fetcher
- **Import Statements**: 1
...
- **`vcr_config()`**
- **`test_bls_series_fetcher(credentials=test_credentials)`**
- **`test_bls_search_fetcher(credentials=test_credentials)`**
...
**Generated**: 2025-11-19T02:16:48.488801Z
