# File Documentation: test_federal_reserve_fetchers.py

## Metadata
- **Path**: `openbb_platform/providers/federal_reserve/tests/test_federal_reserve_fetchers.py`
- **Size**: 5,145 bytes
- **Lines**: 158
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_federal_reserve_fetchers.py`.

**Python Module**

- **Functions** (11): vcr_config, test_federal_reserve_treasury_rates_fetcher, test_federal_reserve_money_measures_fetcher, test_federal_reserve_federal_funds_rate_fetcher, test_federal_reserve_yield_curve_fetcher, test_federal_reserve_central_bank_holdings_fetcher, test_federal_reserve_sofr_fetcher, test_federal_reserve_overnight_bank_funding_rate_fetcher, test_federal_reserve_primary_dealer_positioning_fetcher, test_federal_reserve_primary_dealer_fails_fetcher ... and 1 more
- **Import Statements**: 3
...
- **`vcr_config()`**
- **`test_federal_reserve_treasury_rates_fetcher(credentials=test_credentials)`**
- **`test_federal_reserve_money_measures_fetcher(credentials=test_credentials)`**
- **`test_federal_reserve_federal_funds_rate_fetcher(credentials=test_credentials)`**
- **`test_federal_reserve_yield_curve_fetcher(credentials=test_credentials)`**
- **`test_federal_reserve_central_bank_holdings_fetcher(credentials=test_credentials)`**
- **`test_federal_reserve_sofr_fetcher(credentials=test_credentials)`**
- **`test_federal_reserve_overnight_bank_funding_rate_fetcher(
    credentials=test_credentials,
)`**
- **`test_federal_reserve_primary_dealer_positioning_fetcher(
    credentials=test_credentials,
...
- **`test_federal_reserve_fomc_documents_fetcher(
    credentials=test_credentials,
)`**
...
**Generated**: 2025-11-19T02:16:49.665119Z
