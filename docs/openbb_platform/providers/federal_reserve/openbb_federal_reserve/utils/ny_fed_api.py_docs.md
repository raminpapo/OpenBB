# File Documentation: ny_fed_api.py
...
This is a **python** file named `ny_fed_api.py`.

**Python Module**

- **Classes** (1): SomaHoldings
- **Functions** (10): _get_endpoints, fetch_data, get_nearest_date, __init__, __repr__, get_as_of_dates, get_release_log, get_summary, get_agency_holdings, get_treasury_holdings
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:16:49.659333Z
