# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/utils/ny_fed_api.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/utils/ny_fed_api.py`
- **Size**: 20,839 characters, 559 lines
- **Words**: 1,708
- **Extension**: .py
...
**Functions** (10):
`_get_endpoints`, `fetch_data`, `get_nearest_date`, `__init__`, `__repr__`, `get_as_of_dates`, `get_release_log`, `get_summary`, `get_agency_holdings`, `get_treasury_holdings`

**Imports** (12):
`typing`, `Literal`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_core.provider.utils.helpers`, `amake_request`, `pandas`, `DataFrame`, `the`, `e`


## Key Components

**Class `SomaHoldings`**: Wrapper for NY Fed's System Open Market Account endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:38.512871
