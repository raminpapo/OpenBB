# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/utils/fomc_documents.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/utils/fomc_documents.py`
- **Size**: 7,252 characters, 246 lines
- **Words**: 708
- **Extension**: .py
...
**Functions** (4):
`load_historical_fomc_documents`, `get_current_fomc_documents`, `get_fomc_documents_by_year`, `get_beige_books`

**Imports** (13):
`functools`, `lru_cache`, `typing`, `Literal`, `the`, `json`, `https`, `re`, `bs4`, `BeautifulSoup`, `openbb_core.provider.utils.helpers`, `make_request`, `1959.`
...
## Notes
- Generated: 2025-11-18T07:54:38.510824
