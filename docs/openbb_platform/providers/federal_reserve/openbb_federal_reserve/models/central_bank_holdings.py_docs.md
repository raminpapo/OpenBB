...
- **Classes** (3): FederalReserveCentralBankHoldingsQueryParams, FederalReserveCentralBankHoldingsData, FederalReserveCentralBankHoldingsFetcher
- **Functions** (6): validate_security_type, normalize_percent, empty_strings, transform_query, aextract_data, transform_data
- **Import Statements**: 3
...
- **`FederalReserveCentralBankHoldingsQueryParams`**(CentralBankHoldingsQueryParams)
- **`FederalReserveCentralBankHoldingsData`**(CentralBankHoldingsData)
...
**Generated**: 2025-11-19T02:16:49.636080Z
