# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/central_bank_holdings.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/central_bank_holdings.py`
- **Size**: 13,126 characters, 369 lines
- **Words**: 1,150
- **Extension**: .py
...
**Classes** (3):
`FederalReserveCentralBankHoldingsQueryParams`, `FederalReserveCentralBankHoldingsData`, `FederalReserveCentralBankHoldingsFetcher`

**Functions** (6):
`validate_security_type`, `normalize_percent`, `empty_strings`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (16):
`datetime`, `date`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.central_bank_holdings`, `openbb_core.provider.utils.descriptions`, `pydantic`, `Field`, `2003`, `the`, `the`, `the`, `openbb_federal_reserve.utils.ny_fed_api`, `SomaHoldings`


## Key Components

**Class `FederalReserveCentralBankHoldingsQueryParams`**: Federal Reserve Central Bank Holdings Query.

    The SOMA database contains data on the Federal Reserve's
    domestic securities holdings from 2003 to the present.
    SOMA holdings data is as of th

**Class `FederalReserveCentralBankHoldingsData`**: Federal Reserve Central Bank Holdings Data.

**Class `FederalReserveCentralBankHoldingsFetcher`**: Federal Reserve Central Bank Holdings Fetcher.
...
- `openbb_core.provider.standard_models.central_bank_holdings`
- `openbb_core.provider.utils.descriptions`
- `pydantic`
- `openbb_federal_reserve.utils.ny_fed_api`

## Notes
- Generated: 2025-11-18T07:54:38.494688
