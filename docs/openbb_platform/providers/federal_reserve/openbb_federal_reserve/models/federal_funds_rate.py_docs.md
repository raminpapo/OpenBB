...
- **Classes** (3): FederalReserveFederalFundsRateQueryParams, FederalReserveFederalFundsRateData, FederalReserveFederalFundsRateFetcher
- **Functions** (5): validate_revision_indicator, normalize_percent, transform_query, aextract_data, transform_data
- **Import Statements**: 3
...
- **`FederalReserveFederalFundsRateQueryParams`**(FederalFundsRateQueryParams)
- **`FederalReserveFederalFundsRateData`**(FederalFundsRateData)
...
- **`validate_revision_indicator(cls, v)`**
...
**Generated**: 2025-11-19T02:16:49.639001Z
