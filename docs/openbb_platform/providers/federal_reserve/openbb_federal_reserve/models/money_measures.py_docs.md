# File Documentation: money_measures.py
...
This is a **python** file named `money_measures.py`.

**Python Module**

- **Classes** (3): FederalReserveMoneyMeasuresQueryParams, FederalReserveMoneyMeasuresData, FederalReserveMoneyMeasuresFetcher
...
- **`FederalReserveMoneyMeasuresQueryParams`**(MoneyMeasuresQueryParams)
- **`FederalReserveMoneyMeasuresData`**(MoneyMeasuresData)
...
**Generated**: 2025-11-19T02:16:49.642690Z
