# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/primary_dealer_positioning.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/primary_dealer_positioning.py`
- **Size**: 4,557 characters, 153 lines
- **Words**: 339
- **Extension**: .py
...
**Classes** (3):
`FederalReservePrimaryDealerPositioningQueryParams`, `FederalReservePrimaryDealerPositioningData`, `FederalReservePrimaryDealerPositioningFetcher`

**Functions** (4):
`transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (17):
`typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.primary_dealer_positioning`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `asyncio`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_federal_reserve.utils.primary_dealer_statistics`, `openbb_federal_reserve.utils.primary_dealer_statistics`, `pandas`, `DataFrame`


## Key Components

**Class `FederalReservePrimaryDealerPositioningQueryParams`**: Federal Reserve Primary Dealer Positioning Query Params.

**Class `FederalReservePrimaryDealerPositioningData`**: Federal Reserve Primary Dealer Positioning Data.

**Class `FederalReservePrimaryDealerPositioningFetcher`**: Federal Reserve Primary Dealer Positioning Fetcher.
...
- `openbb_core.provider.standard_models.primary_dealer_positioning`
...
## Notes
- Generated: 2025-11-18T07:54:38.504147
