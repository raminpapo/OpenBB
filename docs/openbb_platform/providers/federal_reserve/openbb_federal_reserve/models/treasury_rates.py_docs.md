# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/treasury_rates.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/treasury_rates.py`
- **Size**: 3,876 characters, 121 lines
- **Words**: 307
- **Extension**: .py
...
**Classes** (3):
`FederalReserveTreasuryRatesQueryParams`, `FederalReserveTreasuryRatesData`, `FederalReserveTreasuryRatesFetcher`

**Functions** (4):
`date_validate`, `transform_query`, `extract_data`, `transform_data`

**Imports** (25):
`datetime`, `datetime`, `typing`, `TYPE_CHECKING`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.treasury_rates`, `pydantic`, `field_validator`, `pandas`, `DataFrame`, `the`, `datetime`, `timedelta`, `the`, `io`, `BytesIO`, `openbb_core.provider.utils.helpers`, `make_request`, `numpy`


## Key Components

**Class `FederalReserveTreasuryRatesQueryParams`**: FederalReserve Treasury Rates Query.

**Class `FederalReserveTreasuryRatesData`**: FederalReserve Treasury Rates Data.

**Class `FederalReserveTreasuryRatesFetcher`**: Transform the query, extract and transform the data from the FederalReserve endpoints.
...
- `openbb_core.provider.standard_models.treasury_rates`
- `pydantic`
- `pandas`
- `datetime`
- `io`
...
## Notes
- Generated: 2025-11-18T07:54:38.507009
