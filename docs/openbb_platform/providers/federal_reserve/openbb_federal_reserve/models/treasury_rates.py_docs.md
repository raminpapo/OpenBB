...
- **Classes** (3): FederalReserveTreasuryRatesQueryParams, FederalReserveTreasuryRatesData, FederalReserveTreasuryRatesFetcher
...
- **`FederalReserveTreasuryRatesQueryParams`**(TreasuryRatesQueryParams)
- **`FederalReserveTreasuryRatesData`**(TreasuryRatesData)
...
**Generated**: 2025-11-19T02:16:49.651897Z
