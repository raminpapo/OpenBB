# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/yield_curve.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/yield_curve.py`
- **Size**: 3,905 characters, 118 lines
- **Words**: 289
- **Extension**: .py
...
**Classes** (3):
`FederalReserveYieldCurveQueryParams`, `FederalReserveYieldCurveData`, `FederalReserveYieldCurveFetcher`

**Functions** (3):
`transform_query`, `extract_data`, `transform_data`

**Imports** (17):
`typing`, `TYPE_CHECKING`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.yield_curve`, `pandas`, `DataFrame`, `io`, `BytesIO`, `numpy`, `nan`, `openbb_core.provider.utils.helpers`, `make_request`, `pandas`, `read_csv`, `pandas`, `Categorical`


## Key Components

**Class `FederalReserveYieldCurveQueryParams`**: FederalReserve Yield Curve Query.

**Class `FederalReserveYieldCurveData`**: FederalReserve Yield Curve Data.

**Class `FederalReserveYieldCurveFetcher`**: FederalReserve Yield Curve Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.508511
