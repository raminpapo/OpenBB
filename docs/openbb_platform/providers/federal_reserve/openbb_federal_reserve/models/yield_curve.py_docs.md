...
- **Classes** (3): FederalReserveYieldCurveQueryParams, FederalReserveYieldCurveData, FederalReserveYieldCurveFetcher
...
- **`FederalReserveYieldCurveQueryParams`**(YieldCurveQueryParams)
- **`FederalReserveYieldCurveData`**(YieldCurveData)
...
**Generated**: 2025-11-19T02:16:49.653639Z
