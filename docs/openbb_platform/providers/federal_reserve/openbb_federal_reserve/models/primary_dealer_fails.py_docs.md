# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/primary_dealer_fails.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/primary_dealer_fails.py`
- **Size**: 7,381 characters, 186 lines
- **Words**: 627
- **Extension**: .py
...
**Classes** (4):
`FederalReservePrimaryDealerFailsQueryParams`, `to`, `FederalReservePrimaryDealerFailsData`, `FederalReservePrimaryDealerFailsFetcher`

**Functions** (3):
`transform_query`, `aextract_data`, `transform_data`

**Imports** (23):
`typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.primary_dealer_fails`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_federal_reserve.utils.primary_dealer_statistics`, `FAILS_SERIES_TO_TITLE`, `pydantic`, `Field`, `the`, `datetime`, `datetime`, `openbb_core.provider.utils.helpers`, `amake_request`, `the`, `e`


## Key Components

**Class `FederalReservePrimaryDealerFailsQueryParams`**: Federal Reserve Primary Dealer Fails Query Params.

**Class `to`**: No documentation

**Class `FederalReservePrimaryDealerFailsData`**: Federal Reserve Primary Dealer Fails Data.

**Class `FederalReservePrimaryDealerFailsFetcher`**: Federal Reserve Primary Dealer Fails Fetcher.
...
- `openbb_core.provider.standard_models.primary_dealer_fails`
...
## Notes
- Generated: 2025-11-18T07:54:38.502594
