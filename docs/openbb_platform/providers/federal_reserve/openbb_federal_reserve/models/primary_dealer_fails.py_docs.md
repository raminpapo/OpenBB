# File Documentation: primary_dealer_fails.py
...
This is a **python** file named `primary_dealer_fails.py`.

**Python Module**

- **Classes** (4): FederalReservePrimaryDealerFailsQueryParams, to, FederalReservePrimaryDealerFailsData, FederalReservePrimaryDealerFailsFetcher
...
- **`FederalReservePrimaryDealerFailsQueryParams`**(PrimaryDealerFailsQueryParams)
- **`FederalReservePrimaryDealerFailsData`**(PrimaryDealerFailsData)
...
**Generated**: 2025-11-19T02:16:49.646273Z
