# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/fomc_documents.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/fomc_documents.py`
- **Size**: 5,469 characters, 170 lines
- **Words**: 486
- **Extension**: .py
...
**Classes** (3):
`FederalReserveFomcDocumentsQueryParams`, `FederalReserveFomcDocumentsData`, `FederalReserveFomcDocumentsFetcher`

**Functions** (4):
`_validate_doc_type`, `transform_query`, `extract_data`, `transform_data`

**Imports** (17):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `openbb_federal_reserve.utils.fomc_documents`, `FomcDocumentType`, `pydantic`, `Field`, `openbb_federal_reserve.utils.fomc_documents`


## Key Components

**Class `FederalReserveFomcDocumentsQueryParams`**: Federal Reserve FOMC Documents Query.

**Class `FederalReserveFomcDocumentsData`**: Federal Reserve FOMC Documents Data.

**Class `FederalReserveFomcDocumentsFetcher`**: Federal Reserve FOMC Documents Fetcher.
...
- `openbb_federal_reserve.utils.fomc_documents`
- `pydantic`
- `openbb_federal_reserve.utils.fomc_documents`

## Notes
- Generated: 2025-11-18T07:54:38.498252
