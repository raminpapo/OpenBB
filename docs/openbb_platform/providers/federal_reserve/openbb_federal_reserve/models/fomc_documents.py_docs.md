# File Documentation: fomc_documents.py
...
This is a **python** file named `fomc_documents.py`.

**Python Module**

- **Classes** (3): FederalReserveFomcDocumentsQueryParams, FederalReserveFomcDocumentsData, FederalReserveFomcDocumentsFetcher
- **Functions** (4): _validate_doc_type, transform_query, extract_data, transform_data
- **Import Statements**: 1
...
- **`FederalReserveFomcDocumentsQueryParams`**(QueryParams)
- **`FederalReserveFomcDocumentsData`**(Data)
...
**Generated**: 2025-11-19T02:16:49.640841Z
