# Documentation: openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/sofr.py

## File Metadata
- **Path**: `openbb_platform/providers/federal_reserve/openbb_federal_reserve/models/sofr.py`
- **Size**: 3,245 characters, 109 lines
- **Words**: 237
- **Extension**: .py
...
**Classes** (3):
`FederalReserveSOFRQueryParams`, `FederalReserveSOFRData`, `FederalReserveSOFRFetcher`

**Functions** (4):
`normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (13):
`datetime`, `datetime`, `typing`, `Any`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.sofr`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `field_validator`, `openbb_core.provider.utils.helpers`, `amake_request`


## Key Components

**Class `FederalReserveSOFRQueryParams`**: FederalReserve FED Query.

**Class `FederalReserveSOFRData`**: FederalReserve FED Data.

**Class `FederalReserveSOFRFetcher`**: Federal Reserve Federal Funds Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:38.505574
