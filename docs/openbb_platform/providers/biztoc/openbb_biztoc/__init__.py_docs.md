# Documentation: openbb_platform/providers/biztoc/openbb_biztoc/__init__.py

## File Metadata
- **Path**: `openbb_platform/providers/biztoc/openbb_biztoc/__init__.py`
- **Size**: 1,585 characters, 26 lines
- **Words**: 139
- **Extension**: .py
...
**Imports** (4):
`openbb_biztoc.models.world_news`, `BiztocWorldNewsFetcher`, `openbb_core.provider.abstract.provider`, `Provider`
...
## Notes
- Generated: 2025-11-18T07:54:37.314029
