# Documentation: openbb_platform/providers/benzinga/tests/record/http/test_benzinga_fetchers/test_benzinga_price_target_fetcher_urllib3_v2.yaml

## File Metadata
- **Path**: `openbb_platform/providers/benzinga/tests/record/http/test_benzinga_fetchers/test_benzinga_price_target_fetcher_urllib3_v2.yaml`
- **Size**: 16,456 characters, 231 lines
- **Words**: 271
- **Extension**: .yaml
...
- request:
    ...
    headers:
      ...
      - keep-alive
    method: GET
    uri: https://api.benzinga.com/api/v2.1/calendar/ratings?page=0&pagesize=200&parameters%5Btickers%5D=AAPL&token=MOCK_TOKEN
  response:
    body:
      string: !!binary |
...
This is a .yaml file containing 231 lines of code.
...
## Notes
- Generated: 2025-11-18T07:54:37.306379
