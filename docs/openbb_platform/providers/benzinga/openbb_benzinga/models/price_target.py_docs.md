...
- **Classes** (3): BenzingaPriceTargetQueryParams, BenzingaPriceTargetData, BenzingaPriceTargetFetcher
- **Functions** (9): convert_action, date_validate, convert_list, parse_date, validate_date, replace_empty_strings, transform_query, aextract_data, transform_data
- **Import Statements**: 4
...
- **`BenzingaPriceTargetData`**(PriceTargetData)
...
- **`convert_action(cls, v)`**
- **`date_validate(cls, v)`**
- **`convert_list(cls, v: str | list[str])`**
- **`parse_date(cls, v: str)`**
...
**Generated**: 2025-11-19T02:16:48.284814Z
