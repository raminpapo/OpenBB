# Documentation: openbb_platform/providers/benzinga/openbb_benzinga/models/price_target.py

## File Metadata
- **Path**: `openbb_platform/providers/benzinga/openbb_benzinga/models/price_target.py`
- **Size**: 11,175 characters, 322 lines
- **Words**: 981
- **Extension**: .py
...
**Classes** (3):
`BenzingaPriceTargetQueryParams`, `BenzingaPriceTargetData`, `BenzingaPriceTargetFetcher`

**Functions** (9):
`convert_action`, `date_validate`, `convert_list`, `parse_date`, `validate_date`, `replace_empty_strings`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (26):
`datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.price_target`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `0`, `and`, `firm`, `firm`, `openbb_core.provider.utils.helpers`, `safe_fromtimestamp`


## Key Components

**Class `BenzingaPriceTargetQueryParams`**: Benzinga Price Target Query.

    Source: https://docs.benzinga.io/benzinga-apis/calendar/get-ratings

**Class `BenzingaPriceTargetData`**: Benzinga Price Target Data.

**Class `BenzingaPriceTargetFetcher`**: Transform the query, extract and transform the data from the Benzinga endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:37.277633
