...
- **Classes** (3): BenzingaWorldNewsQueryParams, BenzingaWorldNewsData, BenzingaWorldNewsFetcher
- **Functions** (8): date_validate, list_validate, id_validate, empty_list, transform_query, aextract_data, get_one, transform_data
- **Import Statements**: 4
...
- **`BenzingaWorldNewsQueryParams`**(WorldNewsQueryParams)
- **`BenzingaWorldNewsData`**(WorldNewsData)
...
**Generated**: 2025-11-19T02:16:48.287692Z
