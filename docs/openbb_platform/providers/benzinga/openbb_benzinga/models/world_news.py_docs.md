# Documentation: openbb_platform/providers/benzinga/openbb_benzinga/models/world_news.py

## File Metadata
- **Path**: `openbb_platform/providers/benzinga/openbb_benzinga/models/world_news.py`
- **Size**: 6,651 characters, 193 lines
- **Words**: 630
- **Extension**: .py
...
**Classes** (3):
`BenzingaWorldNewsQueryParams`, `BenzingaWorldNewsData`, `BenzingaWorldNewsFetcher`

**Functions** (8):
`date_validate`, `list_validate`, `id_validate`, `empty_list`, `transform_query`, `aextract_data`, `get_one`, `transform_data`

**Imports** (22):
`datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.world_news`, `openbb_core.provider.utils.descriptions`, `QUERY_DESCRIPTIONS`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `the`, `asyncio`, `math`, `openbb_core.provider.utils.helpers`, `amake_request`, `openbb_benzinga.utils.helpers`


## Key Components

**Class `BenzingaWorldNewsQueryParams`**: Benzinga World News Query.

    Source: https://docs.benzinga.io/benzinga/newsfeed-v2.html

**Class `BenzingaWorldNewsData`**: Benzinga World News Data.

**Class `BenzingaWorldNewsFetcher`**: Transform the query, extract and transform the data from the Benzinga endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:37.279617
