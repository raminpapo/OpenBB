# Documentation: openbb_platform/providers/benzinga/openbb_benzinga/models/analyst_search.py

## File Metadata
- **Path**: `openbb_platform/providers/benzinga/openbb_benzinga/models/analyst_search.py`
- **Size**: 19,237 characters, 464 lines
- **Words**: 1,801
- **Extension**: .py
...
**Classes** (3):
`BenzingaAnalystSearchQueryParams`, `BenzingaAnalystSearchData`, `BenzingaAnalystSearchFetcher`

**Functions** (6):
`validate_date`, `replace_empty_strings`, `normalize_percent`, `transform_query`, `aextract_data`, `transform_data`

**Imports** (19):
`datetime`, `typing`, `Any`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.standard_models.analyst_search`, `openbb_core.provider.utils.errors`, `EmptyDataError`, `pydantic`, `Field`, `0`, `openbb_core.provider.utils.helpers`, `safe_fromtimestamp`, `openbb_benzinga.utils.helpers`, `response_callback`, `openbb_core.provider.utils.helpers`, `amake_request`


## Key Components

**Class `BenzingaAnalystSearchQueryParams`**: Benzinga Analyst Search Query.

    Source: https://docs.benzinga.io/benzinga-apis/calendar/get-analysts

**Class `BenzingaAnalystSearchData`**: Benzinga Analyst Search Data.

**Class `BenzingaAnalystSearchFetcher`**: Benzinga Analyst Search Fetcher.
...
- `openbb_core.provider.standard_models.analyst_search`
- `openbb_core.provider.utils.errors`
- `pydantic`
- `openbb_core.provider.utils.helpers`
- `openbb_benzinga.utils.helpers`
- `openbb_core.provider.utils.helpers`

## Notes
- Generated: 2025-11-18T07:54:37.272825
