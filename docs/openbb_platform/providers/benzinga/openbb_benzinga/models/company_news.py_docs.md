# Documentation: openbb_platform/providers/benzinga/openbb_benzinga/models/company_news.py

## File Metadata
- **Path**: `openbb_platform/providers/benzinga/openbb_benzinga/models/company_news.py`
- **Size**: 6,690 characters, 191 lines
- **Words**: 611
- **Extension**: .py
...
**Classes** (3):
`BenzingaCompanyNewsQueryParams`, `BenzingaCompanyNewsData`, `BenzingaCompanyNewsFetcher`

**Functions** (7):
`date_validate`, `list_validate`, `id_validate`, `transform_query`, `aextract_data`, `get_one`, `transform_data`
...
**Class `BenzingaCompanyNewsQueryParams`**: Benzinga Company News Query.

    Source: https://docs.benzinga.io/benzinga/newsfeed-v2.html

**Class `BenzingaCompanyNewsData`**: Benzinga Company News Data.

**Class `BenzingaCompanyNewsFetcher`**: Transform the query, extract and transform the data from the Benzinga endpoints.
...
## Notes
- Generated: 2025-11-18T07:54:37.275433
