...
- **Classes** (3): BenzingaCompanyNewsQueryParams, BenzingaCompanyNewsData, BenzingaCompanyNewsFetcher
- **Functions** (7): date_validate, list_validate, id_validate, transform_query, aextract_data, get_one, transform_data
- **Import Statements**: 4
...
- **`BenzingaCompanyNewsQueryParams`**(CompanyNewsQueryParams)
- **`BenzingaCompanyNewsData`**(CompanyNewsData)
...
**Generated**: 2025-11-19T02:16:48.281310Z
