# File Documentation: test_currency_python.py

## Metadata
- **Path**: `openbb_platform/extensions/currency/integration/test_currency_python.py`
- **Size**: 4,576 bytes
- **Lines**: 183
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_currency_python.py`.

**Python Module**

- **Functions** (5): obb, test_currency_search, test_currency_price_historical, test_currency_reference_rates, test_currency_snapshots
- **Import Statements**: 2
...
- **`obb(pytestconfig)`**
- **`test_currency_search(params, obb)`**
- **`test_currency_price_historical(params, obb)`**
- **`test_currency_reference_rates(params, obb)`**
- **`test_currency_snapshots(params, obb)`**
...
**Generated**: 2025-11-19T02:16:46.783331Z
