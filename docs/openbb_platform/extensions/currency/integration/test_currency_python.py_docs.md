# Documentation: openbb_platform/extensions/currency/integration/test_currency_python.py

## File Metadata
- **Path**: `openbb_platform/extensions/currency/integration/test_currency_python.py`
- **Size**: 4,576 characters, 183 lines
- **Words**: 308
- **Extension**: .py
...
**Functions** (5):
`obb`, `test_currency_search`, `test_currency_price_historical`, `test_currency_reference_rates`, `test_currency_snapshots`
...
## Notes
- Generated: 2025-11-18T07:54:35.934182
