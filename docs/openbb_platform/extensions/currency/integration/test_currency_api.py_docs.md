# Documentation: openbb_platform/extensions/currency/integration/test_currency_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/currency/integration/test_currency_api.py`
- **Size**: 5,382 characters, 198 lines
- **Words**: 390
- **Extension**: .py
...
**Functions** (5):
`headers`, `test_currency_search`, `test_currency_price_historical`, `test_currency_reference_rates`, `test_currency_snapshots`
...
## Notes
- Generated: 2025-11-18T07:54:35.932688
