# File Documentation: test_currency_api.py

## Metadata
- **Path**: `openbb_platform/extensions/currency/integration/test_currency_api.py`
- **Size**: 5,382 bytes
- **Lines**: 198
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_currency_api.py`.

**Python Module**

- **Functions** (5): headers, test_currency_search, test_currency_price_historical, test_currency_reference_rates, test_currency_snapshots
- **Import Statements**: 1
...
- **`headers()`**
- **`test_currency_search(params, headers)`**
- **`test_currency_price_historical(params, headers)`**
- **`test_currency_reference_rates(params, headers)`**
- **`test_currency_snapshots(params, headers)`**
...
**Generated**: 2025-11-19T02:16:46.780746Z
