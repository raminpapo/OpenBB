# Documentation: openbb_platform/extensions/currency/openbb_currency/currency_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/currency/openbb_currency/currency_router.py`
- **Size**: 3,599 characters, 100 lines
- **Words**: 355
- **Extension**: .py
...
**Functions** (3):
`search`, `reference_rates`, `snapshots`

**Imports** (16):
`openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `openbb_currency.price.price_router`, `router`, `two`, `USD`, `an`
...
- `openbb_currency.price.price_router`

## Notes
- Generated: 2025-11-18T07:54:35.936844
