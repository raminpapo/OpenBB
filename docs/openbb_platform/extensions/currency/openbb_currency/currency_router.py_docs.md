# File Documentation: currency_router.py
...
This is a **python** file named `currency_router.py`.

**Python Module**

- **Functions** (3): search, reference_rates, snapshots
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:46.785916Z
