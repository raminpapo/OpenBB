# File Documentation: test_crypto_api.py

## Metadata
- **Path**: `openbb_platform/extensions/crypto/integration/test_crypto_api.py`
- **Size**: 3,499 bytes
- **Lines**: 126
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_crypto_api.py`.

**Python Module**

- **Functions** (3): headers, test_crypto_search, test_crypto_price_historical
- **Import Statements**: 1
...
- **`headers()`**
- **`test_crypto_search(params, headers)`**
- **`test_crypto_price_historical(params, headers)`**
...
**Generated**: 2025-11-19T02:16:46.756564Z
