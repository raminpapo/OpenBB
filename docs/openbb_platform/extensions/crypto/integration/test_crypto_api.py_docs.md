# Documentation: openbb_platform/extensions/crypto/integration/test_crypto_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/crypto/integration/test_crypto_api.py`
- **Size**: 3,499 characters, 126 lines
- **Words**: 250
- **Extension**: .py
...
**Functions** (3):
`headers`, `test_crypto_search`, `test_crypto_price_historical`
...
## Notes
- Generated: 2025-11-18T07:54:35.912652
