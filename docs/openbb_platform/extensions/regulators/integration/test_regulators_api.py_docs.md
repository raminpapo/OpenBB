# File Documentation: test_regulators_api.py

## Metadata
- **Path**: `openbb_platform/extensions/regulators/integration/test_regulators_api.py`
- **Size**: 7,083 bytes
- **Lines**: 229
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_regulators_api.py`.

**Python Module**

- **Functions** (11): headers, test_regulators_sec_cik_map, test_regulators_sec_institutions_search, test_regulators_sec_schema_files, test_regulators_sec_symbol_map, test_regulators_sec_rss_litigation, test_regulators_sec_sic_search, test_regulators_cftc_cot_search, test_regulators_cftc_cot, test_regulators_sec_filing_headers ... and 1 more
- **Import Statements**: 1
...
- **`headers()`**
- **`test_regulators_sec_cik_map(params, headers)`**
- **`test_regulators_sec_institutions_search(params, headers)`**
- **`test_regulators_sec_schema_files(params, headers)`**
- **`test_regulators_sec_symbol_map(params, headers)`**
- **`test_regulators_sec_rss_litigation(params, headers)`**
- **`test_regulators_sec_sic_search(params, headers)`**
- **`test_regulators_cftc_cot_search(params, headers)`**
- **`test_regulators_cftc_cot(params, headers)`**
- **`test_regulators_sec_filing_headers(params, headers)`**
- **`test_regulators_sec_htm_file(params, headers)`**
...
**Generated**: 2025-11-19T02:16:47.284448Z
