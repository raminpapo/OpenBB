# Documentation: openbb_platform/extensions/regulators/integration/test_regulators_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/regulators/integration/test_regulators_api.py`
- **Size**: 7,083 characters, 229 lines
- **Words**: 590
- **Extension**: .py
...
**Functions** (11):
`headers`, `test_regulators_sec_cik_map`, `test_regulators_sec_institutions_search`, `test_regulators_sec_schema_files`, `test_regulators_sec_symbol_map`, `test_regulators_sec_rss_litigation`, `test_regulators_sec_sic_search`, `test_regulators_cftc_cot_search`, `test_regulators_cftc_cot`, `test_regulators_sec_filing_headers`, `test_regulators_sec_htm_file`
...
## Notes
- Generated: 2025-11-18T07:54:36.337858
