# Documentation: openbb_platform/extensions/regulators/integration/test_regulators_python.py

## File Metadata
- **Path**: `openbb_platform/extensions/regulators/integration/test_regulators_python.py`
- **Size**: 5,636 characters, 211 lines
- **Words**: 418
- **Extension**: .py
...
**Functions** (11):
`obb`, `test_regulators_sec_cik_map`, `test_regulators_sec_institutions_search`, `test_regulators_sec_schema_files`, `test_regulators_sec_symbol_map`, `test_regulators_sec_rss_litigation`, `test_regulators_sec_sic_search`, `test_regulators_cftc_cot_search`, `test_regulators_cftc_cot`, `test_regulators_sec_filing_headers`, `test_regulators_sec_htm_file`

**Imports** (8):
`pytest`, `openbb_core.app.model.obbject`, `OBBject`, `openbb`, `openbb_sec.models.sec_filing`, `SecFilingData`, `openbb_sec.models.htm_file`, `SecHtmFileData`
...
## Notes
- Generated: 2025-11-18T07:54:36.339374
