# File Documentation: test_regulators_python.py

## Metadata
- **Path**: `openbb_platform/extensions/regulators/integration/test_regulators_python.py`
- **Size**: 5,636 bytes
- **Lines**: 211
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_regulators_python.py`.

**Python Module**

- **Functions** (11): obb, test_regulators_sec_cik_map, test_regulators_sec_institutions_search, test_regulators_sec_schema_files, test_regulators_sec_symbol_map, test_regulators_sec_rss_litigation, test_regulators_sec_sic_search, test_regulators_cftc_cot_search, test_regulators_cftc_cot, test_regulators_sec_filing_headers ... and 1 more
- **Import Statements**: 4
...
- **`obb(pytestconfig)`**
- **`test_regulators_sec_cik_map(params, obb)`**
- **`test_regulators_sec_institutions_search(params, obb)`**
- **`test_regulators_sec_schema_files(params, obb)`**
- **`test_regulators_sec_symbol_map(params, obb)`**
- **`test_regulators_sec_rss_litigation(params, obb)`**
- **`test_regulators_sec_sic_search(params, obb)`**
- **`test_regulators_cftc_cot_search(params, obb)`**
- **`test_regulators_cftc_cot(params, obb)`**
- **`test_regulators_sec_filing_headers(params, obb)`**
- **`test_regulators_sec_htm_file(params, obb)`**
...
**Generated**: 2025-11-19T02:16:47.286298Z
