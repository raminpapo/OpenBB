# Documentation: openbb_platform/extensions/regulators/openbb_regulators/sec/sec_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/regulators/openbb_regulators/sec/sec_router.py`
- **Size**: 6,140 characters, 198 lines
- **Words**: 496
- **Extension**: .py
...
**Functions** (8):
`filing_headers`, `htm_file`, `cik_map`, `institutions_search`, `schema_files`, `symbol_map`, `rss_litigation`, `sic_search`

**Imports** (14):
`openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `the`, `the`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:36.346205
