# File Documentation: sec_router.py
...
This is a **python** file named `sec_router.py`.

**Python Module**

- **Functions** (8): filing_headers, htm_file, cik_map, institutions_search, schema_files, symbol_map, rss_litigation, sic_search
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:47.293587Z
