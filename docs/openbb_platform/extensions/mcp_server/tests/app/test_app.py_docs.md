# Documentation: openbb_platform/extensions/mcp_server/tests/app/test_app.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/app/test_app.py`
- **Size**: 6,174 characters, 178 lines
- **Words**: 410
- **Extension**: .py
...
**Functions** (9):
`test_extract_brief_description`, `test_get_mcp_config_from_route`, `test_strip_api_prefix`, `test_read_system_prompt_file`, `test_create_mcp_server_customization`, `dummy_route`, `test_create_mcp_server_tool_enable_disable`, `enabled_route`, `disabled_route`

**Imports** (13):
`unittest.mock`, `MagicMock`, `fastapi`, `FastAPI`, `fastapi.routing`, `APIRoute`, `fastmcp.server.openapi`, `OpenAPITool`, `fastmcp.utilities.openapi`, `HTTPRoute`, `openbb_mcp_server.app.app`, `openbb_mcp_server.models.settings`, `MCPSettings`
...
## Notes
- Generated: 2025-11-18T07:54:36.217592
