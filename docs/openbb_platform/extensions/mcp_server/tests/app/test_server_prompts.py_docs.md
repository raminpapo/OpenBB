# File Documentation: test_server_prompts.py
...
This is a **python** file named `test_server_prompts.py`.

**Python Module**

- **Functions** (6): test_load_prompts_from_json, test_skip_invalid_prompts, test_skip_invalid_arguments_in_prompts, test_execute_prompt_tool, tool_decorator_factory, decorator
- **Import Statements**: 1
...
- **`test_load_prompts_from_json(
    mock_from_fastapi, mock_tool_registry, mock_process_routes, tmp_path
)`**
- **`test_skip_invalid_prompts(
    mock_from_fastapi,
    mock_tool_registry,
    mock_process_routes,
    mock_logger,
...
- **`test_skip_invalid_arguments_in_prompts(
    mock_from_fastapi,
    mock_tool_registry,
    mock_process_routes,
    mock_logger,
...
- **`test_execute_prompt_tool(
    mock_from_fastapi, mock_tool_registry, mock_process_routes, tmp_path
)`**
- **`tool_decorator_factory(*args, **kwargs)`**
- **`decorator(func)`**
...
**Generated**: 2025-11-19T02:16:47.133092Z
