# Documentation: openbb_platform/extensions/mcp_server/tests/app/test_server_prompts.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/app/test_server_prompts.py`
- **Size**: 8,347 characters, 238 lines
- **Words**: 565
- **Extension**: .py
...
**Functions** (6):
`test_load_prompts_from_json`, `test_skip_invalid_prompts`, `test_skip_invalid_arguments_in_prompts`, `test_execute_prompt_tool`, `tool_decorator_factory`, `decorator`

**Imports** (11):
`json`, `unittest.mock`, `AsyncMock`, `pytest`, `fastapi`, `FastAPI`, `openbb_mcp_server.app.app`, `create_mcp_server`, `openbb_mcp_server.models.settings`, `MCPSettings`, `a`
...
## Notes
- Generated: 2025-11-18T07:54:36.220884
