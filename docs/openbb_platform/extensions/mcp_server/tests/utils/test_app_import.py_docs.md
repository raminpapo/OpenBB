# File Documentation: test_app_import.py

## Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/utils/test_app_import.py`
- **Size**: 5,069 bytes
- **Lines**: 164
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_app_import.py`.

**Python Module**

- **Functions** (16): dummy_app_file, create_app, not_a_factory, test_import_app_from_module_colon_notation, test_import_app_from_file_colon_notation, test_import_app_from_file_path, test_import_app_factory, test_import_app_factory_not_callable, test_import_app_not_fastapi_instance, test_import_app_file_not_found ... and 6 more
- **Import Statements**: 3
...
- **`dummy_app_file(tmp_path: Path)`**
- **`create_app()`**
- **`not_a_factory()`**
- **`test_import_app_from_module_colon_notation(dummy_app_file: Path)`**
- **`test_import_app_from_file_colon_notation(dummy_app_file: Path)`**
- **`test_import_app_from_file_path(dummy_app_file: Path)`**
- **`test_import_app_factory(dummy_app_file: Path)`**
- **`test_import_app_factory_not_callable(dummy_app_file: Path)`**
- **`test_import_app_not_fastapi_instance(dummy_app_file: Path)`**
- **`test_import_app_file_not_found()`**
- **`test_import_app_attribute_not_found(dummy_app_file: Path)`**
- **`test_parse_args_simple()`**
- **`test_parse_args_with_app(dummy_app_file: Path)`**
- **`test_parse_args_with_factory_app(dummy_app_file: Path)`**
- **`test_parse_args_help()`**
- **`test_parse_args_factory_no_name_error()`**
...
- `import`
- `module.`
- `openbb_mcp_server.utils.app_import`
- `patch`
- `pathlib`
- `pytest`
- `sys`
...
**Generated**: 2025-11-19T02:16:47.146045Z
