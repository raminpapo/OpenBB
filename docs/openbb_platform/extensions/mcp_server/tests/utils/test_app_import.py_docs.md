# Documentation: openbb_platform/extensions/mcp_server/tests/utils/test_app_import.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/utils/test_app_import.py`
- **Size**: 5,069 characters, 164 lines
- **Words**: 465
- **Extension**: .py
...
**Functions** (16):
`dummy_app_file`, `create_app`, `not_a_factory`, `test_import_app_from_module_colon_notation`, `test_import_app_from_file_colon_notation`, `test_import_app_from_file_path`, `test_import_app_factory`, `test_import_app_factory_not_callable`, `test_import_app_not_fastapi_instance`, `test_import_app_file_not_found`, `test_import_app_attribute_not_found`, `test_parse_args_simple`, `test_parse_args_with_app`, `test_parse_args_with_factory_app`, `test_parse_args_help`, `test_parse_args_factory_no_name_error`

**Imports** (17):
`module.`, `sys`, `pathlib`, `Path`, `unittest.mock`, `patch`, `pytest`, `fastapi`, `FastAPI`, `openbb_mcp_server.utils.app_import`, `import_app`, `fastapi`, `FastAPI`, `a`, `a`, `a`, `a`
...
## Notes
- Generated: 2025-11-18T07:54:36.232285
