# Documentation: openbb_platform/extensions/mcp_server/tests/utils/test_compress_schema.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/utils/test_compress_schema.py`
- **Size**: 2,475 characters, 70 lines
- **Words**: 220
- **Extension**: .py
...
**Functions** (5):
`test_prune_params`, `test_prune_defs`, `test_prune_additional_properties`, `test_prune_titles`, `test_combined_compression`

**Imports** (2):
`fastmcp.utilities.json_schema`, `compress_schema`
...
## Notes
- Generated: 2025-11-18T07:54:36.233707
