# File Documentation: test_fastapi.py

## Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/utils/test_fastapi.py`
- **Size**: 9,012 bytes
- **Lines**: 251
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_fastapi.py`.

**Python Module**

- **Functions** (17): mock_system_service, test_get_api_prefix, test_get_module_exclusion_targets, test_get_mcp_config, test_should_exclude_by_module_and_path, sample_app, endpoint_a, endpoint_b, endpoint_c, endpoint_d ... and 7 more
- **Import Statements**: 1
...
- **`mock_system_service()`**
- **`test_get_api_prefix(mock_system_service)`**
- **`test_get_module_exclusion_targets()`**
- **`test_get_mcp_config()`**
- **`test_should_exclude_by_module_and_path(mock_system_service)`**
- **`sample_app()`**
- **`endpoint_a()`**
- **`endpoint_b()`**
- **`endpoint_c()`**
- **`endpoint_d(arg1: str, arg2: int = 42)`**
- **`test_process_routes_exclusion(sample_app, mock_system_service)`**
- **`test_process_routes_route_maps(sample_app, mock_system_service)`**
- **`test_process_routes_prompts(sample_app, mock_system_service)`**
- **`test_create_prompt_definitions_for_route()`**
- **`my_endpoint(param1: str, param2: bool = False)`**
- **`test_create_prompt_definitions_auto_naming()`**
- **`my_endpoint()`**
...
- `openbb_mcp_server.utils.fastapi`
- `pytest`
- `sys`
- `unittest.mock`
...
**Generated**: 2025-11-19T02:16:47.149318Z
