# Documentation: openbb_platform/extensions/mcp_server/tests/utils/test_fastapi.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/utils/test_fastapi.py`
- **Size**: 9,012 characters, 251 lines
- **Words**: 684
- **Extension**: .py
...
**Functions** (17):
`mock_system_service`, `test_get_api_prefix`, `test_get_module_exclusion_targets`, `test_get_mcp_config`, `test_should_exclude_by_module_and_path`, `sample_app`, `endpoint_a`, `endpoint_b`, `endpoint_c`, `endpoint_d`, `test_process_routes_exclusion`, `test_process_routes_route_maps`, `test_process_routes_prompts`, `test_create_prompt_definitions_for_route`, `my_endpoint`, `test_create_prompt_definitions_auto_naming`, `my_endpoint`

**Imports** (14):
`sys`, `unittest.mock`, `MagicMock`, `pytest`, `fastapi`, `FastAPI`, `fastapi.routing`, `APIRoute`, `fastmcp.server.openapi`, `MCPType`, `openbb_mcp_server.models.settings`, `MCPSettings`, `openbb_mcp_server.utils.fastapi`, `a`
...
## Notes
- Generated: 2025-11-18T07:54:36.235177
