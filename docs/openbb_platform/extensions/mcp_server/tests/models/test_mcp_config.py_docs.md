# Documentation: openbb_platform/extensions/mcp_server/tests/models/test_mcp_config.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/models/test_mcp_config.py`
- **Size**: 4,013 characters, 126 lines
- **Words**: 279
- **Extension**: .py
...
**Functions** (5):
`test_argument_definition_model`, `test_prompt_config_model`, `test_mcp_config_model`, `test_validate_mcp_config`, `test_is_valid_mcp_config`

**Imports** (6):
`unittest.mock`, `patch`, `pytest`, `openbb_mcp_server.models.mcp_config`, `pydantic`, `ValidationError`
...
## Notes
- Generated: 2025-11-18T07:54:36.222532
