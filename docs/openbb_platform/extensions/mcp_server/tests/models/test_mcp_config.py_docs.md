# File Documentation: test_mcp_config.py

## Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/models/test_mcp_config.py`
- **Size**: 4,013 bytes
- **Lines**: 126
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_mcp_config.py`.

**Python Module**

- **Functions** (5): test_argument_definition_model, test_prompt_config_model, test_mcp_config_model, test_validate_mcp_config, test_is_valid_mcp_config
- **Import Statements**: 2
...
- **`test_argument_definition_model()`**
- **`test_prompt_config_model()`**
- **`test_mcp_config_model()`**
- **`test_validate_mcp_config()`**
- **`test_is_valid_mcp_config()`**
...
**Generated**: 2025-11-19T02:16:47.135752Z
