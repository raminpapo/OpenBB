# File Documentation: test_mcp_registry.py
...
This is a **python** file named `test_mcp_registry.py`.

**Python Module**

- **Functions** (8): tool_registry, test_register_tool, test_get_categories, test_get_category_tools, test_get_tool, test_get_category_subcategories, test_toggle_tools, test_clear
- **Import Statements**: 1
...
- **`tool_registry()`**
- **`test_register_tool(tool_registry)`**
- **`test_get_categories(tool_registry)`**
- **`test_get_category_tools(tool_registry)`**
- **`test_get_tool(tool_registry)`**
- **`test_get_category_subcategories(tool_registry)`**
- **`test_toggle_tools(tool_registry)`**
- **`test_clear(tool_registry)`**
...
**Generated**: 2025-11-19T02:16:47.137540Z
