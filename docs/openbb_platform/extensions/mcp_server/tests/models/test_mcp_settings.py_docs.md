# Documentation: openbb_platform/extensions/mcp_server/tests/models/test_mcp_settings.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/models/test_mcp_settings.py`
- **Size**: 2,393 characters, 66 lines
- **Words**: 209
- **Extension**: .py
...
**Functions** (7):
`test_mcp_settings_defaults`, `test_mcp_settings_validation`, `test_mcp_settings_repr`, `test_get_fastmcp_kwargs`, `test_get_http_run_kwargs`, `test_get_httpx_kwargs`, `test_update_settings`

**Imports** (3):
`openbb_mcp_server.models.settings`, `MCPSettings`, `another`
...
## Notes
- Generated: 2025-11-18T07:54:36.226331
