# Documentation: openbb_platform/extensions/mcp_server/tests/service/test_mcp_service.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/service/test_mcp_service.py`
- **Size**: 6,233 characters, 172 lines
- **Words**: 534
- **Extension**: .py
...
**Functions** (12):
`service`, `test_mcp_settings_path`, `test_mcp_service_init_with_existing_file`, `test_mcp_service_init_with_corrupted_file`, `test_mcp_service_init_no_file`, `test_write_to_file`, `test_mcp_settings_setter`, `test_load_settings_from_env`, `test_load_settings_from_env_empty`, `test_load_with_overrides`, `test_map_cli_args_to_settings`, `test_map_cli_args_to_settings_system_prompt`

**Imports** (16):
`json`, `pathlib`, `Path`, `unittest.mock`, `patch`, `pytest`, `openbb_mcp_server.models.settings`, `MCPSettings`, `openbb_mcp_server.service.mcp_service`, `MCPService`, `file`, `the`, `file`, `the`, `environment`, `empty`


## Key Components

**Class `attribute`**: No documentation

**Class `attribute`**: No documentation

**Class `method`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:36.230735
