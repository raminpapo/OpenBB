# File Documentation: test_mcp_service.py

## Metadata
- **Path**: `openbb_platform/extensions/mcp_server/tests/service/test_mcp_service.py`
- **Size**: 6,233 bytes
- **Lines**: 172
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_mcp_service.py`.

**Python Module**

- **Classes** (3): attribute, attribute, method
- **Functions** (12): service, test_mcp_settings_path, test_mcp_service_init_with_existing_file, test_mcp_service_init_with_corrupted_file, test_mcp_service_init_no_file, test_write_to_file, test_mcp_settings_setter, test_load_settings_from_env, test_load_settings_from_env_empty, test_load_with_overrides ... and 2 more
- **Import Statements**: 1
...
- **`service(tmp_path)`**
- **`test_mcp_settings_path(service: MCPService)`**
- **`test_mcp_service_init_with_existing_file(service: MCPService)`**
- **`test_mcp_service_init_with_corrupted_file(service: MCPService)`**
- **`test_mcp_service_init_no_file(service: MCPService)`**
- **`test_write_to_file(service: MCPService)`**
- **`test_mcp_settings_setter(service: MCPService)`**
- **`test_load_settings_from_env(service: MCPService)`**
- **`test_load_settings_from_env_empty(service: MCPService)`**
- **`test_load_with_overrides(service: MCPService)`**
- **`test_map_cli_args_to_settings(service: MCPService)`**
- **`test_map_cli_args_to_settings_system_prompt(service: MCPService)`**
...
- `openbb_mcp_server.service.mcp_service`
- `patch`
- `pathlib`
- `pytest`
- `unittest.mock`
...
**Generated**: 2025-11-19T02:16:47.143989Z
