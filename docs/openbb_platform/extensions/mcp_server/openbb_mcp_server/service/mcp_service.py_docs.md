# File Documentation: mcp_service.py
...
This is a **python** file named `mcp_service.py`.

**Python Module**

- **Classes** (2): MCPService, is
- **Functions** (10): _merge_nested_dict, __init__, _read_from_file, write_to_file, mcp_settings, mcp_settings, refresh_mcp_settings, load_with_overrides, _load_settings_from_env, _map_cli_args_to_settings
- **Import Statements**: 1
...
- **`MCPService`**(metaclass=SingletonMeta)

#### Decorators Used

classmethod, mcp_settings, property, staticmethod
...
**Generated**: 2025-11-19T02:16:47.117417Z
