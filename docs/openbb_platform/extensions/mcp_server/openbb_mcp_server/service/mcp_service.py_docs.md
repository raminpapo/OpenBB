# Documentation: openbb_platform/extensions/mcp_server/openbb_mcp_server/service/mcp_service.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/openbb_mcp_server/service/mcp_service.py`
- **Size**: 10,412 characters, 272 lines
- **Words**: 838
- **Extension**: .py
...
**Functions** (10):
`_merge_nested_dict`, `__init__`, `_read_from_file`, `write_to_file`, `mcp_settings`, `mcp_settings`, `refresh_mcp_settings`, `load_with_overrides`, `_load_settings_from_env`, `_map_cli_args_to_settings`

**Imports** (21):
`json`, `logging`, `os`, `pathlib`, `Path`, `typing`, `Any`, `openbb_core.app.constants`, `OPENBB_DIRECTORY`, `openbb_core.app.model.abstract.singleton`, `SingletonMeta`, `openbb_mcp_server.models.settings`, `MCPSettings`, `the`, `MCPSettings`, `the`, `the`, `the`, `the`, `MCPSettings`


## Key Components

**Class `MCPService`**: MCP Service. This class is a singleton.
...
## Notes
- Generated: 2025-11-18T07:54:36.197867
