# Documentation: openbb_platform/extensions/mcp_server/openbb_mcp_server/utils/app_import.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/openbb_mcp_server/utils/app_import.py`
- **Size**: 8,926 characters, 245 lines
- **Words**: 919
- **Extension**: .py
...
**Functions** (4):
`import_app`, `_load_module_from_file_path`, `parse_args`, `__init__`

**Imports** (20):
`utilities`, `json`, `os`, `sys`, `pathlib`, `Path`, `fastapi`, `FastAPI`, `a`, `importlib`, `import_module`, `a`, `as`, `fails`, `f`, `relying`, `f`, `openbb_core.env`, `Env`, `arguments`


## Key Components

**Class `Args`**: Container for parsed command line arguments.
...
## Notes
- Generated: 2025-11-18T07:54:36.200815
