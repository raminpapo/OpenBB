# Documentation: openbb_platform/extensions/mcp_server/openbb_mcp_server/utils/fastapi.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/openbb_mcp_server/utils/fastapi.py`
- **Size**: 11,697 characters, 336 lines
- **Words**: 1,152
- **Extension**: .py
...
**Functions** (11):
`__init__`, `get_api_prefix`, `_get_module_exclusion_targets`, `get_mcp_config`, `_get_prompt_configs`, `_create_prompt_definitions_for_route`, `_normalize_methods`, `_methods_from_config_or_route`, `_resolve_mcp_type`, `_should_exclude_by_module_and_path`, `process_fastapi_routes_for_mcp`

**Imports** (28):
`inspect`, `re`, `sys`, `collections.abc`, `Sequence`, `fastapi`, `FastAPI`, `fastapi.routing`, `APIRoute`, `fastmcp.server.openapi`, `MCPType`, `openbb_core.app.service.system_service`, `SystemService`, `pydantic`, `ValidationError`, `openbb_mcp_server.models.mcp_config`, `MCPConfigModel`, `openbb_mcp_server.models.settings`, `MCPSettings`, `openapi_extra.`


## Key Components

**Class `ProcessedRouteData`**: Container for all data collected during route processing.
...
- `pydantic`
- `openbb_mcp_server.models.mcp_config`

## Notes
- Generated: 2025-11-18T07:54:36.202901
