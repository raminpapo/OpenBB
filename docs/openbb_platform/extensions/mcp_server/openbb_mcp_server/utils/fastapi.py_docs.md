...
This is a **python** file named `fastapi.py`.

**Python Module**

- **Classes** (1): ProcessedRouteData
- **Functions** (11): __init__, get_api_prefix, _get_module_exclusion_targets, get_mcp_config, _get_prompt_configs, _create_prompt_definitions_for_route, _normalize_methods, _methods_from_config_or_route, _resolve_mcp_type, _should_exclude_by_module_and_path ... and 1 more
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:16:47.125547Z
