# Documentation: openbb_platform/extensions/mcp_server/openbb_mcp_server/models/settings.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/openbb_mcp_server/models/settings.py`
- **Size**: 10,079 characters, 287 lines
- **Words**: 889
- **Extension**: .py
...
**Functions** (8):
`_split_list`, `_split_set`, `_validate_json_or_tuple`, `get_fastmcp_kwargs`, `get_http_run_kwargs`, `get_httpx_kwargs`, `__repr__`, `update`

**Imports** (9):
`json`, `typing`, `Any`, `pydantic`, `BaseModel`, `SystemService.`, `user`, `the`, `the`


## Key Components

**Class `MCPSettings`**: MCP Server settings model.
...
## Notes
- Generated: 2025-11-18T07:54:36.192767
