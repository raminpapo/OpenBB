# File Documentation: settings.py
...
This is a **python** file named `settings.py`.

**Python Module**

- **Classes** (1): MCPSettings
- **Functions** (8): _split_list, _split_set, _validate_json_or_tuple, get_fastmcp_kwargs, get_http_run_kwargs, get_httpx_kwargs, __repr__, update
- **Import Statements**: 1
...
- **`MCPSettings`**(BaseModel)

#### Functions

- **`_split_list(cls, v)`**
- **`_split_set(cls, v)`**
- **`_validate_json_or_tuple(cls, v)`**
- **`update(self, incoming: "MCPSettings")`**
...
**Generated**: 2025-11-19T02:16:47.110746Z
