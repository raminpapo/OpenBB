# Documentation: openbb_platform/extensions/mcp_server/openbb_mcp_server/models/registry.py

## File Metadata
- **Path**: `openbb_platform/extensions/mcp_server/openbb_mcp_server/models/registry.py`
- **Size**: 3,044 characters, 88 lines
- **Words**: 278
- **Extension**: .py
...
**Functions** (7):
`register_tool`, `get_categories`, `get_category_tools`, `get_tool`, `get_category_subcategories`, `toggle_tools`, `clear`

**Imports** (10):
`collections`, `defaultdict`, `collections.abc`, `Mapping`, `dataclasses`, `dataclass`, `fastmcp.server.openapi`, `OpenAPITool`, `openbb_mcp_server.models.tools`, `ToggleResult`


## Key Components

**Class `class`**: Keeps track of categories, subcategories and tool instances.
...
## Notes
- Generated: 2025-11-18T07:54:36.191324
