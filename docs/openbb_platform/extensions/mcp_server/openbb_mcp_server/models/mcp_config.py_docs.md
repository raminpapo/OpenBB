# File Documentation: mcp_config.py
...
This is a **python** file named `mcp_config.py`.

**Python Module**

- **Classes** (5): MCPType, HTTPMethod, ArgumentDefinitionModel, PromptConfigModel, MCPConfigModel
- **Functions** (10): validate_name, validate_type, validate_content, validate_name, validate_tags, validate_methods, validate_config_consistency, to_dict, validate_mcp_config, is_valid_mcp_config
- **Import Statements**: 1
...
- **`MCPType`**(str, Enum)
- **`HTTPMethod`**(str, Enum)
- **`ArgumentDefinitionModel`**(BaseModel)
- **`PromptConfigModel`**(BaseModel)
- **`MCPConfigModel`**(BaseModel)
...
**Generated**: 2025-11-19T02:16:47.104888Z
