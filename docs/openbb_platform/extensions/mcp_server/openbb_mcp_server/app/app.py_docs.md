...
This is a **python** file named `app.py`.

**Python Module**

- **Classes** (1): SSEShutdownWrapper
- **Functions** (26): _extract_brief_description, _get_mcp_config_from_route, _strip_api_prefix, _read_system_prompt_file, _build_runtime_middleware, create_mcp_server, in, customize_components, system_prompt_func, system_prompt_resource ... and 16 more
- **Import Statements**: 5
...
- **`__init__(self, asgi_app: ASGIApp)`**
- **`safe_send(message)`**
...
**Generated**: 2025-11-19T02:16:47.096876Z
