# File Documentation: discovery_router.py
...
This is a **python** file named `discovery_router.py`.

**Python Module**

- **Functions** (10): gainers, losers, active, undervalued_large_caps, undervalued_growth, aggressive_small_caps, growth_tech, top_retail, filings, latest_financial_reports
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:46.963575Z
