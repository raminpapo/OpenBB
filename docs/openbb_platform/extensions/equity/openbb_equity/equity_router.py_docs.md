# File Documentation: equity_router.py
...
This is a **python** file named `equity_router.py`.

**Python Module**

- **Functions** (5): search, screener, profile, market_snapshots, historical_market_cap
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:46.950129Z
