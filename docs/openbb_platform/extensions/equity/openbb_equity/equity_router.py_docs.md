# Documentation: openbb_platform/extensions/equity/openbb_equity/equity_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/equity/openbb_equity/equity_router.py`
- **Size**: 3,912 characters, 117 lines
- **Words**: 296
- **Extension**: .py
...
**Functions** (5):
`search`, `screener`, `profile`, `market_snapshots`, `historical_market_cap`

**Imports** (29):
`openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `openbb_equity.calendar.calendar_router`, `router`, `openbb_equity.compare.compare_router`, `router`, `openbb_equity.darkpool.darkpool_router`, `router`, `openbb_equity.discovery.discovery_router`, `router`, `openbb_equity.estimates.estimates_router`
...
- `openbb_equity.calendar.calendar_router`
- `openbb_equity.compare.compare_router`
- `openbb_equity.darkpool.darkpool_router`
- `openbb_equity.discovery.discovery_router`

## Notes
- Generated: 2025-11-18T07:54:36.076797
