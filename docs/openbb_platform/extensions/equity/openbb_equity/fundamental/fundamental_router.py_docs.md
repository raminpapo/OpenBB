# Documentation: openbb_platform/extensions/equity/openbb_equity/fundamental/fundamental_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/equity/openbb_equity/fundamental/fundamental_router.py`
- **Size**: 15,488 characters, 536 lines
- **Words**: 1,214
- **Extension**: .py
...
**Functions** (25):
`balance`, `balance_growth`, `cash`, `reported_financials`, `cash_growth`, `dividends`, `historical_eps`, `employee_count`, `search_attributes`, `latest_attributes`, `historical_attributes`, `income`, `income_growth`, `metrics`, `management`, `management_compensation`, `ratios`, `revenue_per_geography`, `revenue_per_segment`, `filings`

**Imports** (15):
`openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `Intrinio.`, `Intrinio.`, `the`, `company`
...
## Notes
- Generated: 2025-11-18T07:54:36.083180
