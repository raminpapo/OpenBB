# File Documentation: ownership_router.py
...
This is a **python** file named `ownership_router.py`.

**Python Module**

- **Functions** (6): major_holders, institutional, insider_trading, share_statistics, form_13f, government_trades
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:46.972988Z
