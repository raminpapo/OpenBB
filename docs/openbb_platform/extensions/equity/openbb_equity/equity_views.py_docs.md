# Documentation: openbb_platform/extensions/equity/openbb_equity/equity_views.py

## File Metadata
- **Path**: `openbb_platform/extensions/equity/openbb_equity/equity_views.py`
- **Size**: 2,705 characters, 86 lines
- **Words**: 214
- **Extension**: .py
...
**Functions** (3):
`equity_price_historical`, `equity_price_performance`, `equity_historical_market_cap`

**Imports** (13):
`typing`, `TYPE_CHECKING`, `openbb_charting.core.openbb_figure`, `openbb_charting.charts.price_historical`, `price_historical`, `openbb_charting.charts.price_performance`, `price_performance`, `openbb_charting.charts.generic_charts`, `line_chart`, `openbb_core.app.utils`, `basemodel_to_df`, `pandas`, `DataFrame`


## Key Components

**Class `EquityViews`**: Equity Views.
...
## Notes
- Generated: 2025-11-18T07:54:36.078185
