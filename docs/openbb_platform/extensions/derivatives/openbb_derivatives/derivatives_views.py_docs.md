# Documentation: openbb_platform/extensions/derivatives/openbb_derivatives/derivatives_views.py

## File Metadata
- **Path**: `openbb_platform/extensions/derivatives/openbb_derivatives/derivatives_views.py`
- **Size**: 12,132 characters, 324 lines
- **Words**: 1,078
- **Extension**: .py
...
**Functions** (4):
`derivatives_futures_historical`, `derivatives_futures_curve`, `create_fig`, `derivatives_options_surface`

**Imports** (26):
`typing`, `TYPE_CHECKING`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.charts.price_historical`, `price_historical`, `the`, `openbb`, `obb`, `the`, `openbb_charting.core.chart_style`, `ChartStyle`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.styles.colors`, `LARGE_CYCLER`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.provider.abstract.data`, `Data`


## Key Components

**Class `DerivativesViews`**: Derivatives Views.
...
## Notes
- Generated: 2025-11-18T07:54:35.958814
