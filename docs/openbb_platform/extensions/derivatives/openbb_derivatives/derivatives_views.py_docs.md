# File Documentation: derivatives_views.py
...
This is a **python** file named `derivatives_views.py`.

**Python Module**

- **Classes** (1): DerivativesViews
- **Functions** (4): derivatives_futures_historical, derivatives_futures_curve, create_fig, derivatives_options_surface
- **Import Statements**: 6
...
- **`create_fig(figure, df, dates, color_count)`**
...
**Generated**: 2025-11-19T02:16:46.812797Z
