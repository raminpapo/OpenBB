# File Documentation: options_router.py
...
This is a **python** file named `options_router.py`.

**Python Module**

- **Functions** (4): chains, surface, unusual, snapshots
- **Import Statements**: 4
...
dte_max, dte_min, high, last_price, low, router, strike_max, strike_min
...
**Generated**: 2025-11-19T02:16:46.820013Z
