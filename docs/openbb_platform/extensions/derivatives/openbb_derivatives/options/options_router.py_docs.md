# Documentation: openbb_platform/extensions/derivatives/openbb_derivatives/options/options_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/derivatives/openbb_derivatives/options/options_router.py`
- **Size**: 10,663 characters, 286 lines
- **Words**: 1,194
- **Extension**: .py
...
**Functions** (4):
`chains`, `surface`, `unusual`, `snapshots`

**Imports** (24):
`typing`, `Literal`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.standard_models.options_chains`, `OptionsChainsData`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:35.964098
