# Documentation: openbb_platform/extensions/derivatives/integration/test_derivatives_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/derivatives/integration/test_derivatives_api.py`
- **Size**: 7,969 characters, 261 lines
- **Words**: 617
- **Extension**: .py
...
**Functions** (9):
`headers`, `test_derivatives_options_chains`, `test_derivatives_options_unusual`, `test_derivatives_futures_historical`, `test_derivatives_futures_curve`, `test_derivatives_options_snapshots`, `test_derivatives_futures_instruments`, `test_derivatives_futures_info`, `test_derivatives_options_surface`

**Imports** (8):
`base64`, `json`, `pytest`, `requests`, `openbb_core.env`, `Env`, `openbb_core.provider.utils.helpers`, `get_querystring`
...
## Notes
- Generated: 2025-11-18T07:54:35.953251
