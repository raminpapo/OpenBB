# File Documentation: test_derivatives_api.py

## Metadata
- **Path**: `openbb_platform/extensions/derivatives/integration/test_derivatives_api.py`
- **Size**: 7,969 bytes
- **Lines**: 261
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_derivatives_api.py`.

**Python Module**

- **Functions** (9): headers, test_derivatives_options_chains, test_derivatives_options_unusual, test_derivatives_futures_historical, test_derivatives_futures_curve, test_derivatives_options_snapshots, test_derivatives_futures_instruments, test_derivatives_futures_info, test_derivatives_options_surface
- **Import Statements**: 1
...
- **`headers()`**
- **`test_derivatives_options_chains(params, headers)`**
- **`test_derivatives_options_unusual(params, headers)`**
- **`test_derivatives_futures_historical(params, headers)`**
- **`test_derivatives_futures_curve(params, headers)`**
- **`test_derivatives_options_snapshots(params, headers)`**
- **`test_derivatives_futures_instruments(params, headers)`**
- **`test_derivatives_futures_info(params, headers)`**
- **`test_derivatives_options_surface(params, headers)`**
...
**Generated**: 2025-11-19T02:16:46.805418Z
