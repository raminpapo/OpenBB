# File Documentation: test_etf_python.py

## Metadata
- **Path**: `openbb_platform/extensions/etf/integration/test_etf_python.py`
- **Size**: 12,091 bytes
- **Lines**: 459
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_etf_python.py`.

**Python Module**

- **Functions** (13): obb, test_etf_search, test_etf_historical, test_etf_info, test_etf_sectors, test_etf_nport_disclosure, test_etf_holdings, test_etf_price_performance, test_etf_countries, test_etf_discovery_gainers ... and 3 more
- **Import Statements**: 2
...
- **`obb(pytestconfig)`**
- **`test_etf_search(params, obb)`**
- **`test_etf_historical(params, obb)`**
- **`test_etf_info(params, obb)`**
- **`test_etf_sectors(params, obb)`**
- **`test_etf_nport_disclosure(params, obb)`**
- **`test_etf_holdings(params, obb)`**
- **`test_etf_price_performance(params, obb)`**
- **`test_etf_countries(params, obb)`**
- **`test_etf_discovery_gainers(params, obb)`**
- **`test_etf_discovery_losers(params, obb)`**
- **`test_etf_discovery_active(params, obb)`**
- **`test_etf_equity_exposure(params, obb)`**
...
**Generated**: 2025-11-19T02:16:46.996027Z
