# Documentation: openbb_platform/extensions/etf/openbb_etf/etf_views.py

## File Metadata
- **Path**: `openbb_platform/extensions/etf/openbb_etf/etf_views.py`
- **Size**: 3,373 characters, 100 lines
- **Words**: 282
- **Extension**: .py
...
**Functions** (3):
`etf_historical`, `etf_price_performance`, `etf_holdings`

**Imports** (17):
`typing`, `TYPE_CHECKING`, `openbb_charting.core.openbb_figure`, `plotly.graph_objs`, `Figure`, `openbb_charting.charts.price_historical`, `price_historical`, `openbb_charting.charts.price_performance`, `price_performance`, `pandas`, `DataFrame`, `openbb_core.app.utils`, `basemodel_to_df`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_charting.charts.generic_charts`, `bar_chart`


## Key Components

**Class `EtfViews`**: Etf Views.
...
## Notes
- Generated: 2025-11-18T07:54:36.112849
