# File Documentation: etf_views.py
...
This is a **python** file named `etf_views.py`.

**Python Module**

- **Classes** (1): EtfViews
- **Functions** (3): etf_historical, etf_price_performance, etf_holdings
- **Import Statements**: 8
...
**Generated**: 2025-11-19T02:16:47.001415Z
