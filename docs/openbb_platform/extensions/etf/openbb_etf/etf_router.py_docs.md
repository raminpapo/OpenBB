# File Documentation: etf_router.py
...
This is a **python** file named `etf_router.py`.

**Python Module**

- **Functions** (9): search, historical, info, sectors, countries, price_performance, holdings, nport_disclosure, equity_exposure
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:46.999711Z
