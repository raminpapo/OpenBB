# Documentation: openbb_platform/extensions/etf/openbb_etf/etf_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/etf/openbb_etf/etf_router.py`
- **Size**: 6,107 characters, 203 lines
- **Words**: 493
- **Extension**: .py
...
**Functions** (9):
`search`, `historical`, `info`, `sectors`, `countries`, `price_performance`, `holdings`, `nport_disclosure`, `equity_exposure`

**Imports** (18):
`openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `openbb_etf.discovery.discovery_router`, `router`, `the`, `text`, `the`, `the`, `the`
...
- `openbb_etf.discovery.discovery_router`

## Notes
- Generated: 2025-11-18T07:54:36.111147
