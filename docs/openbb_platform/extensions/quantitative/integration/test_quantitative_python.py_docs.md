# Documentation: openbb_platform/extensions/quantitative/integration/test_quantitative_python.py

## File Metadata
- **Path**: `openbb_platform/extensions/quantitative/integration/test_quantitative_python.py`
- **Size**: 14,096 characters, 560 lines
- **Words**: 1,192
- **Extension**: .py
...
**Functions** (23):
`obb`, `get_stocks_data`, `get_crypto_data`, `get_data`, `test_quantitative_normality`, `test_quantitative_capm`, `test_quantitative_performance_omega_ratio`, `test_quantitative_rolling_kurtosis`, `test_quantitative_unitroot_test`, `test_quantitative_performance_sharpe_ratio`, `test_quantitative_performance_sortino_ratio`, `test_quantitative_rolling_skew`, `test_quantitative_rolling_quantile`, `test_quantitative_summary`, `test_quantitative_rolling_stdev`, `test_quantitative_rolling_mean`, `test_quantitative_rolling_variance`, `test_quantitative_stats_skew`, `test_quantitative_stats_kurtosis`, `test_quantitative_stats_variance`

**Imports** (9):
`random`, `typing`, `Literal`, `pytest`, `openbb_core.app.model.obbject`, `OBBject`, `openbb`, `openbb`, `openbb`
...
## Notes
- Generated: 2025-11-18T07:54:36.310208
