# File Documentation: test_quantitative_api.py

## Metadata
- **Path**: `openbb_platform/extensions/quantitative/integration/test_quantitative_api.py`
- **Size**: 17,272 bytes
- **Lines**: 565
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_quantitative_api.py`.

**Python Module**

- **Functions** (24): get_headers, request_data, get_stocks_data, get_crypto_data, get_data, test_quantitative_normality, test_quantitative_capm, test_quantitative_performance_omega_ratio, test_quantitative_rolling_kurtosis, test_quantitative_unitroot_test ... and 14 more
- **Import Statements**: 1
...
- **`test_quantitative_normality(params, data_type)`**
- **`test_quantitative_capm(params, data_type)`**
- **`test_quantitative_performance_omega_ratio(params, data_type)`**
- **`test_quantitative_rolling_kurtosis(params, data_type)`**
- **`test_quantitative_unitroot_test(params, data_type)`**
- **`test_quantitative_performance_sharpe_ratio(params, data_type)`**
- **`test_quantitative_performance_sortino_ratio(params, data_type)`**
- **`test_quantitative_rolling_skew(params, data_type)`**
- **`test_quantitative_rolling_variance(params, data_type)`**
- **`test_quantitative_rolling_stdev(params, data_type)`**
- **`test_quantitative_rolling_mean(params, data_type)`**
- **`test_quantitative_rolling_quantile(params, data_type)`**
- **`test_quantitative_summary(params, data_type)`**
- **`test_quantitative_stats_skew(params, data_type)`**
- **`test_quantitative_stats_kurtosis(params, data_type)`**
- **`test_quantitative_stats_mean(params, data_type)`**
- **`test_quantitative_stats_stdev(params, data_type)`**
- **`test_quantitative_stats_variance(params, data_type)`**
- **`test_quantitative_stats_quantile(params, data_type)`**
...
**Generated**: 2025-11-19T02:16:47.249206Z
