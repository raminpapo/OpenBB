# Documentation: openbb_platform/extensions/quantitative/integration/test_quantitative_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/quantitative/integration/test_quantitative_api.py`
- **Size**: 17,272 characters, 565 lines
- **Words**: 1,439
- **Extension**: .py
...
**Functions** (24):
`get_headers`, `request_data`, `get_stocks_data`, `get_crypto_data`, `get_data`, `test_quantitative_normality`, `test_quantitative_capm`, `test_quantitative_performance_omega_ratio`, `test_quantitative_rolling_kurtosis`, `test_quantitative_unitroot_test`, `test_quantitative_performance_sharpe_ratio`, `test_quantitative_performance_sortino_ratio`, `test_quantitative_rolling_skew`, `test_quantitative_rolling_variance`, `test_quantitative_rolling_stdev`, `test_quantitative_rolling_mean`, `test_quantitative_rolling_quantile`, `test_quantitative_summary`, `test_quantitative_stats_skew`, `test_quantitative_stats_kurtosis`

**Imports** (12):
`base64`, `json`, `random`, `typing`, `Literal`, `pytest`, `requests`, `openbb_core.env`, `Env`, `openbb_core.provider.utils.helpers`, `get_querystring`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:36.308177
