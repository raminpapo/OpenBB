# Documentation: openbb_platform/extensions/quantitative/openbb_quantitative/rolling/rolling_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/quantitative/openbb_quantitative/rolling/rolling_router.py`
- **Size**: 15,634 characters, 449 lines
- **Words**: 1,428
- **Extension**: .py
...
**Functions** (6):
`skew`, `variance`, `stdev`, `kurtosis`, `quantile`, `mean`

**Imports** (40):
`openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.router`, `Router`, `openbb_core.provider.abstract.data`, `Data`, `pydantic`, `NonNegativeFloat`, `openbb_core.app.utils`, `openbb_quantitative.helpers`, `validate_window`, `openbb_quantitative.statistics`, `skew_`, `openbb_core.app.utils`, `openbb_quantitative.helpers`, `validate_window`, `openbb_quantitative.statistics`, `var_`
...
- `openbb_quantitative.helpers`
- `openbb_quantitative.statistics`
- `openbb_core.app.utils`
- `openbb_quantitative.helpers`

## Notes
- Generated: 2025-11-18T07:54:36.319415
