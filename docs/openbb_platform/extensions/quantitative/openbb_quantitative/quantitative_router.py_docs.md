# File Documentation: quantitative_router.py
...
This is a **python** file named `quantitative_router.py`.

**Python Module**

- **Functions** (4): normality, capm, unitroot_test, summary
- **Import Statements**: 7
...
**Generated**: 2025-11-19T02:16:47.258896Z
