# Documentation: openbb_platform/extensions/quantitative/openbb_quantitative/quantitative_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/quantitative/openbb_quantitative/quantitative_router.py`
- **Size**: 10,553 characters, 298 lines
- **Words**: 910
- **Extension**: .py
...
**Functions** (4):
`normality`, `capm`, `unitroot_test`, `summary`

**Imports** (32):
`typing`, `Literal`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.router`, `Router`, `openbb_core.provider.abstract.data`, `Data`, `openbb_quantitative.models`, `openbb_quantitative.performance.performance_router`, `openbb_quantitative.rolling.rolling_router`, `router`, `openbb_quantitative.stats.stats_router`, `router`, `the`, `the`, `a`, `scipy`
...
- `openbb_quantitative.models`
- `openbb_quantitative.performance.performance_router`
- `openbb_quantitative.rolling.rolling_router`
- `openbb_quantitative.stats.stats_router`
- `scipy`

## Notes
- Generated: 2025-11-18T07:54:36.317180
