# Documentation: openbb_platform/extensions/quantitative/openbb_quantitative/performance/performance_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/quantitative/openbb_quantitative/performance/performance_router.py`
- **Size**: 9,221 characters, 272 lines
- **Words**: 867
- **Extension**: .py
...
**Functions** (4):
`omega_ratio`, `get_omega_ratio`, `sharpe_ratio`, `sortino_ratio`

**Imports** (29):
`typing`, `TYPE_CHECKING`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.router`, `Router`, `openbb_core.provider.abstract.data`, `Data`, `openbb_quantitative.models`, `pydantic`, `PositiveInt`, `pandas`, `Series`, `numpy`, `linspace`, `openbb_core.app.utils`, `numpy`, `sqrt`
...
## Notes
- Generated: 2025-11-18T07:54:36.315327
