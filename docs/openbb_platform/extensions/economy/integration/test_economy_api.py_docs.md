# Documentation: openbb_platform/extensions/economy/integration/test_economy_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/economy/integration/test_economy_api.py`
- **Size**: 38,228 characters, 1,307 lines
- **Words**: 2,837
- **Extension**: .py
...
**Functions** (42):
`headers`, `test_economy_calendar`, `test_economy_cpi`, `test_economy_risk_premium`, `test_economy_gdp_forecast`, `test_economy_gdp_nominal`, `test_economy_gdp_real`, `test_economy_balance_of_payments`, `test_economy_fred_search`, `test_economy_fred_series`, `test_economy_money_measures`, `test_economy_unemployment`, `test_economy_composite_leading_indicator`, `test_economy_fred_regional`, `test_economy_indicators`, `test_economy_available_indicators`, `test_economy_country_profile`, `test_economy_central_bank_holdings`, `test_economy_share_price_index`, `test_economy_house_price_index`
...
## Notes
- Generated: 2025-11-18T07:54:36.026359
