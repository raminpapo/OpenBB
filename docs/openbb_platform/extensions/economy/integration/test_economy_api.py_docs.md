# File Documentation: test_economy_api.py

## Metadata
- **Path**: `openbb_platform/extensions/economy/integration/test_economy_api.py`
- **Size**: 38,228 bytes
- **Lines**: 1,307
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_economy_api.py`.

**Python Module**

- **Functions** (42): headers, test_economy_calendar, test_economy_cpi, test_economy_risk_premium, test_economy_gdp_forecast, test_economy_gdp_nominal, test_economy_gdp_real, test_economy_balance_of_payments, test_economy_fred_search, test_economy_fred_series ... and 32 more
- **Import Statements**: 1
...
- **`headers()`**
- **`test_economy_calendar(params, headers)`**
- **`test_economy_cpi(params, headers)`**
- **`test_economy_risk_premium(params, headers)`**
- **`test_economy_gdp_forecast(params, headers)`**
- **`test_economy_gdp_nominal(params, headers)`**
- **`test_economy_gdp_real(params, headers)`**
- **`test_economy_balance_of_payments(params, headers)`**
- **`test_economy_fred_search(params, headers)`**
- **`test_economy_fred_series(params, headers)`**
- **`test_economy_money_measures(params, headers)`**
- **`test_economy_unemployment(params, headers)`**
- **`test_economy_composite_leading_indicator(params, headers)`**
- **`test_economy_fred_regional(params, headers)`**
- **`test_economy_indicators(params, headers)`**
- **`test_economy_available_indicators(params, headers)`**
- **`test_economy_country_profile(params, headers)`**
- **`test_economy_central_bank_holdings(params, headers)`**
- **`test_economy_share_price_index(params, headers)`**
- **`test_economy_house_price_index(params, headers)`**
- **`test_economy_interest_rates(params, headers)`**
- **`test_economy_retail_prices(params, headers)`**
- **`test_economy_survey_university_of_michigan(params, headers)`**
- **`test_economy_survey_sloos(params, headers)`**
- **`test_economy_survey_economic_conditions_chicago(params, headers)`**
- **`test_economy_survey_manufacturing_outlook_texas(params, headers)`**
- **`test_economy_survey_manufacturing_outlook_ny(params, headers)`**
- **`test_economy_primary_dealer_positioning(params, headers)`**
- **`test_economy_survey_nonfarm_payrolls(params, headers)`**
- **`test_economy_pce(params, headers)`**
...
**Generated**: 2025-11-19T02:16:46.894530Z
