# File Documentation: test_economy_python.py

## Metadata
- **Path**: `openbb_platform/extensions/economy/integration/test_economy_python.py`
- **Size**: 32,545 bytes
- **Lines**: 1,252
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_economy_python.py`.

**Python Module**

- **Functions** (42): obb, test_economy_calendar, test_economy_cpi, test_economy_risk_premium, test_economy_gdp_forecast, test_economy_gdp_nominal, test_economy_gdp_real, test_economy_balance_of_payments, test_economy_fred_search, test_economy_fred_series ... and 32 more
- **Import Statements**: 2
...
- **`obb(pytestconfig)`**
- **`test_economy_calendar(params, obb)`**
- **`test_economy_cpi(params, obb)`**
- **`test_economy_risk_premium(params, obb)`**
- **`test_economy_gdp_forecast(params, obb)`**
- **`test_economy_gdp_nominal(params, obb)`**
- **`test_economy_gdp_real(params, obb)`**
- **`test_economy_balance_of_payments(params, obb)`**
- **`test_economy_fred_search(params, obb)`**
- **`test_economy_fred_series(params, obb)`**
- **`test_economy_money_measures(params, obb)`**
- **`test_economy_unemployment(params, obb)`**
- **`test_economy_composite_leading_indicator(params, obb)`**
- **`test_economy_fred_regional(params, obb)`**
- **`test_economy_country_profile(params, obb)`**
- **`test_economy_available_indicators(params, obb)`**
- **`test_economy_indicators(params, obb)`**
- **`test_economy_central_bank_holdings(params, obb)`**
- **`test_economy_share_price_index(params, obb)`**
- **`test_economy_house_price_index(params, obb)`**
- **`test_economy_interest_rates(params, obb)`**
- **`test_economy_retail_prices(params, obb)`**
- **`test_economy_survey_university_of_michigan(params, obb)`**
- **`test_economy_survey_sloos(params, obb)`**
- **`test_economy_survey_economic_conditions_chicago(params, obb)`**
- **`test_economy_survey_manufacturing_outlook_texas(params, obb)`**
- **`test_economy_survey_manufacturing_outlook_ny(params, obb)`**
- **`test_economy_primary_dealer_positioning(params, obb)`**
- **`test_economy_survey_nonfarm_payrolls(params, obb)`**
- **`test_economy_pce(params, obb)`**
...
**Generated**: 2025-11-19T02:16:46.899816Z
