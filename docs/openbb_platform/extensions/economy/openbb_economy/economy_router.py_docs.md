# File Documentation: economy_router.py
...
This is a **python** file named `economy_router.py`.

**Python Module**

- **Functions** (26): calendar, cpi, risk_premium, balance_of_payments, fred_search, fred_series, fred_release_table, money_measures, unemployment, composite_leading_indicator ... and 16 more
- **Import Statements**: 4
...
**Generated**: 2025-11-19T02:16:46.906217Z
