# Documentation: openbb_platform/extensions/economy/openbb_economy/economy_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/economy/openbb_economy/economy_router.py`
- **Size**: 27,083 characters, 826 lines
- **Words**: 2,281
- **Extension**: .py
...
**Functions** (26):
`calendar`, `cpi`, `risk_premium`, `balance_of_payments`, `fred_search`, `fred_series`, `fred_release_table`, `money_measures`, `unemployment`, `composite_leading_indicator`, `fred_regional`, `country_profile`, `available_indicators`, `indicators`, `central_bank_holdings`, `share_price_index`, `house_price_index`, `interest_rates`, `retail_prices`, `primary_dealer_positioning`

**Imports** (40):
`typing`, `Annotated`, `fastapi`, `Body`, `openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `openbb_core.app.service.system_service`, `SystemService`, `openbb_economy.gdp.gdp_router`, `router`, `openbb_economy.shipping.shipping_router`
...
- `openbb_economy.gdp.gdp_router`

## Notes
- Generated: 2025-11-18T07:54:36.034774
