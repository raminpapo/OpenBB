# File Documentation: economy_views.py
...
This is a **python** file named `economy_views.py`.

**Python Module**

- **Classes** (1): EconomyViews
- **Functions** (4): economy_fred_series, economy_survey_bls_series, economy_shipping_chokepoint_info, economy_shipping_port_info
- **Import Statements**: 7
...
**Generated**: 2025-11-19T02:16:46.911213Z
