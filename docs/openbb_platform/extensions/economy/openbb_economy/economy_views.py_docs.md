# Documentation: openbb_platform/extensions/economy/openbb_economy/economy_views.py

## File Metadata
- **Path**: `openbb_platform/extensions/economy/openbb_economy/economy_views.py`
- **Size**: 22,526 characters, 599 lines
- **Words**: 1,895
- **Extension**: .py
...
**Functions** (4):
`economy_fred_series`, `economy_survey_bls_series`, `economy_shipping_chokepoint_info`, `economy_shipping_port_info`

**Imports** (32):
`typing`, `TYPE_CHECKING`, `warnings`, `warn`, `openbb_charting.core.openbb_figure`, `openbb_charting.charts.generic_charts`, `bar_chart`, `openbb_charting.charts.helpers`, `openbb_charting.core.chart_style`, `ChartStyle`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.styles.colors`, `LARGE_CYCLER`, `openbb_core.app.utils`, `basemodel_to_df`, `pandas`, `DataFrame`, `openbb_charting.charts.generic_charts`, `bar_chart`


## Key Components

**Class `EconomyViews`**: economy Views.
...
## Notes
- Generated: 2025-11-18T07:54:36.037616
