# File Documentation: survey_router.py
...
This is a **python** file named `survey_router.py`.

**Python Module**

- **Functions** (8): bls_series, bls_search, sloos, university_of_michigan, economic_conditions_chicago, manufacturing_outlook_texas, manufacturing_outlook_ny, nonfarm_payrolls
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:46.920023Z
