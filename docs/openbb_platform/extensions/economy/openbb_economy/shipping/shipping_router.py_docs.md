# File Documentation: shipping_router.py
...
This is a **python** file named `shipping_router.py`.

**Python Module**

- **Functions** (4): port_info, port_volume, chokepoint_info, chokepoint_volume
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:46.918268Z
