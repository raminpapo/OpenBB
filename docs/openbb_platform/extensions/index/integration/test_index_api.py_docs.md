# File Documentation: test_index_api.py

## Metadata
- **Path**: `openbb_platform/extensions/index/integration/test_index_api.py`
- **Size**: 6,592 bytes
- **Lines**: 228
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_index_api.py`.

**Python Module**

- **Functions** (8): headers, test_index_constituents, test_index_price_historical, test_index_available, test_index_search, test_index_snapshots, test_index_sp500_multiples, test_index_sectors
- **Import Statements**: 1
...
- **`headers()`**
- **`test_index_constituents(params, headers)`**
- **`test_index_price_historical(params, headers)`**
- **`test_index_available(params, headers)`**
- **`test_index_search(params, headers)`**
- **`test_index_snapshots(params, headers)`**
- **`test_index_sp500_multiples(params, headers)`**
- **`test_index_sectors(params, headers)`**
...
**Generated**: 2025-11-19T02:16:47.060684Z
