# File Documentation: test_index_python.py

## Metadata
- **Path**: `openbb_platform/extensions/index/integration/test_index_python.py`
- **Size**: 5,316 bytes
- **Lines**: 211
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_index_python.py`.

**Python Module**

- **Functions** (8): obb, test_index_constituents, test_index_price_historical, test_index_available, test_index_search, test_index_snapshots, test_index_sp500_multiples, test_index_sectors
- **Import Statements**: 2
...
- **`obb(pytestconfig)`**
- **`test_index_constituents(params, obb)`**
- **`test_index_price_historical(params, obb)`**
- **`test_index_available(params, obb)`**
- **`test_index_search(params, obb)`**
- **`test_index_snapshots(params, obb)`**
- **`test_index_sp500_multiples(params, obb)`**
- **`test_index_sectors(params, obb)`**
...
**Generated**: 2025-11-19T02:16:47.062421Z
