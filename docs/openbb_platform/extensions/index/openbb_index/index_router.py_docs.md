# Documentation: openbb_platform/extensions/index/openbb_index/index_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/index/openbb_index/index_router.py`
- **Size**: 3,440 characters, 122 lines
- **Words**: 267
- **Extension**: .py
...
**Functions** (6):
`constituents`, `snapshots`, `available`, `search`, `sp500_multiples`, `sectors`

**Imports** (15):
`openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `openbb_index.price.price_router`, `router`, `a`, `a`
...
## Notes
- Generated: 2025-11-18T07:54:36.162387
