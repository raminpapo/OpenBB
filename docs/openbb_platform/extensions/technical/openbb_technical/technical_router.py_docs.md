# Documentation: openbb_platform/extensions/technical/openbb_technical/technical_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/technical/openbb_technical/technical_router.py`
- **Size**: 66,454 characters, 1,917 lines
- **Words**: 7,248
- **Extension**: .py
...
**Functions** (27):
`relative_rotation`, `atr`, `fib`, `obv`, `fisher`, `adosc`, `bbands`, `zlma`, `aroon`, `sma`, `demark`, `vwap`, `macd`, `hma`, `donchian`, `ichimoku`, `clenow`, `ad`, `adx`, `wma`

**Imports** (72):
`typing`, `Any`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.router`, `Router`, `openbb_core.app.utils`, `openbb_core.provider.abstract.data`, `Data`, `pydantic`, `NonNegativeFloat`, `openbb_technical.helpers`, `openbb_technical.relative_rotation`, `the`, `pandas`, `pandas_ta`, `a`, `the`
...
- `openbb_technical.relative_rotation`
- `pandas`

## Notes
- Generated: 2025-11-18T07:54:36.371176
