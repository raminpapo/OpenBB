# Documentation: openbb_platform/extensions/technical/openbb_technical/helpers.py

## File Metadata
- **Path**: `openbb_platform/extensions/technical/openbb_technical/helpers.py`
- **Size**: 17,317 characters, 620 lines
- **Words**: 2,015
- **Extension**: .py
...
**Functions** (13):
`validate_data`, `parkinson`, `f`, `standard_deviation`, `garman_klass`, `f`, `hodges_tompkins`, `rogers_satchell`, `f`, `yang_zhang`, `calculate_cones`, `clenow_momentum`, `calculate_fib_levels`

**Imports** (29):
`typing`, `TYPE_CHECKING`, `warnings`, `warn`, `pandas`, `DataFrame`, `numpy`, `log`, `the`, `numpy`, `log`, `numpy`, `log`, `numpy`, `log`, `numpy`, `log`, `numpy`, `log`, `pandas`
...
## Notes
- Generated: 2025-11-18T07:54:36.364500
