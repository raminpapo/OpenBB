# Documentation: openbb_platform/extensions/technical/openbb_technical/relative_rotation.py

## File Metadata
- **Path**: `openbb_platform/extensions/technical/openbb_technical/relative_rotation.py`
- **Size**: 20,531 characters, 580 lines
- **Words**: 2,116
- **Extension**: .py
...
**Classes** (4):
`RelativeRotation`, `RelativeRotationQueryParams`, `RelativeRotationData`, `RelativeRotationFetcher`

**Functions** (19):
`absolute_maximum_scale`, `min_max_scaling`, `z_score_standardization`, `normalize`, `standard_deviation`, `calculate_momentum`, `get_momentum`, `calculate_relative_strength_ratio`, `process_data`, `__init__`, `_process_data`, `_get_type_name`, `to_upper`, `convert_data`, `__init__`, `__init__`, `transform_query`, `extract_data`, `transform_data`

**Imports** (41):
`typing`, `TYPE_CHECKING`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.fetcher`, `Fetcher`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `pydantic`, `Field`, `pandas`, `DataFrame`, `the`, `numpy`, `log`, `pandas`, `DataFrame`, `the`, `numpy`, `log`


## Key Components

**Class `RelativeRotation`**: Relative Rotation Class.

**Class `RelativeRotationQueryParams`**: Relative Rotation Query Parameters.

**Class `RelativeRotationData`**: Relative Rotation Data Model.

**Class `RelativeRotationFetcher`**: Relative Rotation Fetcher.
...
## Notes
- Generated: 2025-11-18T07:54:36.367383
