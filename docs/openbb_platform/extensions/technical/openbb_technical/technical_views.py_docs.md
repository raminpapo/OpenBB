# Documentation: openbb_platform/extensions/technical/openbb_technical/technical_views.py

## File Metadata
- **Path**: `openbb_platform/extensions/technical/openbb_technical/technical_views.py`
- **Size**: 18,073 characters, 551 lines
- **Words**: 1,422
- **Extension**: .py
...
**Classes** (5):
`TechnicalViews`, `import`, `import`, `import`, `import`

**Functions** (12):
`technical_sma`, `technical_ema`, `technical_hma`, `technical_wma`, `technical_zlma`, `technical_aroon`, `technical_macd`, `technical_adx`, `technical_rsi`, `technical_cones`, `technical_relative_rotation`, `_ta_ma`

**Imports** (56):
`typing`, `TYPE_CHECKING`, `openbb_charting.core.to_chart`, `to_chart`, `openbb_charting.styles.colors`, `LARGE_CYCLER`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.core.plotly_ta.ta_class`, `PlotlyTA`, `openbb_core.app.utils`, `basemodel_to_df`, `pandas`, `DataFrame`, `openbb_charting.core.plotly_ta.ta_class`, `PlotlyTA`, `openbb_core.app.utils`, `basemodel_to_df`, `pandas`, `DataFrame`


## Key Components

**Class `TechnicalViews`**: Technical Views.

**Class `import`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:36.375518
