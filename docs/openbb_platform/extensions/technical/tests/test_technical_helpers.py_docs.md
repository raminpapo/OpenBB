# File Documentation: test_technical_helpers.py

## Metadata
- **Path**: `openbb_platform/extensions/technical/tests/test_technical_helpers.py`
- **Size**: 2,732 bytes
- **Lines**: 102
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_technical_helpers.py`.

**Python Module**

- **Functions** (10): mock_data, test_parkinson_with_mock_data, test_garman_klass_with_mock_data, test_hodges_tompkins_with_mock_data, test_rogers_satchell_with_mock_data, test_yang_zhang_with_mock_data, test_clenow_momentum_with_mock_data, test_calculate_cones_with_mock_data, test_calculate_fib_levels_with_mock_data, test_validate_data_with_mock_data
- **Import Statements**: 1
...
- **`mock_data(top_range: int = 100)`**
- **`test_parkinson_with_mock_data(mock_data)`**
- **`test_garman_klass_with_mock_data(mock_data)`**
- **`test_hodges_tompkins_with_mock_data(mock_data)`**
- **`test_rogers_satchell_with_mock_data(mock_data)`**
- **`test_yang_zhang_with_mock_data(mock_data)`**
- **`test_clenow_momentum_with_mock_data(mock_data)`**
- **`test_calculate_cones_with_mock_data(mock_data)`**
- **`test_calculate_fib_levels_with_mock_data(mock_data)`**
- **`test_validate_data_with_mock_data(mock_data)`**
...
**Imported Modules**:
- `extensions.technical.openbb_technical.helpers`
- `numpy`
- `pandas`
- `pytest`
...
**Generated**: 2025-11-19T02:16:47.341734Z
