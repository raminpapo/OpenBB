# Documentation: openbb_platform/extensions/technical/integration/test_technical_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/technical/integration/test_technical_api.py`
- **Size**: 27,641 characters, 1,003 lines
- **Words**: 2,230
- **Extension**: .py
...
**Functions** (32):
`get_headers`, `get_data`, `request_data`, `get_stocks_data`, `get_crypto_data`, `test_technical_atr`, `test_technical_fib`, `test_technical_obv`, `test_technical_fisher`, `test_technical_adosc`, `test_technical_bbands`, `test_technical_zlma`, `test_technical_aroon`, `test_technical_sma`, `test_technical_demark`, `test_technical_vwap`, `test_technical_macd`, `test_technical_hma`, `test_technical_donchian`, `test_technical_ichimoku`

**Imports** (13):
`base64`, `json`, `random`, `typing`, `Literal`, `pytest`, `requests`, `openbb_core.env`, `Env`, `openbb_core.provider.utils.helpers`, `get_querystring`, `stocks`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:36.358603
