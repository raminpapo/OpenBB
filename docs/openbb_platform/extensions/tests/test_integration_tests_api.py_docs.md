# Documentation: openbb_platform/extensions/tests/test_integration_tests_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/tests/test_integration_tests_api.py`
- **Size**: 2,638 characters, 78 lines
- **Words**: 211
- **Extension**: .py
...
**Functions** (7):
`run_test`, `test_api_interface_integration_test_providers`, `test_api_interface_integration_test_params`, `test_api_interface_wrong_integration_test_params`, `test_charting_extension_function_coverage`, `test_missing_api_integration_tests`, `test_outdated_api_integration_tests`

**Imports** (6):
`typing`, `Literal`, `pytest`, `.utils.integration_tests_testers`, `openbb_charting`, `Charting`
...
## Notes
- Generated: 2025-11-18T07:54:36.392852
