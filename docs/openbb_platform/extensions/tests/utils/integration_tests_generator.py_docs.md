# Documentation: openbb_platform/extensions/tests/utils/integration_tests_generator.py

## File Metadata
- **Path**: `openbb_platform/extensions/tests/utils/integration_tests_generator.py`
- **Size**: 11,028 characters, 334 lines
- **Words**: 841
- **Extension**: .py
...
**Functions** (15):
`test_`, `find_extensions`, `create_integration_test_files`, `obb`, `get_model_params`, `get_test_params`, `get_test_params_data_processing`, `get_full_command_name_and_test_name`, `test_exists`, `write_to_file_w_template`, `write_test`, `write_test_data_processing`, `add_test_commands_to_file`, `write_commands_integration_tests`, `write_charting_extension_integration_tests`

**Imports** (20):
`argparse`, `pathlib`, `Path`, `typing`, `pytest`, `openbb_core.app.provider_interface`, `ProviderInterface`, `openbb_core.app.router`, `CommandMap`, `pydantic.fields`, `FieldInfo`, `pydantic_core`, `PydanticUndefined`, `pytest`, `openbb_core.app.model.obbject`, `OBBject`, `openbb`, `openbb_charting`, `openbb_charting`, `Charting`
...
## Notes
- Generated: 2025-11-18T07:54:36.402310
