# File Documentation: integration_tests_generator.py
...
This is a **python** file named `integration_tests_generator.py`.

**Python Module**

- **Functions** (15): test_, find_extensions, create_integration_test_files, obb, get_model_params, get_test_params, get_test_params_data_processing, get_full_command_name_and_test_name, test_exists, write_to_file_w_template ... and 5 more
- **Import Statements**: 5
...
- **`find_extensions(filter_chart: bool | None = True)`**
- **`obb(pytestconfig)`**
- **`get_test_params_data_processing(hints: dict[str, type])`**
- **`test_exists(command_name: str, path: str)`**
- **`write_to_file_w_template(test_file, params_list, full_command, test_name, extra="")`**
- **`write_test(
    test_file: PosixPath,
    commands_model: dict[str, str],
    extension_name: str,
...
**Generated**: 2025-11-19T02:16:47.359030Z
