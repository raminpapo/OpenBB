...
- **Classes** (2): from, class
- **Functions** (15): get_packages_info, execute_docstring_examples, check_docstring_examples, filter_eps, list_openbb_extensions, collect_routers, import_routers, collect_router_functions, find_decorator, get_decorator_details ... and 5 more
- **Import Statements**: 1
...
- **`parse_examples(matches, example_type)`**
...
- ⚠️ Uses `exec()` - potential security risk


---

**Generated**: 2025-11-19T02:16:47.352868Z
