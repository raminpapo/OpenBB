# Documentation: openbb_platform/extensions/tests/utils/helpers.py

## File Metadata
- **Path**: `openbb_platform/extensions/tests/utils/helpers.py`
- **Size**: 11,278 characters, 318 lines
- **Words**: 1,013
- **Extension**: .py
...
**Functions** (15):
`get_packages_info`, `execute_docstring_examples`, `check_docstring_examples`, `filter_eps`, `list_openbb_extensions`, `collect_routers`, `import_routers`, `collect_router_functions`, `find_decorator`, `get_decorator_details`, `find_missing_router_function_models`, `parse_example_string`, `parse_examples`, `get_required_fields`, `get_all_fields`

**Imports** (24):
`doctest`, `glob`, `importlib`, `inspect`, `logging`, `os`, `re`, `ast`, `AsyncFunctionDef`, `dataclasses`, `dataclass`, `importlib.metadata`, `EntryPoint`, `inspect`, `getmembers`, `sys`, `version_info`, `typing`, `Any`, `importlib_metadata`


## Key Components

**Class `from`**: Get the paths and names of all the static packages.
...
## Notes
- Generated: 2025-11-18T07:54:36.398350
