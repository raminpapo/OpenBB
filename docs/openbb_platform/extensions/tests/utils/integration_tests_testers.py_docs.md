# Documentation: openbb_platform/extensions/tests/utils/integration_tests_testers.py

## File Metadata
- **Path**: `openbb_platform/extensions/tests/utils/integration_tests_testers.py`
- **Size**: 14,292 characters, 369 lines
- **Words**: 1,153
- **Extension**: .py
...
**Functions** (11):
`get_integration_tests`, `get_module_functions`, `check_missing_providers`, `check_wrong_params`, `check_missing_params`, `check_integration_tests`, `check_missing_integration_tests`, `check_outdated_integration_tests`, `check_missing_integration_test_providers`, `check_missing_integration_test_params`, `check_wrong_integration_test_params`

**Imports** (14):
`importlib.util`, `inspect`, `os`, `collections.abc`, `Callable`, `typing`, `openbb_core.app.provider_interface`, `ProviderInterface`, `openbb_core.app.router`, `CommandMap`, `.integration_tests_generator`, `file`, `a`, `the`
...
- `.integration_tests_generator`

## Notes
- Generated: 2025-11-18T07:54:36.404335
