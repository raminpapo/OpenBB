# Documentation: openbb_platform/extensions/tests/utils/router_testers.py

## File Metadata
- **Path**: `openbb_platform/extensions/tests/utils/router_testers.py`
- **Size**: 5,971 characters, 160 lines
- **Words**: 470
- **Extension**: .py
...
**Functions** (5):
`check_router_function_models`, `check_router_model_functions_signature`, `check_general`, `check_api`, `check_router_command_examples`

**Imports** (7):
`ast`, `os`, `typing`, `Any`, `openbb_core.app.provider_interface`, `ProviderInterface`, `.helpers`
...
## Notes
- Generated: 2025-11-18T07:54:36.406108
