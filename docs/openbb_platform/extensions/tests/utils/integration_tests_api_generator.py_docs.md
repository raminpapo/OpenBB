# Documentation: openbb_platform/extensions/tests/utils/integration_tests_api_generator.py

## File Metadata
- **Path**: `openbb_platform/extensions/tests/utils/integration_tests_api_generator.py`
- **Size**: 6,931 characters, 230 lines
- **Words**: 543
- **Extension**: .py
...
**Functions** (9):
`get_http_method`, `get_post_flat_params`, `write_init_test_template`, `headers`, `write_test_w_template`, `test_`, `test_exists`, `write_commands_integration_tests`, `write_charting_extension_integration_tests`

**Imports** (25):
`argparse`, `os`, `pathlib`, `Path`, `typing`, `Literal`, `pytest`, `requests`, `openbb_charting`, `Charting`, `openbb_core.app.provider_interface`, `ProviderInterface`, `openbb_core.app.router`, `CommandMap`, `.integration_tests_generator`, `get_test_params`, `json`, `base64`, `pytest`, `requests`
...
## Notes
- Generated: 2025-11-18T07:54:36.400383
