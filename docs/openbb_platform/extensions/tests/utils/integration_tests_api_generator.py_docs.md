# File Documentation: integration_tests_api_generator.py
...
This is a **python** file named `integration_tests_api_generator.py`.

**Python Module**

- **Functions** (9): get_http_method, get_post_flat_params, write_init_test_template, headers, write_test_w_template, test_, test_exists, write_commands_integration_tests, write_charting_extension_integration_tests
- **Import Statements**: 4
...
- **`get_http_method(api_paths: dict[str, dict], route: str)`**
- **`get_post_flat_params(hints: dict[str, type])`**
- **`write_init_test_template(http_method: str, path: str)`**
- **`headers()`**
- **`write_test_w_template(
    http_method: Literal["post", "get"],
    params_list: list[dict[str, str | bool]],
...
- **`test_exists(route: str, path: str)`**
- **`write_charting_extension_integration_tests()`**
...
**Generated**: 2025-11-19T02:16:47.356147Z
