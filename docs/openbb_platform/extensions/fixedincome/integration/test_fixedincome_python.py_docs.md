# File Documentation: test_fixedincome_python.py

## Metadata
- **Path**: `openbb_platform/extensions/fixedincome/integration/test_fixedincome_python.py`
- **Size**: 17,022 bytes
- **Lines**: 653
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_fixedincome_python.py`.

**Python Module**

- **Functions** (25): obb, test_fixedincome_government_treasury_rates, test_fixedincome_rate_sofr, test_fixedincome_rate_estr, test_fixedincome_rate_sonia, test_fixedincome_rate_ameribor, test_fixedincome_rate_effr, test_fixedincome_rate_effr_forecast, test_fixedincome_rate_iorb, test_fixedincome_rate_dpcredit ... and 15 more
- **Import Statements**: 2
...
- **`obb(pytestconfig)`**
- **`test_fixedincome_government_treasury_rates(params, obb)`**
- **`test_fixedincome_rate_sofr(params, obb)`**
- **`test_fixedincome_rate_estr(params, obb)`**
- **`test_fixedincome_rate_sonia(params, obb)`**
- **`test_fixedincome_rate_ameribor(params, obb)`**
- **`test_fixedincome_rate_effr(params, obb)`**
- **`test_fixedincome_rate_effr_forecast(params, obb)`**
- **`test_fixedincome_rate_iorb(params, obb)`**
- **`test_fixedincome_rate_dpcredit(params, obb)`**
- **`test_fixedincome_rate_ecb(params, obb)`**
- **`test_fixedincome_corporate_commercial_paper(params, obb)`**
- **`test_fixedincome_corporate_spot_rates(params, obb)`**
- **`test_fixedincome_corporate_hqm(params, obb)`**
- **`test_fixedincome_spreads_tcm(params, obb)`**
- **`test_fixedincome_spreads_tcm_effr(params, obb)`**
- **`test_fixedincome_spreads_treasury_effr(params, obb)`**
- **`test_fixedincome_government_treasury_auctions(params, obb)`**
- **`test_fixedincome_government_treasury_prices(params, obb)`**
- **`test_fixedincome_corporate_bond_prices(params, obb)`**
- **`test_fixedincome_government_yield_curve(params, obb)`**
- **`test_fixedincome_bond_indices(params, obb)`**
- **`test_fixedincome_mortgage_indices(params, obb)`**
- **`test_fixedincome_rate_overnight_bank_funding(params, obb)`**
- **`test_fixedincome_government_tips_yields(params, obb)`**
...
**Generated**: 2025-11-19T02:16:47.027889Z
