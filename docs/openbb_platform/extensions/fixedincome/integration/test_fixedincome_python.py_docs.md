# Documentation: openbb_platform/extensions/fixedincome/integration/test_fixedincome_python.py

## File Metadata
- **Path**: `openbb_platform/extensions/fixedincome/integration/test_fixedincome_python.py`
- **Size**: 17,022 characters, 653 lines
- **Words**: 1,273
- **Extension**: .py
...
**Functions** (25):
`obb`, `test_fixedincome_government_treasury_rates`, `test_fixedincome_rate_sofr`, `test_fixedincome_rate_estr`, `test_fixedincome_rate_sonia`, `test_fixedincome_rate_ameribor`, `test_fixedincome_rate_effr`, `test_fixedincome_rate_effr_forecast`, `test_fixedincome_rate_iorb`, `test_fixedincome_rate_dpcredit`, `test_fixedincome_rate_ecb`, `test_fixedincome_corporate_commercial_paper`, `test_fixedincome_corporate_spot_rates`, `test_fixedincome_corporate_hqm`, `test_fixedincome_spreads_tcm`, `test_fixedincome_spreads_tcm_effr`, `test_fixedincome_spreads_treasury_effr`, `test_fixedincome_government_treasury_auctions`, `test_fixedincome_government_treasury_prices`, `test_fixedincome_corporate_bond_prices`
...
## Notes
- Generated: 2025-11-18T07:54:36.131247
