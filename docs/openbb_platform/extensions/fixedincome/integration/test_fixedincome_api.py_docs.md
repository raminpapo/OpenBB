# File Documentation: test_fixedincome_api.py

## Metadata
- **Path**: `openbb_platform/extensions/fixedincome/integration/test_fixedincome_api.py`
- **Size**: 20,781 bytes
- **Lines**: 699
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_fixedincome_api.py`.

**Python Module**

- **Functions** (25): headers, test_fixedincome_government_treasury_rates, test_fixedincome_rate_sofr, test_fixedincome_rate_estr, test_fixedincome_rate_sonia, test_fixedincome_rate_ameribor, test_fixedincome_rate_effr, test_fixedincome_rate_effr_forecast, test_fixedincome_rate_iorb, test_fixedincome_rate_dpcredit ... and 15 more
- **Import Statements**: 1
...
- **`headers()`**
- **`test_fixedincome_government_treasury_rates(params, headers)`**
- **`test_fixedincome_rate_sofr(params, headers)`**
- **`test_fixedincome_rate_estr(params, headers)`**
- **`test_fixedincome_rate_sonia(params, headers)`**
- **`test_fixedincome_rate_ameribor(params, headers)`**
- **`test_fixedincome_rate_effr(params, headers)`**
- **`test_fixedincome_rate_effr_forecast(params, headers)`**
- **`test_fixedincome_rate_iorb(params, headers)`**
- **`test_fixedincome_rate_dpcredit(params, headers)`**
- **`test_fixedincome_rate_ecb(params, headers)`**
- **`test_fixedincome_corporate_commercial_paper(params, headers)`**
- **`test_fixedincome_corporate_spot_rates(params, headers)`**
- **`test_fixedincome_corporate_hqm(params, headers)`**
- **`test_fixedincome_spreads_tcm(params, headers)`**
- **`test_fixedincome_spreads_tcm_effr(params, headers)`**
- **`test_fixedincome_spreads_treasury_effr(params, headers)`**
- **`test_fixedincome_government_treasury_auctions(params, headers)`**
- **`test_fixedincome_government_treasury_prices(params, headers)`**
- **`test_fixedincome_corporate_bond_prices(params, headers)`**
- **`test_fixedincome_government_yield_curve(params, headers)`**
- **`test_fixedincome_bond_indices(params, headers)`**
- **`test_fixedincome_mortgage_indices(params, headers)`**
- **`test_fixedincome_rate_overnight_bank_funding(params, headers)`**
- **`test_fixedincome_government_tips_yields(params, headers)`**
...
**Generated**: 2025-11-19T02:16:47.024827Z
