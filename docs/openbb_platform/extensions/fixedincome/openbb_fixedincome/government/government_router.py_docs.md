# File Documentation: government_router.py
...
This is a **python** file named `government_router.py`.

**Python Module**

- **Functions** (5): yield_curve, treasury_rates, treasury_auctions, treasury_prices, tips_yields
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:47.040887Z
