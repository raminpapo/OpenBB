# File Documentation: rate_router.py
...
This is a **python** file named `rate_router.py`.

**Python Module**

- **Functions** (10): ameribor, sonia, sofr, iorb, effr, effr_forecast, estr, ecb, dpcredit, overnight_bank_funding
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:47.043823Z
