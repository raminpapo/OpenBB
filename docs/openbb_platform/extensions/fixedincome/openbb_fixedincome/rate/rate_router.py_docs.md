# Documentation: openbb_platform/extensions/fixedincome/openbb_fixedincome/rate/rate_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/fixedincome/openbb_fixedincome/rate/rate_router.py`
- **Size**: 8,144 characters, 243 lines
- **Words**: 862
- **Extension**: .py
...
**Functions** (10):
`ameribor`, `sonia`, `sofr`, `iorb`, `effr`, `effr_forecast`, `estr`, `ecb`, `dpcredit`, `overnight_bank_funding`

**Imports** (14):
`openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `one`, `other`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:36.144038
