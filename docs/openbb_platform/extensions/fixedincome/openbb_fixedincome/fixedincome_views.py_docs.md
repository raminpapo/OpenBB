# Documentation: openbb_platform/extensions/fixedincome/openbb_fixedincome/fixedincome_views.py

## File Metadata
- **Path**: `openbb_platform/extensions/fixedincome/openbb_fixedincome/fixedincome_views.py`
- **Size**: 8,128 characters, 223 lines
- **Words**: 620
- **Extension**: .py
...
**Functions** (2):
`fixedincome_government_yield_curve`, `create_fig`

**Imports** (16):
`typing`, `TYPE_CHECKING`, `openbb_core.provider.abstract.data`, `Data`, `openbb_charting.core.openbb_figure`, `openbb_charting.charts.helpers`, `openbb_charting.core.chart_style`, `ChartStyle`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.styles.colors`, `LARGE_CYCLER`, `openbb_core.app.utils`, `basemodel_to_df`, `pandas`, `DataFrame`


## Key Components

**Class `FixedIncomeViews`**: FixedIncome Views.
...
## Notes
- Generated: 2025-11-18T07:54:36.138548
