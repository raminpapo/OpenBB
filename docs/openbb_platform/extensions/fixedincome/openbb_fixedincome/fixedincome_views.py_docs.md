# File Documentation: fixedincome_views.py
...
This is a **python** file named `fixedincome_views.py`.

**Python Module**

- **Classes** (1): FixedIncomeViews
- **Functions** (2): fixedincome_government_yield_curve, create_fig
- **Import Statements**: 2
...
**Generated**: 2025-11-19T02:16:47.033200Z
