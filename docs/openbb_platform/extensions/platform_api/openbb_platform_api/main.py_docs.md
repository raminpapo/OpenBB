...
This is a **python** file named `main.py`.

**Python Module**

- **Functions** (7): check_for_platform_extensions, root, get_widgets, get_apps_json, get_agents, launch_api, main
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:16:47.186198Z
