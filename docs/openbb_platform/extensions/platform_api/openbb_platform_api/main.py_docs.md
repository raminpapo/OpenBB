# Documentation: openbb_platform/extensions/platform_api/openbb_platform_api/main.py

## File Metadata
- **Path**: `openbb_platform/extensions/platform_api/openbb_platform_api/main.py`
- **Size**: 9,431 characters, 274 lines
- **Words**: 869
- **Extension**: .py
...
**Functions** (7):
`check_for_platform_extensions`, `root`, `get_widgets`, `get_apps_json`, `get_agents`, `launch_api`, `main`

**Imports** (20):
`json`, `logging`, `os`, `sys`, `pathlib`, `Path`, `uvicorn`, `fastapi.responses`, `HTMLResponse`, `openbb_core.api.rest_api`, `app`, `openbb_core.app.service.system_service`, `SystemService`, `openbb_core.env`, `Env`, `.utils.api`, `check_port`, `the`, `Workspace`, `OpenBB`
...
## Notes
- Generated: 2025-11-18T07:54:36.264875
