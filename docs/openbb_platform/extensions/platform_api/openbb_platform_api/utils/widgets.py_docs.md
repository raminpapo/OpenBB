# Documentation: openbb_platform/extensions/platform_api/openbb_platform_api/utils/widgets.py

## File Metadata
- **Path**: `openbb_platform/extensions/platform_api/openbb_platform_api/utils/widgets.py`
- **Size**: 28,932 characters, 742 lines
- **Words**: 1,986
- **Extension**: .py
...
**Functions** (6):
`deep_merge_configs`, `merge_values`, `merge_lists`, `modify_query_schema`, `get_form_input_paths`, `build_json`

**Imports** (6):
`copy`, `deepcopy`, `.openapi`, `.openapi`, `direct`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:36.278433
