# File Documentation: widgets.py

## Metadata
- **Path**: `openbb_platform/extensions/platform_api/openbb_platform_api/utils/widgets.py`
- **Size**: 28,932 bytes
- **Lines**: 742
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `widgets.py`.

**Python Module**

- **Functions** (6): deep_merge_configs, merge_values, merge_lists, modify_query_schema, get_form_input_paths, build_json
- **Import Statements**: 1
...
- **`merge_values(base_val, update_val)`**
- **`modify_query_schema(query_schema: list[dict], provider_value: str)`**
- **`build_json(  # noqa: PLR0912  # pylint: disable=too-many-branches, too-many-locals, too-many-statements
    openapi: dict, widget_exclude_filter: list
)`**
...
**Generated**: 2025-11-19T02:16:47.207879Z
