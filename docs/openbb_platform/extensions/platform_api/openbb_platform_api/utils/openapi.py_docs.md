# File Documentation: openapi.py

## Metadata
- **Path**: `openbb_platform/extensions/platform_api/openbb_platform_api/utils/openapi.py`
- **Size**: 35,553 bytes
- **Lines**: 1,040
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `openapi.py`.

**Python Module**

- **Functions** (10): extract_providers, set_parameter_type, set_parameter_options, elif, process_parameter, get_query_schema_for_widget, get_data_schema_for_widget, data_schema_to_columns_defs, post_query_schema_for_widget, set_param
- **Import Statements**: 1
...
- **`set_parameter_type(p: dict, p_schema: dict)`**
- **`get_data_schema_for_widget(openapi_json, operation_id, route: str | None = None)`**
- **`data_schema_to_columns_defs(  # noqa: PLR0912  # pylint: disable=too-many-branches
    openapi_json,
    operation_id,
    provider,
    route: str | None = None,
...
**Generated**: 2025-11-19T02:16:47.202950Z
