# Documentation: openbb_platform/extensions/platform_api/openbb_platform_api/utils/openapi.py

## File Metadata
- **Path**: `openbb_platform/extensions/platform_api/openbb_platform_api/utils/openapi.py`
- **Size**: 35,553 characters, 1,040 lines
- **Words**: 3,140
- **Extension**: .py
...
**Functions** (10):
`extract_providers`, `set_parameter_type`, `set_parameter_options`, `elif`, `process_parameter`, `get_query_schema_for_widget`, `get_data_schema_for_widget`, `data_schema_to_columns_defs`, `post_query_schema_for_widget`, `set_param`

**Imports** (12):
`openbb_core.provider.utils.helpers`, `to_snake_case`, `parameters.`, `title`, `description`, `schema`, `title`, `description`, `the`, `the`, `components`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:36.273703
