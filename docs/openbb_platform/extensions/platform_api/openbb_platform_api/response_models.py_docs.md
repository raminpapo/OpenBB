# File Documentation: response_models.py
...
This is a **python** file named `response_models.py`.

**Python Module**

- **Classes** (3): MetricResponseModel, PdfResponseModel, OmniWidgetResponseModel
- **Functions** (3): validate_model, get_omni_widget, validate_model
- **Import Statements**: 6
...
- **`MetricResponseModel`**(Data)
- **`PdfResponseModel`**(Data)
- **`OmniWidgetResponseModel`**(Data)
...
app, classmethod, model_validator
...
**Generated**: 2025-11-19T02:16:47.189792Z
