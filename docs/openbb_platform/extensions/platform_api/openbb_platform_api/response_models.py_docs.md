# Documentation: openbb_platform/extensions/platform_api/openbb_platform_api/response_models.py

## File Metadata
- **Path**: `openbb_platform/extensions/platform_api/openbb_platform_api/response_models.py`
- **Size**: 9,320 characters, 291 lines
- **Words**: 905
- **Extension**: .py
...
**Classes** (3):
`MetricResponseModel`, `PdfResponseModel`, `OmniWidgetResponseModel`

**Functions** (3):
`validate_model`, `get_omni_widget`, `validate_model`

**Imports** (17):
`typing`, `Any`, `openbb_core.provider.abstract.data`, `Data`, `pydantic`, `ConfigDict`, `base64`, `io`, `BytesIO`, `openbb_platform_api.main`, `app`, `json`, `re`, `pandas`, `e`, `e`, `e`


## Key Components

**Class `MetricResponseModel`**: Metric Widget Response Model.
...
**Class `PdfResponseModel`**: PDF Widget Response Model.
...
**Class `OmniWidgetResponseModel`**: Omni Widget Response Model.
...
## Notes
- Generated: 2025-11-18T07:54:36.267999
