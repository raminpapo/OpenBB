# File Documentation: test_widgets_utils.py
...
This is a **python** file named `test_widgets_utils.py`.

**Python Module**

- **Functions** (5): mock_openapi_json, mock_widgets_json, test_omni_widget_response_model, test_modify_query_schema, test_build_json
- **Import Statements**: 1
...
- **`mock_openapi_json()`**
- **`mock_widgets_json()`**
- **`test_omni_widget_response_model()`**
- **`test_modify_query_schema(query_schema, provider_value, expected_result)`**
- **`test_build_json(mock_openapi_json, mock_widgets_json)`**
...
**Generated**: 2025-11-19T02:16:47.234731Z
