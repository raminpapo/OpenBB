# Documentation: openbb_platform/extensions/platform_api/tests/test_widgets_utils.py

## File Metadata
- **Path**: `openbb_platform/extensions/platform_api/tests/test_widgets_utils.py`
- **Size**: 20,510 characters, 509 lines
- **Words**: 1,596
- **Extension**: .py
...
**Functions** (5):
`mock_openapi_json`, `mock_widgets_json`, `test_omni_widget_response_model`, `test_modify_query_schema`, `test_build_json`

**Imports** (12):
`json`, `pathlib`, `Path`, `pytest`, `openbb_platform_api.response_models`, `OmniWidgetResponseModel`, `openbb_platform_api.utils.widgets`, `build_json`, `Year`, `Year`, `Year`, `Year`
...
- `pathlib`
- `pytest`
- `openbb_platform_api.response_models`
- `openbb_platform_api.utils.widgets`

## Notes
- Generated: 2025-11-18T07:54:36.304996
