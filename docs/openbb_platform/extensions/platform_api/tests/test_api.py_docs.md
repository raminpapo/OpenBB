# File Documentation: test_api.py

## Metadata
- **Path**: `openbb_platform/extensions/platform_api/tests/test_api.py`
- **Size**: 7,784 bytes
- **Lines**: 215
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_api.py`.

**Python Module**

- **Classes** (3): MockFastAPI, MockFastAPI, MockFastAPI
- **Functions** (11): mock_env_vars, test_check_port, test_get_user_settings_no_login, test_get_widgets_json_no_build, test_parse_args, test_import_module_app, __init__, test_import_file_app, __init__, test_import_factory_app ... and 1 more
- **Import Statements**: 4
...
- **`test_check_port(port_input)`**
- **`test_get_user_settings_no_login()`**
- **`test_get_widgets_json_no_build()`**
- **`test_parse_args()`**
- **`test_import_module_app()`**
- **`__init__(self, *args, **kwargs)`**
- **`test_import_file_app()`**
- **`__init__(self, *args, **kwargs)`**
- **`test_import_factory_app()`**
- **`__init__(self, *args, **kwargs)`**
...
**Generated**: 2025-11-19T02:16:47.228959Z
