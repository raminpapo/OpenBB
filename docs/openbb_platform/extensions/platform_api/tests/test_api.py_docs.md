# Documentation: openbb_platform/extensions/platform_api/tests/test_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/platform_api/tests/test_api.py`
- **Size**: 7,784 characters, 215 lines
- **Words**: 496
- **Extension**: .py
...
**Classes** (3):
`MockFastAPI`, `MockFastAPI`, `MockFastAPI`

**Functions** (11):
`mock_env_vars`, `test_check_port`, `test_get_user_settings_no_login`, `test_get_widgets_json_no_build`, `test_parse_args`, `test_import_module_app`, `__init__`, `test_import_file_app`, `__init__`, `test_import_factory_app`, `__init__`

**Imports** (10):
`unittest.mock`, `MagicMock`, `pytest`, `openbb_platform_api.utils.api`, `fastapi`, `FastAPI`, `fastapi`, `FastAPI`, `fastapi`, `FastAPI`


## Key Components

**Class `MockFastAPI`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:36.301377
