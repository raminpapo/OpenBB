# File Documentation: test_openapi_utils.py

## Metadata
- **Path**: `openbb_platform/extensions/platform_api/tests/test_openapi_utils.py`
- **Size**: 16,956 bytes
- **Lines**: 382
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_openapi_utils.py`.

**Python Module**

- **Functions** (5): mock_openapi_json, test_get_query_schema_for_widget, test_get_data_schema_for_widget, test_post_query_schema_for_widget, test_data_schema_to_columns_defs
- **Import Statements**: 1
...
- **`mock_openapi_json()`**
- **`test_get_query_schema_for_widget(
    mock_openapi_json, path, params_number, query_schema, expected_has_chart
)`**
- **`test_get_data_schema_for_widget(mock_openapi_json, openapi_operation_id)`**
- **`test_post_query_schema_for_widget(mock_openapi_json, openapi_operation_id)`**
- **`test_data_schema_to_columns_defs(mock_openapi_json, openapi_operation_id)`**
...
- `Path`
- `json`
- `openbb_platform_api.utils.openapi`
- `pathlib`
- `pytest`
...
**Generated**: 2025-11-19T02:16:47.231691Z
