# Documentation: openbb_platform/extensions/platform_api/tests/test_openapi_utils.py

## File Metadata
- **Path**: `openbb_platform/extensions/platform_api/tests/test_openapi_utils.py`
- **Size**: 16,956 characters, 382 lines
- **Words**: 1,113
- **Extension**: .py
...
**Functions** (5):
`mock_openapi_json`, `test_get_query_schema_for_widget`, `test_get_data_schema_for_widget`, `test_post_query_schema_for_widget`, `test_data_schema_to_columns_defs`

**Imports** (7):
`json`, `pathlib`, `Path`, `pytest`, `openbb_platform_api.utils.openapi`, `Year`, `Year`
...
## Notes
- Generated: 2025-11-18T07:54:36.303044
