# File Documentation: test_famafrench_python.py
...
This is a **python** file named `test_famafrench_python.py`.

**Python Module**

- **Functions** (8): obb, test_famafrench_factors, test_famafrench_us_portfolio_returns, test_famafrench_regional_portfolio_returns, test_famafrench_country_portfolio_returns, test_famafrench_international_index_returns, test_famafrench_breakpoints, test_famafrench_factor_choices
- **Import Statements**: 2
...
- **`obb(pytestconfig)`**
- **`test_famafrench_factors(params, obb)`**
- **`test_famafrench_us_portfolio_returns(params, obb)`**
- **`test_famafrench_regional_portfolio_returns(params, obb)`**
- **`test_famafrench_country_portfolio_returns(params, obb)`**
- **`test_famafrench_international_index_returns(params, obb)`**
- **`test_famafrench_breakpoints(params, obb)`**
- **`test_famafrench_factor_choices(params, obb)`**
...
**Generated**: 2025-11-19T02:16:47.010851Z
