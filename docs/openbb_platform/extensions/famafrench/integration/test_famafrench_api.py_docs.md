# File Documentation: test_famafrench_api.py
...
This is a **python** file named `test_famafrench_api.py`.

**Python Module**

- **Functions** (8): headers, test_famafrench_factors, test_famafrench_us_portfolio_returns, test_famafrench_regional_portfolio_returns, test_famafrench_country_portfolio_returns, test_famafrench_international_index_returns, test_famafrench_breakpoints, test_famafrench_factor_choices
- **Import Statements**: 1
...
- **`headers()`**
- **`test_famafrench_factors(params, headers)`**
- **`test_famafrench_us_portfolio_returns(params, headers)`**
- **`test_famafrench_regional_portfolio_returns(params, headers)`**
- **`test_famafrench_country_portfolio_returns(params, headers)`**
- **`test_famafrench_international_index_returns(params, headers)`**
- **`test_famafrench_breakpoints(params, headers)`**
- **`test_famafrench_factor_choices(params, headers)`**
...
**Generated**: 2025-11-19T02:16:47.008611Z
