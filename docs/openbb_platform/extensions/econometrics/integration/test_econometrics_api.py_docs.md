# File Documentation: test_econometrics_api.py

## Metadata
- **Path**: `openbb_platform/extensions/econometrics/integration/test_econometrics_api.py`
- **Size**: 8,061 bytes
- **Lines**: 279
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_econometrics_api.py`.

**Python Module**

- **Functions** (12): get_headers, request_data, get_equity_data, get_crypto_data, get_data, test_econometrics_correlation_matrix, test_econometrics_ols_regression_summary, test_econometrics_autocorrelation, test_econometrics_residual_autocorrelation, test_econometrics_cointegration ... and 2 more
- **Import Statements**: 1
...
- **`test_econometrics_correlation_matrix(params, data_type)`**
- **`test_econometrics_ols_regression_summary(params, data_type)`**
- **`test_econometrics_autocorrelation(params, data_type)`**
- **`test_econometrics_residual_autocorrelation(params, data_type)`**
- **`test_econometrics_cointegration(params, data_type)`**
- **`test_econometrics_causality(params, data_type)`**
- **`test_econometrics_unit_root(params, data_type)`**
...
**Generated**: 2025-11-19T02:16:46.865142Z
