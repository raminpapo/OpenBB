# Documentation: openbb_platform/extensions/econometrics/integration/test_econometrics_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/econometrics/integration/test_econometrics_api.py`
- **Size**: 8,061 characters, 279 lines
- **Words**: 678
- **Extension**: .py
...
**Functions** (12):
`get_headers`, `request_data`, `get_equity_data`, `get_crypto_data`, `get_data`, `test_econometrics_correlation_matrix`, `test_econometrics_ols_regression_summary`, `test_econometrics_autocorrelation`, `test_econometrics_residual_autocorrelation`, `test_econometrics_cointegration`, `test_econometrics_causality`, `test_econometrics_unit_root`
...
## Notes
- Generated: 2025-11-18T07:54:35.998855
