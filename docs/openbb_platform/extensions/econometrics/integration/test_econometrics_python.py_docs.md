# Documentation: openbb_platform/extensions/econometrics/integration/test_econometrics_python.py

## File Metadata
- **Path**: `openbb_platform/extensions/econometrics/integration/test_econometrics_python.py`
- **Size**: 11,174 characters, 424 lines
- **Words**: 984
- **Extension**: .py
...
**Functions** (19):
`obb`, `get_stocks_data`, `get_crypto_data`, `get_data`, `test_econometrics_correlation_matrix`, `test_econometrics_ols_regression`, `test_econometrics_ols_regression_summary`, `test_econometrics_autocorrelation`, `test_econometrics_residual_autocorrelation`, `test_econometrics_cointegration`, `test_econometrics_causality`, `test_econometrics_unit_root`, `test_econometrics_panel_random_effects`, `test_econometrics_panel_between`, `test_econometrics_panel_pooled`, `test_econometrics_panel_fixed`, `test_econometrics_panel_first_difference`, `test_econometrics_panel_fmac`, `test_econometrics_variance_inflation_factor`

**Imports** (11):
`random`, `typing`, `Literal`, `pytest`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_econometrics.utils`, `mock_multi_index_data`, `openbb`, `openbb`, `openbb`
...
## Notes
- Generated: 2025-11-18T07:54:36.000572
