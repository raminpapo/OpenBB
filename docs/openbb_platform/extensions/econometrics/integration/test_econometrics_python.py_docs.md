# File Documentation: test_econometrics_python.py

## Metadata
- **Path**: `openbb_platform/extensions/econometrics/integration/test_econometrics_python.py`
- **Size**: 11,174 bytes
- **Lines**: 424
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_econometrics_python.py`.

**Python Module**

- **Functions** (19): obb, get_stocks_data, get_crypto_data, get_data, test_econometrics_correlation_matrix, test_econometrics_ols_regression, test_econometrics_ols_regression_summary, test_econometrics_autocorrelation, test_econometrics_residual_autocorrelation, test_econometrics_cointegration ... and 9 more
- **Import Statements**: 4
...
- **`test_econometrics_correlation_matrix(params, data_type, obb)`**
- **`test_econometrics_ols_regression(params, data_type, obb)`**
- **`test_econometrics_ols_regression_summary(params, data_type, obb)`**
- **`test_econometrics_autocorrelation(params, data_type, obb)`**
- **`test_econometrics_residual_autocorrelation(params, data_type, obb)`**
- **`test_econometrics_cointegration(params, data_type, obb)`**
- **`test_econometrics_causality(params, data_type, obb)`**
- **`test_econometrics_unit_root(params, data_type, obb)`**
- **`test_econometrics_panel_random_effects(params, obb)`**
- **`test_econometrics_panel_between(params, obb)`**
- **`test_econometrics_panel_pooled(params, obb)`**
- **`test_econometrics_panel_fixed(params, obb)`**
- **`test_econometrics_panel_first_difference(params, obb)`**
- **`test_econometrics_panel_fmac(params, obb)`**
- **`test_econometrics_variance_inflation_factor(params, obb)`**
...
**Generated**: 2025-11-19T02:16:46.867401Z
