# Documentation: openbb_platform/extensions/econometrics/openbb_econometrics/econometrics_router.py

## File Metadata
- **Path**: `openbb_platform/extensions/econometrics/openbb_econometrics/econometrics_router.py`
- **Size**: 34,123 characters, 986 lines
- **Words**: 3,370
- **Extension**: .py
...
**Functions** (15):
`correlation_matrix`, `ols_regression`, `ols_regression_summary`, `autocorrelation`, `residual_autocorrelation`, `cointegration`, `causality`, `unit_root`, `panel_random_effects`, `panel_between`, `panel_pooled`, `panel_fixed`, `panel_first_difference`, `panel_fmac`, `variance_inflation_factor`

**Imports** (84):
`itertools`, `combinations`, `typing`, `Literal`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.router`, `Router`, `openbb_core.provider.abstract.data`, `Data`, `pydantic`, `PositiveInt`, `numpy`, `openbb_core.app.utils`, `basemodel_to_df`, `the`, `statsmodels`, `statsmodels.api`
...
## Notes
- Generated: 2025-11-18T07:54:36.004556
