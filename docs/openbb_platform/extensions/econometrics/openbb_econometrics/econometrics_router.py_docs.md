# File Documentation: econometrics_router.py
...
This is a **python** file named `econometrics_router.py`.

**Python Module**

- **Functions** (15): correlation_matrix, ols_regression, ols_regression_summary, autocorrelation, residual_autocorrelation, cointegration, causality, unit_root, panel_random_effects, panel_between ... and 5 more
...
**Generated**: 2025-11-19T02:16:46.871825Z
