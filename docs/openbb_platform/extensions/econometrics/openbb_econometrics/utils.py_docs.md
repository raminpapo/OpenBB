# Documentation: openbb_platform/extensions/econometrics/openbb_econometrics/utils.py

## File Metadata
- **Path**: `openbb_platform/extensions/econometrics/openbb_econometrics/utils.py`
- **Size**: 4,297 characters, 116 lines
- **Words**: 537
- **Extension**: .py
...
**Functions** (2):
`get_engle_granger_two_step_cointegration_test`, `mock_multi_index_data`

**Imports** (13):
`warnings`, `typing`, `TYPE_CHECKING`, `pandas`, `Series`, `the`, `statsmodels.api`, `statsmodels.tsa.stattools`, `adfuller`, `numpy`, `random`, `pandas`, `DataFrame`
...
## Notes
- Generated: 2025-11-18T07:54:36.010101
