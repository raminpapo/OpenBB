# Documentation: openbb_platform/extensions/commodity/integration/test_commodity_python.py

## File Metadata
- **Path**: `openbb_platform/extensions/commodity/integration/test_commodity_python.py`
- **Size**: 2,654 characters, 101 lines
- **Words**: 193
- **Extension**: .py
...
**Functions** (4):
`obb`, `test_commodity_price_spot`, `test_commodity_petroleum_status_report`, `test_commodity_short_term_energy_outlook`
...
## Notes
- Generated: 2025-11-18T07:54:35.897320
