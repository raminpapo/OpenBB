# File Documentation: test_uscongress_api.py

## Metadata
- **Path**: `openbb_platform/extensions/uscongress/integration/test_uscongress_api.py`
- **Size**: 3,599 bytes
- **Lines**: 129
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_uscongress_api.py`.

**Python Module**

- **Functions** (5): headers, test_uscongress_bills, test_uscongress_bill_info, test_uscongress_bill_text_urls, test_uscongress_bill_text
- **Import Statements**: 1
...
- **`headers()`**
- **`test_uscongress_bills(params, headers)`**
- **`test_uscongress_bill_info(params, headers)`**
- **`test_uscongress_bill_text_urls(params, headers)`**
- **`test_uscongress_bill_text(params, headers)`**
...
**Generated**: 2025-11-19T02:16:47.366572Z
