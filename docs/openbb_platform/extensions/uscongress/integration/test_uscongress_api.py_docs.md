# Documentation: openbb_platform/extensions/uscongress/integration/test_uscongress_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/uscongress/integration/test_uscongress_api.py`
- **Size**: 3,599 characters, 129 lines
- **Words**: 286
- **Extension**: .py
...
**Functions** (5):
`headers`, `test_uscongress_bills`, `test_uscongress_bill_info`, `test_uscongress_bill_text_urls`, `test_uscongress_bill_text`
...
## Notes
- Generated: 2025-11-18T07:54:36.409480
