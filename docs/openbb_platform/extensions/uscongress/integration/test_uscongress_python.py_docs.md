# File Documentation: test_uscongress_python.py
...
This is a **python** file named `test_uscongress_python.py`.

**Python Module**

- **Functions** (5): obb, test_uscongress_bills, test_uscongress_bill_info, test_uscongress_bill_text_urls, test_uscongress_bill_text
- **Import Statements**: 2
...
- **`obb(pytestconfig)`**
- **`test_uscongress_bills(params, obb)`**
- **`test_uscongress_bill_info(params, obb)`**
- **`test_uscongress_bill_text_urls(params, obb)`**
- **`test_uscongress_bill_text(params, obb)`**
...
**Generated**: 2025-11-19T02:16:47.367948Z
