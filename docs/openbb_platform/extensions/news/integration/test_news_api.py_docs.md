# File Documentation: test_news_api.py

## Metadata
- **Path**: `openbb_platform/extensions/news/integration/test_news_api.py`
- **Size**: 6,252 bytes
- **Lines**: 220
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_news_api.py`.

**Python Module**

- **Functions** (3): headers, test_news_world, test_news_company
- **Import Statements**: 1
...
- **`headers()`**
- **`test_news_world(params, headers)`**
- **`test_news_company(params, headers)`**
...
**Generated**: 2025-11-19T02:16:47.161880Z
