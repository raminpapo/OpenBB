# Documentation: openbb_platform/extensions/news/integration/test_news_api.py

## File Metadata
- **Path**: `openbb_platform/extensions/news/integration/test_news_api.py`
- **Size**: 6,252 characters, 220 lines
- **Words**: 414
- **Extension**: .py
...
**Functions** (3):
`headers`, `test_news_world`, `test_news_company`
...
## Notes
- Generated: 2025-11-18T07:54:36.238517
