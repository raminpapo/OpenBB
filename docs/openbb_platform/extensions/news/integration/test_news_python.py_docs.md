# Documentation: openbb_platform/extensions/news/integration/test_news_python.py

## File Metadata
- **Path**: `openbb_platform/extensions/news/integration/test_news_python.py`
- **Size**: 5,470 characters, 201 lines
- **Words**: 353
- **Extension**: .py
...
**Functions** (3):
`obb`, `test_news_world`, `test_news_company`
...
## Notes
- Generated: 2025-11-18T07:54:36.240357
