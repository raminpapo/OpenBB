# File Documentation: test_news_python.py

## Metadata
- **Path**: `openbb_platform/extensions/news/integration/test_news_python.py`
- **Size**: 5,470 bytes
- **Lines**: 201
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_news_python.py`.

**Python Module**

- **Functions** (3): obb, test_news_world, test_news_company
- **Import Statements**: 2
...
- **`obb(pytestconfig)`**
- **`test_news_world(params, obb)`**
- **`test_news_company(params, obb)`**
...
**Generated**: 2025-11-19T02:16:47.163507Z
