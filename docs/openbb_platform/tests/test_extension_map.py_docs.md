# Documentation: openbb_platform/tests/test_extension_map.py

## File Metadata
- **Path**: `openbb_platform/tests/test_extension_map.py`
- **Size**: 3,018 characters, 77 lines
- **Words**: 300
- **Extension**: .py
...
**Functions** (3):
`create_ext_map`, `load_req_ext`, `test_extension_map`

**Imports** (10):
`json`, `pathlib`, `Path`, `pytest`, `poetry.core.constraints.version`, `Version`, `poetry.core.pyproject.toml`, `PyProjectTOML`, `extension.`, `pyproject.toml.`
...
## Notes
- Generated: 2025-11-18T07:54:43.858693
