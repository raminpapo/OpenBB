# Documentation: openbb_platform/tests/test_pyproject_toml.py

## File Metadata
- **Path**: `openbb_platform/tests/test_pyproject_toml.py`
- **Size**: 3,060 characters, 78 lines
- **Words**: 297
- **Extension**: .py
...
**Functions** (2):
`test_optional_packages`, `test_extension_versions_match_main_pyproject`

**Imports** (4):
`pathlib`, `Path`, `tomlkit`, `load`
...
## Notes
- Generated: 2025-11-18T07:54:43.859891
