# File Documentation: test_pyproject_toml.py

## Metadata
- **Path**: `openbb_platform/tests/test_pyproject_toml.py`
- **Size**: 3,060 bytes
- **Lines**: 78
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_pyproject_toml.py`.

**Python Module**

- **Functions** (2): test_optional_packages, test_extension_versions_match_main_pyproject
- **Import Statements**: 1
...
- **`test_extension_versions_match_main_pyproject()`**
...
**Generated**: 2025-11-19T02:16:55.467595Z
