# Documentation: openbb_platform/obbject_extensions/charting/tests/test_charting.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/tests/test_charting.py`
- **Size**: 4,499 characters, 176 lines
- **Words**: 317
- **Extension**: .py
...
**Classes** (3):
`MockDataframe`, `MockStdParams`, `MockOBBject`

**Functions** (11):
`__init__`, `obbject`, `__init__`, `to_dataframe`, `test_charting_settings`, `test_indicators`, `test_functions`, `test_handle_backend`, `test_get_chart_function`, `test_show`, `test_to_chart`

**Imports** (11):
`unittest.mock`, `MagicMock`, `pytest`, `openbb_charting.charting`, `Charting`, `openbb_core.app.model.system_settings`, `SystemSettings`, `openbb_core.app.model.user_settings`, `UserSettings`, `pydantic`, `BaseModel`


## Key Components

**Class `MockDataframe`**: Mock Dataframe.

**Class `MockStdParams`**: Mock Standard Parameters.
...
## Notes
- Generated: 2025-11-18T07:54:37.208377
