# File Documentation: test_charting.py

## Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/tests/test_charting.py`
- **Size**: 4,499 bytes
- **Lines**: 176
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_charting.py`.

**Python Module**

- **Classes** (3): MockDataframe, MockStdParams, MockOBBject
- **Functions** (11): __init__, obbject, __init__, to_dataframe, test_charting_settings, test_indicators, test_functions, test_handle_backend, test_get_chart_function, test_show ... and 1 more
- **Import Statements**: 1
...
- **`__init__(self)`**
- **`to_dataframe(self)`**
- **`test_charting_settings(obbject)`**
- **`test_indicators(obbject)`**
- **`test_functions(get_charting_functions_list)`**
- **`test_handle_backend(mock_handle_backend, obbject)`**
- **`test_get_chart_function(obbject)`**
- **`test_show(_, mock_get_chart_function, obbject)`**
- **`test_to_chart(_, mock_get_chart_function, mock_prepare_data_as_df, obbject)`**
...
**Generated**: 2025-11-19T02:16:48.226242Z
