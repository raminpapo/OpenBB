# File Documentation: charting.py
...
This is a **python** file named `charting.py`.

**Python Module**

- **Classes** (3): Charting, for, is
- **Functions** (19): __init__, indicators, functions, _get_functions, _handle_backend, _get_chart_function, get_params, _prepare_data_as_df, create_line_chart, create_bar_chart ... and 9 more
...
- **`show(self, render: bool = True, **kwargs)`**
- **`_set_chart_style(self, figure: "Figure")`**
- **`toggle_chart_style(self)`**
- **`_convert_to_string(x)`**
- **`table(
        self,
        data: Union["DataFrame", "Series"] | None = None,
        title: str = "",
...
**Generated**: 2025-11-19T02:16:47.403761Z
