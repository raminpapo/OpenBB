# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/charting.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/charting.py`
- **Size**: 29,671 characters, 782 lines
- **Words**: 2,749
- **Extension**: .py
...
**Functions** (19):
`__init__`, `indicators`, `functions`, `_get_functions`, `_handle_backend`, `_get_chart_function`, `get_params`, `_prepare_data_as_df`, `create_line_chart`, `create_bar_chart`, `create_3d_surface`, `create_correlation_matrix`, `show`, `to_chart`, `_set_chart_style`, `toggle_chart_style`, `_convert_to_string`, `table`, `url`

**Imports** (66):
`collections.abc`, `Callable`, `typing`, `warnings`, `warn`, `importlib_metadata`, `entry_points`, `openbb_core.app.model.abstract.error`, `OpenBBError`, `openbb_core.app.model.charts.chart`, `Chart`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.provider.abstract.data`, `Data`, `openbb_charting.charts.helpers`, `numpy`, `ndarray`, `pandas`, `DataFrame`


## Key Components

**Class `Charting`**: Charting extension.
    ...
    show
        Display chart and save it to the OBBject.
    to_chart
        Redraw the chart and save it to the OBBject, with an optional entry point f
...
## Notes
- Generated: 2025-11-18T07:54:36.426014
