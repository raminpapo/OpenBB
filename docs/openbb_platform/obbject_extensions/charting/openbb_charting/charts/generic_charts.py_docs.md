# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/charts/generic_charts.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/charts/generic_charts.py`
- **Size**: 27,011 characters, 800 lines
- **Words**: 2,351
- **Extension**: .py
...
**Functions** (4):
`line_chart`, `bar_chart`, `bar_increasing_decreasing`, `surface3d`

**Imports** (40):
`typing`, `TYPE_CHECKING`, `openbb_core.app.utils`, `basemodel_to_df`, `openbb_core.provider.abstract.data`, `Data`, `openbb_charting.charts.helpers`, `openbb_charting.core.chart_style`, `ChartStyle`, `openbb_charting.styles.colors`, `LARGE_CYCLER`, `numpy`, `ndarray`, `pandas`, `DataFrame`, `plotly.graph_objs`, `Figure`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `pandas`
...
## Notes
- Generated: 2025-11-18T07:54:36.431522
