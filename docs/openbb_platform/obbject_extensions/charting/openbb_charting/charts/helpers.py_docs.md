# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/charts/helpers.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/charts/helpers.py`
- **Size**: 3,407 characters, 123 lines
- **Words**: 357
- **Extension**: .py
...
**Functions** (8):
`get_charting_functions`, `get_charting_functions_list`, `z_score_standardization`, `calculate_returns`, `should_share_axis`, `heikin_ashi`, `duration_sorter`, `duration_to_months`

**Imports** (12):
`collections.abc`, `Callable`, `typing`, `TYPE_CHECKING`, `pandas`, `DataFrame`, `inspect`, `getmembers`, `pandas`, `Series`, `pandas_ta`, `candles`
...
## Notes
- Generated: 2025-11-18T07:54:36.433974
