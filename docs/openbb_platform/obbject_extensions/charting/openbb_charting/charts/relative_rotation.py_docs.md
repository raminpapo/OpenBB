# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/charts/relative_rotation.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/charts/relative_rotation.py`
- **Size**: 19,957 characters, 674 lines
- **Words**: 1,317
- **Extension**: .py
...
**Functions** (2):
`create_rrg_with_tails`, `create_rrg_without_tails`

**Imports** (20):
`datetime`, `date`, `typing`, `TYPE_CHECKING`, `warnings`, `warn`, `pandas`, `DataFrame`, `plotly.graph_objects`, `Figure`, `pandas`, `to_datetime`, `plotly`, `graph_objects`, `plotly`, `graph_objects`, `pandas`, `to_datetime`, `each`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:36.438824
