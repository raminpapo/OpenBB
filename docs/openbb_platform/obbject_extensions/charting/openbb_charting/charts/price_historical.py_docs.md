# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/charts/price_historical.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/charts/price_historical.py`
- **Size**: 10,765 characters, 322 lines
- **Words**: 889
- **Extension**: .py
...
**Imports** (17):
`typing`, `TYPE_CHECKING`, `openbb_charting.styles.colors`, `LARGE_CYCLER`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `pandas`, `DataFrame`, `openbb_core.app.utils`, `basemodel_to_df`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.core.plotly_ta.ta_class`, `PlotlyTA`, `openbb_charting.core.chart_style`, `ChartStyle`, `openbb_charting.charts.helpers`
...
## Notes
- Generated: 2025-11-18T07:54:36.435570
