# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/charts/correlation_matrix.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/charts/correlation_matrix.py`
- **Size**: 3,419 characters, 112 lines
- **Words**: 290
- **Extension**: .py
...
**Imports** (18):
`typing`, `TYPE_CHECKING`, `plotly.graph_objs`, `Figure`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `numpy`, `ones_like`, `openbb_core.app.utils`, `basemodel_to_df`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.core.chart_style`, `ChartStyle`, `plotly.graph_objs`, `Figure`, `pandas`, `DataFrame`
...
## Notes
- Generated: 2025-11-18T07:54:36.429521
