# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/query_params.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/query_params.py`
- **Size**: 27,275 characters, 853 lines
- **Words**: 2,640
- **Extension**: .py
...
**Classes** (47):
`BaseQueryParams`, `ChartQueryParams`, `EquityPricePerformanceChartQueryParams`, `EtfPricePerformanceChartQueryParams`, `EtfHoldingsChartQueryParams`, `EquityPriceHistoricalChartQueryParams`, `EconomyFredSeriesChartQueryParams`, `TechnicalConesChartQueryParams`, `MAQueryParams`, `FixedincomeGovernmentYieldCurve`, `TechnicalSMAChartQueryParams`, `TechnicalEMAChartQueryParams`, `TechnicalHMAChartQueryParams`, `TechnicalWMAChartQueryParams`, `TechnicalZLMAChartQueryParams`, `TechnicalADXChartQueryParams`, `TechnicalArooonChartQueryParams`, `TechnicalMACDChartQueryParams`, `TechnicalRSIChartQueryParams`, `TechnicalRelativeRotationChartQueryParams`

**Functions** (5):
`_get_type_name`, `__init__`, `__repr__`, `__repr__`, `validate_model`

**Imports** (12):
`typing`, `Any`, `openbb_core.provider.abstract.data`, `Data`, `openbb_core.provider.abstract.query_params`, `QueryParams`, `pydantic`, `Field`, `openbb_charting.core.plotly_ta.data_classes`, `ChartIndicators`, `the`, `one`


## Key Components

**Class `BaseQueryParams`**: Base Query Parmams Base Model.

**Class `ChartQueryParams`**: ChartParams.

**Class `EquityPricePerformanceChartQueryParams`**: Equity Price Performance Chart Query Params.

**Class `EtfPricePerformanceChartQueryParams`**: ETF Price Performance Chart Query Params.

**Class `EtfHoldingsChartQueryParams`**: ETF Holdings Chart Query Params.

**Class `EquityPriceHistoricalChartQueryParams`**: Equity Historical Price Chart Query Params.

**Class `EconomyFredSeriesChartQueryParams`**: FRED Series Chart Query Params.

**Class `TechnicalConesChartQueryParams`**: Technical Cones Chart Query Params.

**Class `MAQueryParams`**: Moving Average Query Params.

**Class `FixedincomeGovernmentYieldCurve`**: Fixed Income Government Yield Curve Chart Query Params.

**Class `TechnicalSMAChartQueryParams`**: Technical SMA Chart Query Params.

**Class `TechnicalEMAChartQueryParams`**: Technical EMA Chart Query Params.

**Class `TechnicalHMAChartQueryParams`**: Technical HMA Chart Query Params.

**Class `TechnicalWMAChartQueryParams`**: Technical WMA Chart Query Params.

**Class `TechnicalZLMAChartQueryParams`**: Technical ZLMA Chart Query Params.

**Class `TechnicalADXChartQueryParams`**: Technical ADX Chart Query Params.

**Class `TechnicalArooonChartQueryParams`**: Technical Aroon Chart Query Params.

**Class `TechnicalMACDChartQueryParams`**: Technical MACD Chart Query Params.

**Class `TechnicalRSIChartQueryParams`**: Technical RSI Chart Query Params.

**Class `TechnicalRelativeRotationChartQueryParams`**: Technical Relative Rotation Chart Query Params.
...
## Notes
- Generated: 2025-11-18T07:54:37.185773
