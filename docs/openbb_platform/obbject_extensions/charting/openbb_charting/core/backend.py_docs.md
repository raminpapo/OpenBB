...
This is a **python** file named `backend.py`.

**Python Module**

- **Classes** (2): PyWry, Backend
- **Functions** (19): __new__, __init__, set_window_dimensions, get_pending, get_plotly_html, get_table_html, get_window_icon, get_json_update, send_figure, process_image ... and 9 more
...
- **`process_image(self, export_image: Path)`**
- **`send_table(  # pylint: disable=too-many-positional-arguments
        self,
        df_table: "DataFrame",
        title: str = "",
        source: str = "",
...
- **`start(self, debug: bool = False, headless: bool = False)`**
- **`check_backend(self)`**
- **`close(self, reset: bool = False)`**
- **`download_plotly_js()`**
- **`create_backend(charting_settings: Optional["ChartingSettings"] = None)`**
- **`get_backend()`**
...
**Generated**: 2025-11-19T02:16:47.430250Z
