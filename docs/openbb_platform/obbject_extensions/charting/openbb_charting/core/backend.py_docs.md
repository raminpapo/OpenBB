# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/backend.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/backend.py`
- **Size**: 14,627 characters, 442 lines
- **Words**: 1,330
- **Extension**: .py
...
**Functions** (19):
`__new__`, `__init__`, `set_window_dimensions`, `get_pending`, `get_plotly_html`, `get_table_html`, `get_window_icon`, `get_json_update`, `send_figure`, `process_image`, `send_table`, `send_url`, `get_kwargs`, `start`, `check_backend`, `close`, `download_plotly_js`, `create_backend`, `get_backend`

**Imports** (41):
`pathlib`, `Path`, `typing`, `TYPE_CHECKING`, `openbb_core.app.model.charts.charting_settings`, `ChartingSettings`, `pandas`, `DataFrame`, `plotly.graph_objs`, `Figure`, `pywry`, `PyWry`, `.dummy_backend`, `DummyBackend`, `atexit`, `sys`, `multiprocessing`, `current_process`, `packaging`, `version`


## Key Components

**Class `PyWry`**: No documentation

**Class `Backend`**: Custom backend for Plotly.
...
## Notes
- Generated: 2025-11-18T07:54:36.819951
