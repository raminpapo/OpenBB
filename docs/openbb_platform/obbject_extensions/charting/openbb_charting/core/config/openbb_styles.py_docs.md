# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/config/openbb_styles.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/config/openbb_styles.py`
- **Size**: 8,101 characters, 309 lines
- **Words**: 672
- **Extension**: .py
...
**Imports** (4):
`typing`, `TYPE_CHECKING`, `pandas`, `DataFrame`
...
## Notes
- Generated: 2025-11-18T07:54:36.825453
