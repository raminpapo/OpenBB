# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/data_classes.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/data_classes.py`
- **Size**: 12,719 characters, 396 lines
- **Words**: 1,063
- **Extension**: .py
...
**Classes** (6):
`from`, `Arguments`, `TAIndicator`, `ChartIndicators`, `TA_DataException`, `TA_Data`

**Functions** (20):
`columns_regex`, `__post_init__`, `__iter__`, `get_args`, `get_argument_values`, `get_indicator`, `get_indicator_args`, `get_indicators`, `get_params`, `get_active_ids`, `get_arg_names`, `get_options_dict`, `get_available_indicators`, `from_dict`, `to_dataframe`, `get_indicator_data`, `remove_indicator`, `__init__`, `get_indicator_data`, `to_dataframe`

**Imports** (19):
`sys`, `warnings`, `dataclasses`, `dataclass`, `typing`, `TYPE_CHECKING`, `pandas`, `DataFrame`, `dictionary.`, `active`, `pandas`, `DataFrame`, `openbb_charting.core.plotly_ta.ta_helpers`, `check_columns`, `pandas_ta`, `pandas`, `DataFrame`, `output`, `e`
...
**Class `Arguments`**: Arguments for technical analysis indicators.

**Class `TAIndicator`**: Technical analysis indicator.

**Class `ChartIndicators`**: Chart technical analysis indicators.

**Class `TA_DataException`**: Exception for TA_Data.

**Class `TA_Data`**: Process technical analysis data.
...
## Notes
- Generated: 2025-11-18T07:54:37.135238
