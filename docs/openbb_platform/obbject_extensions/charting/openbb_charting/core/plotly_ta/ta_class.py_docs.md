# File Documentation: ta_class.py
...
This is a **python** file named `ta_class.py`.

**Python Module**

- **Classes** (7): for, PlotlyTA, is, import, as, and, so
- **Functions** (20): __new__, __init__, setup_theme, ma_mode, ma_mode, inchart, inchart, subplots, subplots, __plot__ ... and 10 more
- **Import Statements**: 5
...
- **`ma_mode(self, value: list[str])`**
- **`inchart(self, value: list[str])`**
- **`subplots(self, value: list[str])`**
- **`_clear_data(self)`**
- **`calculate_indicators(self)`**
- **`get_fig_settings_dict(self)`**

#### Decorators Used

inchart, ma_mode, property, staticmethod, subplots
...
- `PltTA`
- `TYPE_CHECKING`
- `charting.core.plotly_ta.ta_class`
- `check_columns`
- `importlib`
- `inspect`
- `obb`
...
**Generated**: 2025-11-19T02:16:48.198523Z
