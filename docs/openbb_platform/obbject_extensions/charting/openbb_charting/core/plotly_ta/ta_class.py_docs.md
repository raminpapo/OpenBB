# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/ta_class.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/ta_class.py`
- **Size**: 24,948 characters, 672 lines
- **Words**: 2,181
- **Extension**: .py
...
**Classes** (7):
`for`, `PlotlyTA`, `is`, `import`, `as`, `and`, `so`

**Functions** (20):
`__new__`, `__init__`, `setup_theme`, `ma_mode`, `ma_mode`, `inchart`, `inchart`, `subplots`, `subplots`, `__plot__`, `plot`, `_locate_plugins`, `_clear_data`, `calculate_indicators`, `get_subplot`, `check_subplots`, `get_fig_settings_dict`, `init_plot`, `plot_fig`, `process_fig`

**Imports** (27):
`importlib`, `inspect`, `sys`, `warnings`, `pathlib`, `Path`, `typing`, `TYPE_CHECKING`, `openbb_charting.core.chart_style`, `ChartStyle`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.core.plotly_ta.base`, `PltTA`, `openbb_charting.core.plotly_ta.data_classes`, `ChartIndicators`, `openbb_charting.core.plotly_ta.ta_helpers`, `check_columns`, `pandas`, `openbb_core.app.model.charts.charting_settings`
...
**Class `PlotlyTA`**: Plotly Technical Analysis class.

    This class is a singleton. It is created and then reused, to assure
    the plugins are only loaded once. This is done by overriding the __new__
    method. The _

**Class `and`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:37.151450
