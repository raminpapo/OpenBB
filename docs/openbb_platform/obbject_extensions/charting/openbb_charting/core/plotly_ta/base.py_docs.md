# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/base.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/base.py`
- **Size**: 7,314 characters, 217 lines
- **Words**: 636
- **Extension**: .py
...
**Classes** (7):
`for`, `Indicator`, `PluginMeta`, `for`, `PltTA`, `that`, `Plugin`

**Functions** (15):
`columns_regex`, `__init__`, `__call__`, `__new__`, `__iter__`, `__init__`, `__new__`, `ma_mode`, `ma_mode`, `add_plugins`, `remove_plugins`, `__iter__`, `get_float_precision`, `indicator`, `decorator`

**Imports** (7):
`collections.abc`, `Callable`, `typing`, `.data_classes`, `ChartIndicators`, `pandas`, `current`
...
**Class `Indicator`**: Class for technical indicator.

**Class `PluginMeta`**: Metaclass for all Plotly plugins.

**Class `PltTA`**: The base class that all Plotly plugins must inherit from.

**Class `Plugin`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:37.132825
