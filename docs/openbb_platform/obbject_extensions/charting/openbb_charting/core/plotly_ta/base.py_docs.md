...
This is a **python** file named `base.py`.

**Python Module**

- **Classes** (7): for, Indicator, PluginMeta, for, PltTA, that, Plugin
- **Functions** (15): columns_regex, __init__, __call__, __new__, __iter__, __init__, __new__, ma_mode, ma_mode, add_plugins ... and 5 more
- **Import Statements**: 3
...
**Generated**: 2025-11-19T02:16:48.192870Z
