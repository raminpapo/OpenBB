# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/momentum_plugin.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/momentum_plugin.py`
- **Size**: 19,509 characters, 625 lines
- **Words**: 1,207
- **Extension**: .py
...
**Functions** (9):
`plot_cci`, `plot_cg`, `plot_clenow`, `plot_demark`, `plot_fisher`, `plot_macd`, `plot_rsi`, `plot_stoch`, `plot_ichimoku`

**Imports** (9):
`warnings`, `numpy`, `pandas`, `pandas_ta`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.core.plotly_ta.base`, `openbb_charting.core.plotly_ta.data_classes`, `openbb_technical.helpers`


## Key Components

**Class `Momentum`**: Momentum technical indicators.
...
## Notes
- Generated: 2025-11-18T07:54:37.141440
