# File Documentation: momentum_plugin.py

## Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/momentum_plugin.py`
- **Size**: 19,509 bytes
- **Lines**: 625
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `momentum_plugin.py`.

**Python Module**

- **Classes** (1): Momentum
- **Functions** (9): plot_cci, plot_cg, plot_clenow, plot_demark, plot_fisher, plot_macd, plot_rsi, plot_stoch, plot_ichimoku
- **Import Statements**: 1
...
- **`plot_cci(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
- **`plot_cg(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
- **`plot_clenow(self, fig: OpenBBFigure, df_ta: pd.DataFrame, inchart_index: int)`**
- **`plot_demark(self, fig: OpenBBFigure, df_ta: pd.DataFrame, inchart_index: int)`**
- **`plot_fisher(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
- **`plot_macd(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
- **`plot_rsi(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
- **`plot_stoch(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
- **`plot_ichimoku(self, fig: OpenBBFigure, df_ta: pd.DataFrame, inchart_index: int)`**
...
**Generated**: 2025-11-19T02:16:48.207701Z
