# File Documentation: trend_indicators_plugin.py
...
This is a **python** file named `trend_indicators_plugin.py`.

**Python Module**

- **Classes** (1): Trend
- **Functions** (2): plot_adx, plot_aroon
- **Import Statements**: 1
...
- **`plot_adx(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
- **`plot_aroon(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
...
**Generated**: 2025-11-19T02:16:48.212351Z
