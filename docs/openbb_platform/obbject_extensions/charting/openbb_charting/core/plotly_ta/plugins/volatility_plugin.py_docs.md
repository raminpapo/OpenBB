# File Documentation: volatility_plugin.py

## Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/volatility_plugin.py`
- **Size**: 6,877 bytes
- **Lines**: 224
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `volatility_plugin.py`.

**Python Module**

- **Classes** (1): Volatility
- **Functions** (4): plot_atr, plot_bbands, plot_donchian, plot_kc
- **Import Statements**: 1
...
- **`plot_atr(self, fig: OpenBBFigure, df_ta: pd.DataFrame, subplot_row: int)`**
- **`plot_bbands(self, fig: OpenBBFigure, df_ta: pd.DataFrame, inchart_index: int)`**
- **`plot_donchian(self, fig: OpenBBFigure, df_ta: pd.DataFrame, inchart_index: int)`**
- **`plot_kc(self, fig: OpenBBFigure, df_ta: pd.DataFrame, inchart_index: int)`**
...
**Generated**: 2025-11-19T02:16:48.214629Z
