# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/volatility_plugin.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/volatility_plugin.py`
- **Size**: 6,877 characters, 224 lines
- **Words**: 402
- **Extension**: .py
...
**Functions** (4):
`plot_atr`, `plot_bbands`, `plot_donchian`, `plot_kc`

**Imports** (5):
`pandas`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.core.plotly_ta.base`, `openbb_charting.core.plotly_ta.data_classes`


## Key Components

**Class `Volatility`**: Volatility technical indicators.
...
## Notes
- Generated: 2025-11-18T07:54:37.147350
