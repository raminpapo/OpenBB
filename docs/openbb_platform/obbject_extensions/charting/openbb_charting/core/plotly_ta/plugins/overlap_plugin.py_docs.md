# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/overlap_plugin.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/overlap_plugin.py`
- **Size**: 3,300 characters, 97 lines
- **Words**: 187
- **Extension**: .py
...
**Imports** (6):
`warnings`, `pandas`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.core.plotly_ta.base`, `openbb_charting.core.plotly_ta.data_classes`


## Key Components

**Class `Overlap`**: Overlap technical indicators.
...
## Notes
- Generated: 2025-11-18T07:54:37.143654
