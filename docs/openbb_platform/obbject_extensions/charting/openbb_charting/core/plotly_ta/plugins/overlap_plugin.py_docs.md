# File Documentation: overlap_plugin.py
...
This is a **python** file named `overlap_plugin.py`.

**Python Module**

- **Classes** (1): Overlap
- **Functions** (2): plot_ma, plot_vwap
- **Import Statements**: 1
...
- **`plot_ma(self, fig: OpenBBFigure, df_ta: pd.DataFrame, inchart_index: int)`**
- **`plot_vwap(self, fig: OpenBBFigure, df_ta: pd.DataFrame, inchart_index: int)`**
...
**Generated**: 2025-11-19T02:16:48.210521Z
