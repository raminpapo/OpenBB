# File Documentation: custom_indicators_plugin.py
...
This is a **python** file named `custom_indicators_plugin.py`.

**Python Module**

- **Classes** (1): Custom
- **Functions** (5): plot_srlines, is_far_from_level, is_support, is_resistance, plot_fib
- **Import Statements**: 1
...
- **`plot_srlines(self, fig: OpenBBFigure, df_ta: pd.DataFrame)`**
- **`is_far_from_level(value, levels, df_stock)`**
- **`is_support(df, i)`**
- **`is_resistance(df, i)`**
- **`plot_fib(self, fig: OpenBBFigure, df_ta: pd.DataFrame)`**
...
**Generated**: 2025-11-19T02:16:48.204946Z
