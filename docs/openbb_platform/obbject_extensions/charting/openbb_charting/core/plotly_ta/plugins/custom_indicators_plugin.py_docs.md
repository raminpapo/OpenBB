# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/custom_indicators_plugin.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/custom_indicators_plugin.py`
- **Size**: 8,604 characters, 223 lines
- **Words**: 655
- **Extension**: .py
...
**Functions** (5):
`plot_srlines`, `is_far_from_level`, `is_support`, `is_resistance`, `plot_fib`

**Imports** (12):
`warnings`, `datetime`, `datetime`, `numpy`, `pandas`, `openbb_charting.core.config.openbb_styles`, `PLT_FIB_COLORWAY`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_charting.core.plotly_ta.base`, `PltTA`, `openbb_technical.helpers`


## Key Components

**Class `Custom`**: Volatility technical indicators.
...
## Notes
- Generated: 2025-11-18T07:54:37.138866
