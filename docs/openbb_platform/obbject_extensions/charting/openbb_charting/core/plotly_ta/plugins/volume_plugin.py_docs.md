# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/volume_plugin.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/plotly_ta/plugins/volume_plugin.py`
- **Size**: 3,547 characters, 126 lines
- **Words**: 216
- **Extension**: .py
...
**Functions** (4):
`__init__`, `plot_ad`, `plot_adosc`, `plot_obv`
...
**Class `Volume`**: Volume technical indicators.
...
## Notes
- Generated: 2025-11-18T07:54:37.149201
