# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/to_chart.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/to_chart.py`
- **Size**: 2,393 characters, 69 lines
- **Words**: 277
- **Extension**: .py
...
**Imports** (11):
`typing`, `TYPE_CHECKING`, `openbb_charting.core.plotly_ta.data_classes`, `ChartIndicators`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `pandas`, `DataFrame`, `openbb_charting.core.plotly_ta.ta_class`, `PlotlyTA`, `e`
...
## Notes
- Generated: 2025-11-18T07:54:37.183376
