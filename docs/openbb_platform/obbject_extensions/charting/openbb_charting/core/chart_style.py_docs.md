# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/chart_style.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/chart_style.py`
- **Size**: 7,596 characters, 233 lines
- **Words**: 682
- **Extension**: .py
...
**Classes** (4):
`ChartStyle`, `that`, `serves`, `serves`

**Functions** (9):
`__new__`, `__init__`, `apply_style`, `load_available_styles_from_folder`, `load_available_styles`, `load_json_style`, `load_style`, `load_plt_style`, `get_colors`

**Imports** (17):
`json`, `sys`, `pathlib`, `Path`, `typing`, `warnings`, `warn`, `plotly.graph_objects`, `plotly.io`, `openbb_charting.core.config.openbb_styles`, `openbb_core.app.service.user_service`, `UserService`, `folder.`, `default`, `json`, `file.`, `file.`


## Key Components

**Class `ChartStyle`**: The class that helps with handling of style configurations.

    It serves styles for 2 libraries. For `Plotly` this class serves absolute paths
    to the .pltstyle files. For `Plotly` and `Rich` thi
...
- `plotly.io`
- `openbb_charting.core.config.openbb_styles`
- `openbb_core.app.service.user_service`

## Notes
- Generated: 2025-11-18T07:54:36.822612
