# File Documentation: chart_style.py
...
This is a **python** file named `chart_style.py`.

**Python Module**

- **Classes** (4): ChartStyle, that, serves, serves
- **Functions** (9): __new__, __init__, apply_style, load_available_styles_from_folder, load_available_styles, load_json_style, load_style, load_plt_style, get_colors
- **Import Statements**: 3
...
**Generated**: 2025-11-19T02:16:47.433115Z
