# File Documentation: openbb_figure.py
...
This is a **python** file named `openbb_figure.py`.

**Python Module**

- **Classes** (2): OpenBBFigure, for
- **Functions** (40): __init__, theme, subplots_kwargs, subplots_kwargs, has_subplots, bar_width, bar_width, cmd_xshift, cmd_xshift, create_subplots ... and 30 more
...
- **`OpenBBFigure`**(go.Figure)

#### Functions

- **`theme(self)`**
- **`subplots_kwargs(self)`**
- **`subplots_kwargs(self, value)`**
- **`has_subplots(self)`**
- **`bar_width(self)`**
- **`bar_width(self, value)`**
- **`cmd_xshift(self)`**
- **`cmd_xshift(self, value)`**
- **`add_trend(
        self,
        data: "DataFrame",
        row: int = 1,
...
- **`_validate_x(data: ndarray | Series | type[TimeSeriesT])`**
- **`_prepare_data_corr_plot(x, lags)`**

#### Decorators Used

bar_width, classmethod, cmd_xshift, property, staticmethod, subplots_kwargs
...
**Generated**: 2025-11-19T02:16:47.438739Z
