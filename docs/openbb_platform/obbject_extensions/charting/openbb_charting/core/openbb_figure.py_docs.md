# Documentation: openbb_platform/obbject_extensions/charting/openbb_charting/core/openbb_figure.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/openbb_charting/core/openbb_figure.py`
- **Size**: 57,454 characters, 1,668 lines
- **Words**: 5,099
- **Extension**: .py
...
class OpenBBFigure(go.Figure):
    ...
    **kwargs
    ...
    def set_yaxis_title(
        self, title: str, row: int | None = None, col: int | None = None, **kwargs
    ) -> "OpenBBFigure":
    ...
    @staticmethod
    def row_colors(data: "DataFrame") -> list[str] | None:
...
**Functions** (40):
`__init__`, `theme`, `subplots_kwargs`, `subplots_kwargs`, `has_subplots`, `bar_width`, `bar_width`, `cmd_xshift`, `cmd_xshift`, `create_subplots`, `add_trend`, `add_histplot`, `_validate_x`, `set_title`, `set_xaxis_title`, `set_yaxis_title`, `add_hline_legend`, `add_vline_legend`, `horizontal_legend`, `chart_volume_scaling`

**Imports** (52):
`json`, `textwrap`, `datetime`, `datetime`, `math`, `floor`, `pathlib`, `Path`, `typing`, `warnings`, `warn`, `plotly.graph_objects`, `plotly.io`, `plotly.subplots`, `make_subplots`, `openbb_charting.core.backend`, `PLOTLYJS_PATH`, `openbb_charting.core.config.openbb_styles`, `numpy`, `ndarray`


## Key Components

**Class `OpenBBFigure`**: Custom Figure class for OpenBB Terminal.
    ...
    fig : `go.Figure`, optional
        Figure to copy, by default None
    **kwargs
        Keyword arguments to pass to `go.Fi
...
## Notes
- Generated: 2025-11-18T07:54:36.829770
