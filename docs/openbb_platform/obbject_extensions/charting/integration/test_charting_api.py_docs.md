# File Documentation: test_charting_api.py

## Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/integration/test_charting_api.py`
- **Size**: 28,105 bytes
- **Lines**: 1,007
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_charting_api.py`.

**Python Module**

- **Functions** (32): headers, get_headers, get_equity_data, test_charting_equity_price_historical, test_charting_currency_price_historical, test_charting_etf_historical, test_charting_index_price_historical, test_charting_crypto_price_historical, test_charting_technical_adx, test_charting_technical_aroon ... and 22 more
- **Import Statements**: 2
...
- **`get_headers()`**
- **`get_equity_data()`**
- **`test_charting_equity_price_historical(params, headers)`**
- **`test_charting_currency_price_historical(params, headers)`**
- **`test_charting_etf_historical(params, headers)`**
- **`test_charting_index_price_historical(params, headers)`**
- **`test_charting_crypto_price_historical(params, headers)`**
- **`test_charting_technical_adx(params, headers)`**
- **`test_charting_technical_aroon(params, headers)`**
- **`test_charting_technical_ema(params, headers)`**
- **`test_charting_technical_hma(params, headers)`**
- **`test_charting_technical_macd(params, headers)`**
- **`test_charting_technical_rsi(params, headers)`**
- **`test_charting_technical_sma(params, headers)`**
- **`test_charting_technical_wma(params, headers)`**
- **`test_charting_technical_zlma(params, headers)`**
- **`test_charting_technical_cones(params, headers)`**
- **`test_charting_economy_fred_series(params, headers)`**
- **`test_charting_technical_relative_rotation(params)`**
- **`test_charting_equity_price_performance(params, headers)`**
- **`test_charting_etf_price_performance(params, headers)`**
- **`test_charting_etf_holdings(params, headers)`**
- **`test_charting_fixedincome_government_yield_curve(params, headers)`**
- **`test_charting_derivatives_futures_historical(params, headers)`**
- **`test_charting_derivatives_futures_curve(params, headers)`**
- **`test_charting_equity_historical_market_cap(params, headers)`**
- **`test_charting_economy_survey_bls_series(params, headers)`**
- **`test_charting_econometrics_correlation_matrix(params, headers)`**
- **`test_charting_economy_shipping_port_info(params, headers)`**
...
**Generated**: 2025-11-19T02:16:47.394713Z
