# Documentation: openbb_platform/obbject_extensions/charting/integration/test_charting_api.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/integration/test_charting_api.py`
- **Size**: 28,105 characters, 1,007 lines
- **Words**: 2,399
- **Extension**: .py
...
**Functions** (32):
`headers`, `get_headers`, `get_equity_data`, `test_charting_equity_price_historical`, `test_charting_currency_price_historical`, `test_charting_etf_historical`, `test_charting_index_price_historical`, `test_charting_crypto_price_historical`, `test_charting_technical_adx`, `test_charting_technical_aroon`, `test_charting_technical_ema`, `test_charting_technical_hma`, `test_charting_technical_macd`, `test_charting_technical_rsi`, `test_charting_technical_sma`, `test_charting_technical_wma`, `test_charting_technical_zlma`, `test_charting_technical_cones`, `test_charting_economy_fred_series`, `test_charting_technical_relative_rotation`

**Imports** (10):
`base64`, `json`, `pytest`, `requests`, `openbb_core.env`, `Env`, `openbb_core.provider.utils.helpers`, `get_querystring`, `pandas`, `DataFrame`
...
## Notes
- Generated: 2025-11-18T07:54:36.420100
