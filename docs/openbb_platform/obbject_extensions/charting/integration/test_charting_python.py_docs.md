# Documentation: openbb_platform/obbject_extensions/charting/integration/test_charting_python.py

## File Metadata
- **Path**: `openbb_platform/obbject_extensions/charting/integration/test_charting_python.py`
- **Size**: 20,609 characters, 820 lines
- **Words**: 1,556
- **Extension**: .py
...
**Functions** (31):
`obb`, `get_equity_data`, `test_charting_equity_price_historical`, `test_charting_currency_price_historical`, `test_charting_crypto_price_historical`, `test_charting_index_price_historical`, `test_charting_etf_historical`, `test_charting_technical_adx`, `test_charting_technical_aroon`, `test_charting_technical_ema`, `test_charting_technical_hma`, `test_charting_technical_macd`, `test_charting_technical_rsi`, `test_charting_technical_sma`, `test_charting_technical_wma`, `test_charting_technical_zlma`, `test_charting_technical_cones`, `test_charting_economy_fred_series`, `test_charting_technical_relative_rotation`, `test_charting_equity_price_performance`

**Imports** (7):
`pytest`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_core.app.model.obbject`, `OBBject`, `openbb`, `openbb`
...
## Notes
- Generated: 2025-11-18T07:54:36.422576
