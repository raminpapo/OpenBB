# File Documentation: .secrets.baseline

## Metadata
- **Path**: `cookiecutter/openbb_cookiecutter/template/{{cookiecutter.project_tag}}/.secrets.baseline`
- **Size**: 3,237 bytes
- **Lines**: 149
- **Category**: text
- **Extension**: .baseline
...
This is a **text** file named `.secrets.baseline`.

This file contains 149 lines of code/text.
...
**Generated**: 2025-11-19T02:16:44.946177Z
