# Documentation: cookiecutter/openbb_cookiecutter/template/{{cookiecutter.project_tag}}/{{cookiecutter.package_name}}/routers/{{cookiecutter.router_name}}.py

## File Metadata
- **Path**: `cookiecutter/openbb_cookiecutter/template/{{cookiecutter.project_tag}}/{{cookiecutter.package_name}}/routers/{{cookiecutter.router_name}}.py`
- **Size**: 2,583 characters, 79 lines
- **Words**: 248
- **Extension**: .py
...
**Functions** (4):
`get_example`, `post_example`, `model_example`, `candles`

**Imports** (16):
`openbb_core.app.model.command_context`, `CommandContext`, `openbb_core.app.model.example`, `APIEx`, `openbb_core.app.model.obbject`, `OBBject`, `openbb_core.app.provider_interface`, `ExtraParams`, `openbb_core.app.query`, `Query`, `openbb_core.app.router`, `Router`, `pydantic`, `BaseModel`, `Session`, `Fetcher`
...
## Notes
- Generated: 2025-11-18T07:54:34.767858
