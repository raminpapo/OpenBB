# Documentation: cookiecutter/openbb_cookiecutter/template/{{cookiecutter.project_tag}}/{{cookiecutter.package_name}}/routers/{{cookiecutter.router_name}}_views.py

## File Metadata
- **Path**: `cookiecutter/openbb_cookiecutter/template/{{cookiecutter.project_tag}}/{{cookiecutter.package_name}}/routers/{{cookiecutter.router_name}}_views.py`
- **Size**: 1,826 characters, 42 lines
- **Words**: 234
- **Extension**: .py
...
**Imports** (7):
`typing`, `TYPE_CHECKING`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `the`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`


## Key Components

**Class `using`**: {{ cookiecutter.router_name }} Views.
...
## Notes
- Generated: 2025-11-18T07:54:34.769337
