...
- **Classes** (1): OBBjectExtension
- **Functions** (5): to_string, __init__, hello_world, _expensive_operation_worker, empty_plugin_function
- **Import Statements**: 1
...
- **`__init__(self, obbject: OBBject)`**
- **`hello_world(self, **kwargs)`**
- **`_expensive_operation_worker(serialized_obbject: dict)`**
- **`empty_plugin_function(obbject)`**

#### Decorators Used

class_ext, ext, nonblocking_plugin
...
**Generated**: 2025-11-19T02:16:44.956088Z
