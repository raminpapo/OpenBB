# Documentation: cookiecutter/openbb_cookiecutter/cli.py

## File Metadata
- **Path**: `cookiecutter/openbb_cookiecutter/cli.py`
- **Size**: 2,058 characters, 77 lines
- **Words**: 190
- **Extension**: .py
...
**Imports** (8):
`argparse`, `sys`, `cookiecutter.main`, `cookiecutter`, `.`, `get_template_path`, `template`, `arguments`
...
## Notes
- Generated: 2025-11-18T07:54:34.738764
