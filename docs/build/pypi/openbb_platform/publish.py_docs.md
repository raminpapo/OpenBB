# Documentation: build/pypi/openbb_platform/publish.py

## File Metadata
- **Path**: `build/pypi/openbb_platform/publish.py`
- **Size**: 7,762 characters, 240 lines
- **Words**: 617
- **Extension**: .py
...
**Imports** (14):
`argparse`, `logging`, `sys`, `functools`, `partial`, `pathlib`, `Path`, `subprocess`, `PIPE`, `typing`, `Literal`, `openbb`, `openbb`, `obb`
...
## Notes
- Generated: 2025-11-18T07:54:34.604882
