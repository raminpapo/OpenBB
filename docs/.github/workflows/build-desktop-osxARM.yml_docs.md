# Documentation: .github/workflows/build-desktop-osxARM.yml

## File Metadata
- **Path**: `.github/workflows/build-desktop-osxARM.yml`
- **Size**: 4,010 characters, 122 lines
- **Words**: 299
- **Extension**: .yml
    ...
    steps:
      ...
      - name: Setup Cargo Cache
        ...
        with:
          path: |
            ~/.cargo/registry
            ~/.cargo/git
          key: macos-arm-cargo-registry-${{ hashFiles('desktop/**/Cargo.lock') }}
          restore-keys: |
      ...
      - name: Rename artifacts
        run: |
          ...
          for file in *.dmg; do mv "$file" "Open-Data-Platform_${VERSION}_aarch64.dmg"; done
          cd ../macos
          for file in *.app.tar.gz; do mv "$file" "Open-Data-Platform_${VERSION}_aarch64.app.tar.gz"; done
...
This is a .yml file containing 122 lines of code.
...
## Notes
- Generated: 2025-11-18T07:54:34.567134
