# Documentation: .github/scripts/summarize_changelog.py

## File Metadata
- **Path**: `.github/scripts/summarize_changelog.py`
- **Size**: 6,030 characters, 151 lines
- **Words**: 614
- **Extension**: .py
...
**Functions** (5):
`fetch_pr_details`, `parse_and_fetch_pr_details`, `insert_summary_into_markdown`, `summarize_text_with_openai`, `summarize_changelog_v2`

**Imports** (7):
`logging`, `re`, `sys`, `requests`, `GitHub.`, `openai`, `OpenAI`
...
## Notes
- Generated: 2025-11-18T07:54:34.562716
