# File Documentation: noxfile.py

## Metadata
- **Path**: `.github/scripts/noxfile.py`
- **Size**: 1,186 bytes
- **Lines**: 50
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `noxfile.py`.

**Python Module**

- **Functions** (2): unit_test_platform, unit_test_cli
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:15:18.733603Z
