# File Documentation: ResizeHandler.tsx

## Metadata
- **Path**: `frontend-components/plotly/src/components/ResizeHandler.tsx`
- **Size**: 2,655 bytes
- **Lines**: 98
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `ResizeHandler.tsx`.

This file contains 98 lines of code/text.
...
**Generated**: 2025-11-19T02:16:46.015644Z
