# File Documentation: TextChartDialog.tsx

## Metadata
- **Path**: `frontend-components/plotly/src/components/Dialogs/TextChartDialog.tsx`
- **Size**: 9,522 bytes
- **Lines**: 316
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `TextChartDialog.tsx`.

This file contains 316 lines of code/text.
...
**Generated**: 2025-11-19T02:16:46.022081Z
