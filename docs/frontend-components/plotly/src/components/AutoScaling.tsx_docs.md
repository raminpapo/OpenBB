# File Documentation: AutoScaling.tsx

## Metadata
- **Path**: `frontend-components/plotly/src/components/AutoScaling.tsx`
- **Size**: 7,773 bytes
- **Lines**: 233
- **Category**: javascript
- **Extension**: .tsx
...
This is a **javascript** file named `AutoScaling.tsx`.

This file contains 233 lines of code/text.
...
**Generated**: 2025-11-19T02:16:46.006295Z
