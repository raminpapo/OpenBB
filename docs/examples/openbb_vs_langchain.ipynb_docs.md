# File Documentation: openbb_vs_langchain.ipynb

## Metadata
- **Path**: `examples/openbb_vs_langchain.ipynb`
- **Size**: 14,539 bytes
- **Lines**: 384
- **Category**: text
- **Extension**: .ipynb
...
This is a **text** file named `openbb_vs_langchain.ipynb`.

This file contains 384 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.889613Z
