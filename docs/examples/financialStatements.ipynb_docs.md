# File Documentation: financialStatements.ipynb

## Metadata
- **Path**: `examples/financialStatements.ipynb`
- **Size**: 41,134 bytes
- **Lines**: 1,245
- **Category**: text
- **Extension**: .ipynb
...
This is a **text** file named `financialStatements.ipynb`.

This file contains 1245 lines of code/text.
...
**Generated**: 2025-11-19T02:16:45.548908Z
