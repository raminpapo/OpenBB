# Documentation: examples/streamlit/news.py

## File Metadata
- **Path**: `examples/streamlit/news.py`
- **Size**: 18,881 characters, 445 lines
- **Words**: 1,151
- **Extension**: .py
...
**Functions** (3):
`fetch_openbb`, `update_data`, `main`

**Imports** (7):
`datetime`, `datetime`, `openbb`, `obb`, `numpy`, `nan`, `streamlit`
...
## Notes
- Generated: 2025-11-18T07:54:35.233950
