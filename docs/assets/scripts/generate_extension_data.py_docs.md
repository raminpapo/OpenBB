# Documentation: assets/scripts/generate_extension_data.py

## File Metadata
- **Path**: `assets/scripts/generate_extension_data.py`
- **Size**: 4,320 characters, 123 lines
- **Words**: 384
- **Extension**: .py
...
**Functions** (8):
`to_title`, `get_packages`, `write`, `to_camel`, `create_item`, `generate_provider_extensions`, `generate_router_extensions`, `generate_obbject_extensions`

**Imports** (12):
`modules.`, `importlib`, `import_module`, `json`, `dump`, `pathlib`, `Path`, `typing`, `Any`, `poetry.core.pyproject.toml`, `PyProjectTOML`, `object`
...
## Notes
- Generated: 2025-11-18T07:54:34.599481
