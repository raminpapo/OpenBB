# File Documentation: generate_extension_data.py
...
This is a **python** file named `generate_extension_data.py`.

**Python Module**

- **Functions** (8): to_title, get_packages, write, to_camel, create_item, generate_provider_extensions, generate_router_extensions, generate_obbject_extensions
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:15:18.765349Z
