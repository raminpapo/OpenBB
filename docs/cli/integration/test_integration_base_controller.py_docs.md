# Documentation: cli/integration/test_integration_base_controller.py

## File Metadata
- **Path**: `cli/integration/test_integration_base_controller.py`
- **Size**: 2,699 characters, 90 lines
- **Words**: 215
- **Extension**: .py
...
**Functions** (8):
`print_help`, `base_controller`, `test_check_path_valid`, `test_check_path_invalid`, `test_parse_input`, `test_switch_command_execution`, `test_command_routing`, `test_custom_reset`

**Imports** (7):
`unittest.mock`, `Mock`, `pytest`, `openbb_cli.controllers.base_controller`, `BaseController`, `openbb_cli.session`, `Session`


## Key Components

**Class `DummyController`**: Test controller for the BaseController.
...
## Notes
- Generated: 2025-11-18T07:54:34.608109
