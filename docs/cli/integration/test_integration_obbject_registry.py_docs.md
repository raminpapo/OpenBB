# Documentation: cli/integration/test_integration_obbject_registry.py

## File Metadata
- **Path**: `cli/integration/test_integration_obbject_registry.py`
- **Size**: 1,692 characters, 55 lines
- **Words**: 178
- **Extension**: .py
...
**Imports** (4):
`openbb_cli.argparse_translator.obbject_registry`, `Registry`, `openbb_core.app.model.obbject`, `OBBject`
...
## Notes
- Generated: 2025-11-18T07:54:34.611165
