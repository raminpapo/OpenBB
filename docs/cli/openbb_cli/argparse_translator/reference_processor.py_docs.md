# File Documentation: reference_processor.py
...
This is a **python** file named `reference_processor.py`.

**Python Module**

- **Classes** (1): ReferenceToArgumentsProcessor
- **Functions** (6): __init__, custom_groups, _parse_type, _get_nargs, _get_choices, _build_custom_groups
- **Import Statements**: 1
...
- **`__init__(self, reference: dict[str, dict])`**
- **`_build_custom_groups(self)`**
...
**Generated**: 2025-11-19T02:15:18.826258Z
