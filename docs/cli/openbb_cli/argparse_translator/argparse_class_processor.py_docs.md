# Documentation: cli/openbb_cli/argparse_translator/argparse_class_processor.py

## File Metadata
- **Path**: `cli/openbb_cli/argparse_translator/argparse_class_processor.py`
- **Size**: 4,828 characters, 148 lines
- **Words**: 391
- **Extension**: .py
...
**Classes** (4):
`ArgparseClassProcessor`, `to`, `whose`, `self`

**Functions** (8):
`__init__`, `translators`, `paths`, `_custom_groups_from_reference`, `_process_class`, `_get_class_name`, `get_translator`, `_build_paths`

**Imports** (8):
`inspect`, `typing`, `Any`, `openbb_core.app.static.container`, `Container`, `openbb_cli.argparse_translator.argparse_translator`, `ArgparseTranslator`, `openbb_cli.argparse_translator.reference_processor`


## Key Components

**Class `ArgparseClassProcessor`**: Process a target class to create ArgparseTranslators for its methods.

**Class `whose`**: No documentation

**Class `self`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:34.615011
