# Documentation: cli/openbb_cli/argparse_translator/obbject_registry.py

## File Metadata
- **Path**: `cli/openbb_cli/argparse_translator/obbject_registry.py`
- **Size**: 4,658 characters, 129 lines
- **Words**: 433
- **Extension**: .py
...
**Functions** (12):
`__init__`, `_contains_obbject`, `register`, `get`, `_get_by_key`, `_get_by_index`, `remove`, `all`, `_handle_standard_params`, `_handle_data_repr`, `obbjects`, `obbject_keys`

**Imports** (3):
`json`, `openbb_core.app.model.obbject`, `OBBject`


## Key Components

**Class `Registry`**: Registry for OBBjects.
...
## Notes
- Generated: 2025-11-18T07:54:34.618744
