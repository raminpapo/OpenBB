# File Documentation: obbject_registry.py
...
This is a **python** file named `obbject_registry.py`.

**Python Module**

- **Classes** (1): Registry
- **Functions** (12): __init__, _contains_obbject, register, get, _get_by_key, _get_by_index, remove, all, _handle_standard_params, _handle_data_repr ... and 2 more
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:15:18.824100Z
