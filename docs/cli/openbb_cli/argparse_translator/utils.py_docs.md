...
- **Functions** (5): in_group, remove_argument, get_argument_choices, get_argument_optional_choices, set_optional_choices
- **Import Statements**: 1
...
- **`set_optional_choices(action: Action, optional_choices: bool)`**
...
**Generated**: 2025-11-19T02:15:18.827838Z
