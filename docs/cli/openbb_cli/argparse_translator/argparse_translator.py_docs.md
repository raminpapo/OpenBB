# Documentation: cli/openbb_cli/argparse_translator/argparse_translator.py

## File Metadata
- **Path**: `cli/openbb_cli/argparse_translator/argparse_translator.py`
- **Size**: 21,891 characters, 557 lines
- **Words**: 1,861
- **Extension**: .py
...
**Functions** (22):
`__init__`, `_handle_argument_in_groups`, `_update_providers`, `parser`, `_build_description`, `clean_type_annotation`, `_param_is_default`, `_get_action_type`, `_get_type_and_choices`, `get_base_type`, `get_choices`, `_split_annotation`, `_get_argument_custom_help`, `_get_argument_custom_choices`, `_get_nargs`, `_generate_argparse_arguments`, `_unflatten_args`, `_update_with_custom_types`, `execute_func`, `parse_args_and_execute`

**Imports** (20):
`argparse`, `inspect`, `re`, `collections.abc`, `Callable`, `copy`, `deepcopy`, `typing`, `openbb_core.app.model.field`, `OpenBBField`, `pydantic`, `BaseModel`, `openbb_cli.argparse_translator.argparse_argument`, `openbb_cli.argparse_translator.utils`, `help`, `the`, `all`, `the`, `the`, `the`


## Key Components

**Class `ArgparseTranslator`**: Class to translate a function into an argparse program.
...
- `copy`
- `typing`
- `openbb_core.app.model.field`
- `pydantic`
- `openbb_cli.argparse_translator.argparse_argument`
- `openbb_cli.argparse_translator.utils`

## Notes
- Generated: 2025-11-18T07:54:34.616767
