# File Documentation: menu_text.py

## Metadata
- **Path**: `cli/openbb_cli/config/menu_text.py`
- **Size**: 5,429 bytes
- **Lines**: 165
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `menu_text.py`.

**Python Module**

- **Classes** (1): MenuText
- **Functions** (9): __init__, _get_providers, _format_cmd_name, _format_cmd_description, add_raw, add_info, add_cmd, add_menu, add_setting
- **Import Statements**: 1
...
- **`add_raw(self, text: str, left_spacing: bool = False)`**
- **`add_info(self, text: str)`**
- **`add_cmd(self, name: str, description: str = "", disable: bool = False)`**
- **`add_menu(
        self,
        name: str,
        description: str = "",
...
- **`add_setting(self, name: str, status: bool = True, description: str = "")`**
...
**Generated**: 2025-11-19T02:15:18.851053Z
