# Documentation: cli/openbb_cli/config/menu_text.py

## File Metadata
- **Path**: `cli/openbb_cli/config/menu_text.py`
- **Size**: 5,429 characters, 165 lines
- **Words**: 497
- **Extension**: .py
...
**Functions** (9):
`__init__`, `_get_providers`, `_format_cmd_name`, `_format_cmd_description`, `add_raw`, `add_info`, `add_cmd`, `add_menu`, `add_setting`
...
**Class `MenuText`**: Create menu text with rich colors to be displayed by CLI.
...
## Notes
- Generated: 2025-11-18T07:54:34.639224
