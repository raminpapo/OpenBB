# Documentation: cli/openbb_cli/config/console.py

## File Metadata
- **Path**: `cli/openbb_cli/config/console.py`
- **Size**: 3,037 characters, 94 lines
- **Words**: 278
- **Extension**: .py
...
**Functions** (5):
`__init__`, `_filter_rich_tags`, `_blend_text`, `print`, `input`

**Imports** (17):
`typing`, `TYPE_CHECKING`, `rich`, `panel`, `rich.console`, `Console`, `rich.text`, `Text`, `rich.theme`, `Theme`, `openbb_cli.config.menu_text`, `RICH_TAGS`, `openbb_cli.models.settings`, `Settings`, `text.`, `one`, `the`


## Key Components

**Class `Console`**: Create a rich console to wrap the console print with a Panel.
...
## Notes
- Generated: 2025-11-18T07:54:34.637106
