# Documentation: cli/openbb_cli/config/style.py

## File Metadata
- **Path**: `cli/openbb_cli/config/style.py`
- **Size**: 3,480 characters, 107 lines
- **Words**: 351
- **Extension**: .py
...
**Classes** (4):
`Style`, `that`, `serves`, `serves`

**Functions** (6):
`__init__`, `apply`, `_from_directory`, `_load`, `_from_json`, `available_styles`

**Imports** (12):
`json`, `pathlib`, `Path`, `typing`, `Any`, `rich.console`, `Console`, `openbb_cli.config.constants`, `STYLES_DIRECTORY`, `folder.`, `default`, `json`


## Key Components

**Class `Style`**: The class that helps with handling of style configurations.
...
## Notes
- Generated: 2025-11-18T07:54:34.641817
