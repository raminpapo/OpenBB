# File Documentation: completer.py
...
This is a **python** file named `completer.py`.

**Python Module**

- **Classes** (3): WordCompleter, NestedCompleter, CustomFileHistory
- **Functions** (9): __init__, get_completions, word_matches, __init__, __repr__, from_nested_dict, get_completions, sanitize_input, store_string
- **Import Statements**: 2
...
- **`NestedCompleter`**(Completer)
- **`CustomFileHistory`**(FileHistory)
...
**Generated**: 2025-11-19T02:15:18.845527Z
