# Documentation: cli/openbb_cli/models/settings.py

## File Metadata
- **Path**: `cli/openbb_cli/models/settings.py`
- **Size**: 5,380 characters, 168 lines
- **Words**: 449
- **Extension**: .py
...
**Functions** (3):
`__repr__`, `from_env`, `set_item`

**Imports** (15):
`enum`, `Enum`, `typing`, `Any`, `dotenv`, `dotenv_values`, `openbb_cli.config.constants`, `AVAILABLE_FLAIRS`, `openbb_core.app.version`, `get_package_version`, `pydantic`, `BaseModel`, `pytz`, `all_timezones`, `.env.`


## Key Components

**Class `SettingGroups`**: Setting types.
...
## Notes
- Generated: 2025-11-18T07:54:34.663199
