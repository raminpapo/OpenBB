# Documentation: cli/openbb_cli/utils/utils.py

## File Metadata
- **Path**: `cli/openbb_cli/utils/utils.py`
- **Size**: 1,047 characters, 35 lines
- **Words**: 80
- **Extension**: .py
...
**Functions** (2):
`change_logging_sub_app`, `reset_logging_sub_app`
...
## Notes
- Generated: 2025-11-18T07:54:34.665578
