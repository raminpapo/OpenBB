# Documentation: cli/openbb_cli/controllers/utils.py

## File Metadata
- **Path**: `cli/openbb_cli/controllers/utils.py`
- **Size**: 32,291 characters, 988 lines
- **Words**: 3,199
- **Extension**: .py
...
**Functions** (32):
`remove_file`, `print_goodbye`, `bootup`, `welcome_message`, `reset`, `suppress_stdout`, `first_time_user`, `parse_and_split_input`, `return_colored_value`, `print_rich_table`, `_get_headers`, `check_non_negative`, `check_positive`, `validate_register_key`, `get_user_agent`, `get_flair`, `get_dtime`, `get_flair_and_username`, `is_timezone_valid`, `get_user_timezone`

**Imports** (44):
`argparse`, `os`, `random`, `re`, `shutil`, `sys`, `contextlib`, `contextmanager`, `datetime`, `pathlib`, `Path`, `typing`, `TYPE_CHECKING`, `numpy`, `pandas`, `requests`, `openbb_cli.config.constants`, `AVAILABLE_FLAIRS`, `openbb_cli.session`, `Session`
...
## Notes
- Generated: 2025-11-18T07:54:34.660370
