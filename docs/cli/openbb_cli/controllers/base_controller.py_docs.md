# File Documentation: base_controller.py
...
This is a **python** file named `base_controller.py`.

**Python Module**

- **Classes** (4): BaseController, for, for, to
- **Functions** (22): choices_default, __init__, update_completer, check_path, load_class, save_class, custom_reset, print_help, parse_input, switch ... and 12 more
- **Import Statements**: 2
...
- **`BaseController`**(metaclass=ABCMeta)

#### Functions

- **`choices_default(self)`**
- **`load_class(self, class_ins, *args, **kwargs)`**
- **`call_results(self, other_args: list[str])`**
- **`parse_known_args_and_warn(  # pylint: disable=R0917
        cls,
        parser: argparse.ArgumentParser,
        other_args: list[str],
        export_allowed: Literal[
...
- **`menu(self, custom_path_menu_above: str = "")`**

#### Decorators Used

abstractmethod, classmethod, property, staticmethod
...
**Generated**: 2025-11-19T02:15:18.856358Z
