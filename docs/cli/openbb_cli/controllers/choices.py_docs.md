# Documentation: cli/openbb_cli/controllers/choices.py

## File Metadata
- **Path**: `cli/openbb_cli/controllers/choices.py`
- **Size**: 10,275 characters, 346 lines
- **Words**: 857
- **Extension**: .py
...
**Functions** (8):
`__mock_parse_known_args_and_warn`, `__mock_parse_simple_args`, `__get_command_func`, `contains_functions_to_patch`, `__patch_controller_functions`, `_get_argument_parser`, `_build_command_choice_map`, `build_controller_choice_map`

**Imports** (23):
`argparse`, `SUPPRESS`, `collections.abc`, `Callable`, `contextlib`, `contextmanager`, `inspect`, `isfunction`, `types`, `MethodType`, `typing`, `Literal`, `unittest.mock`, `patch`, `openbb_cli.controllers.utils`, `openbb_cli.session`, `Session`, `controller`, `controller.CHOICES_COMMANDS`, `a`
...
## Notes
- Generated: 2025-11-18T07:54:34.649536
