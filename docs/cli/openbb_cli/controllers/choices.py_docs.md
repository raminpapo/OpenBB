...
This is a **python** file named `choices.py`.

**Python Module**

- **Functions** (8): __mock_parse_known_args_and_warn, __mock_parse_simple_args, __get_command_func, contains_functions_to_patch, __patch_controller_functions, _get_argument_parser, _build_command_choice_map, build_controller_choice_map
- **Import Statements**: 2
...
- **`__get_command_func(controller, command: str)`**
- **`__patch_controller_functions(controller)`**
...
**Generated**: 2025-11-19T02:15:18.863509Z
