# File Documentation: platform_controller_factory.py
...
This is a **python** file named `platform_controller_factory.py`.

**Python Module**

- **Classes** (2): PlatformControllerFactory, DynamicClass
- **Functions** (2): __init__, create
- **Import Statements**: 1
...
- **`__init__(self, platform_router: type, **kwargs)`**
...
**Generated**: 2025-11-19T02:15:18.870950Z
