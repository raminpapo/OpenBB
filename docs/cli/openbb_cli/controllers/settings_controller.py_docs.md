# Documentation: cli/openbb_cli/controllers/settings_controller.py

## File Metadata
- **Path**: `cli/openbb_cli/controllers/settings_controller.py`
- **Size**: 5,467 characters, 143 lines
- **Words**: 358
- **Extension**: .py
...
**Functions** (5):
`__init__`, `print_help`, `_generate_command`, `_toggle`, `_set`

**Imports** (15):
`argparse`, `functools`, `partial`, `types`, `MethodType`, `typing`, `Literal`, `openbb_cli.config.menu_text`, `MenuText`, `openbb_cli.controllers.base_controller`, `BaseController`, `openbb_cli.models.settings`, `SettingGroups`, `openbb_cli.session`, `Session`


## Key Components

**Class `SettingsController`**: Settings Controller class.
...
## Notes
- Generated: 2025-11-18T07:54:34.658297
