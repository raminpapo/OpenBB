# Documentation: cli/openbb_cli/controllers/base_platform_controller.py

## File Metadata
- **Path**: `cli/openbb_cli/controllers/base_platform_controller.py`
- **Size**: 15,924 characters, 387 lines
- **Words**: 992
- **Extension**: .py
...
**Classes** (5):
`DummyTranslation`, `PlatformController`, `class_name`, `bound_method`, `bound_method`

**Functions** (14):
`__init__`, `__init__`, `_link_obbject_to_data_processing_commands`, `_intersect_data_processing_commands`, `_generate_sub_controllers`, `_generate_commands`, `_generate_command_call`, `method`, `_generate_controller_call`, `method`, `_get_command_description`, `_get_menu_description`, `_get_sub_menu_commands`, `print_help`

**Imports** (21):
`os`, `functools`, `partial`, `types`, `MethodType`, `pandas`, `openbb`, `obb`, `openbb_charting.core.openbb_figure`, `OpenBBFigure`, `openbb_cli.argparse_translator.argparse_class_processor`, `openbb_cli.config.menu_text`, `MenuText`, `openbb_cli.controllers.base_controller`, `BaseController`, `openbb_cli.controllers.utils`, `export_data`, `openbb_cli.session`, `Session`, `openbb_core.app.model.obbject`


## Key Components

**Class `DummyTranslation`**: Dummy Translation for testing.

**Class `PlatformController`**: Platform Controller Base class.

**Class `class_name`**: No documentation

**Class `bound_method`**: No documentation
...
## Notes
- Generated: 2025-11-18T07:54:34.647428
