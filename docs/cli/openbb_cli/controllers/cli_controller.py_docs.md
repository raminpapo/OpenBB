# Documentation: cli/openbb_cli/controllers/cli_controller.py

## File Metadata
- **Path**: `cli/openbb_cli/controllers/cli_controller.py`
- **Size**: 33,037 characters, 917 lines
- **Words**: 2,621
- **Extension**: .py
...
**Classes** (2):
`CLIController`, `bound_method`

**Functions** (17):
`__init__`, `_generate_platform_commands`, `method_call_class`, `method_call_command`, `update_runtime_choices`, `print_help`, `call_settings`, `call_exe`, `handle_job_cmds`, `run_cli`, `insert_start_slash`, `run_scripts`, `replace_dynamic`, `run_routine`, `main`, `parse_args_and_run`, `launch`

**Imports** (51):
`argparse`, `contextlib`, `difflib`, `os`, `re`, `sys`, `time`, `webbrowser`, `datetime`, `datetime`, `functools`, `partial`, `pathlib`, `Path`, `types`, `MethodType`, `typing`, `Any`, `pandas`, `requests`


## Key Components

**Class `CLIController`**: CLI Controller class.
...
## Notes
- Generated: 2025-11-18T07:54:34.652159
