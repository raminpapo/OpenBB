# File Documentation: cli_controller.py

## Metadata
- **Path**: `cli/openbb_cli/controllers/cli_controller.py`
- **Size**: 33,037 bytes
- **Lines**: 917
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `cli_controller.py`.

**Python Module**

- **Classes** (2): CLIController, bound_method
- **Functions** (17): __init__, _generate_platform_commands, method_call_class, method_call_command, update_runtime_choices, print_help, call_settings, call_exe, handle_job_cmds, run_cli ... and 7 more
- **Import Statements**: 4
...
- **`__init__(self, jobs_cmds: list[str] | None = None)`**
- **`_generate_platform_commands(self)`**
- **`method_call_class(self, _, controller, name, parent_path, target)`**
- **`method_call_command(self, _, router: str)`**
- **`update_runtime_choices(self)`**
- **`print_help(self)`**
- **`call_settings(self, _)`**
- **`call_exe(self, other_args: list[str])`**
- **`run_cli(jobs_cmds: list[str] | None = None, test_mode=False)`**
- **`run_scripts(  # pylint: disable=R0917
    path: Path,
    test_mode: bool = False,
    verbose: bool = False,
    routines_args: list[str] | None = None,
...
- **`run_routine(file: str, routines_args: str | None = None)`**
- **`main(
    debug: bool,
    dev: bool,
    path_list: list[str],
...
**Generated**: 2025-11-19T02:15:18.866816Z
