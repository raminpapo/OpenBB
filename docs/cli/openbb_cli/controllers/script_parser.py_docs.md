# Documentation: cli/openbb_cli/controllers/script_parser.py

## File Metadata
- **Path**: `cli/openbb_cli/controllers/script_parser.py`
- **Size**: 20,217 characters, 482 lines
- **Words**: 1,772
- **Extension**: .py
...
**Functions** (3):
`is_reset`, `match_and_return_openbb_keyword_date`, `parse_openbb_script`

**Imports** (15):
`re`, `datetime`, `datetime`, `re`, `Match`, `dateutil.relativedelta`, `relativedelta`, `openbb_cli.session`, `Session`, `.openbb`, `.openbb`, `external`, `internal`, `0`, `the`
...
## Notes
- Generated: 2025-11-18T07:54:34.656493
