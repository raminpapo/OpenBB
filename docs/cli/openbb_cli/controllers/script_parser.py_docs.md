# File Documentation: script_parser.py
...
This is a **python** file named `script_parser.py`.

**Python Module**

- **Functions** (3): is_reset, match_and_return_openbb_keyword_date, parse_openbb_script
- **Import Statements**: 1
...
**Generated**: 2025-11-19T02:15:18.872844Z
