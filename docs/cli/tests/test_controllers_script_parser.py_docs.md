# File Documentation: test_controllers_script_parser.py
...
This is a **python** file named `test_controllers_script_parser.py`.

**Python Module**

- **Functions** (8): test_is_reset, test_match_and_return_openbb_keyword_date, test_parse_openbb_script_basic, test_parse_openbb_script_with_variable, test_parse_openbb_script_with_foreach_loop, test_parse_openbb_script_with_error, test_parse_openbb_script_foreach_errors, test_date_keyword_last_friday
- **Import Statements**: 2
...
- **`test_is_reset(command, expected)`**
...
- **`test_parse_openbb_script_foreach_errors(line, expected)`**
...
**Generated**: 2025-11-19T02:16:44.928402Z
