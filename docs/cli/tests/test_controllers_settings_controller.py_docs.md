# File Documentation: test_controllers_settings_controller.py

## Metadata
- **Path**: `cli/tests/test_controllers_settings_controller.py`
- **Size**: 3,793 bytes
- **Lines**: 129
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_controllers_settings_controller.py`.

**Python Module**

- **Functions** (12): mock_session, test_call_interactive, test_call_n_rows, test_call_n_rows_no_args_provided, test_call_timezone, test_call_console_style, test_call_console_style_no_args, test_call_flair, test_call_flair_no_args, test_call_obbject_display ... and 2 more
- **Import Statements**: 1
...
- **`mock_session()`**
- **`test_call_interactive(mock_session)`**
- **`test_call_n_rows(input_rows, expected, mock_session)`**
- **`test_call_n_rows_no_args_provided(mock_session)`**
- **`test_call_timezone(timezone, valid, mock_session)`**
- **`test_call_console_style(mock_session)`**
- **`test_call_console_style_no_args(mock_session)`**
- **`test_call_flair(mock_session)`**
- **`test_call_flair_no_args(mock_session)`**
- **`test_call_obbject_display(mock_session)`**
- **`test_call_obbject_display_no_args(mock_session)`**
- **`test_call_n_rows_v2(args, expected, mock_session)`**
...
- `MagicMock`
- `SettingsController`
- `openbb_cli.controllers.settings_controller`
- `pytest`
- `unittest.mock`
...
**Generated**: 2025-11-19T02:16:44.929790Z
