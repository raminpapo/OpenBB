# Documentation: cli/tests/test_controllers_settings_controller.py

## File Metadata
- **Path**: `cli/tests/test_controllers_settings_controller.py`
- **Size**: 3,793 characters, 129 lines
- **Words**: 221
- **Extension**: .py
...
**Functions** (12):
`mock_session`, `test_call_interactive`, `test_call_n_rows`, `test_call_n_rows_no_args_provided`, `test_call_timezone`, `test_call_console_style`, `test_call_console_style_no_args`, `test_call_flair`, `test_call_flair_no_args`, `test_call_obbject_display`, `test_call_obbject_display_no_args`, `test_call_n_rows_v2`

**Imports** (5):
`unittest.mock`, `MagicMock`, `pytest`, `openbb_cli.controllers.settings_controller`, `SettingsController`
...
## Notes
- Generated: 2025-11-18T07:54:34.726291
