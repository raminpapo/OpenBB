# Documentation: cli/tests/test_config_style.py

## File Metadata
- **Path**: `cli/tests/test_config_style.py`
- **Size**: 2,051 characters, 61 lines
- **Words**: 165
- **Extension**: .py
...
**Functions** (7):
`mock_style_directory`, `style`, `test_initialization`, `test_load_styles`, `test_from_json`, `test_apply_invalid_style`, `test_available_styles`

**Imports** (9):
`pathlib`, `Path`, `unittest.mock`, `MagicMock`, `pytest`, `openbb_cli.config.style`, `Style`, `directories.`, `a`


## Key Components

**Class `initializes`**: Test loading styles from directories.
...
## Notes
- Generated: 2025-11-18T07:54:34.714631
