# File Documentation: test_controllers_cli_controller.py

## Metadata
- **Path**: `cli/tests/test_controllers_cli_controller.py`
- **Size**: 2,760 bytes
- **Lines**: 80
- **Category**: python
- **Extension**: .py
...
This is a **python** file named `test_controllers_cli_controller.py`.

**Python Module**

- **Functions** (6): test_parse_and_split_input_custom_filters, test_cli_controller_print_help, test_CLIController_has_command, test_handle_job_cmds_with_export_path, test_run_cli_quit_command, test_execute_openbb_routine_with_mocked_requests
- **Import Statements**: 1
...
- **`test_cli_controller_print_help(mock_print_help)`**
- **`test_CLIController_has_command(controller_input, expected_output)`**
- **`test_handle_job_cmds_with_export_path()`**
- **`test_run_cli_quit_command(mock_print_goodbye, mock_switch)`**
...
**Generated**: 2025-11-19T02:16:44.925594Z
