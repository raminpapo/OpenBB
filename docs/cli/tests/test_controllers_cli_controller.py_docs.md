# Documentation: cli/tests/test_controllers_cli_controller.py

## File Metadata
- **Path**: `cli/tests/test_controllers_cli_controller.py`
- **Size**: 2,760 characters, 80 lines
- **Words**: 211
- **Extension**: .py
...
**Functions** (6):
`test_parse_and_split_input_custom_filters`, `test_cli_controller_print_help`, `test_CLIController_has_command`, `test_handle_job_cmds_with_export_path`, `test_run_cli_quit_command`, `test_execute_openbb_routine_with_mocked_requests`

**Imports** (4):
`unittest.mock`, `MagicMock`, `pytest`, `openbb_cli.controllers.cli_controller`
...
## Notes
- Generated: 2025-11-18T07:54:34.720178
