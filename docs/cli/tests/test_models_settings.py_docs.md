# Documentation: cli/tests/test_models_settings.py

## File Metadata
- **Path**: `cli/tests/test_models_settings.py`
- **Size**: 2,617 characters, 70 lines
- **Words**: 219
- **Extension**: .py
...
**Functions** (4):
`test_default_values`, `test_repr`, `test_from_env`, `test_set_item`

**Imports** (6):
`unittest.mock`, `mock_open`, `openbb_cli.models.settings`, `Settings`, `environment`, `environment`
...
## Notes
- Generated: 2025-11-18T07:54:34.729806
